...
printint(int fd, int xx, int base, int sgn)
{
 ...
 6be:	8d 4f 02             	lea    0x2(%edi),%ecx
  ...
  while(--i >= 0)
 6c1:	8d 79 ff             	lea    -0x1(%ecx),%edi
 6c4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 6c8:	0f b6 44 3d d8       	movzbl -0x28(%ebp,%edi,1),%eax
  write(fd, &c, 1);
 6cd:	83 ec 04             	sub    $0x4,%esp
  while(--i >= 0)
 6d0:	83 ef 01             	sub    $0x1,%edi
  write(fd, &c, 1);
 6d3:	6a 01                	push   $0x1
 6d5:	53                   	push   %ebx
 6d6:	56                   	push   %esi
 6d7:	88 45 d7             	mov    %al,-0x29(%ebp)
 6da:	e8 c3 fe ff ff       	call   5a2 <write>
  while(--i >= 0)
 6df:	83 c4 10             	add    $0x10,%esp
 6e2:	83 ff ff             	cmp    $0xffffffff,%edi
 6e5:	75 e1                	jne    6c8 <printint+0x68>
    putc(fd, buf[i]);
}
 ...
 70c:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 81d:	74 7c                	je     89b <printf+0x19b>
        while(*s != 0){
 81f:	0f b6 03             	movzbl (%ebx),%eax
 822:	84 c0                	test   %al,%al
 824:	74 29                	je     84f <printf+0x14f>
 ...
 896:	e9 5b ff ff ff       	jmp    7f6 <printf+0xf6>
        while(*s != 0){
 89b:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 8a0:	bb 6a 0a 00 00       	mov    $0xa6a,%ebx
 8a5:	eb 89                	jmp    830 <printf+0x130>
...
free(void *ap)
{
 ...
 8b1:	a1 90 0d 00 00       	mov    0xd90,%eax
{
 ...
 8d6:	73 18                	jae    8f0 <free+0x40>
{
 ...
 907:	89 08                	mov    %ecx,(%eax)
  freep = p;
 909:	a3 90 0d 00 00       	mov    %eax,0xd90
}
 90e:	5b                   	pop    %ebx
 90f:	5e                   	pop    %esi
 910:	5f                   	pop    %edi
 ...
 92a:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 92d:	a3 90 0d 00 00       	mov    %eax,0xd90
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 949:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 94c:	8b 15 90 0d 00 00    	mov    0xd90,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 a16:	00 00 00 
 a19:	e9 4e ff ff ff       	jmp    96c <malloc+0x2c>
