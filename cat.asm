...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4aa:	e8 c3 fe ff ff       	call   372 <write>
  while(--i >= 0)
 ...
 4dc:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 66b:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 670:	bb 28 08 00 00       	mov    $0x828,%ebx
