 ...
 50c:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 69b:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 6a0:	bb 43 08 00 00       	mov    $0x843,%ebx
...
free(void *ap)
{
 ...
 6b1:	a1 f0 0a 00 00       	mov    0xaf0,%eax
{
 ...
 6d6:	73 18                	jae    6f0 <free+0x40>
{
 ...
 72a:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 72d:	a3 f0 0a 00 00       	mov    %eax,0xaf0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 749:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 74c:	8b 15 f0 0a 00 00    	mov    0xaf0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
