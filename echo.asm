 ...
 43c:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 5cb:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5d0:	bb 59 07 00 00       	mov    $0x759,%ebx
 ...
 606:	73 18                	jae    620 <free+0x40>
{
 ...
 637:	89 08                	mov    %ecx,(%eax)
  freep = p;
 639:	a3 04 0a 00 00       	mov    %eax,0xa04
}
 63e:	5b                   	pop    %ebx
 63f:	5e                   	pop    %esi
 640:	5f                   	pop    %edi
 ...
 65a:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 65d:	a3 04 0a 00 00       	mov    %eax,0xa04
    p->s.size += bp->s.size;
