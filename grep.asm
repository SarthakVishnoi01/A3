...
printint(int fd, int xx, int base, int sgn)
{
 ...
 6aa:	e8 d3 fe ff ff       	call   582 <write>
  while(--i >= 0)
 ...
 6dc:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 86b:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 870:	bb 26 0a 00 00       	mov    $0xa26,%ebx
...
free(void *ap)
{
 ...
 881:	a1 c0 0d 00 00       	mov    0xdc0,%eax
{
 ...
 8a6:	73 18                	jae    8c0 <free+0x40>
{
 ...
 8fa:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 8fd:	a3 c0 0d 00 00       	mov    %eax,0xdc0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 919:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 91c:	8b 15 c0 0d 00 00    	mov    0xdc0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
