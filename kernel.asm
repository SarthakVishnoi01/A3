...
80100519:	e8 92 41 00 00       	call   801046b0 <memmove>
    memset(crt+pos, 0, sizeof(crt[0])*(24*80 - pos));
...
8010052e:	e8 cd 40 00 00       	call   80104600 <memset>
...
80100705:	e8 a6 3e 00 00       	call   801045b0 <release>
...
801007a8:	e8 53 3d 00 00       	call   80104500 <acquire>
...
801007f3:	e8 08 3d 00 00       	call   80104500 <acquire>
  while((c = getc()) >= 0){
...
80100858:	e8 53 3d 00 00       	call   801045b0 <release>
  if(doprocdump) {
...
801008e6:	e8 d5 37 00 00       	call   801040c0 <wakeup>
...
80100967:	e9 44 38 00 00       	jmp    801041b0 <procdump>
        input.buf[input.e++ % INPUT_BUF] = c;
...
80100a62:	75 d2                	jne    80100a36 <exec+0x56>
  if((pgdir = setupkvm()) == 0)
80100a64:	e8 c7 64 00 00       	call   80106f30 <setupkvm>
...
80100af4:	e8 97 62 00 00       	call   80106d90 <allocuvm>
...
80100b2a:	e8 a1 61 00 00       	call   80106cd0 <loaduvm>
...
80100b49:	e8 62 63 00 00       	call   80106eb0 <freevm>
...
80100b85:	e8 06 62 00 00       	call   80106d90 <allocuvm>
...
80100b9c:	e8 0f 63 00 00       	call   80106eb0 <freevm>
...
80100be1:	e8 ea 63 00 00       	call   80106fd0 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
...
80100c1d:	e8 fe 3b 00 00       	call   80104820 <strlen>
...
80100c30:	e8 eb 3b 00 00       	call   80104820 <strlen>
...
80100c41:	e8 ea 64 00 00       	call   80107130 <copyout>
...
80100ca5:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100cab:	e8 80 64 00 00       	call   80107130 <copyout>
...
80100cf0:	e8 eb 3a 00 00       	call   801047e0 <safestrcpy>
  curproc->pgdir = pgdir;
...
80100d1c:	e8 1f 5e 00 00       	call   80106b40 <switchuvm>
  freevm(oldpgdir);
80100d21:	89 3c 24             	mov    %edi,(%esp)
80100d24:	e8 87 61 00 00       	call   80106eb0 <freevm>
  return 0;
...
80100d50:	e8 4b 36 00 00       	call   801043a0 <initlock>
}
...
80100d71:	e8 8a 37 00 00       	call   80104500 <acquire>
...
80100dba:	e8 f1 37 00 00       	call   801045b0 <release>
}
...
80100ddf:	e8 1c 37 00 00       	call   80104500 <acquire>
  if(f->ref < 1)
...
80100e31:	e8 ca 36 00 00       	call   80104500 <acquire>
  if(f->ref < 1)
...
801019f5:	01 de                	add    %ebx,%esi
    memmove(dst, bp->data + off%BSIZE, m);
801019f7:	e8 b4 2c 00 00       	call   801046b0 <memmove>
    brelse(bp);
...
80101af3:	e8 b8 2b 00 00       	call   801046b0 <memmove>
    log_write(bp);
...
80101b8e:	e8 8d 2b 00 00       	call   80104720 <strncmp>
}
80101b93:	c9                   	leave  
80101b94:	c3                   	ret    
...
80101bf5:	e8 26 2b 00 00       	call   80104720 <strncmp>
      continue;
...
80101ea8:	68 b6 7c 10 80       	push   $0x80107cb6
...
80102189:	e8 72 1d 00 00       	call   80103f00 <sleep>
  while((b->flags & (B_VALID|B_DIRTY)) != B_VALID){
...
80102907:	e8 44 1d 00 00       	call   80104650 <memcmp>
...
80102a34:	e8 77 1c 00 00       	call   801046b0 <memmove>
...
80102ae4:	e8 b7 18 00 00       	call   801043a0 <initlock>
  readsb(dev, &sb);
80102ae9:	58                   	pop    %eax
...
80102b7b:	e8 80 19 00 00       	call   80104500 <acquire>
...
80102b95:	e8 66 13 00 00       	call   80103f00 <sleep>
...
80102bcc:	e8 df 19 00 00       	call   801045b0 <release>
      break;
    }
  }
}
...
80102bee:	e8 0d 19 00 00       	call   80104500 <acquire>
  log.outstanding -= 1;
...
80102c2c:	e8 7f 19 00 00       	call   801045b0 <release>
}
...
80102c8c:	e8 1f 1a 00 00       	call   801046b0 <memmove>
...
80102cd5:	e8 26 18 00 00       	call   80104500 <acquire>
    wakeup(&log);
...
80102ce8:	00 00 00 
    wakeup(&log);
80102ceb:	e8 d0 13 00 00       	call   801040c0 <wakeup>
    release(&log.lock);
80102cf0:	c7 04 24 e0 36 11 80 	movl   $0x801136e0,(%esp)
80102cf7:	e8 b4 18 00 00       	call   801045b0 <release>
...
80102d18:	e8 a3 13 00 00       	call   801040c0 <wakeup>
  release(&log.lock);
80102d1d:	c7 04 24 e0 36 11 80 	movl   $0x801136e0,(%esp)
80102d24:	e8 87 18 00 00       	call   801045b0 <release>
...
80102d8e:	e8 6d 17 00 00       	call   80104500 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102ddc:	c9                   	leave  
  release(&log.lock);
80102ddd:	e9 ce 17 00 00       	jmp    801045b0 <release>
...
80102e42:	e8 b9 2b 00 00       	call   80105a00 <idtinit>
...
80102e5a:	e8 71 0d 00 00       	call   80103bd0 <scheduler>
80102e5f:	90                   	nop
...
80102e63:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102e66:	e8 b5 3c 00 00       	call   80106b20 <switchkvm>
  seginit();
80102e6b:	e8 b0 3b 00 00       	call   80106a20 <seginit>
  lapicinit();
...
80102ec9:	e8 22 2e 00 00       	call   80105cf0 <uartinit>
  pinit();         // process table
...
80102ef9:	e8 b2 17 00 00       	call   801046b0 <memmove>
  for(c = cpus; c < cpus+ncpu; c++){
...
80102f95:	e8 36 42 00 00       	call   801071d0 <containerInit>
...
80102fde:	e8 6d 16 00 00       	call   80104650 <memcmp>
...
80103092:	e8 b9 15 00 00       	call   80104650 <memcmp>
...
80103289:	e8 12 11 00 00       	call   801043a0 <initlock>
  (*f0)->type = FD_PIPE;
...
8010331f:	e8 dc 11 00 00       	call   80104500 <acquire>
  if(writable){
...
8010333f:	e8 7c 0d 00 00       	call   801040c0 <wakeup>
...
80103363:	5d                   	pop    %ebp
    release(&p->lock);
80103364:	e9 47 12 00 00       	jmp    801045b0 <release>
...
80103384:	e8 37 0d 00 00       	call   801040c0 <wakeup>
...
80103394:	e8 17 12 00 00       	call   801045b0 <release>
    kfree((char*)p);
...
801033bd:	e8 3e 11 00 00       	call   80104500 <acquire>
  for(i = 0; i < n; i++){
...
80103414:	e8 a7 0c 00 00       	call   801040c0 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
80103419:	5a                   	pop    %edx
8010341a:	59                   	pop    %ecx
8010341b:	53                   	push   %ebx
8010341c:	56                   	push   %esi
8010341d:	e8 de 0a 00 00       	call   80103f00 <sleep>
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
...
80103454:	e8 57 11 00 00       	call   801045b0 <release>
        return -1;
...
801034a4:	e8 17 0c 00 00       	call   801040c0 <wakeup>
  release(&p->lock);
801034a9:	89 1c 24             	mov    %ebx,(%esp)
801034ac:	e8 ff 10 00 00       	call   801045b0 <release>
  return n;
...
801034d0:	e8 2b 10 00 00       	call   80104500 <acquire>
...
80103505:	e8 f6 09 00 00       	call   80103f00 <sleep>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
...
8010353e:	e8 6d 10 00 00       	call   801045b0 <release>
      return -1;
...
80103597:	e8 24 0b 00 00       	call   801040c0 <wakeup>
  release(&p->lock);
8010359c:	89 34 24             	mov    %esi,(%esp)
8010359f:	e8 0c 10 00 00       	call   801045b0 <release>
  return i;
...
801035d1:	e8 2a 0f 00 00       	call   80104500 <acquire>
...
8010360c:	89 15 04 b0 10 80    	mov    %edx,0x8010b004
  release(&ptable.lock);
80103612:	e8 99 0f 00 00       	call   801045b0 <release>
...
80103634:	89 53 1c             	mov    %edx,0x1c(%ebx)
  *(uint*)sp = (uint)trapret;
80103637:	c7 40 14 52 59 10 80 	movl   $0x80105952,0x14(%eax)
  p->context = (struct context*)sp;
...
80103646:	e8 b5 0f 00 00       	call   80104600 <memset>
...
8010366a:	e8 41 0f 00 00       	call   801045b0 <release>
}
...
8010369b:	e8 10 0f 00 00       	call   801045b0 <release>
...
801036f5:	e8 06 0e 00 00       	call   80104500 <acquire>
...
80103749:	5d                   	pop    %ebp
  release(&ptable.lock);
8010374a:	e9 61 0e 00 00       	jmp    801045b0 <release>
8010374f:	90                   	nop
...
801037b0:	e8 eb 0b 00 00       	call   801043a0 <initlock>
}
...
80103864:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103867:	e8 b4 0b 00 00       	call   80104420 <pushcli>
  c = mycpu();
8010386c:	e8 4f ff ff ff       	call   801037c0 <mycpu>
  p = c->proc;
80103871:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103877:	e8 e4 0b 00 00       	call   80104460 <popcli>
}
...
801038a3:	e8 88 36 00 00       	call   80106f30 <setupkvm>
801038a8:	85 c0                	test   %eax,%eax
801038aa:	89 43 04             	mov    %eax,0x4(%ebx)
801038ad:	0f 84 ea 00 00 00    	je     8010399d <userinit+0x10d>
...
801038d6:	e8 25 0d 00 00       	call   80104600 <memset>
...
80103935:	e8 a6 0e 00 00       	call   801047e0 <safestrcpy>
  p->cwd = namei("/");
...
8010396a:	e8 41 0c 00 00       	call   801045b0 <release>
  acquire(&ctable.lock);
8010396f:	c7 04 24 80 3d 11 80 	movl   $0x80113d80,(%esp)
80103976:	e8 85 0b 00 00       	call   80104500 <acquire>
  ctable.container[0].presentProc[p->pid] =1;
8010397b:	8b 43 10             	mov    0x10(%ebx),%eax
  release(&ctable.lock);
8010397e:	c7 04 24 80 3d 11 80 	movl   $0x80113d80,(%esp)
  ctable.container[0].presentProc[p->pid] =1;
80103985:	c7 04 85 b8 3d 11 80 	movl   $0x1,-0x7feec248(,%eax,4)
8010398c:	01 00 00 00 
  release(&ctable.lock);
80103990:	e8 1b 0c 00 00       	call   801045b0 <release>
}
...
801039a0:	68 59 7a 10 80       	push   $0x80107a59
...
801039b5:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
801039b8:	e8 63 0a 00 00       	call   80104420 <pushcli>
  c = mycpu();
801039bd:	e8 fe fd ff ff       	call   801037c0 <mycpu>
  p = c->proc;
801039c2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801039c8:	e8 93 0a 00 00       	call   80104460 <popcli>
  if(n > 0){
...
801039de:	e8 ad 33 00 00       	call   80106d90 <allocuvm>
...
801039f0:	e8 4b 31 00 00       	call   80106b40 <switchuvm>
  return 0;
...
80103a14:	e8 67 34 00 00       	call   80106e80 <deallocuvm>
...
80103a36:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103a39:	e8 e2 09 00 00       	call   80104420 <pushcli>
  c = mycpu();
80103a3e:	e8 7d fd ff ff       	call   801037c0 <mycpu>
  p = c->proc;
80103a43:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103a49:	e8 12 0a 00 00       	call   80104460 <popcli>
  if((np = allocproc()) == 0){
80103a4e:	e8 6d fb ff ff       	call   801035c0 <allocproc>
80103a53:	85 c0                	test   %eax,%eax
80103a55:	89 c7                	mov    %eax,%edi
80103a57:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80103a5a:	0f 84 df 00 00 00    	je     80103b3f <fork+0x10f>
  if((np->pgdir = copyuvm(curproc->pgdir, curproc->sz)) == 0){
80103a60:	83 ec 08             	sub    $0x8,%esp
80103a63:	ff 33                	pushl  (%ebx)
80103a65:	ff 73 04             	pushl  0x4(%ebx)
80103a68:	e8 93 35 00 00       	call   80107000 <copyuvm>
80103a6d:	83 c4 10             	add    $0x10,%esp
80103a70:	85 c0                	test   %eax,%eax
80103a72:	89 47 04             	mov    %eax,0x4(%edi)
80103a75:	0f 84 cb 00 00 00    	je     80103b46 <fork+0x116>
  np->sz = curproc->sz;
80103a7b:	8b 03                	mov    (%ebx),%eax
80103a7d:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  *np->tf = *curproc->tf;
80103a80:	b9 13 00 00 00       	mov    $0x13,%ecx
  np->sz = curproc->sz;
80103a85:	89 07                	mov    %eax,(%edi)
  np->parent = curproc;
80103a87:	89 5f 14             	mov    %ebx,0x14(%edi)
  *np->tf = *curproc->tf;
80103a8a:	89 f8                	mov    %edi,%eax
80103a8c:	8b 73 1c             	mov    0x1c(%ebx),%esi
80103a8f:	8b 7f 1c             	mov    0x1c(%edi),%edi
80103a92:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  for(i = 0; i < NOFILE; i++)
80103a94:	31 f6                	xor    %esi,%esi
  np->tf->eax = 0;
80103a96:	8b 40 1c             	mov    0x1c(%eax),%eax
...
80103aac:	e8 1f d3 ff ff       	call   80100dd0 <filedup>
80103ab1:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80103ab4:	83 c4 10             	add    $0x10,%esp
80103ab7:	89 44 b2 2c          	mov    %eax,0x2c(%edx,%esi,4)
  for(i = 0; i < NOFILE; i++)
...
80103ac6:	ff 73 6c             	pushl  0x6c(%ebx)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103ac9:	83 c3 70             	add    $0x70,%ebx
  np->cwd = idup(curproc->cwd);
80103acc:	e8 6f db ff ff       	call   80101640 <idup>
80103ad1:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103ad4:	83 c4 0c             	add    $0xc,%esp
  np->cwd = idup(curproc->cwd);
80103ad7:	89 47 6c             	mov    %eax,0x6c(%edi)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103ada:	8d 47 70             	lea    0x70(%edi),%eax
80103add:	6a 10                	push   $0x10
80103adf:	53                   	push   %ebx
80103ae0:	50                   	push   %eax
80103ae1:	e8 fa 0c 00 00       	call   801047e0 <safestrcpy>
  pid = np->pid;
80103ae6:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103ae9:	c7 04 24 c0 52 11 80 	movl   $0x801152c0,(%esp)
80103af0:	e8 0b 0a 00 00       	call   80104500 <acquire>
  np->state = RUNNABLE;
80103af5:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  np->containerID = 0;
80103afc:	c7 47 18 00 00 00 00 	movl   $0x0,0x18(%edi)
  release(&ptable.lock);
80103b03:	c7 04 24 c0 52 11 80 	movl   $0x801152c0,(%esp)
80103b0a:	e8 a1 0a 00 00       	call   801045b0 <release>
  acquire(&ctable.lock);
80103b0f:	c7 04 24 80 3d 11 80 	movl   $0x80113d80,(%esp)
80103b16:	e8 e5 09 00 00       	call   80104500 <acquire>
  release(&ctable.lock);
80103b1b:	c7 04 24 80 3d 11 80 	movl   $0x80113d80,(%esp)
  ctable.container[0].presentProc[pid] =1;
80103b22:	c7 04 9d b8 3d 11 80 	movl   $0x1,-0x7feec248(,%ebx,4)
80103b29:	01 00 00 00 
  release(&ctable.lock);
80103b2d:	e8 7e 0a 00 00       	call   801045b0 <release>
  return pid;
80103b32:	83 c4 10             	add    $0x10,%esp
}
80103b35:	8d 65 f4             	lea    -0xc(%ebp),%esp
...
80103b3e:	c3                   	ret    
    return -1;
80103b3f:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80103b44:	eb ef                	jmp    80103b35 <fork+0x105>
    kfree(np->kstack);
80103b46:	8b 7d e4             	mov    -0x1c(%ebp),%edi
80103b49:	83 ec 0c             	sub    $0xc,%esp
    return -1;
80103b4c:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
    kfree(np->kstack);
80103b51:	ff 77 08             	pushl  0x8(%edi)
80103b54:	e8 87 e7 ff ff       	call   801022e0 <kfree>
    np->kstack = 0;
80103b59:	c7 47 08 00 00 00 00 	movl   $0x0,0x8(%edi)
    np->state = UNUSED;
80103b60:	c7 47 0c 00 00 00 00 	movl   $0x0,0xc(%edi)
    return -1;
80103b67:	83 c4 10             	add    $0x10,%esp
80103b6a:	eb c9                	jmp    80103b35 <fork+0x105>
80103b6c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

80103b70 <getName>:
{
80103b70:	55                   	push   %ebp
80103b71:	b8 7d 7a 10 80       	mov    $0x80107a7d,%eax
80103b76:	89 e5                	mov    %esp,%ebp
80103b78:	8b 55 08             	mov    0x8(%ebp),%edx
80103b7b:	83 fa 02             	cmp    $0x2,%edx
80103b7e:	77 07                	ja     80103b87 <getName+0x17>
80103b80:	8b 04 95 94 7b 10 80 	mov    -0x7fef846c(,%edx,4),%eax
}
80103b87:	5d                   	pop    %ebp
80103b88:	c3                   	ret    
...
80103b93:	8b 55 08             	mov    0x8(%ebp),%edx
  for(int i = (c->nextprocId)+1;i<NPROC;i++){
80103b96:	8b 82 08 01 00 00    	mov    0x108(%edx),%eax
80103b9c:	83 c0 01             	add    $0x1,%eax
80103b9f:	83 f8 3f             	cmp    $0x3f,%eax
80103ba2:	7e 14                	jle    80103bb8 <nextproc+0x28>
80103ba4:	eb 22                	jmp    80103bc8 <nextproc+0x38>
80103ba6:	8d 76 00             	lea    0x0(%esi),%esi
80103ba9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
80103bb0:	83 c0 01             	add    $0x1,%eax
80103bb3:	83 f8 40             	cmp    $0x40,%eax
80103bb6:	74 10                	je     80103bc8 <nextproc+0x38>
    if(c->presentProc[i])
80103bb8:	8b 4c 82 04          	mov    0x4(%edx,%eax,4),%ecx
80103bbc:	85 c9                	test   %ecx,%ecx
80103bbe:	74 f0                	je     80103bb0 <nextproc+0x20>
}
80103bc0:	5d                   	pop    %ebp
80103bc1:	c3                   	ret    
...
80103bd6:	83 ec 1c             	sub    $0x1c,%esp
  struct cpu *c = mycpu();
80103bd9:	e8 e2 fb ff ff       	call   801037c0 <mycpu>
  c->proc = 0;
...
80103bf1:	bf b4 3d 11 80       	mov    $0x80113db4,%edi
80103bf6:	eb 16                	jmp    80103c0e <scheduler+0x3e>
80103bf8:	90                   	nop
80103bf9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80103c00:	81 c7 0c 01 00 00    	add    $0x10c,%edi
80103c06:	81 ff a4 52 11 80    	cmp    $0x801152a4,%edi
80103c0c:	73 e2                	jae    80103bf0 <scheduler+0x20>
      if(con->state != CWAITING){
80103c0e:	83 bf 04 01 00 00 01 	cmpl   $0x1,0x104(%edi)
80103c15:	75 e9                	jne    80103c00 <scheduler+0x30>
      acquire(&ptable.lock);
80103c17:	83 ec 0c             	sub    $0xc,%esp
      for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c1a:	bb f4 52 11 80       	mov    $0x801152f4,%ebx
      acquire(&ptable.lock);
80103c1f:	68 c0 52 11 80       	push   $0x801152c0
80103c24:	e8 d7 08 00 00       	call   80104500 <acquire>
80103c29:	83 c4 10             	add    $0x10,%esp
80103c2c:	eb 0d                	jmp    80103c3b <scheduler+0x6b>
80103c2e:	66 90                	xchg   %ax,%ax
      for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c30:	83 eb 80             	sub    $0xffffff80,%ebx
80103c33:	81 fb f4 72 11 80    	cmp    $0x801172f4,%ebx
80103c39:	73 65                	jae    80103ca0 <scheduler+0xd0>
        if(con->presentProc[p->pid]){
80103c3b:	8b 43 10             	mov    0x10(%ebx),%eax
80103c3e:	8b 4c 87 04          	mov    0x4(%edi,%eax,4),%ecx
80103c42:	85 c9                	test   %ecx,%ecx
80103c44:	74 ea                	je     80103c30 <scheduler+0x60>
          if(p->state != RUNNABLE)
80103c46:	83 7b 0c 03          	cmpl   $0x3,0xc(%ebx)
80103c4a:	75 e4                	jne    80103c30 <scheduler+0x60>
          switchuvm(p);
80103c4c:	83 ec 0c             	sub    $0xc,%esp
          c->proc = p;
80103c4f:	89 9e ac 00 00 00    	mov    %ebx,0xac(%esi)
          switchuvm(p);
80103c55:	53                   	push   %ebx
      for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c56:	83 eb 80             	sub    $0xffffff80,%ebx
          switchuvm(p);
80103c59:	e8 e2 2e 00 00       	call   80106b40 <switchuvm>
            cprintf("Container %d : Scheduling process %d\n",con->containerID,p->pid);
80103c5e:	83 c4 0c             	add    $0xc,%esp
80103c61:	ff 73 90             	pushl  -0x70(%ebx)
80103c64:	ff 37                	pushl  (%edi)
80103c66:	68 6c 7b 10 80       	push   $0x80107b6c
          p->state = RUNNING;
80103c6b:	c7 43 8c 04 00 00 00 	movl   $0x4,-0x74(%ebx)
            cprintf("Container %d : Scheduling process %d\n",con->containerID,p->pid);
80103c72:	e8 e9 c9 ff ff       	call   80100660 <cprintf>
          swtch(&(c->scheduler), p->context);
80103c77:	58                   	pop    %eax
80103c78:	5a                   	pop    %edx
80103c79:	ff 73 a0             	pushl  -0x60(%ebx)
80103c7c:	ff 75 e4             	pushl  -0x1c(%ebp)
80103c7f:	e8 b7 0b 00 00       	call   8010483b <swtch>
          switchkvm();
80103c84:	e8 97 2e 00 00       	call   80106b20 <switchkvm>
          c->proc = 0;
80103c89:	83 c4 10             	add    $0x10,%esp
      for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c8c:	81 fb f4 72 11 80    	cmp    $0x801172f4,%ebx
          c->proc = 0;
80103c92:	c7 86 ac 00 00 00 00 	movl   $0x0,0xac(%esi)
80103c99:	00 00 00 
      for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c9c:	72 9d                	jb     80103c3b <scheduler+0x6b>
80103c9e:	66 90                	xchg   %ax,%ax
      release(&ptable.lock);
80103ca0:	83 ec 0c             	sub    $0xc,%esp
80103ca3:	68 c0 52 11 80       	push   $0x801152c0
80103ca8:	e8 03 09 00 00       	call   801045b0 <release>
80103cad:	83 c4 10             	add    $0x10,%esp
80103cb0:	e9 4b ff ff ff       	jmp    80103c00 <scheduler+0x30>
80103cb5:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
...
80103cc4:	53                   	push   %ebx
  pushcli();
80103cc5:	e8 56 07 00 00       	call   80104420 <pushcli>
  c = mycpu();
80103cca:	e8 f1 fa ff ff       	call   801037c0 <mycpu>
  p = c->proc;
80103ccf:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103cd5:	e8 86 07 00 00       	call   80104460 <popcli>
  if(!holding(&ptable.lock))
80103cda:	83 ec 0c             	sub    $0xc,%esp
80103cdd:	68 c0 52 11 80       	push   $0x801152c0
80103ce2:	e8 e9 07 00 00       	call   801044d0 <holding>
...
80103d07:	75 41                	jne    80103d4a <sched+0x8a>
  intena = mycpu()->intena;
80103d09:	e8 b2 fa ff ff       	call   801037c0 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
80103d0e:	83 c3 20             	add    $0x20,%ebx
  intena = mycpu()->intena;
80103d11:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103d17:	e8 a4 fa ff ff       	call   801037c0 <mycpu>
80103d1c:	83 ec 08             	sub    $0x8,%esp
80103d1f:	ff 70 04             	pushl  0x4(%eax)
80103d22:	53                   	push   %ebx
80103d23:	e8 13 0b 00 00       	call   8010483b <swtch>
  mycpu()->intena = intena;
80103d28:	e8 93 fa ff ff       	call   801037c0 <mycpu>
}
...
80103d40:	68 82 7a 10 80       	push   $0x80107a82
80103d45:	e8 26 c6 ff ff       	call   80100370 <panic>
    panic("sched interruptible");
80103d4a:	83 ec 0c             	sub    $0xc,%esp
80103d4d:	68 ae 7a 10 80       	push   $0x80107aae
80103d52:	e8 19 c6 ff ff       	call   80100370 <panic>
    panic("sched running");
80103d57:	83 ec 0c             	sub    $0xc,%esp
80103d5a:	68 a0 7a 10 80       	push   $0x80107aa0
80103d5f:	e8 0c c6 ff ff       	call   80100370 <panic>
    panic("sched locks");
80103d64:	83 ec 0c             	sub    $0xc,%esp
80103d67:	68 94 7a 10 80       	push   $0x80107a94
...
80103d86:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103d89:	e8 92 06 00 00       	call   80104420 <pushcli>
  c = mycpu();
80103d8e:	e8 2d fa ff ff       	call   801037c0 <mycpu>
  p = c->proc;
80103d93:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103d99:	e8 c2 06 00 00       	call   80104460 <popcli>
  if(curproc == initproc)
80103d9e:	39 35 b8 b5 10 80    	cmp    %esi,0x8010b5b8
80103da4:	8d 5e 2c             	lea    0x2c(%esi),%ebx
80103da7:	8d 7e 6c             	lea    0x6c(%esi),%edi
...
80103dba:	e8 61 d0 ff ff       	call   80100e20 <fileclose>
      curproc->ofile[fd] = 0;
...
80103dcd:	75 e1                	jne    80103db0 <exit+0x30>
  begin_op();
80103dcf:	e8 9c ed ff ff       	call   80102b70 <begin_op>
  iput(curproc->cwd);
80103dd4:	83 ec 0c             	sub    $0xc,%esp
80103dd7:	ff 76 6c             	pushl  0x6c(%esi)
80103dda:	e8 c1 d9 ff ff       	call   801017a0 <iput>
  end_op();
80103ddf:	e8 fc ed ff ff       	call   80102be0 <end_op>
  curproc->cwd = 0;
80103de4:	c7 46 6c 00 00 00 00 	movl   $0x0,0x6c(%esi)
  acquire(&ptable.lock);
80103deb:	c7 04 24 c0 52 11 80 	movl   $0x801152c0,(%esp)
80103df2:	e8 09 07 00 00       	call   80104500 <acquire>
...
80103e59:	b8 f4 52 11 80       	mov    $0x801152f4,%eax
80103e5e:	eb 0a                	jmp    80103e6a <exit+0xea>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103e60:	83 e8 80             	sub    $0xffffff80,%eax
80103e63:	3d f4 72 11 80       	cmp    $0x801172f4,%eax
80103e68:	73 d6                	jae    80103e40 <exit+0xc0>
    if(p->state == SLEEPING && p->chan == chan){
...
80103e8d:	68 cf 7a 10 80       	push   $0x80107acf
80103e92:	e8 d9 c4 ff ff       	call   80100370 <panic>
    panic("init exiting");
80103e97:	83 ec 0c             	sub    $0xc,%esp
80103e9a:	68 c2 7a 10 80       	push   $0x80107ac2
80103e9f:	e8 cc c4 ff ff       	call   80100370 <panic>
...
80103eb7:	68 c0 52 11 80       	push   $0x801152c0
80103ebc:	e8 3f 06 00 00       	call   80104500 <acquire>
  pushcli();
80103ec1:	e8 5a 05 00 00       	call   80104420 <pushcli>
  c = mycpu();
80103ec6:	e8 f5 f8 ff ff       	call   801037c0 <mycpu>
  p = c->proc;
80103ecb:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ed1:	e8 8a 05 00 00       	call   80104460 <popcli>
  myproc()->state = RUNNABLE;
80103ed6:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  sched();
80103edd:	e8 de fd ff ff       	call   80103cc0 <sched>
  release(&ptable.lock);
80103ee2:	c7 04 24 c0 52 11 80 	movl   $0x801152c0,(%esp)
80103ee9:	e8 c2 06 00 00       	call   801045b0 <release>
}
...
80103f0f:	e8 0c 05 00 00       	call   80104420 <pushcli>
  c = mycpu();
80103f14:	e8 a7 f8 ff ff       	call   801037c0 <mycpu>
  p = c->proc;
80103f19:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f1f:	e8 3c 05 00 00       	call   80104460 <popcli>
  if(p == 0)
...
80103f30:	81 fe c0 52 11 80    	cmp    $0x801152c0,%esi
80103f36:	74 50                	je     80103f88 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
80103f38:	83 ec 0c             	sub    $0xc,%esp
80103f3b:	68 c0 52 11 80       	push   $0x801152c0
80103f40:	e8 bb 05 00 00       	call   80104500 <acquire>
    release(lk);
80103f45:	89 34 24             	mov    %esi,(%esp)
80103f48:	e8 63 06 00 00       	call   801045b0 <release>
  p->chan = chan;
...
80103f5c:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
    release(&ptable.lock);
80103f63:	c7 04 24 c0 52 11 80 	movl   $0x801152c0,(%esp)
80103f6a:	e8 41 06 00 00       	call   801045b0 <release>
    acquire(lk);
...
80103f7b:	5d                   	pop    %ebp
    acquire(lk);
80103f7c:	e9 7f 05 00 00       	jmp    80104500 <acquire>
...
80103fa9:	68 e1 7a 10 80       	push   $0x80107ae1
80103fae:	e8 bd c3 ff ff       	call   80100370 <panic>
    panic("sleep");
80103fb3:	83 ec 0c             	sub    $0xc,%esp
80103fb6:	68 db 7a 10 80       	push   $0x80107adb
80103fbb:	e8 b0 c3 ff ff       	call   80100370 <panic>
...
80104044:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
80104047:	e8 94 e2 ff ff       	call   801022e0 <kfree>
        freevm(p->pgdir);
8010404c:	5a                   	pop    %edx
...
80104050:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80104057:	e8 54 2e 00 00       	call   80106eb0 <freevm>
        p->pid = 0;
8010405c:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
80104063:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
8010406a:	c6 43 70 00          	movb   $0x0,0x70(%ebx)
        p->killed = 0;
8010406e:	c7 43 28 00 00 00 00 	movl   $0x0,0x28(%ebx)
        p->state = UNUSED;
80104075:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
8010407c:	c7 04 24 c0 52 11 80 	movl   $0x801152c0,(%esp)
80104083:	e8 28 05 00 00       	call   801045b0 <release>
        return pid;
...
80104094:	83 ec 0c             	sub    $0xc,%esp
      return -1;
80104097:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
8010409c:	68 c0 52 11 80       	push   $0x801152c0
801040a1:	e8 0a 05 00 00       	call   801045b0 <release>
      return -1;
801040a6:	83 c4 10             	add    $0x10,%esp
}
801040a9:	8d 65 f8             	lea    -0x8(%ebp),%esp
801040ac:	89 f0                	mov    %esi,%eax
801040ae:	5b                   	pop    %ebx
801040af:	5e                   	pop    %esi
801040b0:	5d                   	pop    %ebp
801040b1:	c3                   	ret    
...
801040ff:	3d f4 72 11 80       	cmp    $0x801172f4,%eax
80104104:	72 e4                	jb     801040ea <wakeup+0x2a>
  wakeup1(chan);
  release(&ptable.lock);
80104106:	c7 45 08 c0 52 11 80 	movl   $0x801152c0,0x8(%ebp)
}
8010410d:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104110:	c9                   	leave  
  release(&ptable.lock);
80104111:	e9 9a 04 00 00       	jmp    801045b0 <release>
...
80104127:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ptable.lock);
8010412a:	68 c0 52 11 80       	push   $0x801152c0
8010412f:	e8 cc 03 00 00       	call   80104500 <acquire>
80104134:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104137:	b8 f4 52 11 80       	mov    $0x801152f4,%eax
8010413c:	eb 0c                	jmp    8010414a <kill+0x2a>
8010413e:	66 90                	xchg   %ax,%ax
80104140:	83 e8 80             	sub    $0xffffff80,%eax
80104143:	3d f4 72 11 80       	cmp    $0x801172f4,%eax
80104148:	73 3e                	jae    80104188 <kill+0x68>
    if(p->pid == pid){
...
8010415f:	68 c0 52 11 80       	push   $0x801152c0
80104164:	e8 47 04 00 00       	call   801045b0 <release>
      return 0;
...
801041b6:	8d 75 e8             	lea    -0x18(%ebp),%esi
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801041b9:	bb f4 52 11 80       	mov    $0x801152f4,%ebx
{
...
801041ee:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
801041f1:	ba f2 7a 10 80       	mov    $0x80107af2,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801041f6:	77 11                	ja     80104209 <procdump+0x59>
801041f8:	8b 14 85 a0 7b 10 80 	mov    -0x7fef8460(,%eax,4),%edx
      state = "???";
801041ff:	b8 f2 7a 10 80       	mov    $0x80107af2,%eax
...
80104211:	68 f6 7a 10 80       	push   $0x80107af6
...
8010424d:	68 01 75 10 80       	push   $0x80107501
...
8010427a:	68 b8 7b 10 80       	push   $0x80107bb8
...
801042d5:	e8 26 fc ff ff       	call   80103f00 <sleep>
  while (lk->locked) {
...
80104373:	e8 e8 f4 ff ff       	call   80103860 <myproc>
...
80104429:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
8010442a:	e8 91 f3 ff ff       	call   801037c0 <mycpu>
...
8010443f:	e8 7c f3 ff ff       	call   801037c0 <mycpu>
80104444:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
  mycpu()->ncli += 1;
8010444a:	e8 71 f3 ff ff       	call   801037c0 <mycpu>
...
8010446b:	75 52                	jne    801044bf <popcli+0x5f>
  ...
  if(--mycpu()->ncli < 0)
8010446d:	e8 4e f3 ff ff       	call   801037c0 <mycpu>
...
80104485:	e8 36 f3 ff ff       	call   801037c0 <mycpu>
...
80104499:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  if(mycpu()->ncli == 0 && mycpu()->intena)
801044a0:	e8 1b f3 ff ff       	call   801037c0 <mycpu>
...
801044b5:	68 da 7b 10 80       	push   $0x80107bda
801044ba:	e8 b1 be ff ff       	call   80100370 <panic>
    panic("popcli - interruptible");
801044bf:	83 ec 0c             	sub    $0xc,%esp
801044c2:	68 c3 7b 10 80       	push   $0x80107bc3
...
801044e8:	e8 d3 f2 ff ff       	call   801037c0 <mycpu>
...
80104505:	e8 16 ff ff ff       	call   80104420 <pushcli>
  if(holding(lk))
8010450a:	8b 75 08             	mov    0x8(%ebp),%esi
...
8010451b:	0f 85 7f 00 00 00    	jne    801045a0 <acquire+0xa0>
...
80104530:	8b 75 08             	mov    0x8(%ebp),%esi
80104533:	89 d0                	mov    %edx,%eax
80104535:	f0 87 06             	lock xchg %eax,(%esi)
...
8010453c:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  lk->cpu = mycpu();
80104541:	8b 75 08             	mov    0x8(%ebp),%esi
80104544:	e8 77 f2 ff ff       	call   801037c0 <mycpu>
  getcallerpcs(&lk, lk->pcs);
80104549:	8d 56 0c             	lea    0xc(%esi),%edx
  lk->cpu = mycpu();
8010454c:	89 46 08             	mov    %eax,0x8(%esi)
  ebp = (uint*)v - 2;
...
80104569:	89 0c 9a             	mov    %ecx,(%edx,%ebx,4)
  for(i = 0; i < 10; i++){
8010456c:	83 c3 01             	add    $0x1,%ebx
    ebp = (uint*)ebp[0]; // saved %ebp
8010456f:	8b 00                	mov    (%eax),%eax
  for(i = 0; i < 10; i++){
80104571:	83 fb 0a             	cmp    $0xa,%ebx
...
8010457d:	8d 76 00             	lea    0x0(%esi),%esi
    pcs[i] = 0;
80104580:	c7 04 9a 00 00 00 00 	movl   $0x0,(%edx,%ebx,4)
  for(; i < 10; i++)
80104587:	83 c3 01             	add    $0x1,%ebx
8010458a:	83 fb 0a             	cmp    $0xa,%ebx
8010458d:	74 e7                	je     80104576 <acquire+0x76>
    pcs[i] = 0;
8010458f:	c7 04 9a 00 00 00 00 	movl   $0x0,(%edx,%ebx,4)
  for(; i < 10; i++)
80104596:	83 c3 01             	add    $0x1,%ebx
80104599:	83 fb 0a             	cmp    $0xa,%ebx
8010459c:	75 e2                	jne    80104580 <acquire+0x80>
8010459e:	eb d6                	jmp    80104576 <acquire+0x76>
    panic("acquire");
801045a0:	83 ec 0c             	sub    $0xc,%esp
801045a3:	68 e1 7b 10 80       	push   $0x80107be1
...
801045ec:	68 e9 7b 10 80       	push   $0x80107be9
...
801046c2:	8d 14 33             	lea    (%ebx,%esi,1),%edx
...
80104733:	0f b6 11             	movzbl (%ecx),%edx
...
80104748:	0f b6 11             	movzbl (%ecx),%edx
8010474b:	84 d2                	test   %dl,%dl
8010474d:	74 21                	je     80104770 <strncmp+0x50>
8010474f:	0f b6 18             	movzbl (%eax),%ebx
80104752:	89 c6                	mov    %eax,%esi
80104754:	38 da                	cmp    %bl,%dl
80104756:	75 1c                	jne    80104774 <strncmp+0x54>
    n--, p++, q++;
80104758:	8d 46 01             	lea    0x1(%esi),%eax
8010475b:	83 c1 01             	add    $0x1,%ecx
  while(n > 0 && *p && *p == *q)
8010475e:	39 f8                	cmp    %edi,%eax
...
80104770:	0f b6 5e 01          	movzbl 0x1(%esi),%ebx
  return (uchar)*p - (uchar)*q;
80104774:	0f b6 c2             	movzbl %dl,%eax
...
80104857:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
8010485a:	e8 01 f0 ff ff       	call   80103860 <myproc>
...
80104897:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
8010489a:	e8 c1 ef ff ff       	call   80103860 <myproc>
...
801048f5:	e8 66 ef ff ff       	call   80103860 <myproc>
...
80104903:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104906:	e8 55 ef ff ff       	call   80103860 <myproc>
  if(addr >= curproc->sz || addr+4 > curproc->sz)
...
80104948:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
8010494b:	e8 10 ef ff ff       	call   80103860 <myproc>
...
801049e5:	e8 76 ee ff ff       	call   80103860 <myproc>
  ...
  num = curproc->tf->eax;
801049ea:	8b 70 1c             	mov    0x1c(%eax),%esi
  struct proc *curproc = myproc();
...
801049f5:	83 fa 1a             	cmp    $0x1a,%edx
801049f8:	77 1e                	ja     80104a18 <syscall+0x38>
801049fa:	8b 14 85 20 7c 10 80 	mov    -0x7fef83e0(,%eax,4),%edx
...
80104a20:	68 f1 7b 10 80       	push   $0x80107bf1
...
80104a46:	8d 5d da             	lea    -0x26(%ebp),%ebx
{
...
80104aa7:	66 83 7f 50 02       	cmpw   $0x2,0x50(%edi)
...
80104ac4:	31 ff                	xor    %edi,%edi
    iunlockput(ip);
80104ac6:	e8 35 ce ff ff       	call   80101900 <iunlockput>
    return 0;
...
80104b69:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    dp->nlink++;  // for ".."
80104b70:	66 83 46 56 01       	addw   $0x1,0x56(%esi)
    iupdate(dp);
...
80104b84:	68 ac 7c 10 80       	push   $0x80107cac
...
80104b9c:	68 ab 7c 10 80       	push   $0x80107cab
...
80104c04:	e8 57 ec ff ff       	call   80103860 <myproc>
80104c09:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104c0c:	8b 44 90 2c          	mov    0x2c(%eax,%edx,4),%eax
...
80104c68:	8b 75 f4             	mov    -0xc(%ebp),%esi
  struct proc *curproc = myproc();
80104c6b:	e8 f0 eb ff ff       	call   80103860 <myproc>
...
80104c80:	8d 65 f8             	lea    -0x8(%ebp),%esp
    return -1;
80104c83:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
}
80104c88:	89 d8                	mov    %ebx,%eax
80104c8a:	5b                   	pop    %ebx
80104c8b:	5e                   	pop    %esi
80104c8c:	5d                   	pop    %ebp
80104c8d:	c3                   	ret    
80104c8e:	66 90                	xchg   %ax,%ax
      curproc->ofile[fd] = f;
80104c90:	89 74 98 2c          	mov    %esi,0x2c(%eax,%ebx,4)
  filedup(f);
80104c94:	83 ec 0c             	sub    $0xc,%esp
80104c97:	ff 75 f4             	pushl  -0xc(%ebp)
80104c9a:	e8 31 c1 ff ff       	call   80100dd0 <filedup>
  return fd;
...
80104cfd:	e8 3e c2 ff ff       	call   80100f40 <fileread>
...
80104d6d:	e8 5e c2 ff ff       	call   80100fd0 <filewrite>
...
80104da3:	78 2b                	js     80104dd0 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104da5:	e8 b6 ea ff ff       	call   80103860 <myproc>
80104daa:	8b 55 f0             	mov    -0x10(%ebp),%edx
  fileclose(f);
80104dad:	83 ec 0c             	sub    $0xc,%esp
  myproc()->ofile[fd] = 0;
80104db0:	c7 44 90 2c 00 00 00 	movl   $0x0,0x2c(%eax,%edx,4)
80104db7:	00 
  fileclose(f);
80104db8:	ff 75 f4             	pushl  -0xc(%ebp)
80104dbb:	e8 60 c0 ff ff       	call   80100e20 <fileclose>
  return 0;
...
80104e14:	e8 d7 c0 ff ff       	call   80100ef0 <filestat>
...
80104e62:	0f 88 e2 00 00 00    	js     80104f4a <sys_link+0x11a>
  begin_op();
80104e68:	e8 03 dd ff ff       	call   80102b70 <begin_op>
  if((ip = namei(old)) == 0){
...
80104efb:	e8 a0 c8 ff ff       	call   801017a0 <iput>
  end_op();
80104f00:	e8 db dc ff ff       	call   80102be0 <end_op>
  return 0;
...
80104f3d:	e8 be c9 ff ff       	call   80101900 <iunlockput>
  end_op();
80104f42:	e8 99 dc ff ff       	call   80102be0 <end_op>
  return -1;
...
80104faf:	8d 5d ca             	lea    -0x36(%ebp),%ebx
  begin_op();
80104fb2:	e8 b9 db ff ff       	call   80102b70 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
...
80104fdd:	58                   	pop    %eax
80104fde:	5a                   	pop    %edx
80104fdf:	68 ac 7c 10 80       	push   $0x80107cac
...
80104ff8:	68 ab 7c 10 80       	push   $0x80107cab
...
80105052:	e8 a9 f5 ff ff       	call   80104600 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
80105097:	e8 64 c8 ff ff       	call   80101900 <iunlockput>
  end_op();
8010509c:	e8 3f db ff ff       	call   80102be0 <end_op>
  return 0;
...
801050f7:	e8 04 c8 ff ff       	call   80101900 <iunlockput>
  end_op();
801050fc:	e8 df da ff ff       	call   80102be0 <end_op>
  return -1;
...
80105136:	e9 6b ff ff ff       	jmp    801050a6 <sys_unlink+0x116>
    end_op();
8010513b:	e8 a0 da ff ff       	call   80102be0 <end_op>
    return -1;
...
801051b2:	0f 88 85 00 00 00    	js     8010523d <sys_open+0xbd>
  ...
  begin_op();
801051b8:	e8 b3 d9 ff ff       	call   80102b70 <begin_op>
...
801051f6:	e8 65 bb ff ff       	call   80100d60 <filealloc>
...
80105201:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105203:	e8 58 e6 ff ff       	call   80103860 <myproc>
80105208:	90                   	nop
...
80105224:	e8 f7 bb ff ff       	call   80100e20 <fileclose>
...
80105230:	e8 cb c6 ff ff       	call   80101900 <iunlockput>
    end_op();
80105235:	e8 a6 d9 ff ff       	call   80102be0 <end_op>
    return -1;
...
8010523d:	8d 65 f4             	lea    -0xc(%ebp),%esp
    return -1;
80105240:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
}
80105245:	89 d8                	mov    %ebx,%eax
80105247:	5b                   	pop    %ebx
80105248:	5e                   	pop    %esi
80105249:	5f                   	pop    %edi
8010524a:	5d                   	pop    %ebp
...
8010526d:	e8 6e d9 ff ff       	call   80102be0 <end_op>
      return -1;
80105272:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80105277:	eb 40                	jmp    801052b9 <sys_open+0x139>
80105279:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  iunlock(ip);
80105280:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
80105283:	89 7c 98 2c          	mov    %edi,0x2c(%eax,%ebx,4)
  iunlock(ip);
80105287:	56                   	push   %esi
80105288:	e8 c3 c4 ff ff       	call   80101750 <iunlock>
  end_op();
8010528d:	e8 4e d9 ff ff       	call   80102be0 <end_op>
  f->type = FD_INODE;
80105292:	c7 07 02 00 00 00    	movl   $0x2,(%edi)
  f->readable = !(omode & O_WRONLY);
80105298:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
...
801052aa:	f7 d2                	not    %edx
801052ac:	88 57 08             	mov    %dl,0x8(%edi)
801052af:	80 67 08 01          	andb   $0x1,0x8(%edi)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
801052b3:	a8 03                	test   $0x3,%al
801052b5:	0f 95 47 09          	setne  0x9(%edi)
}
801052b9:	8d 65 f4             	lea    -0xc(%ebp),%esp
801052bc:	89 d8                	mov    %ebx,%eax
801052be:	5b                   	pop    %ebx
801052bf:	5e                   	pop    %esi
801052c0:	5f                   	pop    %edi
801052c1:	5d                   	pop    %ebp
...
801052e3:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
801052e6:	e8 85 d8 ff ff       	call   80102b70 <begin_op>
...
8010531f:	e8 dc c5 ff ff       	call   80101900 <iunlockput>
  end_op();
80105324:	e8 b7 d8 ff ff       	call   80102be0 <end_op>
  return 0;
...
80105343:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
80105346:	e8 25 d8 ff ff       	call   80102b70 <begin_op>
  if((argstr(0, &path)) < 0 ||
...
801053ae:	e8 4d c5 ff ff       	call   80101900 <iunlockput>
  end_op();
801053b3:	e8 28 d8 ff ff       	call   80102be0 <end_op>
  return 0;
...
801053d5:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
801053d8:	e8 83 e4 ff ff       	call   80103860 <myproc>
801053dd:	89 c6                	mov    %eax,%esi
  
  begin_op();
801053df:	e8 8c d7 ff ff       	call   80102b70 <begin_op>
...
80105424:	e8 27 c3 ff ff       	call   80101750 <iunlock>
  iput(curproc->cwd);
80105429:	58                   	pop    %eax
8010542a:	ff 76 6c             	pushl  0x6c(%esi)
8010542d:	e8 6e c3 ff ff       	call   801017a0 <iput>
  end_op();
80105432:	e8 a9 d7 ff ff       	call   80102be0 <end_op>
  curproc->cwd = ip;
80105437:	89 5e 6c             	mov    %ebx,0x6c(%esi)
  return 0;
...
80105454:	e8 a7 c4 ff ff       	call   80101900 <iunlockput>
    end_op();
80105459:	e8 82 d7 ff ff       	call   80102be0 <end_op>
    return -1;
...
80105469:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    end_op();
80105470:	e8 6b d7 ff ff       	call   80102be0 <end_op>
    return -1;
...
801054d8:	e8 23 f1 ff ff       	call   80104600 <memset>
...
8010554b:	e8 90 b4 ff ff       	call   801009e0 <exec>
...
80105588:	e8 83 dc ff ff       	call   80103210 <pipealloc>
...
80105596:	8b 7d e0             	mov    -0x20(%ebp),%edi
  struct proc *curproc = myproc();
80105599:	e8 c2 e2 ff ff       	call   80103860 <myproc>
8010559e:	66 90                	xchg   %ax,%ax
    if(curproc->ofile[fd] == 0){
801055a0:	8b 74 98 2c          	mov    0x2c(%eax,%ebx,4),%esi
...
801055b6:	e8 65 b8 ff ff       	call   80100e20 <fileclose>
    fileclose(wf);
801055bb:	58                   	pop    %eax
801055bc:	ff 75 e4             	pushl  -0x1c(%ebp)
801055bf:	e8 5c b8 ff ff       	call   80100e20 <fileclose>
    return -1;
...
801055db:	89 7c b0 0c          	mov    %edi,0xc(%eax,%esi,4)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
801055df:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
801055e2:	e8 79 e2 ff ff       	call   80103860 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
801055e7:	31 d2                	xor    %edx,%edx
801055e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(curproc->ofile[fd] == 0){
801055f0:	8b 4c 90 2c          	mov    0x2c(%eax,%edx,4),%ecx
...
80105633:	5d                   	pop    %ebp
  id = createContainer();
80105634:	e9 e7 1b 00 00       	jmp    80107220 <createContainer>
80105639:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

80105640 <sys_destroy_container>:
...
80105657:	8b 14 85 c0 b5 10 80 	mov    -0x7fef4a40(,%eax,4),%edx
8010565e:	85 d2                	test   %edx,%edx
80105660:	74 1e                	je     80105680 <sys_destroy_container+0x40>
  }
  else{
...
80105662:	83 ec 0c             	sub    $0xc,%esp
    containers[id] = 0;
80105665:	c7 04 85 c0 b5 10 80 	movl   $0x0,-0x7fef4a40(,%eax,4)
8010566c:	00 00 00 00 
  destroyContainer(id);
80105670:	50                   	push   %eax
80105671:	e8 3a 1c 00 00       	call   801072b0 <destroyContainer>
  return 0;
}
80105676:	31 c0                	xor    %eax,%eax
80105678:	c9                   	leave  
80105679:	c3                   	ret    
8010567a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    cprintf("This is id is already non-existant\n");
80105680:	83 ec 0c             	sub    $0xc,%esp
80105683:	68 f4 7c 10 80       	push   $0x80107cf4
80105688:	e8 d3 af ff ff       	call   80100660 <cprintf>
8010568d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105690:	83 c4 10             	add    $0x10,%esp
  destroyContainer(id);
80105693:	83 ec 0c             	sub    $0xc,%esp
80105696:	50                   	push   %eax
80105697:	e8 14 1c 00 00       	call   801072b0 <destroyContainer>
}
8010569c:	31 c0                	xor    %eax,%eax
8010569e:	c9                   	leave  
8010569f:	c3                   	ret    

801056a0 <sys_join_container>:
...
801056b8:	8b 04 85 c0 b5 10 80 	mov    -0x7fef4a40(,%eax,4),%eax
801056bf:	85 c0                	test   %eax,%eax
801056c1:	74 2d                	je     801056f0 <sys_join_container+0x50>
    cprintf("This container doesn't exists");
    return 0;
  }
  myproc()->containerID = id;
801056c3:	e8 98 e1 ff ff       	call   80103860 <myproc>
801056c8:	8b 5d f4             	mov    -0xc(%ebp),%ebx
801056cb:	89 58 18             	mov    %ebx,0x18(%eax)
  //Add this process in this container
  addProcessToContainer(myproc()->pid, id);
801056ce:	e8 8d e1 ff ff       	call   80103860 <myproc>
801056d3:	83 ec 08             	sub    $0x8,%esp
801056d6:	53                   	push   %ebx
801056d7:	ff 70 10             	pushl  0x10(%eax)
801056da:	e8 91 1c 00 00       	call   80107370 <addProcessToContainer>
  return 0;
...
801056f3:	68 18 7d 10 80       	push   $0x80107d18
...
80105714:	83 ec 04             	sub    $0x4,%esp
  int pid = myproc()->pid;
80105717:	e8 44 e1 ff ff       	call   80103860 <myproc>
8010571c:	8b 58 10             	mov    0x10(%eax),%ebx
  int containerID = myproc()->containerID;
8010571f:	e8 3c e1 ff ff       	call   80103860 <myproc>
  removeProcessFromContainer(pid, containerID);
80105724:	83 ec 08             	sub    $0x8,%esp
80105727:	ff 70 18             	pushl  0x18(%eax)
8010572a:	53                   	push   %ebx
8010572b:	e8 a0 1c 00 00       	call   801073d0 <removeProcessFromContainer>
  return 0;
}
...
80105745:	e8 16 e1 ff ff       	call   80103860 <myproc>
8010574a:	8b 70 10             	mov    0x10(%eax),%esi
  int containerID = myproc()->containerID;
8010574d:	e8 0e e1 ff ff       	call   80103860 <myproc>
80105752:	8b 58 18             	mov    0x18(%eax),%ebx
  cprintf("My containerID is: %d", containerID);
80105755:	83 ec 08             	sub    $0x8,%esp
80105758:	53                   	push   %ebx
80105759:	68 36 7d 10 80       	push   $0x80107d36
8010575e:	e8 fd ae ff ff       	call   80100660 <cprintf>
  psHelper(procID, containerID);
80105763:	58                   	pop    %eax
80105764:	5a                   	pop    %edx
80105765:	53                   	push   %ebx
80105766:	56                   	push   %esi
80105767:	e8 74 df ff ff       	call   801036e0 <psHelper>
  return 0;
}
...
80105773:	5d                   	pop    %ebp
80105774:	c3                   	ret    
80105775:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105779:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

80105780 <sys_list_containers>:
...
80105786:	e8 a5 1c 00 00       	call   80107430 <listContainersHelper>
  return 0;
}
...
80105793:	5d                   	pop    %ebp
  return fork();
80105794:	e9 97 e2 ff ff       	jmp    80103a30 <fork>
...
801057a3:	83 ec 08             	sub    $0x8,%esp
  exit();
801057a6:	e8 d5 e5 ff ff       	call   80103d80 <exit>
...
801057b3:	5d                   	pop    %ebp
  return wait();
801057b4:	e9 07 e8 ff ff       	jmp    80103fc0 <wait>
...
801057de:	e8 3d e9 ff ff       	call   80104120 <kill>
...
80105836:	e8 75 e1 ff ff       	call   801039b0 <growproc>
...
8010586d:	e8 7e f0 ff ff       	call   801048f0 <argint>
...
80105880:	68 00 73 11 80       	push   $0x80117300
80105885:	e8 76 ec ff ff       	call   80104500 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010588a:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010588d:	83 c4 10             	add    $0x10,%esp
  ticks0 = ticks;
80105890:	8b 1d 40 7b 11 80    	mov    0x80117b40,%ebx
  while(ticks - ticks0 < n){
...
801058a3:	68 00 73 11 80       	push   $0x80117300
801058a8:	68 40 7b 11 80       	push   $0x80117b40
801058ad:	e8 4e e6 ff ff       	call   80103f00 <sleep>
  while(ticks - ticks0 < n){
801058b2:	a1 40 7b 11 80       	mov    0x80117b40,%eax
...
801058bf:	73 2f                	jae    801058f0 <sys_sleep+0x90>
    if(myproc()->killed){
801058c1:	e8 9a df ff ff       	call   80103860 <myproc>
801058c6:	8b 40 28             	mov    0x28(%eax),%eax
801058c9:	85 c0                	test   %eax,%eax
801058cb:	74 d3                	je     801058a0 <sys_sleep+0x40>
      release(&tickslock);
801058cd:	83 ec 0c             	sub    $0xc,%esp
801058d0:	68 00 73 11 80       	push   $0x80117300
801058d5:	e8 d6 ec ff ff       	call   801045b0 <release>
      return -1;
...
801058f3:	68 00 73 11 80       	push   $0x80117300
801058f8:	e8 b3 ec ff ff       	call   801045b0 <release>
  return 0;
...
80105914:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105917:	68 00 73 11 80       	push   $0x80117300
8010591c:	e8 df eb ff ff       	call   80104500 <acquire>
  xticks = ticks;
80105921:	8b 1d 40 7b 11 80    	mov    0x80117b40,%ebx
  release(&tickslock);
80105927:	c7 04 24 00 73 11 80 	movl   $0x80117300,(%esp)
8010592e:	e8 7d ec ff ff       	call   801045b0 <release>
  return xticks;
}
...
80105970:	8b 14 85 08 b0 10 80 	mov    -0x7fef4ff8(,%eax,4),%edx
80105977:	b9 08 00 00 00       	mov    $0x8,%ecx
8010597c:	c6 04 c5 44 73 11 80 	movb   $0x0,-0x7fee8cbc(,%eax,8)
80105983:	00 
80105984:	66 89 0c c5 42 73 11 	mov    %cx,-0x7fee8cbe(,%eax,8)
8010598b:	80 
8010598c:	c6 04 c5 45 73 11 80 	movb   $0x8e,-0x7fee8cbb(,%eax,8)
80105993:	8e 
80105994:	66 89 14 c5 40 73 11 	mov    %dx,-0x7fee8cc0(,%eax,8)
8010599b:	80 
8010599c:	c1 ea 10             	shr    $0x10,%edx
8010599f:	66 89 14 c5 46 73 11 	mov    %dx,-0x7fee8cba(,%eax,8)
801059a6:	80 
  for(i = 0; i < 256; i++)
801059a7:	83 c0 01             	add    $0x1,%eax
801059aa:	3d 00 01 00 00       	cmp    $0x100,%eax
801059af:	75 bf                	jne    80105970 <tvinit+0x10>
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801059b1:	a1 08 b1 10 80       	mov    0x8010b108,%eax

  initlock(&tickslock, "time");
801059b6:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801059b9:	ba 08 00 00 00       	mov    $0x8,%edx
  initlock(&tickslock, "time");
801059be:	68 4c 7d 10 80       	push   $0x80107d4c
801059c3:	68 00 73 11 80       	push   $0x80117300
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801059c8:	66 89 15 42 75 11 80 	mov    %dx,0x80117542
801059cf:	c6 05 44 75 11 80 00 	movb   $0x0,0x80117544
801059d6:	66 a3 40 75 11 80    	mov    %ax,0x80117540
801059dc:	c1 e8 10             	shr    $0x10,%eax
801059df:	c6 05 45 75 11 80 ef 	movb   $0xef,0x80117545
801059e6:	66 a3 46 75 11 80    	mov    %ax,0x80117546
  initlock(&tickslock, "time");
801059ec:	e8 af e9 ff ff       	call   801043a0 <initlock>
}
...
80105a0b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105a0f:	b8 40 73 11 80       	mov    $0x80117340,%eax
...
80105a50:	ff 24 85 f4 7d 10 80 	jmp    *-0x7fef820c(,%eax,4)
...
80105a83:	e8 b8 dd ff ff       	call   80103840 <cpuid>
...
80105aad:	53                   	push   %ebx
            myproc()->pid, myproc()->name, tf->trapno,
80105aae:	83 c2 70             	add    $0x70,%edx
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105ab1:	52                   	push   %edx
80105ab2:	ff 70 10             	pushl  0x10(%eax)
80105ab5:	68 b0 7d 10 80       	push   $0x80107db0
...
80105ac7:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
...
80105ad0:	e8 8b dd ff ff       	call   80103860 <myproc>
80105ad5:	85 c0                	test   %eax,%eax
80105ad7:	74 0c                	je     80105ae5 <trap+0xb5>
80105ad9:	e8 82 dd ff ff       	call   80103860 <myproc>
80105ade:	8b 50 28             	mov    0x28(%eax),%edx
...
80105ae5:	e8 76 dd ff ff       	call   80103860 <myproc>
80105aea:	85 c0                	test   %eax,%eax
80105aec:	74 0b                	je     80105af9 <trap+0xc9>
80105aee:	e8 6d dd ff ff       	call   80103860 <myproc>
...
80105b02:	e8 59 dd ff ff       	call   80103860 <myproc>
80105b07:	8b 40 28             	mov    0x28(%eax),%eax
...
80105b3b:	75 a8                	jne    80105ae5 <trap+0xb5>
    exit();
80105b3d:	e8 3e e2 ff ff       	call   80103d80 <exit>
...
80105b4c:	75 ab                	jne    80105af9 <trap+0xc9>
    yield();
80105b4e:	e8 5d e3 ff ff       	call   80103eb0 <yield>
80105b53:	eb a4                	jmp    80105af9 <trap+0xc9>
80105b55:	8d 76 00             	lea    0x0(%esi),%esi
    if(cpuid() == 0){
80105b58:	e8 e3 dc ff ff       	call   80103840 <cpuid>
...
80105b6f:	90                   	nop
    kbdintr();
80105b70:	e8 6b ca ff ff       	call   801025e0 <kbdintr>
    lapiceoi();
80105b75:	e8 a6 cb ff ff       	call   80102720 <lapiceoi>
    break;
...
80105b97:	e8 a4 dc ff ff       	call   80103840 <cpuid>
80105b9c:	56                   	push   %esi
80105b9d:	53                   	push   %ebx
80105b9e:	50                   	push   %eax
80105b9f:	68 58 7d 10 80       	push   $0x80107d58
80105ba4:	e8 b7 aa ff ff       	call   80100660 <cprintf>
    lapiceoi();
80105ba9:	e8 72 cb ff ff       	call   80102720 <lapiceoi>
    break;
...
80105bb9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    ideintr();
80105bc0:	e8 8b c4 ff ff       	call   80102050 <ideintr>
80105bc5:	eb 9e                	jmp    80105b65 <trap+0x135>
80105bc7:	89 f6                	mov    %esi,%esi
80105bc9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    if(myproc()->killed)
80105bd0:	e8 8b dc ff ff       	call   80103860 <myproc>
80105bd5:	8b 58 28             	mov    0x28(%eax),%ebx
80105bd8:	85 db                	test   %ebx,%ebx
80105bda:	75 2c                	jne    80105c08 <trap+0x1d8>
    myproc()->tf = tf;
80105bdc:	e8 7f dc ff ff       	call   80103860 <myproc>
80105be1:	89 78 1c             	mov    %edi,0x1c(%eax)
    syscall();
80105be4:	e8 f7 ed ff ff       	call   801049e0 <syscall>
    if(myproc()->killed)
80105be9:	e8 72 dc ff ff       	call   80103860 <myproc>
80105bee:	8b 48 28             	mov    0x28(%eax),%ecx
...
80105bff:	5d                   	pop    %ebp
      exit();
80105c00:	e9 7b e1 ff ff       	jmp    80103d80 <exit>
...
80105c13:	68 00 73 11 80       	push   $0x80117300
80105c18:	e8 e3 e8 ff ff       	call   80104500 <acquire>
      wakeup(&ticks);
80105c1d:	c7 04 24 40 7b 11 80 	movl   $0x80117b40,(%esp)
      ticks++;
80105c24:	83 05 40 7b 11 80 01 	addl   $0x1,0x80117b40
      wakeup(&ticks);
80105c2b:	e8 90 e4 ff ff       	call   801040c0 <wakeup>
      release(&tickslock);
80105c30:	c7 04 24 00 73 11 80 	movl   $0x80117300,(%esp)
80105c37:	e8 74 e9 ff ff       	call   801045b0 <release>
...
80105c4a:	e8 f1 db ff ff       	call   80103840 <cpuid>
...
80105c58:	68 7c 7d 10 80       	push   $0x80107d7c
80105c5d:	e8 fe a9 ff ff       	call   80100660 <cprintf>
      panic("trap");
80105c62:	83 c4 14             	add    $0x14,%esp
80105c65:	68 51 7d 10 80       	push   $0x80107d51
...
{
  if(!uart)
80105c70:	a1 10 b6 10 80       	mov    0x8010b610,%eax
{
...
80105cc5:	e8 76 ca ff ff       	call   80102740 <microdelay>
...
80105d47:	74 5a                	je     80105da3 <uartinit+0xb3>
  uart = 1;
80105d49:	c7 05 10 b6 10 80 01 	movl   $0x1,0x8010b610
80105d50:	00 00 00 
...
80105d5f:	bb 74 7e 10 80       	mov    $0x80107e74,%ebx
...
80105d88:	74 19                	je     80105da3 <uartinit+0xb3>
  if(!uart)
80105d8a:	8b 15 10 b6 10 80    	mov    0x8010b610,%edx
...
80105db0 <uartputc>:
  if(!uart)
80105db0:	8b 15 10 b6 10 80    	mov    0x8010b610,%edx
{
...
80105deb:	e8 f0 a9 ff ff       	call   801007e0 <consoleintr>
}
...
80105df7:	6a 00                	push   $0x0
  jmp alltraps
80105df9:	e9 3c fb ff ff       	jmp    8010593a <alltraps>
...
80105e00:	6a 01                	push   $0x1
  jmp alltraps
80105e02:	e9 33 fb ff ff       	jmp    8010593a <alltraps>
...
80105e09:	6a 02                	push   $0x2
  jmp alltraps
80105e0b:	e9 2a fb ff ff       	jmp    8010593a <alltraps>
...
80105e12:	6a 03                	push   $0x3
  jmp alltraps
80105e14:	e9 21 fb ff ff       	jmp    8010593a <alltraps>
...
80105e1b:	6a 04                	push   $0x4
  jmp alltraps
80105e1d:	e9 18 fb ff ff       	jmp    8010593a <alltraps>
...
80105e24:	6a 05                	push   $0x5
  jmp alltraps
80105e26:	e9 0f fb ff ff       	jmp    8010593a <alltraps>
...
80105e2d:	6a 06                	push   $0x6
  jmp alltraps
80105e2f:	e9 06 fb ff ff       	jmp    8010593a <alltraps>
...
80105e36:	6a 07                	push   $0x7
  jmp alltraps
80105e38:	e9 fd fa ff ff       	jmp    8010593a <alltraps>
...
80105e3d:	6a 08                	push   $0x8
  jmp alltraps
80105e3f:	e9 f6 fa ff ff       	jmp    8010593a <alltraps>
...
80105e46:	6a 09                	push   $0x9
  jmp alltraps
80105e48:	e9 ed fa ff ff       	jmp    8010593a <alltraps>
...
80105e69:	6a 0e                	push   $0xe
  jmp alltraps
80105e6b:	e9 ca fa ff ff       	jmp    8010593a <alltraps>
...
80105e72:	6a 0f                	push   $0xf
  jmp alltraps
80105e74:	e9 c1 fa ff ff       	jmp    8010593a <alltraps>
...
80105ea6:	6a 15                	push   $0x15
  jmp alltraps
80105ea8:	e9 8d fa ff ff       	jmp    8010593a <alltraps>
...
80105eaf:	6a 16                	push   $0x16
  jmp alltraps
80105eb1:	e9 84 fa ff ff       	jmp    8010593a <alltraps>
...
80105eb8:	6a 17                	push   $0x17
  jmp alltraps
80105eba:	e9 7b fa ff ff       	jmp    8010593a <alltraps>
...
80105ec1:	6a 18                	push   $0x18
  jmp alltraps
80105ec3:	e9 72 fa ff ff       	jmp    8010593a <alltraps>
...
80105eca:	6a 19                	push   $0x19
  jmp alltraps
80105ecc:	e9 69 fa ff ff       	jmp    8010593a <alltraps>
...
80105ed3:	6a 1a                	push   $0x1a
  jmp alltraps
80105ed5:	e9 60 fa ff ff       	jmp    8010593a <alltraps>
...
80105edc:	6a 1b                	push   $0x1b
  jmp alltraps
80105ede:	e9 57 fa ff ff       	jmp    8010593a <alltraps>
...
80105ee5:	6a 1c                	push   $0x1c
  jmp alltraps
80105ee7:	e9 4e fa ff ff       	jmp    8010593a <alltraps>
...
80105eee:	6a 1d                	push   $0x1d
  jmp alltraps
80105ef0:	e9 45 fa ff ff       	jmp    8010593a <alltraps>
...
80105ef7:	6a 1e                	push   $0x1e
  jmp alltraps
80105ef9:	e9 3c fa ff ff       	jmp    8010593a <alltraps>
...
80105f00:	6a 1f                	push   $0x1f
  jmp alltraps
80105f02:	e9 33 fa ff ff       	jmp    8010593a <alltraps>
...
80105f09:	6a 20                	push   $0x20
  jmp alltraps
80105f0b:	e9 2a fa ff ff       	jmp    8010593a <alltraps>
...
80105f12:	6a 21                	push   $0x21
  jmp alltraps
80105f14:	e9 21 fa ff ff       	jmp    8010593a <alltraps>
...
80105f1b:	6a 22                	push   $0x22
  jmp alltraps
80105f1d:	e9 18 fa ff ff       	jmp    8010593a <alltraps>
...
80105f24:	6a 23                	push   $0x23
  jmp alltraps
80105f26:	e9 0f fa ff ff       	jmp    8010593a <alltraps>
...
80105f2d:	6a 24                	push   $0x24
  jmp alltraps
80105f2f:	e9 06 fa ff ff       	jmp    8010593a <alltraps>
...
80105f36:	6a 25                	push   $0x25
  jmp alltraps
80105f38:	e9 fd f9 ff ff       	jmp    8010593a <alltraps>
...
80105f3f:	6a 26                	push   $0x26
  jmp alltraps
80105f41:	e9 f4 f9 ff ff       	jmp    8010593a <alltraps>
...
80105f48:	6a 27                	push   $0x27
  jmp alltraps
80105f4a:	e9 eb f9 ff ff       	jmp    8010593a <alltraps>
...
80105f51:	6a 28                	push   $0x28
  jmp alltraps
80105f53:	e9 e2 f9 ff ff       	jmp    8010593a <alltraps>
...
80105f5a:	6a 29                	push   $0x29
  jmp alltraps
80105f5c:	e9 d9 f9 ff ff       	jmp    8010593a <alltraps>
...
80105f63:	6a 2a                	push   $0x2a
  jmp alltraps
80105f65:	e9 d0 f9 ff ff       	jmp    8010593a <alltraps>
...
80105f6c:	6a 2b                	push   $0x2b
  jmp alltraps
80105f6e:	e9 c7 f9 ff ff       	jmp    8010593a <alltraps>
...
80105f75:	6a 2c                	push   $0x2c
  jmp alltraps
80105f77:	e9 be f9 ff ff       	jmp    8010593a <alltraps>
...
80105f7e:	6a 2d                	push   $0x2d
  jmp alltraps
80105f80:	e9 b5 f9 ff ff       	jmp    8010593a <alltraps>
...
80105f87:	6a 2e                	push   $0x2e
  jmp alltraps
80105f89:	e9 ac f9 ff ff       	jmp    8010593a <alltraps>
...
80105f90:	6a 2f                	push   $0x2f
  jmp alltraps
80105f92:	e9 a3 f9 ff ff       	jmp    8010593a <alltraps>
...
80105f99:	6a 30                	push   $0x30
  jmp alltraps
80105f9b:	e9 9a f9 ff ff       	jmp    8010593a <alltraps>
...
80105fa2:	6a 31                	push   $0x31
  jmp alltraps
80105fa4:	e9 91 f9 ff ff       	jmp    8010593a <alltraps>
...
80105fab:	6a 32                	push   $0x32
  jmp alltraps
80105fad:	e9 88 f9 ff ff       	jmp    8010593a <alltraps>
...
80105fb4:	6a 33                	push   $0x33
  jmp alltraps
80105fb6:	e9 7f f9 ff ff       	jmp    8010593a <alltraps>
...
80105fbd:	6a 34                	push   $0x34
  jmp alltraps
80105fbf:	e9 76 f9 ff ff       	jmp    8010593a <alltraps>
...
80105fc6:	6a 35                	push   $0x35
  jmp alltraps
80105fc8:	e9 6d f9 ff ff       	jmp    8010593a <alltraps>
...
80105fcf:	6a 36                	push   $0x36
  jmp alltraps
80105fd1:	e9 64 f9 ff ff       	jmp    8010593a <alltraps>
...
80105fd8:	6a 37                	push   $0x37
  jmp alltraps
80105fda:	e9 5b f9 ff ff       	jmp    8010593a <alltraps>
...
80105fe1:	6a 38                	push   $0x38
  jmp alltraps
80105fe3:	e9 52 f9 ff ff       	jmp    8010593a <alltraps>
...
80105fea:	6a 39                	push   $0x39
  jmp alltraps
80105fec:	e9 49 f9 ff ff       	jmp    8010593a <alltraps>
...
80105ff3:	6a 3a                	push   $0x3a
  jmp alltraps
80105ff5:	e9 40 f9 ff ff       	jmp    8010593a <alltraps>
...
80105ffc:	6a 3b                	push   $0x3b
  jmp alltraps
80105ffe:	e9 37 f9 ff ff       	jmp    8010593a <alltraps>
...
80106005:	6a 3c                	push   $0x3c
  jmp alltraps
80106007:	e9 2e f9 ff ff       	jmp    8010593a <alltraps>
...
8010600e:	6a 3d                	push   $0x3d
  jmp alltraps
80106010:	e9 25 f9 ff ff       	jmp    8010593a <alltraps>
...
80106017:	6a 3e                	push   $0x3e
  jmp alltraps
80106019:	e9 1c f9 ff ff       	jmp    8010593a <alltraps>
...
80106020:	6a 3f                	push   $0x3f
  jmp alltraps
80106022:	e9 13 f9 ff ff       	jmp    8010593a <alltraps>
...
80106029:	6a 40                	push   $0x40
  jmp alltraps
8010602b:	e9 0a f9 ff ff       	jmp    8010593a <alltraps>
...
80106032:	6a 41                	push   $0x41
  jmp alltraps
80106034:	e9 01 f9 ff ff       	jmp    8010593a <alltraps>
...
8010603b:	6a 42                	push   $0x42
  jmp alltraps
8010603d:	e9 f8 f8 ff ff       	jmp    8010593a <alltraps>
...
80106044:	6a 43                	push   $0x43
  jmp alltraps
80106046:	e9 ef f8 ff ff       	jmp    8010593a <alltraps>
...
8010604d:	6a 44                	push   $0x44
  jmp alltraps
8010604f:	e9 e6 f8 ff ff       	jmp    8010593a <alltraps>
...
80106056:	6a 45                	push   $0x45
  jmp alltraps
80106058:	e9 dd f8 ff ff       	jmp    8010593a <alltraps>
...
8010605f:	6a 46                	push   $0x46
  jmp alltraps
80106061:	e9 d4 f8 ff ff       	jmp    8010593a <alltraps>
...
80106068:	6a 47                	push   $0x47
  jmp alltraps
8010606a:	e9 cb f8 ff ff       	jmp    8010593a <alltraps>
...
80106071:	6a 48                	push   $0x48
  jmp alltraps
80106073:	e9 c2 f8 ff ff       	jmp    8010593a <alltraps>
...
8010607a:	6a 49                	push   $0x49
  jmp alltraps
8010607c:	e9 b9 f8 ff ff       	jmp    8010593a <alltraps>
...
80106083:	6a 4a                	push   $0x4a
  jmp alltraps
80106085:	e9 b0 f8 ff ff       	jmp    8010593a <alltraps>
...
8010608c:	6a 4b                	push   $0x4b
  jmp alltraps
8010608e:	e9 a7 f8 ff ff       	jmp    8010593a <alltraps>
...
80106095:	6a 4c                	push   $0x4c
  jmp alltraps
80106097:	e9 9e f8 ff ff       	jmp    8010593a <alltraps>
...
8010609e:	6a 4d                	push   $0x4d
  jmp alltraps
801060a0:	e9 95 f8 ff ff       	jmp    8010593a <alltraps>
...
801060a7:	6a 4e                	push   $0x4e
  jmp alltraps
801060a9:	e9 8c f8 ff ff       	jmp    8010593a <alltraps>
...
801060b0:	6a 4f                	push   $0x4f
  jmp alltraps
801060b2:	e9 83 f8 ff ff       	jmp    8010593a <alltraps>
...
801060b9:	6a 50                	push   $0x50
  jmp alltraps
801060bb:	e9 7a f8 ff ff       	jmp    8010593a <alltraps>
...
801060c2:	6a 51                	push   $0x51
  jmp alltraps
801060c4:	e9 71 f8 ff ff       	jmp    8010593a <alltraps>
...
801060cb:	6a 52                	push   $0x52
  jmp alltraps
801060cd:	e9 68 f8 ff ff       	jmp    8010593a <alltraps>
...
801060d4:	6a 53                	push   $0x53
  jmp alltraps
801060d6:	e9 5f f8 ff ff       	jmp    8010593a <alltraps>
...
801060dd:	6a 54                	push   $0x54
  jmp alltraps
801060df:	e9 56 f8 ff ff       	jmp    8010593a <alltraps>
...
801060e6:	6a 55                	push   $0x55
  jmp alltraps
801060e8:	e9 4d f8 ff ff       	jmp    8010593a <alltraps>
...
801060ef:	6a 56                	push   $0x56
  jmp alltraps
801060f1:	e9 44 f8 ff ff       	jmp    8010593a <alltraps>
...
801060f8:	6a 57                	push   $0x57
  jmp alltraps
801060fa:	e9 3b f8 ff ff       	jmp    8010593a <alltraps>
...
80106101:	6a 58                	push   $0x58
  jmp alltraps
80106103:	e9 32 f8 ff ff       	jmp    8010593a <alltraps>
...
8010610a:	6a 59                	push   $0x59
  jmp alltraps
8010610c:	e9 29 f8 ff ff       	jmp    8010593a <alltraps>
...
80106113:	6a 5a                	push   $0x5a
  jmp alltraps
80106115:	e9 20 f8 ff ff       	jmp    8010593a <alltraps>
...
8010611c:	6a 5b                	push   $0x5b
  jmp alltraps
8010611e:	e9 17 f8 ff ff       	jmp    8010593a <alltraps>
...
80106125:	6a 5c                	push   $0x5c
  jmp alltraps
80106127:	e9 0e f8 ff ff       	jmp    8010593a <alltraps>
...
8010612e:	6a 5d                	push   $0x5d
  jmp alltraps
80106130:	e9 05 f8 ff ff       	jmp    8010593a <alltraps>
...
80106137:	6a 5e                	push   $0x5e
  jmp alltraps
80106139:	e9 fc f7 ff ff       	jmp    8010593a <alltraps>
...
80106140:	6a 5f                	push   $0x5f
  jmp alltraps
80106142:	e9 f3 f7 ff ff       	jmp    8010593a <alltraps>
...
80106149:	6a 60                	push   $0x60
  jmp alltraps
8010614b:	e9 ea f7 ff ff       	jmp    8010593a <alltraps>
...
80106152:	6a 61                	push   $0x61
  jmp alltraps
80106154:	e9 e1 f7 ff ff       	jmp    8010593a <alltraps>
...
8010615b:	6a 62                	push   $0x62
  jmp alltraps
8010615d:	e9 d8 f7 ff ff       	jmp    8010593a <alltraps>
...
80106164:	6a 63                	push   $0x63
  jmp alltraps
80106166:	e9 cf f7 ff ff       	jmp    8010593a <alltraps>
...
8010616d:	6a 64                	push   $0x64
  jmp alltraps
8010616f:	e9 c6 f7 ff ff       	jmp    8010593a <alltraps>
...
80106176:	6a 65                	push   $0x65
  jmp alltraps
80106178:	e9 bd f7 ff ff       	jmp    8010593a <alltraps>
...
8010617f:	6a 66                	push   $0x66
  jmp alltraps
80106181:	e9 b4 f7 ff ff       	jmp    8010593a <alltraps>
...
80106188:	6a 67                	push   $0x67
  jmp alltraps
8010618a:	e9 ab f7 ff ff       	jmp    8010593a <alltraps>
...
80106191:	6a 68                	push   $0x68
  jmp alltraps
80106193:	e9 a2 f7 ff ff       	jmp    8010593a <alltraps>
...
8010619a:	6a 69                	push   $0x69
  jmp alltraps
8010619c:	e9 99 f7 ff ff       	jmp    8010593a <alltraps>
...
801061a3:	6a 6a                	push   $0x6a
  jmp alltraps
801061a5:	e9 90 f7 ff ff       	jmp    8010593a <alltraps>
...
801061ac:	6a 6b                	push   $0x6b
  jmp alltraps
801061ae:	e9 87 f7 ff ff       	jmp    8010593a <alltraps>
...
801061b5:	6a 6c                	push   $0x6c
  jmp alltraps
801061b7:	e9 7e f7 ff ff       	jmp    8010593a <alltraps>
...
801061be:	6a 6d                	push   $0x6d
  jmp alltraps
801061c0:	e9 75 f7 ff ff       	jmp    8010593a <alltraps>
...
801061c7:	6a 6e                	push   $0x6e
  jmp alltraps
801061c9:	e9 6c f7 ff ff       	jmp    8010593a <alltraps>
...
801061d0:	6a 6f                	push   $0x6f
  jmp alltraps
801061d2:	e9 63 f7 ff ff       	jmp    8010593a <alltraps>
...
801061d9:	6a 70                	push   $0x70
  jmp alltraps
801061db:	e9 5a f7 ff ff       	jmp    8010593a <alltraps>
...
801061e2:	6a 71                	push   $0x71
  jmp alltraps
801061e4:	e9 51 f7 ff ff       	jmp    8010593a <alltraps>
...
801061eb:	6a 72                	push   $0x72
  jmp alltraps
801061ed:	e9 48 f7 ff ff       	jmp    8010593a <alltraps>
...
801061f4:	6a 73                	push   $0x73
  jmp alltraps
801061f6:	e9 3f f7 ff ff       	jmp    8010593a <alltraps>
...
801061fd:	6a 74                	push   $0x74
  jmp alltraps
801061ff:	e9 36 f7 ff ff       	jmp    8010593a <alltraps>
...
80106206:	6a 75                	push   $0x75
  jmp alltraps
80106208:	e9 2d f7 ff ff       	jmp    8010593a <alltraps>
...
8010620f:	6a 76                	push   $0x76
  jmp alltraps
80106211:	e9 24 f7 ff ff       	jmp    8010593a <alltraps>
...
80106218:	6a 77                	push   $0x77
  jmp alltraps
8010621a:	e9 1b f7 ff ff       	jmp    8010593a <alltraps>
...
80106221:	6a 78                	push   $0x78
  jmp alltraps
80106223:	e9 12 f7 ff ff       	jmp    8010593a <alltraps>
...
8010622a:	6a 79                	push   $0x79
  jmp alltraps
8010622c:	e9 09 f7 ff ff       	jmp    8010593a <alltraps>
...
80106233:	6a 7a                	push   $0x7a
  jmp alltraps
80106235:	e9 00 f7 ff ff       	jmp    8010593a <alltraps>
...
8010623c:	6a 7b                	push   $0x7b
  jmp alltraps
8010623e:	e9 f7 f6 ff ff       	jmp    8010593a <alltraps>
...
80106245:	6a 7c                	push   $0x7c
  jmp alltraps
80106247:	e9 ee f6 ff ff       	jmp    8010593a <alltraps>
...
8010624e:	6a 7d                	push   $0x7d
  jmp alltraps
80106250:	e9 e5 f6 ff ff       	jmp    8010593a <alltraps>
...
80106257:	6a 7e                	push   $0x7e
  jmp alltraps
80106259:	e9 dc f6 ff ff       	jmp    8010593a <alltraps>
...
80106260:	6a 7f                	push   $0x7f
  jmp alltraps
80106262:	e9 d3 f6 ff ff       	jmp    8010593a <alltraps>
...
80106275:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010627a:	e9 bb f6 ff ff       	jmp    8010593a <alltraps>
...
80106281:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106286:	e9 af f6 ff ff       	jmp    8010593a <alltraps>
...
801068ca:	e8 31 dd ff ff       	call   80104600 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
8010696d:	68 7c 7e 10 80       	push   $0x80107e7c
...
80106a12:	68 26 77 10 80       	push   $0x80107726
...
80106a23:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106a26:	e8 15 ce ff ff       	call   80103840 <cpuid>
...
80106a38:	66 89 90 58 38 11 80 	mov    %dx,-0x7feec7a8(%eax)
80106a3f:	66 89 88 5a 38 11 80 	mov    %cx,-0x7feec7a6(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106a46:	ba ff ff ff ff       	mov    $0xffffffff,%edx
80106a4b:	31 c9                	xor    %ecx,%ecx
80106a4d:	66 89 90 60 38 11 80 	mov    %dx,-0x7feec7a0(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106a54:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106a59:	66 89 88 62 38 11 80 	mov    %cx,-0x7feec79e(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106a60:	31 c9                	xor    %ecx,%ecx
80106a62:	66 89 90 68 38 11 80 	mov    %dx,-0x7feec798(%eax)
80106a69:	66 89 88 6a 38 11 80 	mov    %cx,-0x7feec796(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106a70:	ba ff ff ff ff       	mov    $0xffffffff,%edx
80106a75:	31 c9                	xor    %ecx,%ecx
80106a77:	66 89 90 70 38 11 80 	mov    %dx,-0x7feec790(%eax)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80106a7e:	c6 80 5c 38 11 80 00 	movb   $0x0,-0x7feec7a4(%eax)
  pd[0] = size-1;
80106a85:	ba 2f 00 00 00       	mov    $0x2f,%edx
80106a8a:	c6 80 5d 38 11 80 9a 	movb   $0x9a,-0x7feec7a3(%eax)
80106a91:	c6 80 5e 38 11 80 cf 	movb   $0xcf,-0x7feec7a2(%eax)
80106a98:	c6 80 5f 38 11 80 00 	movb   $0x0,-0x7feec7a1(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106a9f:	c6 80 64 38 11 80 00 	movb   $0x0,-0x7feec79c(%eax)
80106aa6:	c6 80 65 38 11 80 92 	movb   $0x92,-0x7feec79b(%eax)
80106aad:	c6 80 66 38 11 80 cf 	movb   $0xcf,-0x7feec79a(%eax)
80106ab4:	c6 80 67 38 11 80 00 	movb   $0x0,-0x7feec799(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106abb:	c6 80 6c 38 11 80 00 	movb   $0x0,-0x7feec794(%eax)
80106ac2:	c6 80 6d 38 11 80 fa 	movb   $0xfa,-0x7feec793(%eax)
80106ac9:	c6 80 6e 38 11 80 cf 	movb   $0xcf,-0x7feec792(%eax)
80106ad0:	c6 80 6f 38 11 80 00 	movb   $0x0,-0x7feec791(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106ad7:	66 89 88 72 38 11 80 	mov    %cx,-0x7feec78e(%eax)
80106ade:	c6 80 74 38 11 80 00 	movb   $0x0,-0x7feec78c(%eax)
80106ae5:	c6 80 75 38 11 80 f2 	movb   $0xf2,-0x7feec78b(%eax)
80106aec:	c6 80 76 38 11 80 cf 	movb   $0xcf,-0x7feec78a(%eax)
80106af3:	c6 80 77 38 11 80 00 	movb   $0x0,-0x7feec789(%eax)
  lgdt(c->gdt, sizeof(c->gdt));
80106afa:	05 50 38 11 80       	add    $0x80113850,%eax
...
80106b20:	a1 44 7b 11 80       	mov    0x80117b44,%eax
{
...
80106b64:	0f 84 c4 00 00 00    	je     80106c2e <switchuvm+0xee>
  pushcli();
80106b6a:	e8 b1 d8 ff ff       	call   80104420 <pushcli>
...
80106cb9:	68 c1 7e 10 80       	push   $0x80107ec1
...
80106d9e:	78 7b                	js     80106e1b <allocuvm+0x8b>
  if(newsz < oldsz)
80106da0:	3b 7d 0c             	cmp    0xc(%ebp),%edi
    return oldsz;
80106da3:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(newsz < oldsz)
80106da6:	72 75                	jb     80106e1d <allocuvm+0x8d>
  a = PGROUNDUP(oldsz);
80106da8:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
80106dae:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a < newsz; a += PGSIZE){
80106db4:	39 df                	cmp    %ebx,%edi
80106db6:	77 43                	ja     80106dfb <allocuvm+0x6b>
80106db8:	eb 6e                	jmp    80106e28 <allocuvm+0x98>
...
80106dcb:	e8 30 d8 ff ff       	call   80104600 <memset>
...
80106de5:	e8 06 fb ff ff       	call   801068f0 <mappages>
80106dea:	83 c4 10             	add    $0x10,%esp
80106ded:	85 c0                	test   %eax,%eax
80106def:	78 47                	js     80106e38 <allocuvm+0xa8>
  for(; a < newsz; a += PGSIZE){
80106df1:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106df7:	39 df                	cmp    %ebx,%edi
80106df9:	76 2d                	jbe    80106e28 <allocuvm+0x98>
    mem = kalloc();
80106dfb:	e8 90 b6 ff ff       	call   80102490 <kalloc>
    if(mem == 0){
80106e00:	85 c0                	test   %eax,%eax
    mem = kalloc();
80106e02:	89 c6                	mov    %eax,%esi
    if(mem == 0){
80106e04:	75 ba                	jne    80106dc0 <allocuvm+0x30>
      cprintf("allocuvm out of memory\n");
80106e06:	83 ec 0c             	sub    $0xc,%esp
80106e09:	68 f9 7e 10 80       	push   $0x80107ef9
80106e0e:	e8 4d 98 ff ff       	call   80100660 <cprintf>
  if(newsz >= oldsz)
80106e13:	83 c4 10             	add    $0x10,%esp
80106e16:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106e19:	77 4f                	ja     80106e6a <allocuvm+0xda>
      return 0;
...
80106e3b:	68 11 7f 10 80       	push   $0x80107f11
80106e40:	e8 1b 98 ff ff       	call   80100660 <cprintf>
  if(newsz >= oldsz)
80106e45:	83 c4 10             	add    $0x10,%esp
80106e48:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106e4b:	76 0d                	jbe    80106e5a <allocuvm+0xca>
80106e4d:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106e50:	8b 45 08             	mov    0x8(%ebp),%eax
80106e53:	89 fa                	mov    %edi,%edx
80106e55:	e8 26 fb ff ff       	call   80106980 <deallocuvm.part.0>
      kfree(mem);
...
80106e68:	eb b3                	jmp    80106e1d <allocuvm+0x8d>
80106e6a:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106e6d:	8b 45 08             	mov    0x8(%ebp),%eax
80106e70:	89 fa                	mov    %edi,%edx
80106e72:	e8 09 fb ff ff       	call   80106980 <deallocuvm.part.0>
      return 0;
80106e77:	31 c0                	xor    %eax,%eax
80106e79:	eb a2                	jmp    80106e1d <allocuvm+0x8d>
80106e7b:	90                   	nop
...
80106e90:	5d                   	pop    %ebp
80106e91:	e9 ea fa ff ff       	jmp    80106980 <deallocuvm.part.0>
...
80106ec9:	e8 b2 fa ff ff       	call   80106980 <deallocuvm.part.0>
...
80106efe:	e8 dd b3 ff ff       	call   801022e0 <kfree>
...
80106f13:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106f14:	e9 c7 b3 ff ff       	jmp    801022e0 <kfree>
    panic("freevm: no pgdir");
80106f19:	83 ec 0c             	sub    $0xc,%esp
80106f1c:	68 2d 7f 10 80       	push   $0x80107f2d
...
80106f35:	e8 56 b5 ff ff       	call   80102490 <kalloc>
...
80106f43:	bb 20 b4 10 80       	mov    $0x8010b420,%ebx
  memset(pgdir, 0, PGSIZE);
80106f48:	68 00 10 00 00       	push   $0x1000
80106f4d:	6a 00                	push   $0x0
80106f4f:	50                   	push   %eax
80106f50:	e8 ab d6 ff ff       	call   80104600 <memset>
...
80106f6b:	e8 80 f9 ff ff       	call   801068f0 <mappages>
...
80106f7a:	81 fb 60 b4 10 80    	cmp    $0x8010b460,%ebx
...
80106fbb:	a3 44 7b 11 80       	mov    %eax,0x80117b44
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106fde:	e8 8d f8 ff ff       	call   80106870 <walkpgdir>
  if(pte == 0)
...
80106fef:	68 3e 7f 10 80       	push   $0x80107f3e
...
80107040:	e8 6b d6 ff ff       	call   801046b0 <memmove>
...
80107079:	e8 f2 f7 ff ff       	call   80106870 <walkpgdir>
...
80107095:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
80107098:	e8 f3 b3 ff ff       	call   80102490 <kalloc>
...
801070fe:	e8 6d f7 ff ff       	call   80106870 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
8010716f:	e8 3c d5 ff ff       	call   801046b0 <memmove>
    len -= n;
    buf += n;
...
801071c0:	5d                   	pop    %ebp
801071c1:	c3                   	ret    
801071c2:	66 90                	xchg   %ax,%ax
801071c4:	66 90                	xchg   %ax,%ax
...
801071d1:	ba b8 3e 11 80       	mov    $0x80113eb8,%edx
  struct container *con;
  for(int i=0; i<NCONT; i++){
801071d6:	31 c9                	xor    %ecx,%ecx
void containerInit(void){
801071d8:	89 e5                	mov    %esp,%ebp
801071da:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
801071e0:	8d 82 00 ff ff ff    	lea    -0x100(%edx),%eax
    con = &ctable.container[i];
    con->containerID = i;
801071e6:	89 8a fc fe ff ff    	mov    %ecx,-0x104(%edx)
    con->state = CUNUSED;
801071ec:	c7 02 02 00 00 00    	movl   $0x2,(%edx)
801071f2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    for(int j=0; j<NPROC; j++){
      con->presentProc[j] = 0;
801071f8:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
801071fe:	83 c0 04             	add    $0x4,%eax
    for(int j=0; j<NPROC; j++){
80107201:	39 d0                	cmp    %edx,%eax
80107203:	75 f3                	jne    801071f8 <containerInit+0x28>
  for(int i=0; i<NCONT; i++){
80107205:	83 c1 01             	add    $0x1,%ecx
80107208:	8d 90 0c 01 00 00    	lea    0x10c(%eax),%edx
8010720e:	83 f9 14             	cmp    $0x14,%ecx
80107211:	75 cd                	jne    801071e0 <containerInit+0x10>
    }
  }
...
80107213:	c7 05 b8 3e 11 80 01 	movl   $0x1,0x80113eb8
8010721a:	00 00 00 
...
80107220 <createContainer>:

int createContainer(void){
80107220:	55                   	push   %ebp
80107221:	89 e5                	mov    %esp,%ebp
80107223:	83 ec 24             	sub    $0x24,%esp
  struct container *c;
  acquire(&ctable.lock);
80107226:	68 80 3d 11 80       	push   $0x80113d80
8010722b:	e8 d0 d2 ff ff       	call   80104500 <acquire>
80107230:	83 c4 10             	add    $0x10,%esp
  int id = 0;
  for(c=ctable.container; c<&ctable.container[NCONT]; c++){
80107233:	ba b4 3d 11 80       	mov    $0x80113db4,%edx
80107238:	90                   	nop
80107239:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    id = c->containerID;
80107240:	8b 02                	mov    (%edx),%eax
    if(containers[id] == 0 && id!=0){
80107242:	8b 0c 85 c0 b5 10 80 	mov    -0x7fef4a40(,%eax,4),%ecx
80107249:	85 c9                	test   %ecx,%ecx
8010724b:	75 04                	jne    80107251 <createContainer+0x31>
8010724d:	85 c0                	test   %eax,%eax
8010724f:	75 2f                	jne    80107280 <createContainer+0x60>
  for(c=ctable.container; c<&ctable.container[NCONT]; c++){
80107251:	81 c2 0c 01 00 00    	add    $0x10c,%edx
80107257:	81 fa a4 52 11 80    	cmp    $0x801152a4,%edx
8010725d:	72 e1                	jb     80107240 <createContainer+0x20>
      c->state = CWAITING;
      release(&ctable.lock);
      return id;
    }
...
80107262:	68 80 3d 11 80       	push   $0x80113d80
80107267:	e8 44 d3 ff ff       	call   801045b0 <release>
  return -1;
...
80107280:	83 ec 0c             	sub    $0xc,%esp
      c->state = CWAITING;
80107283:	c7 82 04 01 00 00 01 	movl   $0x1,0x104(%edx)
8010728a:	00 00 00 
      containers[id] = 1;
8010728d:	89 45 f4             	mov    %eax,-0xc(%ebp)
      release(&ctable.lock);
80107290:	68 80 3d 11 80       	push   $0x80113d80
      containers[id] = 1;
80107295:	c7 04 85 c0 b5 10 80 	movl   $0x1,-0x7fef4a40(,%eax,4)
8010729c:	01 00 00 00 
      release(&ctable.lock);
801072a0:	e8 0b d3 ff ff       	call   801045b0 <release>
      return id;
...
801072b5:	53                   	push   %ebx
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p<&ptable.proc[NPROC]; p++){
801072b6:	bb f4 52 11 80       	mov    $0x801152f4,%ebx
void destroyContainer(int id){
801072bb:	83 ec 18             	sub    $0x18,%esp
801072be:	8b 7d 08             	mov    0x8(%ebp),%edi
  acquire(&ctable.lock);
801072c1:	68 80 3d 11 80       	push   $0x80113d80
801072c6:	e8 35 d2 ff ff       	call   80104500 <acquire>
  release(&ctable.lock);
801072cb:	c7 04 24 80 3d 11 80 	movl   $0x80113d80,(%esp)
801072d2:	e8 d9 d2 ff ff       	call   801045b0 <release>
  con->state = CUNUSED;
801072d7:	69 c7 0c 01 00 00    	imul   $0x10c,%edi,%eax
  acquire(&ptable.lock);
801072dd:	c7 04 24 c0 52 11 80 	movl   $0x801152c0,(%esp)
    int pid = p->pid;
    if(con->presentProc[pid] == 1){
801072e4:	6b ff 43             	imul   $0x43,%edi,%edi
  con->state = CUNUSED;
801072e7:	c7 80 b8 3e 11 80 02 	movl   $0x2,-0x7feec148(%eax)
801072ee:	00 00 00 
  acquire(&ptable.lock);
801072f1:	e8 0a d2 ff ff       	call   80104500 <acquire>
801072f6:	83 c4 10             	add    $0x10,%esp
801072f9:	eb 10                	jmp    8010730b <destroyContainer+0x5b>
801072fb:	90                   	nop
801072fc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for(p = ptable.proc; p<&ptable.proc[NPROC]; p++){
80107300:	83 eb 80             	sub    $0xffffff80,%ebx
80107303:	81 fb f4 72 11 80    	cmp    $0x801172f4,%ebx
80107309:	73 4b                	jae    80107356 <destroyContainer+0xa6>
    int pid = p->pid;
8010730b:	8b 73 10             	mov    0x10(%ebx),%esi
    if(con->presentProc[pid] == 1){
8010730e:	8d 44 3e 0c          	lea    0xc(%esi,%edi,1),%eax
80107312:	83 3c 85 88 3d 11 80 	cmpl   $0x1,-0x7feec278(,%eax,4)
80107319:	01 
8010731a:	75 e4                	jne    80107300 <destroyContainer+0x50>
      //This proc is present in the container, SO KILL IT
      con->presentProc[pid] = 0;
      release(&ptable.lock);
8010731c:	83 ec 0c             	sub    $0xc,%esp
  for(p = ptable.proc; p<&ptable.proc[NPROC]; p++){
8010731f:	83 eb 80             	sub    $0xffffff80,%ebx
      con->presentProc[pid] = 0;
80107322:	c7 04 85 88 3d 11 80 	movl   $0x0,-0x7feec278(,%eax,4)
80107329:	00 00 00 00 
      release(&ptable.lock);
8010732d:	68 c0 52 11 80       	push   $0x801152c0
80107332:	e8 79 d2 ff ff       	call   801045b0 <release>
      kill(pid);
80107337:	89 34 24             	mov    %esi,(%esp)
8010733a:	e8 e1 cd ff ff       	call   80104120 <kill>
      acquire(&ptable.lock);
8010733f:	c7 04 24 c0 52 11 80 	movl   $0x801152c0,(%esp)
80107346:	e8 b5 d1 ff ff       	call   80104500 <acquire>
8010734b:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p<&ptable.proc[NPROC]; p++){
8010734e:	81 fb f4 72 11 80    	cmp    $0x801172f4,%ebx
80107354:	72 b5                	jb     8010730b <destroyContainer+0x5b>
    }
  }
  release(&ptable.lock);
80107356:	c7 45 08 c0 52 11 80 	movl   $0x801152c0,0x8(%ebp)
}
...
80107363:	5d                   	pop    %ebp
  release(&ptable.lock);
80107364:	e9 47 d2 ff ff       	jmp    801045b0 <release>
80107369:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

80107370 <addProcessToContainer>:
...
80107375:	8b 75 08             	mov    0x8(%ebp),%esi
80107378:	8b 5d 0c             	mov    0xc(%ebp),%ebx
  struct container *con;
  acquire(&ctable.lock);
8010737b:	83 ec 0c             	sub    $0xc,%esp
8010737e:	68 80 3d 11 80       	push   $0x80113d80
80107383:	e8 78 d1 ff ff       	call   80104500 <acquire>
80107388:	83 c4 10             	add    $0x10,%esp
  for(con = ctable.container; con < &ctable.container[NCONT]; con++){
8010738b:	b8 b4 3d 11 80       	mov    $0x80113db4,%eax
    if(con->containerID == containerID){
80107390:	39 18                	cmp    %ebx,(%eax)
80107392:	74 2c                	je     801073c0 <addProcessToContainer+0x50>
  for(con = ctable.container; con < &ctable.container[NCONT]; con++){
80107394:	05 0c 01 00 00       	add    $0x10c,%eax
80107399:	3d a4 52 11 80       	cmp    $0x801152a4,%eax
8010739e:	72 f0                	jb     80107390 <addProcessToContainer+0x20>
  }
...
801073a0:	c7 04 b5 b8 3d 11 80 	movl   $0x0,-0x7feec248(,%esi,4)
801073a7:	00 00 00 00 
  release(&ctable.lock);
801073ab:	c7 45 08 80 3d 11 80 	movl   $0x80113d80,0x8(%ebp)
}
...
801073b7:	5d                   	pop    %ebp
  release(&ctable.lock);
801073b8:	e9 f3 d1 ff ff       	jmp    801045b0 <release>
801073bd:	8d 76 00             	lea    0x0(%esi),%esi
      con->presentProc[pid] = 1; // Added the process
801073c0:	c7 44 b0 04 01 00 00 	movl   $0x1,0x4(%eax,%esi,4)
801073c7:	00 
      break;
801073c8:	eb d6                	jmp    801073a0 <addProcessToContainer+0x30>
801073ca:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

801073d0 <removeProcessFromContainer>:
...
801073d5:	8b 75 08             	mov    0x8(%ebp),%esi
801073d8:	8b 5d 0c             	mov    0xc(%ebp),%ebx
  struct container *con;
  acquire(&ctable.lock);
801073db:	83 ec 0c             	sub    $0xc,%esp
801073de:	68 80 3d 11 80       	push   $0x80113d80
801073e3:	e8 18 d1 ff ff       	call   80104500 <acquire>
801073e8:	83 c4 10             	add    $0x10,%esp
  for(con = ctable.container; con < &ctable.container[NCONT]; con++){
801073eb:	b8 b4 3d 11 80       	mov    $0x80113db4,%eax
    if(con->containerID == containerID){
801073f0:	39 18                	cmp    %ebx,(%eax)
801073f2:	74 2c                	je     80107420 <removeProcessFromContainer+0x50>
  for(con = ctable.container; con < &ctable.container[NCONT]; con++){
801073f4:	05 0c 01 00 00       	add    $0x10c,%eax
801073f9:	3d a4 52 11 80       	cmp    $0x801152a4,%eax
801073fe:	72 f0                	jb     801073f0 <removeProcessFromContainer+0x20>
  }
...
80107400:	c7 04 b5 b8 3d 11 80 	movl   $0x1,-0x7feec248(,%esi,4)
80107407:	01 00 00 00 
  release(&ctable.lock);
8010740b:	c7 45 08 80 3d 11 80 	movl   $0x80113d80,0x8(%ebp)
}
...
80107417:	5d                   	pop    %ebp
  release(&ctable.lock);
80107418:	e9 93 d1 ff ff       	jmp    801045b0 <release>
8010741d:	8d 76 00             	lea    0x0(%esi),%esi
      con->presentProc[pid] = 0; // Remove the process
80107420:	c7 44 b0 04 00 00 00 	movl   $0x0,0x4(%eax,%esi,4)
80107427:	00 
      break;
80107428:	eb d6                	jmp    80107400 <removeProcessFromContainer+0x30>
8010742a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

80107430 <listContainersHelper>:
...
80107434:	53                   	push   %ebx
  ...
  acquire(&ctable.lock);
  for(c = ctable.container; c < &ctable.container[NCONT]; c++){
80107435:	be b4 3d 11 80       	mov    $0x80113db4,%esi
  acquire(&ctable.lock);
8010743a:	83 ec 0c             	sub    $0xc,%esp
8010743d:	68 80 3d 11 80       	push   $0x80113d80
80107442:	e8 b9 d0 ff ff       	call   80104500 <acquire>
80107447:	83 c4 10             	add    $0x10,%esp
8010744a:	eb 12                	jmp    8010745e <listContainersHelper+0x2e>
8010744c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for(c = ctable.container; c < &ctable.container[NCONT]; c++){
80107450:	81 c6 0c 01 00 00    	add    $0x10c,%esi
80107456:	81 fe a4 52 11 80    	cmp    $0x801152a4,%esi
8010745c:	73 46                	jae    801074a4 <listContainersHelper+0x74>
    if(containers[c->containerID] == 1){
8010745e:	8b 06                	mov    (%esi),%eax
80107460:	83 3c 85 c0 b5 10 80 	cmpl   $0x1,-0x7fef4a40(,%eax,4)
80107467:	01 
80107468:	75 e6                	jne    80107450 <listContainersHelper+0x20>
...
8010746a:	83 ec 08             	sub    $0x8,%esp
      ...
      for(int j=0; j<NPROC; j++){
8010746d:	31 db                	xor    %ebx,%ebx
      cprintf("The container with id %d is initialised: \n", c->containerID);
8010746f:	50                   	push   %eax
80107470:	68 a0 7f 10 80       	push   $0x80107fa0
80107475:	e8 e6 91 ff ff       	call   80100660 <cprintf>
8010747a:	83 c4 10             	add    $0x10,%esp
8010747d:	eb 09                	jmp    80107488 <listContainersHelper+0x58>
8010747f:	90                   	nop
      for(int j=0; j<NPROC; j++){
80107480:	83 c3 01             	add    $0x1,%ebx
80107483:	83 fb 40             	cmp    $0x40,%ebx
80107486:	74 c8                	je     80107450 <listContainersHelper+0x20>
        if(c->presentProc[j] == 1){
80107488:	83 7c 9e 04 01       	cmpl   $0x1,0x4(%esi,%ebx,4)
8010748d:	75 f1                	jne    80107480 <listContainersHelper+0x50>
          cprintf("The process with id %d is present in container with id %d: \n", j, c->containerID);
8010748f:	83 ec 04             	sub    $0x4,%esp
80107492:	ff 36                	pushl  (%esi)
80107494:	53                   	push   %ebx
80107495:	68 cc 7f 10 80       	push   $0x80107fcc
8010749a:	e8 c1 91 ff ff       	call   80100660 <cprintf>
8010749f:	83 c4 10             	add    $0x10,%esp
801074a2:	eb dc                	jmp    80107480 <listContainersHelper+0x50>
        }
      }
    }
  }
...
801074a7:	68 80 3d 11 80       	push   $0x80113d80
801074ac:	e8 ff d0 ff ff       	call   801045b0 <release>
}
801074b1:	83 c4 10             	add    $0x10,%esp
801074b4:	8d 65 f8             	lea    -0x8(%ebp),%esp
801074b7:	5b                   	pop    %ebx
801074b8:	5e                   	pop    %esi
801074b9:	5d                   	pop    %ebp
801074ba:	c3                   	ret    
