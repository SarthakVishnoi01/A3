...
801003c0:	e8 9b 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003c5:	c7 04 24 8f 7f 10 80 	movl   $0x80107f8f,(%esp)
...
8010084f:	75 54                	jne    801008a5 <consoleintr+0x95>
      if(input.e != input.w){
80100851:	a1 08 10 11 80       	mov    0x80111008,%eax
80100856:	3b 05 04 10 11 80    	cmp    0x80111004,%eax
8010085c:	74 d2                	je     80100830 <consoleintr+0x20>
        input.e--;
8010085e:	83 e8 01             	sub    $0x1,%eax
80100861:	a3 08 10 11 80       	mov    %eax,0x80111008
        consputc(BACKSPACE);
...
801008a9:	a1 08 10 11 80       	mov    0x80111008,%eax
801008ae:	89 c2                	mov    %eax,%edx
801008b0:	2b 15 00 10 11 80    	sub    0x80111000,%edx
...
801008c8:	89 15 08 10 11 80    	mov    %edx,0x80111008
        c = (c == '\r') ? '\n' : c;
801008ce:	0f 84 cc 00 00 00    	je     801009a0 <consoleintr+0x190>
        input.buf[input.e++ % INPUT_BUF] = c;
801008d4:	89 f9                	mov    %edi,%ecx
801008d6:	88 88 80 0f 11 80    	mov    %cl,-0x7feef080(%eax)
        consputc(c);
...
801008f5:	a1 00 10 11 80       	mov    0x80111000,%eax
801008fa:	83 e8 80             	sub    $0xffffff80,%eax
801008fd:	39 05 08 10 11 80    	cmp    %eax,0x80111008
80100903:	0f 85 27 ff ff ff    	jne    80100830 <consoleintr+0x20>
          wakeup(&input.r);
80100909:	83 ec 0c             	sub    $0xc,%esp
          input.w = input.e;
8010090c:	a3 04 10 11 80       	mov    %eax,0x80111004
          wakeup(&input.r);
80100911:	68 00 10 11 80       	push   $0x80111000
...
80100938:	a1 08 10 11 80       	mov    0x80111008,%eax
8010093d:	39 05 04 10 11 80    	cmp    %eax,0x80111004
80100943:	75 2b                	jne    80100970 <consoleintr+0x160>
80100945:	e9 e6 fe ff ff       	jmp    80100830 <consoleintr+0x20>
8010094a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        input.e--;
80100950:	a3 08 10 11 80       	mov    %eax,0x80111008
        consputc(BACKSPACE);
80100955:	b8 00 01 00 00       	mov    $0x100,%eax
8010095a:	e8 b1 fa ff ff       	call   80100410 <consputc>
      while(input.e != input.w &&
8010095f:	a1 08 10 11 80       	mov    0x80111008,%eax
80100964:	3b 05 04 10 11 80    	cmp    0x80111004,%eax
...
80100975:	83 e2 7f             	and    $0x7f,%edx
      while(input.e != input.w &&
80100978:	80 ba 80 0f 11 80 0a 	cmpb   $0xa,-0x7feef080(%edx)
...
8010099c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        input.buf[input.e++ % INPUT_BUF] = c;
801009a0:	c6 80 80 0f 11 80 0a 	movb   $0xa,-0x7feef080(%eax)
        consputc(c);
801009a7:	b8 0a 00 00 00       	mov    $0xa,%eax
801009ac:	e8 5f fa ff ff       	call   80100410 <consputc>
801009b1:	a1 08 10 11 80       	mov    0x80111008,%eax
...
80101119:	8b 0d 20 1a 11 80    	mov    0x80111a20,%ecx
{
...
8010113c:	03 05 38 1a 11 80    	add    0x80111a38,%eax
80101142:	50                   	push   %eax
80101143:	ff 75 d8             	pushl  -0x28(%ebp)
80101146:	e8 85 ef ff ff       	call   801000d0 <bread>
8010114b:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    for(bi = 0; bi < BPB && b + bi < sb.size; bi++){
8010114e:	a1 20 1a 11 80       	mov    0x80111a20,%eax
...
801011a9:	39 05 20 1a 11 80    	cmp    %eax,0x80111a20
...
8010122a:	bb 74 1a 11 80       	mov    $0x80111a74,%ebx
{
8010122f:	83 ec 28             	sub    $0x28,%esp
80101232:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  acquire(&icache.lock);
80101235:	68 40 1a 11 80       	push   $0x80111a40
...
80101256:	81 fb 94 36 11 80    	cmp    $0x80113694,%ebx
...
80101278:	81 fb 94 36 11 80    	cmp    $0x80113694,%ebx
...
80101293:	c7 46 4c 00 00 00 00 	movl   $0x0,0x4c(%esi)
  release(&icache.lock);
8010129a:	68 40 1a 11 80       	push   $0x80111a40
...
801012c3:	89 de                	mov    %ebx,%esi
      release(&icache.lock);
801012c5:	68 40 1a 11 80       	push   $0x80111a40
      ip->ref++;
...
8010141c:	68 20 1a 11 80       	push   $0x80111a20
...
8010142e:	03 15 38 1a 11 80    	add    0x80111a38,%edx
...
80101494:	bb 80 1a 11 80       	mov    $0x80111a80,%ebx
80101499:	83 ec 0c             	sub    $0xc,%esp
  initlock(&icache.lock, "icache");
8010149c:	68 6b 76 10 80       	push   $0x8010766b
801014a1:	68 40 1a 11 80       	push   $0x80111a40
...
801014c7:	81 fb a0 36 11 80    	cmp    $0x801136a0,%ebx
801014cd:	75 e1                	jne    801014b0 <iinit+0x20>
  readsb(dev, &sb);
801014cf:	83 ec 08             	sub    $0x8,%esp
801014d2:	68 20 1a 11 80       	push   $0x80111a20
801014d7:	ff 75 08             	pushl  0x8(%ebp)
801014da:	e8 f1 fe ff ff       	call   801013d0 <readsb>
  cprintf("sb: size %d nblocks %d ninodes %d nlog %d logstart %d\
801014df:	ff 35 38 1a 11 80    	pushl  0x80111a38
801014e5:	ff 35 34 1a 11 80    	pushl  0x80111a34
801014eb:	ff 35 30 1a 11 80    	pushl  0x80111a30
801014f1:	ff 35 2c 1a 11 80    	pushl  0x80111a2c
801014f7:	ff 35 28 1a 11 80    	pushl  0x80111a28
801014fd:	ff 35 24 1a 11 80    	pushl  0x80111a24
80101503:	ff 35 20 1a 11 80    	pushl  0x80111a20
...
80101529:	83 3d 28 1a 11 80 01 	cmpl   $0x1,0x80111a28
{
...
8010155f:	39 1d 28 1a 11 80    	cmp    %ebx,0x80111a28
80101565:	76 69                	jbe    801015d0 <ialloc+0xb0>
    bp = bread(dev, IBLOCK(inum, sb));
80101567:	89 d8                	mov    %ebx,%eax
80101569:	83 ec 08             	sub    $0x8,%esp
8010156c:	c1 e8 03             	shr    $0x3,%eax
8010156f:	03 05 34 1a 11 80    	add    0x80111a34,%eax
...
801015f4:	03 05 34 1a 11 80    	add    0x80111a34,%eax
...
80101667:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&icache.lock);
8010166a:	68 40 1a 11 80       	push   $0x80111a40
8010166f:	e8 fc 2d 00 00       	call   80104470 <acquire>
  ip->ref++;
80101674:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101678:	c7 04 24 40 1a 11 80 	movl   $0x80111a40,(%esp)
...
801016d9:	03 05 34 1a 11 80    	add    0x80111a34,%eax
...
801017ea:	e8 b1 2a 00 00       	call   801042a0 <releasesleep>
  acquire(&icache.lock);
801017ef:	c7 04 24 40 1a 11 80 	movl   $0x80111a40,(%esp)
801017f6:	e8 75 2c 00 00       	call   80104470 <acquire>
  ip->ref--;
801017fb:	83 6b 08 01          	subl   $0x1,0x8(%ebx)
  release(&icache.lock);
801017ff:	83 c4 10             	add    $0x10,%esp
80101802:	c7 45 08 40 1a 11 80 	movl   $0x80111a40,0x8(%ebp)
}
...
8010181b:	68 40 1a 11 80       	push   $0x80111a40
80101820:	e8 4b 2c 00 00       	call   80104470 <acquire>
    int r = ip->ref;
80101825:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101828:	c7 04 24 40 1a 11 80 	movl   $0x80111a40,(%esp)
...
80101a4a:	8b 04 c5 c0 19 11 80 	mov    -0x7feee640(,%eax,8),%eax
...
80101b5a:	8b 04 c5 c4 19 11 80 	mov    -0x7feee63c(,%eax,8),%eax
...
80101c91:	8b 70 6c             	mov    0x6c(%eax),%esi
  acquire(&icache.lock);
80101c94:	68 40 1a 11 80       	push   $0x80111a40
80101c99:	e8 d2 27 00 00       	call   80104470 <acquire>
  ip->ref++;
80101c9e:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101ca2:	c7 04 24 40 1a 11 80 	movl   $0x80111a40,(%esp)
...
80101ed8:	68 1a 7d 10 80       	push   $0x80107d1a
...
80102025:	58                   	pop    %eax
80102026:	a1 60 3d 11 80       	mov    0x80113d60,%eax
8010202b:	5a                   	pop    %edx
...
80102231:	c7 05 94 36 11 80 00 	movl   $0xfec00000,0x80113694
80102238:	00 c0 fe 
{
...
80102246:	00 00 00 
  return ioapic->data;
80102249:	a1 94 36 11 80       	mov    0x80113694,%eax
8010224e:	8b 58 10             	mov    0x10(%eax),%ebx
  ioapic->reg = reg;
80102251:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  return ioapic->data;
80102257:	8b 0d 94 36 11 80    	mov    0x80113694,%ecx
  maxintr = (ioapicread(REG_VER) >> 16) & 0xFF;
  id = ioapicread(REG_ID) >> 24;
  if(id != ioapicid)
8010225d:	0f b6 15 c0 37 11 80 	movzbl 0x801137c0,%edx
  maxintr = (ioapicread(REG_VER) >> 16) & 0xFF;
...
80102281:	8b 0d 94 36 11 80    	mov    0x80113694,%ecx
...
801022a0:	89 11                	mov    %edx,(%ecx)
  ioapic->data = data;
801022a2:	8b 0d 94 36 11 80    	mov    0x80113694,%ecx
...
801022be:	89 31                	mov    %esi,(%ecx)
  ioapic->data = data;
801022c0:	8b 0d 94 36 11 80    	mov    0x80113694,%ecx
...
801022e0:	55                   	push   %ebp
  ioapic->reg = reg;
801022e1:	8b 0d 94 36 11 80    	mov    0x80113694,%ecx
{
...
801022f3:	89 01                	mov    %eax,(%ecx)
  ioapic->data = data;
801022f5:	8b 0d 94 36 11 80    	mov    0x80113694,%ecx
...
80102304:	89 01                	mov    %eax,(%ecx)
  ioapic->data = data;
80102306:	a1 94 36 11 80       	mov    0x80113694,%eax
  ioapicwrite(REG_TABLE+2*irq+1, cpunum << 24);
...
80102332:	81 fb 14 de 11 80    	cmp    $0x8011de14,%ebx
...
80102352:	e8 29 22 00 00       	call   80104580 <memset>
  ...
  if(kmem.use_lock)
80102357:	8b 15 d4 36 11 80    	mov    0x801136d4,%edx
...
80102364:	a1 d8 36 11 80       	mov    0x801136d8,%eax
80102369:	89 03                	mov    %eax,(%ebx)
  kmem.freelist = r;
  if(kmem.use_lock)
8010236b:	a1 d4 36 11 80       	mov    0x801136d4,%eax
  kmem.freelist = r;
80102370:	89 1d d8 36 11 80    	mov    %ebx,0x801136d8
  if(kmem.use_lock)
...
8010237f:	90                   	nop
    release(&kmem.lock);
80102380:	c7 45 08 a0 36 11 80 	movl   $0x801136a0,0x8(%ebp)
}
...
80102393:	68 a0 36 11 80       	push   $0x801136a0
80102398:	e8 d3 20 00 00       	call   80104470 <acquire>
8010239d:	83 c4 10             	add    $0x10,%esp
801023a0:	eb c2                	jmp    80102364 <kfree+0x44>
    panic("kfree");
801023a2:	83 ec 0c             	sub    $0xc,%esp
801023a5:	68 c6 77 10 80       	push   $0x801077c6
...
8010240b:	68 cc 77 10 80       	push   $0x801077cc
80102410:	68 a0 36 11 80       	push   $0x801136a0
...
8010241d:	83 c4 10             	add    $0x10,%esp
  kmem.use_lock = 0;
80102420:	c7 05 d4 36 11 80 00 	movl   $0x0,0x801136d4
80102427:	00 00 00 
  p = (char*)PGROUNDUP((uint)vstart);
...
801024b2:	73 e4                	jae    80102498 <kinit2+0x28>
  kmem.use_lock = 1;
801024b4:	c7 05 d4 36 11 80 01 	movl   $0x1,0x801136d4
801024bb:	00 00 00 
}
...
kalloc(void)
{
  ...
  if(kmem.use_lock)
801024d0:	a1 d4 36 11 80       	mov    0x801136d4,%eax
801024d5:	85 c0                	test   %eax,%eax
801024d7:	75 1f                	jne    801024f8 <kalloc+0x28>
    acquire(&kmem.lock);
  r = kmem.freelist;
801024d9:	a1 d8 36 11 80       	mov    0x801136d8,%eax
  if(r)
801024de:	85 c0                	test   %eax,%eax
801024e0:	74 0e                	je     801024f0 <kalloc+0x20>
    kmem.freelist = r->next;
801024e2:	8b 10                	mov    (%eax),%edx
801024e4:	89 15 d8 36 11 80    	mov    %edx,0x801136d8
801024ea:	c3                   	ret    
801024eb:	90                   	nop
...
801024fb:	83 ec 24             	sub    $0x24,%esp
    acquire(&kmem.lock);
801024fe:	68 a0 36 11 80       	push   $0x801136a0
80102503:	e8 68 1f 00 00       	call   80104470 <acquire>
  r = kmem.freelist;
80102508:	a1 d8 36 11 80       	mov    0x801136d8,%eax
  if(r)
8010250d:	83 c4 10             	add    $0x10,%esp
80102510:	8b 15 d4 36 11 80    	mov    0x801136d4,%edx
80102516:	85 c0                	test   %eax,%eax
80102518:	74 08                	je     80102522 <kalloc+0x52>
    kmem.freelist = r->next;
8010251a:	8b 08                	mov    (%eax),%ecx
8010251c:	89 0d d8 36 11 80    	mov    %ecx,0x801136d8
  if(kmem.use_lock)
...
8010252c:	68 a0 36 11 80       	push   $0x801136a0
...
80102583:	0f b6 82 00 79 10 80 	movzbl -0x7fef8700(%edx),%eax
8010258a:	09 c1                	or     %eax,%ecx
  shift ^= togglecode[data];
8010258c:	0f b6 82 00 78 10 80 	movzbl -0x7fef8800(%edx),%eax
...
801025a0:	83 e1 08             	and    $0x8,%ecx
  c = charcode[shift & (CTL | SHIFT)][data];
801025a3:	8b 04 85 e0 77 10 80 	mov    -0x7fef8820(,%eax,4),%eax
...
801025c5:	0f 44 d0             	cmove  %eax,%edx
    shift &= ~(shiftcode[data] | E0ESC);
801025c8:	0f b6 82 00 79 10 80 	movzbl -0x7fef8700(%edx),%eax
...
{
  if(!lapic)
80102640:	a1 dc 36 11 80       	mov    0x801136dc,%eax
{
...
{
  if (!lapic)
80102740:	8b 15 dc 36 11 80    	mov    0x801136dc,%edx
{
...
{
  if(lapic)
80102760:	a1 dc 36 11 80       	mov    0x801136dc,%eax
{
...
801027c8:	66 a3 69 04 00 80    	mov    %ax,0x80000469
  lapic[index] = value;
801027ce:	a1 dc 36 11 80       	mov    0x801136dc,%eax
...
80102a10:	8b 0d 28 37 11 80    	mov    0x80113728,%ecx
...
80102a30:	a1 14 37 11 80       	mov    0x80113714,%eax
80102a35:	83 ec 08             	sub    $0x8,%esp
80102a38:	01 d8                	add    %ebx,%eax
80102a3a:	83 c0 01             	add    $0x1,%eax
80102a3d:	50                   	push   %eax
80102a3e:	ff 35 24 37 11 80    	pushl  0x80113724
80102a44:	e8 87 d6 ff ff       	call   801000d0 <bread>
80102a49:	89 c7                	mov    %eax,%edi
    struct buf *dbuf = bread(log.dev, log.lh.block[tail]); // read dst
80102a4b:	58                   	pop    %eax
80102a4c:	5a                   	pop    %edx
80102a4d:	ff 34 9d 2c 37 11 80 	pushl  -0x7feec8d4(,%ebx,4)
80102a54:	ff 35 24 37 11 80    	pushl  0x80113724
  for (tail = 0; tail < log.lh.n; tail++) {
...
80102a94:	39 1d 28 37 11 80    	cmp    %ebx,0x80113728
...
80102ab8:	ff 35 14 37 11 80    	pushl  0x80113714
80102abe:	ff 35 24 37 11 80    	pushl  0x80113724
80102ac4:	e8 07 d6 ff ff       	call   801000d0 <bread>
  struct logheader *hb = (struct logheader *) (buf->data);
  int i;
  hb->n = log.lh.n;
80102ac9:	8b 1d 28 37 11 80    	mov    0x80113728,%ebx
...
80102ae0:	8b 8a 2c 37 11 80    	mov    -0x7feec8d4(%edx),%ecx
...
80102b1a:	68 00 7a 10 80       	push   $0x80107a00
80102b1f:	68 e0 36 11 80       	push   $0x801136e0
...
80102b3b:	59                   	pop    %ecx
  log.dev = dev;
80102b3c:	89 1d 24 37 11 80    	mov    %ebx,0x80113724
  log.size = sb.nlog;
80102b42:	89 15 18 37 11 80    	mov    %edx,0x80113718
  log.start = sb.logstart;
80102b48:	a3 14 37 11 80       	mov    %eax,0x80113714
  struct buf *buf = bread(log.dev, log.start);
80102b4d:	5a                   	pop    %edx
...
80102b5b:	85 db                	test   %ebx,%ebx
  log.lh.n = lh->n;
80102b5d:	89 1d 28 37 11 80    	mov    %ebx,0x80113728
  for (i = 0; i < log.lh.n; i++) {
...
80102b77:	89 8a 28 37 11 80    	mov    %ecx,-0x7feec8d8(%edx)
  for (i = 0; i < log.lh.n; i++) {
...
80102b8a:	e8 81 fe ff ff       	call   80102a10 <install_trans>
  log.lh.n = 0;
80102b8f:	c7 05 28 37 11 80 00 	movl   $0x0,0x80113728
80102b96:	00 00 00 
...
80102bb3:	83 ec 14             	sub    $0x14,%esp
  acquire(&log.lock);
80102bb6:	68 e0 36 11 80       	push   $0x801136e0
...
80102bcb:	68 e0 36 11 80       	push   $0x801136e0
80102bd0:	68 e0 36 11 80       	push   $0x801136e0
80102bd5:	e8 d6 12 00 00       	call   80103eb0 <sleep>
80102bda:	83 c4 10             	add    $0x10,%esp
    if(log.committing){
80102bdd:	a1 20 37 11 80       	mov    0x80113720,%eax
80102be2:	85 c0                	test   %eax,%eax
80102be4:	75 e2                	jne    80102bc8 <begin_op+0x18>
    } else if(log.lh.n + (log.outstanding+1)*MAXOPBLOCKS > LOGSIZE){
80102be6:	a1 1c 37 11 80       	mov    0x8011371c,%eax
80102beb:	8b 15 28 37 11 80    	mov    0x80113728,%edx
...
80102bff:	83 ec 0c             	sub    $0xc,%esp
      log.outstanding += 1;
80102c02:	a3 1c 37 11 80       	mov    %eax,0x8011371c
      release(&log.lock);
80102c07:	68 e0 36 11 80       	push   $0x801136e0
...
80102c26:	83 ec 18             	sub    $0x18,%esp
  ...
  acquire(&log.lock);
80102c29:	68 e0 36 11 80       	push   $0x801136e0
80102c2e:	e8 3d 18 00 00       	call   80104470 <acquire>
  log.outstanding -= 1;
80102c33:	a1 1c 37 11 80       	mov    0x8011371c,%eax
  if(log.committing)
80102c38:	8b 35 20 37 11 80    	mov    0x80113720,%esi
...
80102c44:	85 f6                	test   %esi,%esi
  log.outstanding -= 1;
80102c46:	89 1d 1c 37 11 80    	mov    %ebx,0x8011371c
  if(log.committing)
...
80102c5a:	83 ec 0c             	sub    $0xc,%esp
    log.committing = 1;
80102c5d:	c7 05 20 37 11 80 01 	movl   $0x1,0x80113720
80102c64:	00 00 00 
  release(&log.lock);
80102c67:	68 e0 36 11 80       	push   $0x801136e0
...
{
  if (log.lh.n > 0) {
80102c71:	8b 0d 28 37 11 80    	mov    0x80113728,%ecx
80102c77:	83 c4 10             	add    $0x10,%esp
80102c7a:	85 c9                	test   %ecx,%ecx
80102c7c:	0f 8e 85 00 00 00    	jle    80102d07 <end_op+0xe7>
    struct buf *to = bread(log.dev, log.start+tail+1); // log block
80102c82:	a1 14 37 11 80       	mov    0x80113714,%eax
80102c87:	83 ec 08             	sub    $0x8,%esp
80102c8a:	01 d8                	add    %ebx,%eax
80102c8c:	83 c0 01             	add    $0x1,%eax
80102c8f:	50                   	push   %eax
80102c90:	ff 35 24 37 11 80    	pushl  0x80113724
80102c96:	e8 35 d4 ff ff       	call   801000d0 <bread>
80102c9b:	89 c6                	mov    %eax,%esi
    struct buf *from = bread(log.dev, log.lh.block[tail]); // cache block
80102c9d:	58                   	pop    %eax
80102c9e:	5a                   	pop    %edx
80102c9f:	ff 34 9d 2c 37 11 80 	pushl  -0x7feec8d4(,%ebx,4)
80102ca6:	ff 35 24 37 11 80    	pushl  0x80113724
  for (tail = 0; tail < log.lh.n; tail++) {
...
80102ce6:	3b 1d 28 37 11 80    	cmp    0x80113728,%ebx
...
80102cf3:	e8 18 fd ff ff       	call   80102a10 <install_trans>
    log.lh.n = 0;
80102cf8:	c7 05 28 37 11 80 00 	movl   $0x0,0x80113728
80102cff:	00 00 00 
    write_head();    // Erase the transaction from the log
80102d02:	e8 a9 fd ff ff       	call   80102ab0 <write_head>
    acquire(&log.lock);
80102d07:	83 ec 0c             	sub    $0xc,%esp
80102d0a:	68 e0 36 11 80       	push   $0x801136e0
80102d0f:	e8 5c 17 00 00       	call   80104470 <acquire>
    wakeup(&log);
80102d14:	c7 04 24 e0 36 11 80 	movl   $0x801136e0,(%esp)
    log.committing = 0;
80102d1b:	c7 05 20 37 11 80 00 	movl   $0x0,0x80113720
80102d22:	00 00 00 
    wakeup(&log);
80102d25:	e8 36 13 00 00       	call   80104060 <wakeup>
    release(&log.lock);
80102d2a:	c7 04 24 e0 36 11 80 	movl   $0x801136e0,(%esp)
...
80102d4b:	68 e0 36 11 80       	push   $0x801136e0
80102d50:	e8 0b 13 00 00       	call   80104060 <wakeup>
  release(&log.lock);
80102d55:	c7 04 24 e0 36 11 80 	movl   $0x801136e0,(%esp)
...
80102d6f:	68 04 7a 10 80       	push   $0x80107a04
...
80102d87:	8b 15 28 37 11 80    	mov    0x80113728,%edx
{
80102d8d:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if (log.lh.n >= LOGSIZE || log.lh.n >= log.size - 1)
80102d90:	83 fa 1d             	cmp    $0x1d,%edx
80102d93:	0f 8f 9d 00 00 00    	jg     80102e36 <log_write+0xb6>
80102d99:	a1 18 37 11 80       	mov    0x80113718,%eax
80102d9e:	83 e8 01             	sub    $0x1,%eax
80102da1:	39 c2                	cmp    %eax,%edx
80102da3:	0f 8d 8d 00 00 00    	jge    80102e36 <log_write+0xb6>
    panic("too big a transaction");
  if (log.outstanding < 1)
80102da9:	a1 1c 37 11 80       	mov    0x8011371c,%eax
...
80102db9:	68 e0 36 11 80       	push   $0x801136e0
80102dbe:	e8 ad 16 00 00       	call   80104470 <acquire>
  for (i = 0; i < log.lh.n; i++) {
80102dc3:	8b 0d 28 37 11 80    	mov    0x80113728,%ecx
...
80102dd4:	31 c0                	xor    %eax,%eax
    if (log.lh.block[i] == b->blockno)   // log absorbtion
80102dd6:	3b 15 2c 37 11 80    	cmp    0x8011372c,%edx
80102ddc:	75 0b                	jne    80102de9 <log_write+0x69>
80102dde:	eb 38                	jmp    80102e18 <log_write+0x98>
80102de0:	39 14 85 2c 37 11 80 	cmp    %edx,-0x7feec8d4(,%eax,4)
...
80102df0:	89 14 85 2c 37 11 80 	mov    %edx,-0x7feec8d4(,%eax,4)
  if (i == log.lh.n)
    log.lh.n++;
80102df7:	83 c0 01             	add    $0x1,%eax
80102dfa:	a3 28 37 11 80       	mov    %eax,0x80113728
  b->flags |= B_DIRTY; // prevent eviction
80102dff:	83 0b 04             	orl    $0x4,(%ebx)
  release(&log.lock);
80102e02:	c7 45 08 e0 36 11 80 	movl   $0x801136e0,0x8(%ebp)
}
...
80102e12:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  log.lh.block[i] = b->blockno;
80102e18:	89 14 85 2c 37 11 80 	mov    %edx,-0x7feec8d4(,%eax,4)
80102e1f:	eb de                	jmp    80102dff <log_write+0x7f>
80102e21:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80102e28:	8b 43 08             	mov    0x8(%ebx),%eax
80102e2b:	a3 2c 37 11 80       	mov    %eax,0x8011372c
  if (i == log.lh.n)
...
80102e39:	68 13 7a 10 80       	push   $0x80107a13
80102e3e:	e8 4d d5 ff ff       	call   80100390 <panic>
    panic("log_write outside of trans");
80102e43:	83 ec 0c             	sub    $0xc,%esp
80102e46:	68 29 7a 10 80       	push   $0x80107a29
...
80102e68:	68 44 7a 10 80       	push   $0x80107a44
80102e6d:	e8 ee d7 ff ff       	call   80100660 <cprintf>
  idtinit();       // load idt register
80102e72:	e8 19 2b 00 00       	call   80105990 <idtinit>
...
80102e8a:	e8 11 0d 00 00       	call   80103ba0 <scheduler>
80102e8f:	90                   	nop
...
80102e93:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102e96:	e8 e5 3b 00 00       	call   80106a80 <switchkvm>
  seginit();
80102e9b:	e8 50 3b 00 00       	call   801069f0 <seginit>
  lapicinit();
...
80102ec7:	68 14 de 11 80       	push   $0x8011de14
80102ecc:	e8 2f f5 ff ff       	call   80102400 <kinit1>
  kvmalloc();      // kernel page table
80102ed1:	e8 7a 40 00 00       	call   80106f50 <kvmalloc>
  mpinit();        // detect other processors
80102ed6:	e8 85 01 00 00       	call   80103060 <mpinit>
  lapicinit();     // interrupt controller
80102edb:	e8 60 f7 ff ff       	call   80102640 <lapicinit>
  seginit();       // segment descriptors
80102ee0:	e8 0b 3b 00 00       	call   801069f0 <seginit>
  picinit();       // disable pic
...
80102ef4:	e8 c7 2d 00 00       	call   80105cc0 <uartinit>
  pinit();         // process table
80102ef9:	e8 b2 08 00 00       	call   801037b0 <pinit>
  tvinit();        // trap vectors
80102efe:	e8 0d 2a 00 00       	call   80105910 <tvinit>
  binit();         // buffer cache
...
80102f29:	69 05 60 3d 11 80 b0 	imul   $0xb0,0x80113d60,%eax
80102f30:	00 00 00 
80102f33:	83 c4 10             	add    $0x10,%esp
80102f36:	05 e0 37 11 80       	add    $0x801137e0,%eax
80102f3b:	3d e0 37 11 80       	cmp    $0x801137e0,%eax
80102f40:	76 71                	jbe    80102fb3 <main+0x103>
80102f42:	bb e0 37 11 80       	mov    $0x801137e0,%ebx
...
80102f98:	74 f6                	je     80102f90 <main+0xe0>
  for(c = cpus; c < cpus+ncpu; c++){
80102f9a:	69 05 60 3d 11 80 b0 	imul   $0xb0,0x80113d60,%eax
80102fa1:	00 00 00 
80102fa4:	81 c3 b0 00 00 00    	add    $0xb0,%ebx
80102faa:	05 e0 37 11 80       	add    $0x801137e0,%eax
...
80102fc5:	e8 a6 41 00 00       	call   80107170 <containerInit>
...
8010300e:	68 58 7a 10 80       	push   $0x80107a58
80103013:	56                   	push   %esi
80103014:	e8 b7 15 00 00       	call   801045d0 <memcmp>
...
801030cc:	68 75 7a 10 80       	push   $0x80107a75
801030d1:	56                   	push   %esi
801030d2:	e8 f9 14 00 00       	call   801045d0 <memcmp>
...
80103137:	a3 dc 36 11 80       	mov    %eax,0x801136dc
...
80103160:	ff 24 95 9c 7a 10 80 	jmp    *-0x7fef8564(,%edx,4)
...
801031a5:	8d 76 00             	lea    0x0(%esi),%esi
      if(ncpu < NCPU) {
801031a8:	8b 0d 60 3d 11 80    	mov    0x80113d60,%ecx
...
801031c0:	89 0d 60 3d 11 80    	mov    %ecx,0x80113d60
        cpus[ncpu].apicid = proc->apicid;  // apicid may differ from ncpu
801031c6:	88 97 e0 37 11 80    	mov    %dl,-0x7feec820(%edi)
...
801031dc:	83 c0 08             	add    $0x8,%eax
      ioapicid = ioapic->apicno;
801031df:	88 15 c0 37 11 80    	mov    %dl,0x801137c0
      continue;
...
80103213:	68 5d 7a 10 80       	push   $0x80107a5d
80103218:	e8 73 d1 ff ff       	call   80100390 <panic>
    panic("Didn't find a suitable machine");
8010321d:	83 ec 0c             	sub    $0xc,%esp
80103220:	68 7c 7a 10 80       	push   $0x80107a7c
...
80103318:	00 00 00 
  initlock(&p->lock, "pipe");
8010331b:	68 b0 7a 10 80       	push   $0x80107ab0
80103320:	50                   	push   %eax
80103321:	e8 0a 10 00 00       	call   80104330 <initlock>
  (*f0)->type = FD_PIPE;
...
8010337f:	e8 ec 10 00 00       	call   80104470 <acquire>
  if(writable){
...
8010339f:	e8 bc 0c 00 00       	call   80104060 <wakeup>
...
801033c3:	5d                   	pop    %ebp
    release(&p->lock);
801033c4:	e9 67 11 00 00       	jmp    80104530 <release>
...
801033e4:	e8 77 0c 00 00       	call   80104060 <wakeup>
...
801033f4:	e8 37 11 00 00       	call   80104530 <release>
    kfree((char*)p);
...
8010341d:	e8 4e 10 00 00       	call   80104470 <acquire>
  for(i = 0; i < n; i++){
...
80103474:	e8 e7 0b 00 00       	call   80104060 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
80103479:	5a                   	pop    %edx
8010347a:	59                   	pop    %ecx
8010347b:	53                   	push   %ebx
8010347c:	56                   	push   %esi
8010347d:	e8 2e 0a 00 00       	call   80103eb0 <sleep>
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
...
801034b4:	e8 77 10 00 00       	call   80104530 <release>
        return -1;
...
80103503:	e8 58 0b 00 00       	call   80104060 <wakeup>
  release(&p->lock);
80103508:	89 1c 24             	mov    %ebx,(%esp)
8010350b:	e8 20 10 00 00       	call   80104530 <release>
  return n;
...
80103530:	e8 3b 0f 00 00       	call   80104470 <acquire>
...
80103565:	e8 46 09 00 00       	call   80103eb0 <sleep>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
...
8010359e:	e8 8d 0f 00 00       	call   80104530 <release>
      return -1;
...
801035f7:	e8 64 0a 00 00       	call   80104060 <wakeup>
  release(&p->lock);
801035fc:	89 34 24             	mov    %esi,(%esp)
801035ff:	e8 2c 0f 00 00       	call   80104530 <release>
  return i;
...
80103624:	bb f4 b0 11 80       	mov    $0x8011b0f4,%ebx
{
80103629:	83 ec 10             	sub    $0x10,%esp
  acquire(&ptable.lock);
8010362c:	68 c0 b0 11 80       	push   $0x8011b0c0
80103631:	e8 3a 0e 00 00       	call   80104470 <acquire>
...
80103643:	81 fb f4 d0 11 80    	cmp    $0x8011d0f4,%ebx
...
80103664:	89 43 10             	mov    %eax,0x10(%ebx)
  release(&ptable.lock);
80103667:	68 c0 b0 11 80       	push   $0x8011b0c0
  p->pid = nextpid++;
8010366c:	89 15 04 b0 10 80    	mov    %edx,0x8010b004
  release(&ptable.lock);
80103672:	e8 b9 0e 00 00       	call   80104530 <release>
...
80103694:	89 53 1c             	mov    %edx,0x1c(%ebx)
  *(uint*)sp = (uint)trapret;
80103697:	c7 40 14 02 59 10 80 	movl   $0x80105902,0x14(%eax)
  p->context = (struct context*)sp;
...
801036a6:	e8 d5 0e 00 00       	call   80104580 <memset>
...
801036c3:	31 db                	xor    %ebx,%ebx
  release(&ptable.lock);
801036c5:	68 c0 b0 11 80       	push   $0x8011b0c0
801036ca:	e8 61 0e 00 00       	call   80104530 <release>
}
...
801036f3:	83 ec 14             	sub    $0x14,%esp
  ...
  release(&ptable.lock);
801036f6:	68 c0 b0 11 80       	push   $0x8011b0c0
801036fb:	e8 30 0e 00 00       	call   80104530 <release>
...
80103745:	8b 75 0c             	mov    0xc(%ebp),%esi
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103748:	bb f4 b0 11 80       	mov    $0x8011b0f4,%ebx
  acquire(&ptable.lock);
8010374d:	83 ec 0c             	sub    $0xc,%esp
80103750:	68 c0 b0 11 80       	push   $0x8011b0c0
80103755:	e8 16 0d 00 00       	call   80104470 <acquire>
8010375a:	83 c4 10             	add    $0x10,%esp
8010375d:	eb 0c                	jmp    8010376b <psHelper+0x2b>
8010375f:	90                   	nop
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103760:	83 eb 80             	sub    $0xffffff80,%ebx
80103763:	81 fb f4 d0 11 80    	cmp    $0x8011d0f4,%ebx
...
80103788:	68 b5 7a 10 80       	push   $0x80107ab5
8010378d:	e8 ce ce ff ff       	call   80100660 <cprintf>
80103792:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103795:	81 fb f4 d0 11 80    	cmp    $0x8011d0f4,%ebx
8010379b:	72 ce                	jb     8010376b <psHelper+0x2b>
  release(&ptable.lock);
8010379d:	c7 45 08 c0 b0 11 80 	movl   $0x8011b0c0,0x8(%ebp)
}
...
801037a9:	5d                   	pop    %ebp
  release(&ptable.lock);
801037aa:	e9 81 0d 00 00       	jmp    80104530 <release>
801037af:	90                   	nop
...
801037b6:	68 c5 7a 10 80       	push   $0x80107ac5
801037bb:	68 c0 b0 11 80       	push   $0x8011b0c0
801037c0:	e8 6b 0b 00 00       	call   80104330 <initlock>
}
...
801037dc:	e8 5f ef ff ff       	call   80102740 <lapicid>
  for (i = 0; i < ncpu; ++i) {
801037e1:	8b 35 60 3d 11 80    	mov    0x80113d60,%esi
801037e7:	85 f6                	test   %esi,%esi
801037e9:	7e 42                	jle    8010382d <mycpu+0x5d>
    if (cpus[i].apicid == apicid)
801037eb:	0f b6 15 e0 37 11 80 	movzbl 0x801137e0,%edx
801037f2:	39 d0                	cmp    %edx,%eax
801037f4:	74 30                	je     80103826 <mycpu+0x56>
801037f6:	b9 90 38 11 80       	mov    $0x80113890,%ecx
  for (i = 0; i < ncpu; ++i) {
...
8010381a:	05 e0 37 11 80       	add    $0x801137e0,%eax
}
...
8010385b:	2d e0 37 11 80       	sub    $0x801137e0,%eax
}
80103860:	c9                   	leave  
  return mycpu()-cpus;
...
80103874:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103877:	e8 24 0b 00 00       	call   801043a0 <pushcli>
  c = mycpu();
8010387c:	e8 4f ff ff ff       	call   801037d0 <mycpu>
  p = c->proc;
80103881:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103887:	e8 54 0b 00 00       	call   801043e0 <popcli>
}
...
801038b3:	e8 18 36 00 00       	call   80106ed0 <setupkvm>
...
801038d1:	e8 da 32 00 00       	call   80106bb0 <inituvm>
...
801038e6:	e8 95 0c 00 00       	call   80104580 <memset>
...
8010393f:	68 f5 7a 10 80       	push   $0x80107af5
80103944:	50                   	push   %eax
80103945:	e8 16 0e 00 00       	call   80104760 <safestrcpy>
  p->cwd = namei("/");
8010394a:	c7 04 24 fe 7a 10 80 	movl   $0x80107afe,(%esp)
80103951:	e8 9a e5 ff ff       	call   80101ef0 <namei>
80103956:	89 43 6c             	mov    %eax,0x6c(%ebx)
  acquire(&ptable.lock);
80103959:	c7 04 24 c0 b0 11 80 	movl   $0x8011b0c0,(%esp)
80103960:	e8 0b 0b 00 00       	call   80104470 <acquire>
  p->state = RUNNABLE;
80103965:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  p->containerID = 0;
8010396c:	c7 43 18 00 00 00 00 	movl   $0x0,0x18(%ebx)
  release(&ptable.lock);
80103973:	c7 04 24 c0 b0 11 80 	movl   $0x8011b0c0,(%esp)
8010397a:	e8 b1 0b 00 00       	call   80104530 <release>
  acquire(&ctable.lock);
8010397f:	c7 04 24 80 3d 11 80 	movl   $0x80113d80,(%esp)
80103986:	e8 e5 0a 00 00       	call   80104470 <acquire>
  tempContainer->presentProc[p->pid] =1;
8010398b:	8b 43 10             	mov    0x10(%ebx),%eax
  release(&ctable.lock);
8010398e:	c7 04 24 80 3d 11 80 	movl   $0x80113d80,(%esp)
  tempContainer->presentProc[p->pid] =1;
80103995:	c7 04 85 b8 3d 11 80 	movl   $0x1,-0x7feec248(,%eax,4)
8010399c:	01 00 00 00 
  release(&ctable.lock);
801039a0:	e8 8b 0b 00 00       	call   80104530 <release>
}
...
801039b0:	68 dc 7a 10 80       	push   $0x80107adc
...
801039c5:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
801039c8:	e8 d3 09 00 00       	call   801043a0 <pushcli>
  c = mycpu();
801039cd:	e8 fe fd ff ff       	call   801037d0 <mycpu>
  p = c->proc;
801039d2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801039d8:	e8 03 0a 00 00       	call   801043e0 <popcli>
  if(n > 0){
...
80103a46:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103a49:	e8 52 09 00 00       	call   801043a0 <pushcli>
  c = mycpu();
80103a4e:	e8 7d fd ff ff       	call   801037d0 <mycpu>
  p = c->proc;
80103a53:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103a59:	e8 82 09 00 00       	call   801043e0 <popcli>
  if((np = allocproc()) == 0){
...
80103af1:	e8 6a 0c 00 00       	call   80104760 <safestrcpy>
  pid = np->pid;
80103af6:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103af9:	c7 04 24 c0 b0 11 80 	movl   $0x8011b0c0,(%esp)
80103b00:	e8 6b 09 00 00       	call   80104470 <acquire>
  np->state = RUNNABLE;
80103b05:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  np->containerID = 0;
80103b0c:	c7 47 18 00 00 00 00 	movl   $0x0,0x18(%edi)
  release(&ptable.lock);
80103b13:	c7 04 24 c0 b0 11 80 	movl   $0x8011b0c0,(%esp)
80103b1a:	e8 11 0a 00 00       	call   80104530 <release>
  acquire(&ctable.lock);
80103b1f:	c7 04 24 80 3d 11 80 	movl   $0x80113d80,(%esp)
80103b26:	e8 45 09 00 00       	call   80104470 <acquire>
  tempContainer->presentProc[np->pid] =1;
80103b2b:	8b 47 10             	mov    0x10(%edi),%eax
  release(&ctable.lock);
80103b2e:	c7 04 24 80 3d 11 80 	movl   $0x80113d80,(%esp)
  tempContainer->presentProc[np->pid] =1;
80103b35:	c7 04 85 b8 3d 11 80 	movl   $0x1,-0x7feec248(,%eax,4)
...
80103b81:	b8 00 7b 10 80       	mov    $0x80107b00,%eax
...
80103b90:	8b 04 95 f0 7b 10 80 	mov    -0x7fef8410(,%edx,4),%eax
}
80103b97:	5d                   	pop    %ebp
80103b98:	c3                   	ret    
...
80103ba6:	83 ec 1c             	sub    $0x1c,%esp
  struct cpu *c = mycpu();
80103ba9:	e8 22 fc ff ff       	call   801037d0 <mycpu>
  c->proc = 0;
80103bae:	c7 80 ac 00 00 00 00 	movl   $0x0,0xac(%eax)
80103bb5:	00 00 00 
  struct cpu *c = mycpu();
80103bb8:	89 c6                	mov    %eax,%esi
80103bba:	8d 40 04             	lea    0x4(%eax),%eax
80103bbd:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  asm volatile("sti");
80103bc0:	fb                   	sti    
    for(con = ctable.container; con < &ctable.container[NCONT]; con++){
80103bc1:	bf b4 3d 11 80       	mov    $0x80113db4,%edi
80103bc6:	eb 16                	jmp    80103bde <scheduler+0x3e>
80103bc8:	90                   	nop
80103bc9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80103bd0:	81 c7 c0 05 00 00    	add    $0x5c0,%edi
80103bd6:	81 ff b4 b0 11 80    	cmp    $0x8011b0b4,%edi
80103bdc:	73 e2                	jae    80103bc0 <scheduler+0x20>
      if(con->state != CWAITING){
80103bde:	83 bf 04 01 00 00 01 	cmpl   $0x1,0x104(%edi)
80103be5:	75 e9                	jne    80103bd0 <scheduler+0x30>
      acquire(&ptable.lock);
80103be7:	83 ec 0c             	sub    $0xc,%esp
      for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103bea:	bb f4 b0 11 80       	mov    $0x8011b0f4,%ebx
      acquire(&ptable.lock);
80103bef:	68 c0 b0 11 80       	push   $0x8011b0c0
80103bf4:	e8 77 08 00 00       	call   80104470 <acquire>
80103bf9:	83 c4 10             	add    $0x10,%esp
80103bfc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        if(con->presentProc[p->pid]){
80103c00:	8b 43 10             	mov    0x10(%ebx),%eax
80103c03:	8b 4c 87 04          	mov    0x4(%edi,%eax,4),%ecx
80103c07:	85 c9                	test   %ecx,%ecx
80103c09:	74 45                	je     80103c50 <scheduler+0xb0>
          if(p->state != RUNNABLE)
80103c0b:	83 7b 0c 03          	cmpl   $0x3,0xc(%ebx)
80103c0f:	75 3f                	jne    80103c50 <scheduler+0xb0>
          switchuvm(p);
80103c11:	83 ec 0c             	sub    $0xc,%esp
          c->proc = p;
80103c14:	89 9e ac 00 00 00    	mov    %ebx,0xac(%esi)
          switchuvm(p);
80103c1a:	53                   	push   %ebx
80103c1b:	e8 80 2e 00 00       	call   80106aa0 <switchuvm>
          swtch(&(c->scheduler), p->context);
80103c20:	58                   	pop    %eax
80103c21:	5a                   	pop    %edx
80103c22:	ff 73 20             	pushl  0x20(%ebx)
80103c25:	ff 75 e4             	pushl  -0x1c(%ebp)
          p->state = RUNNING;
80103c28:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
          swtch(&(c->scheduler), p->context);
80103c2f:	e8 87 0b 00 00       	call   801047bb <swtch>
          switchkvm();
80103c34:	e8 47 2e 00 00       	call   80106a80 <switchkvm>
          c->proc = 0;
80103c39:	c7 86 ac 00 00 00 00 	movl   $0x0,0xac(%esi)
80103c40:	00 00 00 
...
80103c53:	81 fb f4 d0 11 80    	cmp    $0x8011d0f4,%ebx
80103c59:	72 a5                	jb     80103c00 <scheduler+0x60>
      release(&ptable.lock);
80103c5b:	83 ec 0c             	sub    $0xc,%esp
80103c5e:	68 c0 b0 11 80       	push   $0x8011b0c0
80103c63:	e8 c8 08 00 00       	call   80104530 <release>
80103c68:	83 c4 10             	add    $0x10,%esp
80103c6b:	e9 60 ff ff ff       	jmp    80103bd0 <scheduler+0x30>
...
80103c75:	e8 26 07 00 00       	call   801043a0 <pushcli>
  c = mycpu();
80103c7a:	e8 51 fb ff ff       	call   801037d0 <mycpu>
  p = c->proc;
80103c7f:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103c85:	e8 56 07 00 00       	call   801043e0 <popcli>
  if(!holding(&ptable.lock))
80103c8a:	83 ec 0c             	sub    $0xc,%esp
80103c8d:	68 c0 b0 11 80       	push   $0x8011b0c0
80103c92:	e8 a9 07 00 00       	call   80104440 <holding>
80103c97:	83 c4 10             	add    $0x10,%esp
80103c9a:	85 c0                	test   %eax,%eax
80103c9c:	74 4f                	je     80103ced <sched+0x7d>
  if(mycpu()->ncli != 1)
80103c9e:	e8 2d fb ff ff       	call   801037d0 <mycpu>
...
80103cb7:	75 41                	jne    80103cfa <sched+0x8a>
  intena = mycpu()->intena;
80103cb9:	e8 12 fb ff ff       	call   801037d0 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
80103cbe:	83 c3 20             	add    $0x20,%ebx
  intena = mycpu()->intena;
80103cc1:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103cc7:	e8 04 fb ff ff       	call   801037d0 <mycpu>
80103ccc:	83 ec 08             	sub    $0x8,%esp
80103ccf:	ff 70 04             	pushl  0x4(%eax)
80103cd2:	53                   	push   %ebx
80103cd3:	e8 e3 0a 00 00       	call   801047bb <swtch>
  mycpu()->intena = intena;
80103cd8:	e8 f3 fa ff ff       	call   801037d0 <mycpu>
}
...
80103d39:	e8 62 06 00 00       	call   801043a0 <pushcli>
  c = mycpu();
80103d3e:	e8 8d fa ff ff       	call   801037d0 <mycpu>
  p = c->proc;
80103d43:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103d49:	e8 92 06 00 00       	call   801043e0 <popcli>
  if(curproc == initproc)
80103d4e:	39 35 b8 b5 10 80    	cmp    %esi,0x8010b5b8
80103d54:	8d 5e 2c             	lea    0x2c(%esi),%ebx
80103d57:	8d 7e 6c             	lea    0x6c(%esi),%edi
...
80103d87:	ff 76 6c             	pushl  0x6c(%esi)
80103d8a:	e8 31 da ff ff       	call   801017c0 <iput>
  end_op();
80103d8f:	e8 8c ee ff ff       	call   80102c20 <end_op>
  curproc->cwd = 0;
80103d94:	c7 46 6c 00 00 00 00 	movl   $0x0,0x6c(%esi)
  acquire(&ptable.lock);
80103d9b:	c7 04 24 c0 b0 11 80 	movl   $0x8011b0c0,(%esp)
80103da2:	e8 c9 06 00 00       	call   80104470 <acquire>
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103dad:	b8 f4 b0 11 80       	mov    $0x8011b0f4,%eax
80103db2:	eb 0e                	jmp    80103dc2 <exit+0x92>
80103db4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103db8:	83 e8 80             	sub    $0xffffff80,%eax
80103dbb:	3d f4 d0 11 80       	cmp    $0x8011d0f4,%eax
80103dc0:	73 1c                	jae    80103dde <exit+0xae>
    if(p->state == SLEEPING && p->chan == chan){
80103dc2:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80103dc6:	75 f0                	jne    80103db8 <exit+0x88>
80103dc8:	3b 50 24             	cmp    0x24(%eax),%edx
80103dcb:	75 eb                	jne    80103db8 <exit+0x88>
      p->state = RUNNABLE;
80103dcd:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103dd4:	83 e8 80             	sub    $0xffffff80,%eax
80103dd7:	3d f4 d0 11 80       	cmp    $0x8011d0f4,%eax
80103ddc:	72 e4                	jb     80103dc2 <exit+0x92>
      p->parent = initproc;
80103dde:	8b 0d b8 b5 10 80    	mov    0x8010b5b8,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103de4:	ba f4 b0 11 80       	mov    $0x8011b0f4,%edx
80103de9:	eb 10                	jmp    80103dfb <exit+0xcb>
80103deb:	90                   	nop
80103dec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103df0:	83 ea 80             	sub    $0xffffff80,%edx
80103df3:	81 fa f4 d0 11 80    	cmp    $0x8011d0f4,%edx
80103df9:	73 33                	jae    80103e2e <exit+0xfe>
    if(p->parent == curproc){
...
80103e07:	75 e7                	jne    80103df0 <exit+0xc0>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103e09:	b8 f4 b0 11 80       	mov    $0x8011b0f4,%eax
80103e0e:	eb 0a                	jmp    80103e1a <exit+0xea>
80103e10:	83 e8 80             	sub    $0xffffff80,%eax
80103e13:	3d f4 d0 11 80       	cmp    $0x8011d0f4,%eax
80103e18:	73 d6                	jae    80103df0 <exit+0xc0>
    if(p->state == SLEEPING && p->chan == chan){
...
80103e3d:	68 52 7b 10 80       	push   $0x80107b52
80103e42:	e8 49 c5 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103e47:	83 ec 0c             	sub    $0xc,%esp
80103e4a:	68 45 7b 10 80       	push   $0x80107b45
...
80103e67:	68 c0 b0 11 80       	push   $0x8011b0c0
80103e6c:	e8 ff 05 00 00       	call   80104470 <acquire>
  pushcli();
80103e71:	e8 2a 05 00 00       	call   801043a0 <pushcli>
  c = mycpu();
80103e76:	e8 55 f9 ff ff       	call   801037d0 <mycpu>
  p = c->proc;
80103e7b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103e81:	e8 5a 05 00 00       	call   801043e0 <popcli>
  myproc()->state = RUNNABLE;
80103e86:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  sched();
80103e8d:	e8 de fd ff ff       	call   80103c70 <sched>
  release(&ptable.lock);
80103e92:	c7 04 24 c0 b0 11 80 	movl   $0x8011b0c0,(%esp)
80103e99:	e8 92 06 00 00       	call   80104530 <release>
}
...
80103ebf:	e8 dc 04 00 00       	call   801043a0 <pushcli>
  c = mycpu();
80103ec4:	e8 07 f9 ff ff       	call   801037d0 <mycpu>
  p = c->proc;
80103ec9:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ecf:	e8 0c 05 00 00       	call   801043e0 <popcli>
  if(p == 0)
...
80103ee0:	81 fe c0 b0 11 80    	cmp    $0x8011b0c0,%esi
80103ee6:	74 50                	je     80103f38 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
80103ee8:	83 ec 0c             	sub    $0xc,%esp
80103eeb:	68 c0 b0 11 80       	push   $0x8011b0c0
80103ef0:	e8 7b 05 00 00       	call   80104470 <acquire>
    release(lk);
80103ef5:	89 34 24             	mov    %esi,(%esp)
80103ef8:	e8 33 06 00 00       	call   80104530 <release>
  p->chan = chan;
80103efd:	89 7b 24             	mov    %edi,0x24(%ebx)
  p->state = SLEEPING;
80103f00:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
80103f07:	e8 64 fd ff ff       	call   80103c70 <sched>
  p->chan = 0;
80103f0c:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
    release(&ptable.lock);
80103f13:	c7 04 24 c0 b0 11 80 	movl   $0x8011b0c0,(%esp)
80103f1a:	e8 11 06 00 00       	call   80104530 <release>
    acquire(lk);
...
80103f59:	68 64 7b 10 80       	push   $0x80107b64
80103f5e:	e8 2d c4 ff ff       	call   80100390 <panic>
    panic("sleep");
80103f63:	83 ec 0c             	sub    $0xc,%esp
80103f66:	68 5e 7b 10 80       	push   $0x80107b5e
...
80103f75:	e8 26 04 00 00       	call   801043a0 <pushcli>
  c = mycpu();
80103f7a:	e8 51 f8 ff ff       	call   801037d0 <mycpu>
  p = c->proc;
80103f7f:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103f85:	e8 56 04 00 00       	call   801043e0 <popcli>
  acquire(&ptable.lock);
80103f8a:	83 ec 0c             	sub    $0xc,%esp
80103f8d:	68 c0 b0 11 80       	push   $0x8011b0c0
80103f92:	e8 d9 04 00 00       	call   80104470 <acquire>
80103f97:	83 c4 10             	add    $0x10,%esp
    havekids = 0;
80103f9a:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f9c:	bb f4 b0 11 80       	mov    $0x8011b0f4,%ebx
80103fa1:	eb 10                	jmp    80103fb3 <wait+0x43>
80103fa3:	90                   	nop
80103fa4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103fa8:	83 eb 80             	sub    $0xffffff80,%ebx
80103fab:	81 fb f4 d0 11 80    	cmp    $0x8011d0f4,%ebx
...
80104002:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80104009:	e8 42 2e 00 00       	call   80106e50 <freevm>
        release(&ptable.lock);
8010400e:	c7 04 24 c0 b0 11 80 	movl   $0x8011b0c0,(%esp)
        p->pid = 0;
80104015:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
8010401c:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
80104023:	c6 43 70 00          	movb   $0x0,0x70(%ebx)
        p->killed = 0;
80104027:	c7 43 28 00 00 00 00 	movl   $0x0,0x28(%ebx)
        p->state = UNUSED;
8010402e:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80104035:	e8 f6 04 00 00       	call   80104530 <release>
        return pid;
...
80104049:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
8010404e:	68 c0 b0 11 80       	push   $0x8011b0c0
80104053:	e8 d8 04 00 00       	call   80104530 <release>
      return -1;
...
8010409f:	3d f4 d0 11 80       	cmp    $0x8011d0f4,%eax
801040a4:	72 e4                	jb     8010408a <wakeup+0x2a>
  wakeup1(chan);
  release(&ptable.lock);
801040a6:	c7 45 08 c0 b0 11 80 	movl   $0x8011b0c0,0x8(%ebp)
}
801040ad:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801040b0:	c9                   	leave  
  release(&ptable.lock);
801040b1:	e9 7a 04 00 00       	jmp    80104530 <release>
...
801040c7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ptable.lock);
801040ca:	68 c0 b0 11 80       	push   $0x8011b0c0
801040cf:	e8 9c 03 00 00       	call   80104470 <acquire>
801040d4:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801040d7:	b8 f4 b0 11 80       	mov    $0x8011b0f4,%eax
801040dc:	eb 0c                	jmp    801040ea <kill+0x2a>
801040de:	66 90                	xchg   %ax,%ax
801040e0:	83 e8 80             	sub    $0xffffff80,%eax
801040e3:	3d f4 d0 11 80       	cmp    $0x8011d0f4,%eax
...
801040ef:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
      p->killed = 1;
801040f3:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
      if(p->state == SLEEPING){
...
80104106:	68 c0 b0 11 80       	push   $0x8011b0c0
8010410b:	e8 20 04 00 00       	call   80104530 <release>
      return 0;
...
80104123:	68 c0 b0 11 80       	push   $0x8011b0c0
80104128:	e8 03 04 00 00       	call   80104530 <release>
  return -1;
...
80104146:	8d 75 e8             	lea    -0x18(%ebp),%esi
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104149:	bb f4 b0 11 80       	mov    $0x8011b0f4,%ebx
{
...
8010417e:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80104181:	ba 75 7b 10 80       	mov    $0x80107b75,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104186:	77 11                	ja     80104199 <procdump+0x59>
80104188:	8b 14 85 fc 7b 10 80 	mov    -0x7fef8404(,%eax,4),%edx
      state = "???";
8010418f:	b8 75 7b 10 80       	mov    $0x80107b75,%eax
80104194:	85 d2                	test   %edx,%edx
80104196:	0f 44 d0             	cmove  %eax,%edx
    cprintf("%d %s %s", p->pid, state, p->name);
80104199:	8d 43 70             	lea    0x70(%ebx),%eax
8010419c:	50                   	push   %eax
8010419d:	52                   	push   %edx
8010419e:	ff 73 10             	pushl  0x10(%ebx)
801041a1:	68 79 7b 10 80       	push   $0x80107b79
...
801041be:	8b 43 20             	mov    0x20(%ebx),%eax
...
801041dd:	68 a1 75 10 80       	push   $0x801075a1
...
8010420a:	68 14 7c 10 80       	push   $0x80107c14
...
80104273:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104279:	e8 f2 f5 ff ff       	call   80103870 <myproc>
...
80104303:	e8 68 f5 ff ff       	call   80103870 <myproc>
...
801043a9:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
801043aa:	e8 21 f4 ff ff       	call   801037d0 <mycpu>
...
801043bf:	e8 0c f4 ff ff       	call   801037d0 <mycpu>
...
801043eb:	75 35                	jne    80104422 <popcli+0x42>
  ...
  if(--mycpu()->ncli < 0)
801043ed:	e8 de f3 ff ff       	call   801037d0 <mycpu>
...
8010440c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104410:	e8 bb f3 ff ff       	call   801037d0 <mycpu>
...
80104425:	68 1f 7c 10 80       	push   $0x80107c1f
8010442a:	e8 61 bf ff ff       	call   80100390 <panic>
    panic("popcli");
8010442f:	83 ec 0c             	sub    $0xc,%esp
80104432:	68 36 7c 10 80       	push   $0x80107c36
...
80104458:	e8 73 f3 ff ff       	call   801037d0 <mycpu>
...
80104517:	68 3d 7c 10 80       	push   $0x80107c3d
...
8010456c:	68 45 7c 10 80       	push   $0x80107c45
...
80104817:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
8010481a:	e8 51 f0 ff ff       	call   80103870 <myproc>
...
80104885:	e8 e6 ef ff ff       	call   80103870 <myproc>
8010488a:	8b 40 1c             	mov    0x1c(%eax),%eax
8010488d:	8b 55 08             	mov    0x8(%ebp),%edx
80104890:	8b 40 44             	mov    0x44(%eax),%eax
80104893:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104896:	e8 d5 ef ff ff       	call   80103870 <myproc>
  if(addr >= curproc->sz || addr+4 > curproc->sz)
...
801048d8:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
801048db:	e8 90 ef ff ff       	call   80103870 <myproc>
...
801049b0:	68 4d 7c 10 80       	push   $0x80107c4d
801049b5:	e8 a6 bc ff ff       	call   80100660 <cprintf>
    curproc->tf->eax = -1;
801049ba:	8b 43 1c             	mov    0x1c(%ebx),%eax
...
80104b04:	68 10 7d 10 80       	push   $0x80107d10
...
80104b1c:	68 0f 7d 10 80       	push   $0x80107d0f
...
80104b35:	68 03 7d 10 80       	push   $0x80107d03
...
80104b4a:	68 12 7d 10 80       	push   $0x80107d12
80104b4f:	e8 3c b8 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104b54:	83 ec 0c             	sub    $0xc,%esp
80104b57:	68 f4 7c 10 80       	push   $0x80107cf4
...
80104bd9:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104bdb:	e8 90 ec ff ff       	call   80103870 <myproc>
...
80104f49:	58                   	pop    %eax
80104f4a:	5a                   	pop    %edx
80104f4b:	68 10 7d 10 80       	push   $0x80107d10
...
80104f64:	68 0f 7d 10 80       	push   $0x80107d0f
...
8010515f:	0f 84 a6 00 00 00    	je     8010520b <sys_open+0x12b>
  struct proc *curproc = myproc();
80105165:	e8 06 e7 ff ff       	call   80103870 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801054fc:	e8 5f dd ff ff       	call   80103260 <pipealloc>
...
8010550f:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105511:	e8 5a e3 ff ff       	call   80103870 <myproc>
...
80105537:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
8010553a:	e8 31 e3 ff ff       	call   80103870 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105571:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      myproc()->ofile[fd0] = 0;
80105578:	e8 f3 e2 ff ff       	call   80103870 <myproc>
...
801055b3:	5d                   	pop    %ebp
  id = createContainer();
801055b4:	e9 17 1c 00 00       	jmp    801071d0 <createContainer>
801055b9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

801055c0 <sys_destroy_container>:
...
801055d7:	8b 14 85 c0 b5 10 80 	mov    -0x7fef4a40(,%eax,4),%edx
801055de:	85 d2                	test   %edx,%edx
801055e0:	74 1e                	je     80105600 <sys_destroy_container+0x40>
  }
  else{
...
801055e2:	83 ec 0c             	sub    $0xc,%esp
    containers[id] = 0;
801055e5:	c7 04 85 c0 b5 10 80 	movl   $0x0,-0x7fef4a40(,%eax,4)
801055ec:	00 00 00 00 
  destroyContainer(id);
801055f0:	50                   	push   %eax
801055f1:	e8 7a 1c 00 00       	call   80107270 <destroyContainer>
  return 0;
}
801055f6:	31 c0                	xor    %eax,%eax
801055f8:	c9                   	leave  
801055f9:	c3                   	ret    
801055fa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    cprintf("This is id is already non-existant\n");
80105600:	83 ec 0c             	sub    $0xc,%esp
80105603:	68 58 7d 10 80       	push   $0x80107d58
80105608:	e8 53 b0 ff ff       	call   80100660 <cprintf>
8010560d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105610:	83 c4 10             	add    $0x10,%esp
  destroyContainer(id);
80105613:	83 ec 0c             	sub    $0xc,%esp
80105616:	50                   	push   %eax
80105617:	e8 54 1c 00 00       	call   80107270 <destroyContainer>
}
8010561c:	31 c0                	xor    %eax,%eax
8010561e:	c9                   	leave  
8010561f:	c3                   	ret    

80105620 <sys_join_container>:
...
80105638:	8b 04 85 c0 b5 10 80 	mov    -0x7fef4a40(,%eax,4),%eax
8010563f:	85 c0                	test   %eax,%eax
80105641:	74 2d                	je     80105670 <sys_join_container+0x50>
    cprintf("This container doesn't exists");
    return 0;
  }
  myproc()->containerID = id;
80105643:	e8 28 e2 ff ff       	call   80103870 <myproc>
80105648:	8b 5d f4             	mov    -0xc(%ebp),%ebx
8010564b:	89 58 18             	mov    %ebx,0x18(%eax)
  //Add this process in this container
  addProcessToContainer(myproc()->pid, id);
8010564e:	e8 1d e2 ff ff       	call   80103870 <myproc>
80105653:	83 ec 08             	sub    $0x8,%esp
80105656:	53                   	push   %ebx
80105657:	ff 70 10             	pushl  0x10(%eax)
8010565a:	e8 d1 1c 00 00       	call   80107330 <addProcessToContainer>
  return 0;
...
80105673:	68 7c 7d 10 80       	push   $0x80107d7c
80105678:	e8 e3 af ff ff       	call   80100660 <cprintf>
    return 0;
...
80105694:	83 ec 04             	sub    $0x4,%esp
  int pid = myproc()->pid;
80105697:	e8 d4 e1 ff ff       	call   80103870 <myproc>
8010569c:	8b 58 10             	mov    0x10(%eax),%ebx
  int containerID = myproc()->containerID;
8010569f:	e8 cc e1 ff ff       	call   80103870 <myproc>
  removeProcessFromContainer(pid, containerID);
801056a4:	83 ec 08             	sub    $0x8,%esp
801056a7:	ff 70 18             	pushl  0x18(%eax)
801056aa:	53                   	push   %ebx
801056ab:	e8 e0 1c 00 00       	call   80107390 <removeProcessFromContainer>
  return 0;
}
...
801056c5:	e8 a6 e1 ff ff       	call   80103870 <myproc>
801056ca:	8b 70 10             	mov    0x10(%eax),%esi
  int containerID = myproc()->containerID;
801056cd:	e8 9e e1 ff ff       	call   80103870 <myproc>
801056d2:	8b 58 18             	mov    0x18(%eax),%ebx
  cprintf("My containerID is: %d\n", containerID);
801056d5:	83 ec 08             	sub    $0x8,%esp
801056d8:	53                   	push   %ebx
801056d9:	68 9a 7d 10 80       	push   $0x80107d9a
801056de:	e8 7d af ff ff       	call   80100660 <cprintf>
  psHelper(procID, containerID);
801056e3:	58                   	pop    %eax
801056e4:	5a                   	pop    %edx
801056e5:	53                   	push   %ebx
801056e6:	56                   	push   %esi
801056e7:	e8 54 e0 ff ff       	call   80103740 <psHelper>
  return 0;
}
...
80105706:	e8 e5 1c 00 00       	call   801073f0 <listContainersHelper>
  return 0;
}
...
8010571c:	e8 5f f1 ff ff       	call   80104880 <argint>
  int pid = myproc()->pid;
80105721:	e8 4a e1 ff ff       	call   80103870 <myproc>
  container_malloc(numBytes, pid);
80105726:	5a                   	pop    %edx
80105727:	59                   	pop    %ecx
80105728:	ff 70 10             	pushl  0x10(%eax)
8010572b:	ff 75 f4             	pushl  -0xc(%ebp)
8010572e:	e8 4d 1d 00 00       	call   80107480 <container_malloc>
  return 0;
}
...
80105743:	5d                   	pop    %ebp
  return fork();
80105744:	e9 f7 e2 ff ff       	jmp    80103a40 <fork>
...
80105753:	83 ec 08             	sub    $0x8,%esp
  exit();
80105756:	e8 d5 e5 ff ff       	call   80103d30 <exit>
...
80105763:	5d                   	pop    %ebp
  return wait();
80105764:	e9 07 e8 ff ff       	jmp    80103f70 <wait>
...
8010577c:	e8 ff f0 ff ff       	call   80104880 <argint>
...
8010578e:	e8 2d e9 ff ff       	call   801040c0 <kill>
...
801057b3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801057b6:	e8 b5 e0 ff ff       	call   80103870 <myproc>
...
801057e6:	e8 d5 e1 ff ff       	call   801039c0 <growproc>
...
8010581d:	e8 5e f0 ff ff       	call   80104880 <argint>
...
80105830:	68 00 d1 11 80       	push   $0x8011d100
80105835:	e8 36 ec ff ff       	call   80104470 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010583a:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010583d:	83 c4 10             	add    $0x10,%esp
  ticks0 = ticks;
80105840:	8b 1d 40 d9 11 80    	mov    0x8011d940,%ebx
  while(ticks - ticks0 < n){
...
80105853:	68 00 d1 11 80       	push   $0x8011d100
80105858:	68 40 d9 11 80       	push   $0x8011d940
8010585d:	e8 4e e6 ff ff       	call   80103eb0 <sleep>
  while(ticks - ticks0 < n){
80105862:	a1 40 d9 11 80       	mov    0x8011d940,%eax
...
8010586f:	73 2f                	jae    801058a0 <sys_sleep+0x90>
    if(myproc()->killed){
80105871:	e8 fa df ff ff       	call   80103870 <myproc>
80105876:	8b 40 28             	mov    0x28(%eax),%eax
80105879:	85 c0                	test   %eax,%eax
8010587b:	74 d3                	je     80105850 <sys_sleep+0x40>
      release(&tickslock);
8010587d:	83 ec 0c             	sub    $0xc,%esp
80105880:	68 00 d1 11 80       	push   $0x8011d100
80105885:	e8 a6 ec ff ff       	call   80104530 <release>
      return -1;
...
801058a3:	68 00 d1 11 80       	push   $0x8011d100
801058a8:	e8 83 ec ff ff       	call   80104530 <release>
  return 0;
...
801058c4:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
801058c7:	68 00 d1 11 80       	push   $0x8011d100
801058cc:	e8 9f eb ff ff       	call   80104470 <acquire>
  xticks = ticks;
801058d1:	8b 1d 40 d9 11 80    	mov    0x8011d940,%ebx
  release(&tickslock);
801058d7:	c7 04 24 00 d1 11 80 	movl   $0x8011d100,(%esp)
801058de:	e8 4d ec ff ff       	call   80104530 <release>
  return xticks;
}
...
80105920:	8b 14 85 08 b0 10 80 	mov    -0x7fef4ff8(,%eax,4),%edx
80105927:	c7 04 c5 42 d1 11 80 	movl   $0x8e000008,-0x7fee2ebe(,%eax,8)
8010592e:	08 00 00 8e 
80105932:	66 89 14 c5 40 d1 11 	mov    %dx,-0x7fee2ec0(,%eax,8)
80105939:	80 
8010593a:	c1 ea 10             	shr    $0x10,%edx
8010593d:	66 89 14 c5 46 d1 11 	mov    %dx,-0x7fee2eba(,%eax,8)
80105944:	80 
  for(i = 0; i < 256; i++)
...
8010594f:	a1 08 b1 10 80       	mov    0x8010b108,%eax

  initlock(&tickslock, "time");
80105954:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105957:	c7 05 42 d3 11 80 08 	movl   $0xef000008,0x8011d342
8010595e:	00 00 ef 
  initlock(&tickslock, "time");
80105961:	68 b1 7d 10 80       	push   $0x80107db1
80105966:	68 00 d1 11 80       	push   $0x8011d100
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010596b:	66 a3 40 d3 11 80    	mov    %ax,0x8011d340
80105971:	c1 e8 10             	shr    $0x10,%eax
80105974:	66 a3 46 d3 11 80    	mov    %ax,0x8011d346
  initlock(&tickslock, "time");
8010597a:	e8 b1 e9 ff ff       	call   80104330 <initlock>
}
...
8010599b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010599f:	b8 40 d1 11 80       	mov    $0x8011d140,%eax
...
801059e0:	ff 24 85 58 7e 10 80 	jmp    *-0x7fef81a8(,%eax,4)
...
80105a10:	e8 3b de ff ff       	call   80103850 <cpuid>
...
80105a21:	e8 4a de ff ff       	call   80103870 <myproc>
80105a26:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105a29:	e8 42 de ff ff       	call   80103870 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105a45:	68 14 7e 10 80       	push   $0x80107e14
80105a4a:	e8 11 ac ff ff       	call   80100660 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
80105a4f:	83 c4 20             	add    $0x20,%esp
80105a52:	e8 19 de ff ff       	call   80103870 <myproc>
...
80105a67:	e8 04 de ff ff       	call   80103870 <myproc>
...
80105a8d:	e8 de dd ff ff       	call   80103870 <myproc>
...
80105ac2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(myproc()->killed)
80105ac8:	e8 a3 dd ff ff       	call   80103870 <myproc>
80105acd:	8b 58 28             	mov    0x28(%eax),%ebx
80105ad0:	85 db                	test   %ebx,%ebx
80105ad2:	0f 85 e8 00 00 00    	jne    80105bc0 <trap+0x200>
    myproc()->tf = tf;
80105ad8:	e8 93 dd ff ff       	call   80103870 <myproc>
80105add:	89 78 1c             	mov    %edi,0x1c(%eax)
    syscall();
80105ae0:	e8 8b ee ff ff       	call   80104970 <syscall>
    if(myproc()->killed)
80105ae5:	e8 86 dd ff ff       	call   80103870 <myproc>
...
80105b34:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80105b38:	e8 e3 ca ff ff       	call   80102620 <kbdintr>
    lapiceoi();
80105b3d:	e8 1e cc ff ff       	call   80102760 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b42:	e8 29 dd ff ff       	call   80103870 <myproc>
...
80105b5d:	e8 fe cb ff ff       	call   80102760 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b62:	e8 09 dd ff ff       	call   80103870 <myproc>
...
80105b7f:	e8 cc dc ff ff       	call   80103850 <cpuid>
80105b84:	56                   	push   %esi
80105b85:	53                   	push   %ebx
80105b86:	50                   	push   %eax
80105b87:	68 bc 7d 10 80       	push   $0x80107dbc
80105b8c:	e8 cf aa ff ff       	call   80100660 <cprintf>
    lapiceoi();
80105b91:	e8 ca cb ff ff       	call   80102760 <lapiceoi>
    break;
80105b96:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b99:	e8 d2 dc ff ff       	call   80103870 <myproc>
...
80105bac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ideintr();
80105bb0:	e8 db c4 ff ff       	call   80102090 <ideintr>
80105bb5:	e9 63 ff ff ff       	jmp    80105b1d <trap+0x15d>
80105bba:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105bc0:	e8 6b e1 ff ff       	call   80103d30 <exit>
80105bc5:	e9 0e ff ff ff       	jmp    80105ad8 <trap+0x118>
80105bca:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    exit();
80105bd0:	e8 5b e1 ff ff       	call   80103d30 <exit>
80105bd5:	e9 aa fe ff ff       	jmp    80105a84 <trap+0xc4>
80105bda:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      acquire(&tickslock);
80105be0:	83 ec 0c             	sub    $0xc,%esp
80105be3:	68 00 d1 11 80       	push   $0x8011d100
80105be8:	e8 83 e8 ff ff       	call   80104470 <acquire>
      wakeup(&ticks);
80105bed:	c7 04 24 40 d9 11 80 	movl   $0x8011d940,(%esp)
      ticks++;
80105bf4:	83 05 40 d9 11 80 01 	addl   $0x1,0x8011d940
      wakeup(&ticks);
80105bfb:	e8 60 e4 ff ff       	call   80104060 <wakeup>
      release(&tickslock);
80105c00:	c7 04 24 00 d1 11 80 	movl   $0x8011d100,(%esp)
80105c07:	e8 24 e9 ff ff       	call   80104530 <release>
80105c0c:	83 c4 10             	add    $0x10,%esp
80105c0f:	e9 09 ff ff ff       	jmp    80105b1d <trap+0x15d>
80105c14:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105c17:	e8 34 dc ff ff       	call   80103850 <cpuid>
...
80105c25:	68 e0 7d 10 80       	push   $0x80107de0
80105c2a:	e8 31 aa ff ff       	call   80100660 <cprintf>
      panic("trap");
80105c2f:	83 c4 14             	add    $0x14,%esp
80105c32:	68 b6 7d 10 80       	push   $0x80107db6
...
{
  if(!uart)
80105c40:	a1 10 b6 10 80       	mov    0x8010b610,%eax
{
...
80105c95:	e8 e6 ca ff ff       	call   80102780 <microdelay>
...
80105d17:	74 5a                	je     80105d73 <uartinit+0xb3>
  uart = 1;
80105d19:	c7 05 10 b6 10 80 01 	movl   $0x1,0x8010b610
80105d20:	00 00 00 
...
80105d2c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105d2f:	bb d8 7e 10 80       	mov    $0x80107ed8,%ebx
  ioapicenable(IRQ_COM1, 0);
80105d34:	6a 00                	push   $0x0
80105d36:	6a 04                	push   $0x4
80105d38:	e8 a3 c5 ff ff       	call   801022e0 <ioapicenable>
...
80105d58:	74 19                	je     80105d73 <uartinit+0xb3>
  if(!uart)
80105d5a:	8b 15 10 b6 10 80    	mov    0x8010b610,%edx
...
80105d80 <uartputc>:
  if(!uart)
80105d80:	8b 15 10 b6 10 80    	mov    0x8010b610,%edx
{
...
80105dc7:	6a 00                	push   $0x0
  jmp alltraps
80105dc9:	e9 1c fb ff ff       	jmp    801058ea <alltraps>
...
80105dd0:	6a 01                	push   $0x1
  jmp alltraps
80105dd2:	e9 13 fb ff ff       	jmp    801058ea <alltraps>
...
80105dd9:	6a 02                	push   $0x2
  jmp alltraps
80105ddb:	e9 0a fb ff ff       	jmp    801058ea <alltraps>
...
80105de2:	6a 03                	push   $0x3
  jmp alltraps
80105de4:	e9 01 fb ff ff       	jmp    801058ea <alltraps>
...
80105deb:	6a 04                	push   $0x4
  jmp alltraps
80105ded:	e9 f8 fa ff ff       	jmp    801058ea <alltraps>
...
80105df4:	6a 05                	push   $0x5
  jmp alltraps
80105df6:	e9 ef fa ff ff       	jmp    801058ea <alltraps>
...
80105dfd:	6a 06                	push   $0x6
  jmp alltraps
80105dff:	e9 e6 fa ff ff       	jmp    801058ea <alltraps>
...
80105e06:	6a 07                	push   $0x7
  jmp alltraps
80105e08:	e9 dd fa ff ff       	jmp    801058ea <alltraps>
...
80105e2b:	6a 0c                	push   $0xc
  jmp alltraps
80105e2d:	e9 b8 fa ff ff       	jmp    801058ea <alltraps>
...
80105e39:	6a 0e                	push   $0xe
  jmp alltraps
80105e3b:	e9 aa fa ff ff       	jmp    801058ea <alltraps>
...
80105e4b:	6a 10                	push   $0x10
  jmp alltraps
80105e4d:	e9 98 fa ff ff       	jmp    801058ea <alltraps>
...
80105e64:	6a 13                	push   $0x13
  jmp alltraps
80105e66:	e9 7f fa ff ff       	jmp    801058ea <alltraps>
...
80105e76:	6a 15                	push   $0x15
  jmp alltraps
80105e78:	e9 6d fa ff ff       	jmp    801058ea <alltraps>
...
80105e7f:	6a 16                	push   $0x16
  jmp alltraps
80105e81:	e9 64 fa ff ff       	jmp    801058ea <alltraps>
...
80105e88:	6a 17                	push   $0x17
  jmp alltraps
80105e8a:	e9 5b fa ff ff       	jmp    801058ea <alltraps>
...
80105e91:	6a 18                	push   $0x18
  jmp alltraps
80105e93:	e9 52 fa ff ff       	jmp    801058ea <alltraps>
...
80105e9a:	6a 19                	push   $0x19
  jmp alltraps
80105e9c:	e9 49 fa ff ff       	jmp    801058ea <alltraps>
...
80105ea3:	6a 1a                	push   $0x1a
  jmp alltraps
80105ea5:	e9 40 fa ff ff       	jmp    801058ea <alltraps>
...
80105eac:	6a 1b                	push   $0x1b
  jmp alltraps
80105eae:	e9 37 fa ff ff       	jmp    801058ea <alltraps>
...
80105eb5:	6a 1c                	push   $0x1c
  jmp alltraps
80105eb7:	e9 2e fa ff ff       	jmp    801058ea <alltraps>
...
80105ebe:	6a 1d                	push   $0x1d
  jmp alltraps
80105ec0:	e9 25 fa ff ff       	jmp    801058ea <alltraps>
...
80105ec7:	6a 1e                	push   $0x1e
  jmp alltraps
80105ec9:	e9 1c fa ff ff       	jmp    801058ea <alltraps>
...
80105ed0:	6a 1f                	push   $0x1f
  jmp alltraps
80105ed2:	e9 13 fa ff ff       	jmp    801058ea <alltraps>
...
80105ed9:	6a 20                	push   $0x20
  jmp alltraps
80105edb:	e9 0a fa ff ff       	jmp    801058ea <alltraps>
...
80105ee2:	6a 21                	push   $0x21
  jmp alltraps
80105ee4:	e9 01 fa ff ff       	jmp    801058ea <alltraps>
...
80105eeb:	6a 22                	push   $0x22
  jmp alltraps
80105eed:	e9 f8 f9 ff ff       	jmp    801058ea <alltraps>
...
80105ef4:	6a 23                	push   $0x23
  jmp alltraps
80105ef6:	e9 ef f9 ff ff       	jmp    801058ea <alltraps>
...
80105efd:	6a 24                	push   $0x24
  jmp alltraps
80105eff:	e9 e6 f9 ff ff       	jmp    801058ea <alltraps>
...
80105f06:	6a 25                	push   $0x25
  jmp alltraps
80105f08:	e9 dd f9 ff ff       	jmp    801058ea <alltraps>
...
80105f0f:	6a 26                	push   $0x26
  jmp alltraps
80105f11:	e9 d4 f9 ff ff       	jmp    801058ea <alltraps>
...
80105f18:	6a 27                	push   $0x27
  jmp alltraps
80105f1a:	e9 cb f9 ff ff       	jmp    801058ea <alltraps>
...
80105f21:	6a 28                	push   $0x28
  jmp alltraps
80105f23:	e9 c2 f9 ff ff       	jmp    801058ea <alltraps>
...
80105f2a:	6a 29                	push   $0x29
  jmp alltraps
80105f2c:	e9 b9 f9 ff ff       	jmp    801058ea <alltraps>
...
80105f33:	6a 2a                	push   $0x2a
  jmp alltraps
80105f35:	e9 b0 f9 ff ff       	jmp    801058ea <alltraps>
...
80105f3c:	6a 2b                	push   $0x2b
  jmp alltraps
80105f3e:	e9 a7 f9 ff ff       	jmp    801058ea <alltraps>
...
80105f45:	6a 2c                	push   $0x2c
  jmp alltraps
80105f47:	e9 9e f9 ff ff       	jmp    801058ea <alltraps>
...
80105f4e:	6a 2d                	push   $0x2d
  jmp alltraps
80105f50:	e9 95 f9 ff ff       	jmp    801058ea <alltraps>
...
80105f57:	6a 2e                	push   $0x2e
  jmp alltraps
80105f59:	e9 8c f9 ff ff       	jmp    801058ea <alltraps>
...
80105f60:	6a 2f                	push   $0x2f
  jmp alltraps
80105f62:	e9 83 f9 ff ff       	jmp    801058ea <alltraps>
...
80105f69:	6a 30                	push   $0x30
  jmp alltraps
80105f6b:	e9 7a f9 ff ff       	jmp    801058ea <alltraps>
...
80105f72:	6a 31                	push   $0x31
  jmp alltraps
80105f74:	e9 71 f9 ff ff       	jmp    801058ea <alltraps>
...
80105f7b:	6a 32                	push   $0x32
  jmp alltraps
80105f7d:	e9 68 f9 ff ff       	jmp    801058ea <alltraps>
...
80105f84:	6a 33                	push   $0x33
  jmp alltraps
80105f86:	e9 5f f9 ff ff       	jmp    801058ea <alltraps>
...
80105f8d:	6a 34                	push   $0x34
  jmp alltraps
80105f8f:	e9 56 f9 ff ff       	jmp    801058ea <alltraps>
...
80105f96:	6a 35                	push   $0x35
  jmp alltraps
80105f98:	e9 4d f9 ff ff       	jmp    801058ea <alltraps>
...
80105f9f:	6a 36                	push   $0x36
  jmp alltraps
80105fa1:	e9 44 f9 ff ff       	jmp    801058ea <alltraps>
...
80105fa8:	6a 37                	push   $0x37
  jmp alltraps
80105faa:	e9 3b f9 ff ff       	jmp    801058ea <alltraps>
...
80105fb1:	6a 38                	push   $0x38
  jmp alltraps
80105fb3:	e9 32 f9 ff ff       	jmp    801058ea <alltraps>
...
80105fba:	6a 39                	push   $0x39
  jmp alltraps
80105fbc:	e9 29 f9 ff ff       	jmp    801058ea <alltraps>
...
80105fc3:	6a 3a                	push   $0x3a
  jmp alltraps
80105fc5:	e9 20 f9 ff ff       	jmp    801058ea <alltraps>
...
80105fcc:	6a 3b                	push   $0x3b
  jmp alltraps
80105fce:	e9 17 f9 ff ff       	jmp    801058ea <alltraps>
...
80105fd5:	6a 3c                	push   $0x3c
  jmp alltraps
80105fd7:	e9 0e f9 ff ff       	jmp    801058ea <alltraps>
...
80105fde:	6a 3d                	push   $0x3d
  jmp alltraps
80105fe0:	e9 05 f9 ff ff       	jmp    801058ea <alltraps>
...
80105fe7:	6a 3e                	push   $0x3e
  jmp alltraps
80105fe9:	e9 fc f8 ff ff       	jmp    801058ea <alltraps>
...
80105ff0:	6a 3f                	push   $0x3f
  jmp alltraps
80105ff2:	e9 f3 f8 ff ff       	jmp    801058ea <alltraps>
...
80105ff9:	6a 40                	push   $0x40
  jmp alltraps
80105ffb:	e9 ea f8 ff ff       	jmp    801058ea <alltraps>
...
80106002:	6a 41                	push   $0x41
  jmp alltraps
80106004:	e9 e1 f8 ff ff       	jmp    801058ea <alltraps>
...
8010600b:	6a 42                	push   $0x42
  jmp alltraps
8010600d:	e9 d8 f8 ff ff       	jmp    801058ea <alltraps>
...
80106014:	6a 43                	push   $0x43
  jmp alltraps
80106016:	e9 cf f8 ff ff       	jmp    801058ea <alltraps>
...
8010601d:	6a 44                	push   $0x44
  jmp alltraps
8010601f:	e9 c6 f8 ff ff       	jmp    801058ea <alltraps>
...
80106026:	6a 45                	push   $0x45
  jmp alltraps
80106028:	e9 bd f8 ff ff       	jmp    801058ea <alltraps>
...
8010602f:	6a 46                	push   $0x46
  jmp alltraps
80106031:	e9 b4 f8 ff ff       	jmp    801058ea <alltraps>
...
80106038:	6a 47                	push   $0x47
  jmp alltraps
8010603a:	e9 ab f8 ff ff       	jmp    801058ea <alltraps>
...
80106041:	6a 48                	push   $0x48
  jmp alltraps
80106043:	e9 a2 f8 ff ff       	jmp    801058ea <alltraps>
...
8010604a:	6a 49                	push   $0x49
  jmp alltraps
8010604c:	e9 99 f8 ff ff       	jmp    801058ea <alltraps>
...
80106053:	6a 4a                	push   $0x4a
  jmp alltraps
80106055:	e9 90 f8 ff ff       	jmp    801058ea <alltraps>
...
8010605c:	6a 4b                	push   $0x4b
  jmp alltraps
8010605e:	e9 87 f8 ff ff       	jmp    801058ea <alltraps>
...
80106065:	6a 4c                	push   $0x4c
  jmp alltraps
80106067:	e9 7e f8 ff ff       	jmp    801058ea <alltraps>
...
8010606e:	6a 4d                	push   $0x4d
  jmp alltraps
80106070:	e9 75 f8 ff ff       	jmp    801058ea <alltraps>
...
80106077:	6a 4e                	push   $0x4e
  jmp alltraps
80106079:	e9 6c f8 ff ff       	jmp    801058ea <alltraps>
...
80106080:	6a 4f                	push   $0x4f
  jmp alltraps
80106082:	e9 63 f8 ff ff       	jmp    801058ea <alltraps>
...
80106089:	6a 50                	push   $0x50
  jmp alltraps
8010608b:	e9 5a f8 ff ff       	jmp    801058ea <alltraps>
...
80106092:	6a 51                	push   $0x51
  jmp alltraps
80106094:	e9 51 f8 ff ff       	jmp    801058ea <alltraps>
...
8010609b:	6a 52                	push   $0x52
  jmp alltraps
8010609d:	e9 48 f8 ff ff       	jmp    801058ea <alltraps>
...
801060a4:	6a 53                	push   $0x53
  jmp alltraps
801060a6:	e9 3f f8 ff ff       	jmp    801058ea <alltraps>
...
801060ad:	6a 54                	push   $0x54
  jmp alltraps
801060af:	e9 36 f8 ff ff       	jmp    801058ea <alltraps>
...
801060b6:	6a 55                	push   $0x55
  jmp alltraps
801060b8:	e9 2d f8 ff ff       	jmp    801058ea <alltraps>
...
801060bf:	6a 56                	push   $0x56
  jmp alltraps
801060c1:	e9 24 f8 ff ff       	jmp    801058ea <alltraps>
...
801060c8:	6a 57                	push   $0x57
  jmp alltraps
801060ca:	e9 1b f8 ff ff       	jmp    801058ea <alltraps>
...
801060d1:	6a 58                	push   $0x58
  jmp alltraps
801060d3:	e9 12 f8 ff ff       	jmp    801058ea <alltraps>
...
801060da:	6a 59                	push   $0x59
  jmp alltraps
801060dc:	e9 09 f8 ff ff       	jmp    801058ea <alltraps>
...
801060e3:	6a 5a                	push   $0x5a
  jmp alltraps
801060e5:	e9 00 f8 ff ff       	jmp    801058ea <alltraps>
...
801060ec:	6a 5b                	push   $0x5b
  jmp alltraps
801060ee:	e9 f7 f7 ff ff       	jmp    801058ea <alltraps>
...
801060f5:	6a 5c                	push   $0x5c
  jmp alltraps
801060f7:	e9 ee f7 ff ff       	jmp    801058ea <alltraps>
...
801060fe:	6a 5d                	push   $0x5d
  jmp alltraps
80106100:	e9 e5 f7 ff ff       	jmp    801058ea <alltraps>
...
80106107:	6a 5e                	push   $0x5e
  jmp alltraps
80106109:	e9 dc f7 ff ff       	jmp    801058ea <alltraps>
...
80106110:	6a 5f                	push   $0x5f
  jmp alltraps
80106112:	e9 d3 f7 ff ff       	jmp    801058ea <alltraps>
...
80106119:	6a 60                	push   $0x60
  jmp alltraps
8010611b:	e9 ca f7 ff ff       	jmp    801058ea <alltraps>
...
80106122:	6a 61                	push   $0x61
  jmp alltraps
80106124:	e9 c1 f7 ff ff       	jmp    801058ea <alltraps>
...
8010612b:	6a 62                	push   $0x62
  jmp alltraps
8010612d:	e9 b8 f7 ff ff       	jmp    801058ea <alltraps>
...
80106134:	6a 63                	push   $0x63
  jmp alltraps
80106136:	e9 af f7 ff ff       	jmp    801058ea <alltraps>
...
8010613d:	6a 64                	push   $0x64
  jmp alltraps
8010613f:	e9 a6 f7 ff ff       	jmp    801058ea <alltraps>
...
80106146:	6a 65                	push   $0x65
  jmp alltraps
80106148:	e9 9d f7 ff ff       	jmp    801058ea <alltraps>
...
8010614f:	6a 66                	push   $0x66
  jmp alltraps
80106151:	e9 94 f7 ff ff       	jmp    801058ea <alltraps>
...
80106158:	6a 67                	push   $0x67
  jmp alltraps
8010615a:	e9 8b f7 ff ff       	jmp    801058ea <alltraps>
...
80106161:	6a 68                	push   $0x68
  jmp alltraps
80106163:	e9 82 f7 ff ff       	jmp    801058ea <alltraps>
...
8010616a:	6a 69                	push   $0x69
  jmp alltraps
8010616c:	e9 79 f7 ff ff       	jmp    801058ea <alltraps>
...
80106173:	6a 6a                	push   $0x6a
  jmp alltraps
80106175:	e9 70 f7 ff ff       	jmp    801058ea <alltraps>
...
8010617c:	6a 6b                	push   $0x6b
  jmp alltraps
8010617e:	e9 67 f7 ff ff       	jmp    801058ea <alltraps>
...
80106185:	6a 6c                	push   $0x6c
  jmp alltraps
80106187:	e9 5e f7 ff ff       	jmp    801058ea <alltraps>
...
8010618e:	6a 6d                	push   $0x6d
  jmp alltraps
80106190:	e9 55 f7 ff ff       	jmp    801058ea <alltraps>
...
80106197:	6a 6e                	push   $0x6e
  jmp alltraps
80106199:	e9 4c f7 ff ff       	jmp    801058ea <alltraps>
...
801061a0:	6a 6f                	push   $0x6f
  jmp alltraps
801061a2:	e9 43 f7 ff ff       	jmp    801058ea <alltraps>
...
801061a9:	6a 70                	push   $0x70
  jmp alltraps
801061ab:	e9 3a f7 ff ff       	jmp    801058ea <alltraps>
...
801061b2:	6a 71                	push   $0x71
  jmp alltraps
801061b4:	e9 31 f7 ff ff       	jmp    801058ea <alltraps>
...
801061bb:	6a 72                	push   $0x72
  jmp alltraps
801061bd:	e9 28 f7 ff ff       	jmp    801058ea <alltraps>
...
801061c4:	6a 73                	push   $0x73
  jmp alltraps
801061c6:	e9 1f f7 ff ff       	jmp    801058ea <alltraps>
...
801061cd:	6a 74                	push   $0x74
  jmp alltraps
801061cf:	e9 16 f7 ff ff       	jmp    801058ea <alltraps>
...
801061d6:	6a 75                	push   $0x75
  jmp alltraps
801061d8:	e9 0d f7 ff ff       	jmp    801058ea <alltraps>
...
801061df:	6a 76                	push   $0x76
  jmp alltraps
801061e1:	e9 04 f7 ff ff       	jmp    801058ea <alltraps>
...
801061e8:	6a 77                	push   $0x77
  jmp alltraps
801061ea:	e9 fb f6 ff ff       	jmp    801058ea <alltraps>
...
801061f1:	6a 78                	push   $0x78
  jmp alltraps
801061f3:	e9 f2 f6 ff ff       	jmp    801058ea <alltraps>
...
801061fa:	6a 79                	push   $0x79
  jmp alltraps
801061fc:	e9 e9 f6 ff ff       	jmp    801058ea <alltraps>
...
80106203:	6a 7a                	push   $0x7a
  jmp alltraps
80106205:	e9 e0 f6 ff ff       	jmp    801058ea <alltraps>
...
8010620c:	6a 7b                	push   $0x7b
  jmp alltraps
8010620e:	e9 d7 f6 ff ff       	jmp    801058ea <alltraps>
...
80106215:	6a 7c                	push   $0x7c
  jmp alltraps
80106217:	e9 ce f6 ff ff       	jmp    801058ea <alltraps>
...
8010621e:	6a 7d                	push   $0x7d
  jmp alltraps
80106220:	e9 c5 f6 ff ff       	jmp    801058ea <alltraps>
...
80106227:	6a 7e                	push   $0x7e
  jmp alltraps
80106229:	e9 bc f6 ff ff       	jmp    801058ea <alltraps>
...
80106230:	6a 7f                	push   $0x7f
  jmp alltraps
80106232:	e9 b3 f6 ff ff       	jmp    801058ea <alltraps>
...
80106245:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010624a:	e9 9b f6 ff ff       	jmp    801058ea <alltraps>
...
80106251:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106256:	e9 8f f6 ff ff       	jmp    801058ea <alltraps>
...
80106884:	e8 47 bc ff ff       	call   801024d0 <kalloc>
...
8010689a:	e8 e1 dc ff ff       	call   80104580 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
8010693d:	68 e0 7e 10 80       	push   $0x80107ee0
...
80106994:	e8 87 b9 ff ff       	call   80102320 <kfree>
      *pte = 0;
...
801069e2:	68 c6 77 10 80       	push   $0x801077c6
...
80106a0a:	c7 80 58 38 11 80 ff 	movl   $0xffff,-0x7feec7a8(%eax)
80106a11:	ff 00 00 
80106a14:	c7 80 5c 38 11 80 00 	movl   $0xcf9a00,-0x7feec7a4(%eax)
80106a1b:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106a1e:	c7 80 60 38 11 80 ff 	movl   $0xffff,-0x7feec7a0(%eax)
80106a25:	ff 00 00 
80106a28:	c7 80 64 38 11 80 00 	movl   $0xcf9200,-0x7feec79c(%eax)
80106a2f:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106a32:	c7 80 68 38 11 80 ff 	movl   $0xffff,-0x7feec798(%eax)
80106a39:	ff 00 00 
80106a3c:	c7 80 6c 38 11 80 00 	movl   $0xcffa00,-0x7feec794(%eax)
80106a43:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106a46:	c7 80 70 38 11 80 ff 	movl   $0xffff,-0x7feec790(%eax)
80106a4d:	ff 00 00 
80106a50:	c7 80 74 38 11 80 00 	movl   $0xcff200,-0x7feec78c(%eax)
80106a57:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
80106a5a:	05 50 38 11 80       	add    $0x80113850,%eax
  pd[1] = (uint)p;
...
80106a80:	a1 44 d9 11 80       	mov    0x8011d944,%eax
{
...
80106ac4:	0f 84 c2 00 00 00    	je     80106b8c <switchuvm+0xec>
  pushcli();
80106aca:	e8 d1 d8 ff ff       	call   801043a0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106acf:	e8 fc cc ff ff       	call   801037d0 <mycpu>
80106ad4:	89 c6                	mov    %eax,%esi
80106ad6:	e8 f5 cc ff ff       	call   801037d0 <mycpu>
...
80106ae8:	e8 e3 cc ff ff       	call   801037d0 <mycpu>
...
80106bcb:	77 49                	ja     80106c16 <inituvm+0x66>
  mem = kalloc();
80106bcd:	e8 fe b8 ff ff       	call   801024d0 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106bdf:	e8 9c d9 ff ff       	call   80104580 <memset>
...
80106c10:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106c11:	e9 1a da ff ff       	jmp    80104630 <memmove>
    panic("inituvm: more than a page");
80106c16:	83 ec 0c             	sub    $0xc,%esp
80106c19:	68 25 7f 10 80       	push   $0x80107f25
...
80106ca1:	e8 ca ac ff ff       	call   80101970 <readi>
...
80106d3b:	e8 40 d8 ff ff       	call   80104580 <memset>
...
80106d69:	0f 86 81 00 00 00    	jbe    80106df0 <allocuvm+0x100>
    mem = kalloc();
80106d6f:	e8 5c b7 ff ff       	call   801024d0 <kalloc>
    if(mem == 0){
...
80106d7d:	68 5d 7f 10 80       	push   $0x80107f5d
...
80106db3:	68 75 7f 10 80       	push   $0x80107f75
...
80106ddb:	e8 40 b5 ff ff       	call   80102320 <kfree>
      return 0;
...
80106e9e:	e8 7d b4 ff ff       	call   80102320 <kfree>
...
80106eb3:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106eb4:	e9 67 b4 ff ff       	jmp    80102320 <kfree>
    panic("freevm: no pgdir");
80106eb9:	83 ec 0c             	sub    $0xc,%esp
80106ebc:	68 91 7f 10 80       	push   $0x80107f91
...
80106ed5:	e8 f6 b5 ff ff       	call   801024d0 <kalloc>
...
80106ef0:	e8 8b d6 ff ff       	call   80104580 <memset>
...
80106f5b:	a3 44 d9 11 80       	mov    %eax,0x8011d944
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106f8f:	68 a2 7f 10 80       	push   $0x80107fa2
...
80106fe0:	e8 4b d6 ff ff       	call   80104630 <memmove>
...
80107035:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
80107038:	e8 93 b4 ff ff       	call   801024d0 <kalloc>
...
8010710f:	e8 1c d5 ff ff       	call   80104630 <memmove>
    len -= n;
    buf += n;
...
80107171:	ba b8 3e 11 80       	mov    $0x80113eb8,%edx
  struct container *con;
  for(int i=0; i<NCONT; i++){
80107176:	31 c9                	xor    %ecx,%ecx
void containerInit(void){
80107178:	89 e5                	mov    %esp,%ebp
8010717a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80107180:	8d 82 00 ff ff ff    	lea    -0x100(%edx),%eax
    con = &ctable.container[i];
    con->containerID = i;
80107186:	89 8a fc fe ff ff    	mov    %ecx,-0x104(%edx)
    con->state = CUNUSED;
8010718c:	c7 02 02 00 00 00    	movl   $0x2,(%edx)
    con->nextGVA = 0;
80107192:	c7 42 04 00 00 00 00 	movl   $0x0,0x4(%edx)
    con->pgTable.next = 0; //Setting Next for this pgTable
80107199:	c7 82 b8 04 00 00 00 	movl   $0x0,0x4b8(%edx)
801071a0:	00 00 00 
801071a3:	90                   	nop
801071a4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    for(int j=0; j<NPROC; j++){
      con->presentProc[j] = 0;
801071a8:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
801071ae:	83 c0 04             	add    $0x4,%eax
    for(int j=0; j<NPROC; j++){
801071b1:	39 d0                	cmp    %edx,%eax
801071b3:	75 f3                	jne    801071a8 <containerInit+0x38>
  for(int i=0; i<NCONT; i++){
801071b5:	83 c1 01             	add    $0x1,%ecx
801071b8:	8d 90 c0 05 00 00    	lea    0x5c0(%eax),%edx
801071be:	83 f9 14             	cmp    $0x14,%ecx
801071c1:	75 bd                	jne    80107180 <containerInit+0x10>
  }
...
801071c3:	c7 05 b8 3e 11 80 01 	movl   $0x1,0x80113eb8
801071ca:	00 00 00 
}
801071cd:	5d                   	pop    %ebp
801071ce:	c3                   	ret    
...
801071d0 <createContainer>:

int createContainer(void){
801071d0:	55                   	push   %ebp
801071d1:	89 e5                	mov    %esp,%ebp
801071d3:	53                   	push   %ebx
801071d4:	83 ec 10             	sub    $0x10,%esp
  struct container *c;
  acquire(&ctable.lock);
801071d7:	68 80 3d 11 80       	push   $0x80113d80
801071dc:	e8 8f d2 ff ff       	call   80104470 <acquire>
801071e1:	83 c4 10             	add    $0x10,%esp
  int id = 0;
  for(c=ctable.container; c<&ctable.container[NCONT]; c++){
801071e4:	ba b4 3d 11 80       	mov    $0x80113db4,%edx
801071e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    id = c->containerID;
801071f0:	8b 1a                	mov    (%edx),%ebx
    if(containers[id] == 0 && id!=0){
801071f2:	8b 04 9d c0 b5 10 80 	mov    -0x7fef4a40(,%ebx,4),%eax
801071f9:	85 c0                	test   %eax,%eax
801071fb:	75 04                	jne    80107201 <createContainer+0x31>
801071fd:	85 db                	test   %ebx,%ebx
801071ff:	75 3f                	jne    80107240 <createContainer+0x70>
  for(c=ctable.container; c<&ctable.container[NCONT]; c++){
80107201:	81 c2 c0 05 00 00    	add    $0x5c0,%edx
80107207:	81 fa b4 b0 11 80    	cmp    $0x8011b0b4,%edx
8010720d:	72 e1                	jb     801071f0 <createContainer+0x20>
      c->state = CWAITING;
      release(&ctable.lock);
      return id;
    }
...
8010720f:	83 ec 0c             	sub    $0xc,%esp
  release(&ctable.lock);
  return -1;
80107212:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
  cprintf("Couldn't create a new container\n");
80107217:	68 04 80 10 80       	push   $0x80108004
8010721c:	e8 3f 94 ff ff       	call   80100660 <cprintf>
  release(&ctable.lock);
80107221:	c7 04 24 80 3d 11 80 	movl   $0x80113d80,(%esp)
80107228:	e8 03 d3 ff ff       	call   80104530 <release>
}
8010722d:	89 d8                	mov    %ebx,%eax
  return -1;
8010722f:	83 c4 10             	add    $0x10,%esp
}
80107232:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80107235:	c9                   	leave  
80107236:	c3                   	ret    
...
80107240:	83 ec 0c             	sub    $0xc,%esp
      c->state = CWAITING;
80107243:	c7 82 04 01 00 00 01 	movl   $0x1,0x104(%edx)
8010724a:	00 00 00 
      containers[id] = 1;
8010724d:	c7 04 9d c0 b5 10 80 	movl   $0x1,-0x7fef4a40(,%ebx,4)
80107254:	01 00 00 00 
      release(&ctable.lock);
80107258:	68 80 3d 11 80       	push   $0x80113d80
8010725d:	e8 ce d2 ff ff       	call   80104530 <release>
}
80107262:	89 d8                	mov    %ebx,%eax
      return id;
...
80107275:	53                   	push   %ebx
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p<&ptable.proc[NPROC]; p++){
80107276:	bb f4 b0 11 80       	mov    $0x8011b0f4,%ebx
void destroyContainer(int id){
8010727b:	83 ec 18             	sub    $0x18,%esp
8010727e:	8b 7d 08             	mov    0x8(%ebp),%edi
  acquire(&ctable.lock);
80107281:	68 80 3d 11 80       	push   $0x80113d80
80107286:	e8 e5 d1 ff ff       	call   80104470 <acquire>
  release(&ctable.lock);
8010728b:	c7 04 24 80 3d 11 80 	movl   $0x80113d80,(%esp)
80107292:	e8 99 d2 ff ff       	call   80104530 <release>
  con->state = CUNUSED;
80107297:	69 c7 c0 05 00 00    	imul   $0x5c0,%edi,%eax
  acquire(&ptable.lock);
8010729d:	c7 04 24 c0 b0 11 80 	movl   $0x8011b0c0,(%esp)
    int pid = p->pid;
    if(con->presentProc[pid] == 1){
801072a4:	69 ff 70 01 00 00    	imul   $0x170,%edi,%edi
  con->state = CUNUSED;
801072aa:	c7 80 b8 3e 11 80 02 	movl   $0x2,-0x7feec148(%eax)
801072b1:	00 00 00 
  acquire(&ptable.lock);
801072b4:	e8 b7 d1 ff ff       	call   80104470 <acquire>
801072b9:	83 c4 10             	add    $0x10,%esp
801072bc:	eb 0d                	jmp    801072cb <destroyContainer+0x5b>
801072be:	66 90                	xchg   %ax,%ax
  for(p = ptable.proc; p<&ptable.proc[NPROC]; p++){
801072c0:	83 eb 80             	sub    $0xffffff80,%ebx
801072c3:	81 fb f4 d0 11 80    	cmp    $0x8011d0f4,%ebx
801072c9:	73 4b                	jae    80107316 <destroyContainer+0xa6>
    int pid = p->pid;
801072cb:	8b 73 10             	mov    0x10(%ebx),%esi
    if(con->presentProc[pid] == 1){
801072ce:	8d 44 3e 0c          	lea    0xc(%esi,%edi,1),%eax
801072d2:	83 3c 85 88 3d 11 80 	cmpl   $0x1,-0x7feec278(,%eax,4)
801072d9:	01 
801072da:	75 e4                	jne    801072c0 <destroyContainer+0x50>
      //This proc is present in the container, SO KILL IT
      con->presentProc[pid] = 0;
      release(&ptable.lock);
801072dc:	83 ec 0c             	sub    $0xc,%esp
  for(p = ptable.proc; p<&ptable.proc[NPROC]; p++){
801072df:	83 eb 80             	sub    $0xffffff80,%ebx
      con->presentProc[pid] = 0;
801072e2:	c7 04 85 88 3d 11 80 	movl   $0x0,-0x7feec278(,%eax,4)
801072e9:	00 00 00 00 
      release(&ptable.lock);
801072ed:	68 c0 b0 11 80       	push   $0x8011b0c0
801072f2:	e8 39 d2 ff ff       	call   80104530 <release>
      kill(pid);
801072f7:	89 34 24             	mov    %esi,(%esp)
801072fa:	e8 c1 cd ff ff       	call   801040c0 <kill>
      acquire(&ptable.lock);
801072ff:	c7 04 24 c0 b0 11 80 	movl   $0x8011b0c0,(%esp)
80107306:	e8 65 d1 ff ff       	call   80104470 <acquire>
8010730b:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p<&ptable.proc[NPROC]; p++){
8010730e:	81 fb f4 d0 11 80    	cmp    $0x8011d0f4,%ebx
80107314:	72 b5                	jb     801072cb <destroyContainer+0x5b>
    }
  }
  release(&ptable.lock);
80107316:	c7 45 08 c0 b0 11 80 	movl   $0x8011b0c0,0x8(%ebp)
}
...
80107323:	5d                   	pop    %ebp
  release(&ptable.lock);
80107324:	e9 07 d2 ff ff       	jmp    80104530 <release>
80107329:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

80107330 <addProcessToContainer>:
...
80107335:	8b 75 08             	mov    0x8(%ebp),%esi
80107338:	8b 5d 0c             	mov    0xc(%ebp),%ebx
  struct container *con;
  acquire(&ctable.lock);
8010733b:	83 ec 0c             	sub    $0xc,%esp
8010733e:	68 80 3d 11 80       	push   $0x80113d80
80107343:	e8 28 d1 ff ff       	call   80104470 <acquire>
80107348:	83 c4 10             	add    $0x10,%esp
  for(con = ctable.container; con < &ctable.container[NCONT]; con++){
8010734b:	b8 b4 3d 11 80       	mov    $0x80113db4,%eax
80107350:	eb 12                	jmp    80107364 <addProcessToContainer+0x34>
80107352:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80107358:	05 c0 05 00 00       	add    $0x5c0,%eax
8010735d:	3d b4 b0 11 80       	cmp    $0x8011b0b4,%eax
80107362:	73 0c                	jae    80107370 <addProcessToContainer+0x40>
    if(con->containerID == containerID){
80107364:	39 18                	cmp    %ebx,(%eax)
80107366:	75 f0                	jne    80107358 <addProcessToContainer+0x28>
      //This is the container ID, add this process
      con->presentProc[pid] = 1; // Added the process
80107368:	c7 44 b0 04 01 00 00 	movl   $0x1,0x4(%eax,%esi,4)
8010736f:	00 
  }
...
80107370:	c7 04 b5 b8 3d 11 80 	movl   $0x0,-0x7feec248(,%esi,4)
80107377:	00 00 00 00 
  release(&ctable.lock);
8010737b:	c7 45 08 80 3d 11 80 	movl   $0x80113d80,0x8(%ebp)
}
...
80107387:	5d                   	pop    %ebp
  release(&ctable.lock);
80107388:	e9 a3 d1 ff ff       	jmp    80104530 <release>
8010738d:	8d 76 00             	lea    0x0(%esi),%esi

80107390 <removeProcessFromContainer>:
...
80107398:	8b 5d 0c             	mov    0xc(%ebp),%ebx
  struct container *con;
  acquire(&ctable.lock);
8010739b:	83 ec 0c             	sub    $0xc,%esp
8010739e:	68 80 3d 11 80       	push   $0x80113d80
801073a3:	e8 c8 d0 ff ff       	call   80104470 <acquire>
801073a8:	83 c4 10             	add    $0x10,%esp
  for(con = ctable.container; con < &ctable.container[NCONT]; con++){
801073ab:	b8 b4 3d 11 80       	mov    $0x80113db4,%eax
801073b0:	eb 12                	jmp    801073c4 <removeProcessFromContainer+0x34>
801073b2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
801073b8:	05 c0 05 00 00       	add    $0x5c0,%eax
801073bd:	3d b4 b0 11 80       	cmp    $0x8011b0b4,%eax
801073c2:	73 0c                	jae    801073d0 <removeProcessFromContainer+0x40>
    if(con->containerID == containerID){
801073c4:	39 18                	cmp    %ebx,(%eax)
801073c6:	75 f0                	jne    801073b8 <removeProcessFromContainer+0x28>
      //This is the container ID, remove this process
      con->presentProc[pid] = 0; // Remove the process
801073c8:	c7 44 b0 04 00 00 00 	movl   $0x0,0x4(%eax,%esi,4)
801073cf:	00 
  }
...
801073d0:	c7 04 b5 b8 3d 11 80 	movl   $0x1,-0x7feec248(,%esi,4)
801073d7:	01 00 00 00 
  release(&ctable.lock);
801073db:	c7 45 08 80 3d 11 80 	movl   $0x80113d80,0x8(%ebp)
}
...
801073e7:	5d                   	pop    %ebp
  release(&ctable.lock);
801073e8:	e9 43 d1 ff ff       	jmp    80104530 <release>
801073ed:	8d 76 00             	lea    0x0(%esi),%esi

801073f0 <listContainersHelper>:
...
801073f4:	53                   	push   %ebx
  ...
  acquire(&ctable.lock);
  for(c = ctable.container; c < &ctable.container[NCONT]; c++){
801073f5:	be b4 3d 11 80       	mov    $0x80113db4,%esi
  acquire(&ctable.lock);
801073fa:	83 ec 0c             	sub    $0xc,%esp
801073fd:	68 80 3d 11 80       	push   $0x80113d80
80107402:	e8 69 d0 ff ff       	call   80104470 <acquire>
80107407:	83 c4 10             	add    $0x10,%esp
8010740a:	eb 12                	jmp    8010741e <listContainersHelper+0x2e>
8010740c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for(c = ctable.container; c < &ctable.container[NCONT]; c++){
80107410:	81 c6 c0 05 00 00    	add    $0x5c0,%esi
80107416:	81 fe b4 b0 11 80    	cmp    $0x8011b0b4,%esi
8010741c:	73 46                	jae    80107464 <listContainersHelper+0x74>
    if(containers[c->containerID] == 1){
8010741e:	8b 06                	mov    (%esi),%eax
80107420:	83 3c 85 c0 b5 10 80 	cmpl   $0x1,-0x7fef4a40(,%eax,4)
80107427:	01 
80107428:	75 e6                	jne    80107410 <listContainersHelper+0x20>
...
8010742a:	83 ec 08             	sub    $0x8,%esp
      ...
      for(int j=0; j<NPROC; j++){
8010742d:	31 db                	xor    %ebx,%ebx
      cprintf("The container with id %d is initialised: \n", c->containerID);
8010742f:	50                   	push   %eax
80107430:	68 28 80 10 80       	push   $0x80108028
80107435:	e8 26 92 ff ff       	call   80100660 <cprintf>
8010743a:	83 c4 10             	add    $0x10,%esp
8010743d:	eb 09                	jmp    80107448 <listContainersHelper+0x58>
8010743f:	90                   	nop
      for(int j=0; j<NPROC; j++){
80107440:	83 c3 01             	add    $0x1,%ebx
80107443:	83 fb 40             	cmp    $0x40,%ebx
80107446:	74 c8                	je     80107410 <listContainersHelper+0x20>
        if(c->presentProc[j] == 1){
80107448:	83 7c 9e 04 01       	cmpl   $0x1,0x4(%esi,%ebx,4)
8010744d:	75 f1                	jne    80107440 <listContainersHelper+0x50>
          cprintf("The process with id %d is present in container with id %d: \n", j, c->containerID);
8010744f:	83 ec 04             	sub    $0x4,%esp
80107452:	ff 36                	pushl  (%esi)
80107454:	53                   	push   %ebx
80107455:	68 54 80 10 80       	push   $0x80108054
8010745a:	e8 01 92 ff ff       	call   80100660 <cprintf>
8010745f:	83 c4 10             	add    $0x10,%esp
80107462:	eb dc                	jmp    80107440 <listContainersHelper+0x50>
        }
      }
    }
  }
...
80107467:	68 80 3d 11 80       	push   $0x80113d80
8010746c:	e8 bf d0 ff ff       	call   80104530 <release>
}
80107471:	83 c4 10             	add    $0x10,%esp
80107474:	8d 65 f8             	lea    -0x8(%ebp),%esp
80107477:	5b                   	pop    %ebx
80107478:	5e                   	pop    %esi
80107479:	5d                   	pop    %ebp
8010747a:	c3                   	ret    
...
80107485:	53                   	push   %ebx
  ...
  acquire(&ctable.lock);
  for(c=ctable.container; c<&ctable.container[NCONT]; c++){
80107486:	bb b4 3d 11 80       	mov    $0x80113db4,%ebx
void container_malloc(int numBytes, int pid){
8010748b:	83 ec 28             	sub    $0x28,%esp
8010748e:	8b 45 08             	mov    0x8(%ebp),%eax
80107491:	8b 75 0c             	mov    0xc(%ebp),%esi
  acquire(&ctable.lock);
80107494:	68 80 3d 11 80       	push   $0x80113d80
void container_malloc(int numBytes, int pid){
80107499:	89 45 e0             	mov    %eax,-0x20(%ebp)
  acquire(&ctable.lock);
8010749c:	e8 cf cf ff ff       	call   80104470 <acquire>
801074a1:	83 c4 10             	add    $0x10,%esp
801074a4:	eb 18                	jmp    801074be <container_malloc+0x3e>
801074a6:	8d 76 00             	lea    0x0(%esi),%esi
801074a9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  for(c=ctable.container; c<&ctable.container[NCONT]; c++){
801074b0:	81 c3 c0 05 00 00    	add    $0x5c0,%ebx
801074b6:	81 fb b4 b0 11 80    	cmp    $0x8011b0b4,%ebx
801074bc:	73 78                	jae    80107536 <container_malloc+0xb6>
    if(c->presentProc[pid] == 1){
801074be:	83 7c b3 04 01       	cmpl   $0x1,0x4(%ebx,%esi,4)
801074c3:	75 eb                	jne    801074b0 <container_malloc+0x30>
      //This is the container in which this process is present;
      nextGVA = c->nextGVA;
801074c5:	8b bb 08 01 00 00    	mov    0x108(%ebx),%edi
      nextFree = c->pgTable.next;

      //Updation
      c->nextGVA = c->nextGVA + numBytes;
801074cb:	8b 55 e0             	mov    -0x20(%ebp),%edx
      nextFree = c->pgTable.next;
801074ce:	8b 83 bc 05 00 00    	mov    0x5bc(%ebx),%eax
      c->nextGVA = c->nextGVA + numBytes;
801074d4:	8d 0c 17             	lea    (%edi,%edx,1),%ecx
801074d7:	89 8b 08 01 00 00    	mov    %ecx,0x108(%ebx)
      c->pgTable.next++;
801074dd:	8d 48 01             	lea    0x1(%eax),%ecx

      //Setting
      c->pgTable.page[nextFree].GVA = nextGVA;
801074e0:	8d 04 40             	lea    (%eax,%eax,2),%eax
      c->pgTable.next++;
801074e3:	89 8b bc 05 00 00    	mov    %ecx,0x5bc(%ebx)
      c->pgTable.page[nextFree].GVA = nextGVA;
801074e9:	8d 0c 83             	lea    (%ebx,%eax,4),%ecx
  for(c=ctable.container; c<&ctable.container[NCONT]; c++){
801074ec:	81 c3 c0 05 00 00    	add    $0x5c0,%ebx
      c->pgTable.page[nextFree].GVA = nextGVA;
801074f2:	89 b9 0c 01 00 00    	mov    %edi,0x10c(%ecx)
801074f8:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
      c->pgTable.page[nextFree].HVA = kalloc();
801074fb:	e8 d0 af ff ff       	call   801024d0 <kalloc>
80107500:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
...
80107503:	83 ec 04             	sub    $0x4,%esp
      c->pgTable.page[nextFree].HVA = kalloc();
80107506:	89 81 10 01 00 00    	mov    %eax,0x110(%ecx)
      c->pgTable.page[nextFree].pid = pid;
8010750c:	89 b1 14 01 00 00    	mov    %esi,0x114(%ecx)
      cprintf("%d  %p\n", nextGVA, c->pgTable.page[nextFree].HVA);
80107512:	50                   	push   %eax
80107513:	57                   	push   %edi
80107514:	68 94 80 10 80       	push   $0x80108094
80107519:	e8 42 91 ff ff       	call   80100660 <cprintf>
      cprintf("%d\n", pid);
8010751e:	58                   	pop    %eax
8010751f:	5a                   	pop    %edx
80107520:	56                   	push   %esi
80107521:	68 ad 7d 10 80       	push   $0x80107dad
80107526:	e8 35 91 ff ff       	call   80100660 <cprintf>
8010752b:	83 c4 10             	add    $0x10,%esp
  for(c=ctable.container; c<&ctable.container[NCONT]; c++){
8010752e:	81 fb b4 b0 11 80    	cmp    $0x8011b0b4,%ebx
80107534:	72 88                	jb     801074be <container_malloc+0x3e>
    }
  }
  release(&ctable.lock);
80107536:	c7 45 08 80 3d 11 80 	movl   $0x80113d80,0x8(%ebp)
}
...
80107543:	5d                   	pop    %ebp
  release(&ctable.lock);
80107544:	e9 e7 cf ff ff       	jmp    80104530 <release>
