...
801003c0:	e8 9b 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003c5:	c7 04 24 cb 7d 10 80 	movl   $0x80107dcb,(%esp)
...
80101ed8:	68 36 7b 10 80       	push   $0x80107b36
...
80102332:	81 fb e8 6a 11 80    	cmp    $0x80116ae8,%ebx
...
80102ec7:	68 e8 6a 11 80       	push   $0x80116ae8
...
80102fc5:	e8 46 41 00 00       	call   80107110 <containerInit>
...
8010300e:	68 b8 78 10 80       	push   $0x801078b8
80103013:	56                   	push   %esi
80103014:	e8 27 15 00 00       	call   80104540 <memcmp>
...
801030cc:	68 d5 78 10 80       	push   $0x801078d5
801030d1:	56                   	push   %esi
801030d2:	e8 69 14 00 00       	call   80104540 <memcmp>
...
80103160:	ff 24 95 fc 78 10 80 	jmp    *-0x7fef8704(,%edx,4)
...
80103213:	68 bd 78 10 80       	push   $0x801078bd
80103218:	e8 73 d1 ff ff       	call   80100390 <panic>
    panic("Didn't find a suitable machine");
8010321d:	83 ec 0c             	sub    $0xc,%esp
80103220:	68 dc 78 10 80       	push   $0x801078dc
...
80103318:	00 00 00 
  initlock(&p->lock, "pipe");
8010331b:	68 10 79 10 80       	push   $0x80107910
80103320:	50                   	push   %eax
80103321:	e8 7a 0f 00 00       	call   801042a0 <initlock>
  (*f0)->type = FD_PIPE;
...
8010337f:	e8 5c 10 00 00       	call   801043e0 <acquire>
  if(writable){
...
8010339f:	e8 2c 0c 00 00       	call   80103fd0 <wakeup>
...
801033c3:	5d                   	pop    %ebp
    release(&p->lock);
801033c4:	e9 d7 10 00 00       	jmp    801044a0 <release>
...
801033e4:	e8 e7 0b 00 00       	call   80103fd0 <wakeup>
...
801033f4:	e8 a7 10 00 00       	call   801044a0 <release>
    kfree((char*)p);
...
8010341d:	e8 be 0f 00 00       	call   801043e0 <acquire>
  for(i = 0; i < n; i++){
...
80103474:	e8 57 0b 00 00       	call   80103fd0 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
80103479:	5a                   	pop    %edx
8010347a:	59                   	pop    %ecx
8010347b:	53                   	push   %ebx
8010347c:	56                   	push   %esi
8010347d:	e8 9e 09 00 00       	call   80103e20 <sleep>
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
...
801034b4:	e8 e7 0f 00 00       	call   801044a0 <release>
        return -1;
...
80103503:	e8 c8 0a 00 00       	call   80103fd0 <wakeup>
  release(&p->lock);
80103508:	89 1c 24             	mov    %ebx,(%esp)
8010350b:	e8 90 0f 00 00       	call   801044a0 <release>
  return n;
...
80103530:	e8 ab 0e 00 00       	call   801043e0 <acquire>
...
80103565:	e8 b6 08 00 00       	call   80103e20 <sleep>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
...
8010359e:	e8 fd 0e 00 00       	call   801044a0 <release>
      return -1;
...
801035f7:	e8 d4 09 00 00       	call   80103fd0 <wakeup>
  release(&p->lock);
801035fc:	89 34 24             	mov    %esi,(%esp)
801035ff:	e8 9c 0e 00 00       	call   801044a0 <release>
  return i;
...
80103624:	bb 94 42 11 80       	mov    $0x80114294,%ebx
{
80103629:	83 ec 10             	sub    $0x10,%esp
  acquire(&ptable.lock);
8010362c:	68 60 42 11 80       	push   $0x80114260
80103631:	e8 aa 0d 00 00       	call   801043e0 <acquire>
...
80103643:	81 fb 94 62 11 80    	cmp    $0x80116294,%ebx
...
80103664:	89 43 10             	mov    %eax,0x10(%ebx)
  release(&ptable.lock);
80103667:	68 60 42 11 80       	push   $0x80114260
  p->pid = nextpid++;
8010366c:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
80103672:	e8 29 0e 00 00       	call   801044a0 <release>
...
80103694:	89 53 1c             	mov    %edx,0x1c(%ebx)
  *(uint*)sp = (uint)trapret;
80103697:	c7 40 14 a2 58 10 80 	movl   $0x801058a2,0x14(%eax)
  p->context = (struct context*)sp;
...
801036a6:	e8 45 0e 00 00       	call   801044f0 <memset>
...
801036c3:	31 db                	xor    %ebx,%ebx
  release(&ptable.lock);
801036c5:	68 60 42 11 80       	push   $0x80114260
...
801036f3:	83 ec 14             	sub    $0x14,%esp
  ...
  release(&ptable.lock);
801036f6:	68 60 42 11 80       	push   $0x80114260
...
80103745:	8b 75 0c             	mov    0xc(%ebp),%esi
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103748:	bb 94 42 11 80       	mov    $0x80114294,%ebx
  acquire(&ptable.lock);
8010374d:	83 ec 0c             	sub    $0xc,%esp
80103750:	68 60 42 11 80       	push   $0x80114260
80103755:	e8 86 0c 00 00       	call   801043e0 <acquire>
8010375a:	83 c4 10             	add    $0x10,%esp
8010375d:	eb 0c                	jmp    8010376b <psHelper+0x2b>
8010375f:	90                   	nop
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103760:	83 eb 80             	sub    $0xffffff80,%ebx
80103763:	81 fb 94 62 11 80    	cmp    $0x80116294,%ebx
...
80103788:	68 15 79 10 80       	push   $0x80107915
8010378d:	e8 ce ce ff ff       	call   80100660 <cprintf>
80103792:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103795:	81 fb 94 62 11 80    	cmp    $0x80116294,%ebx
8010379b:	72 ce                	jb     8010376b <psHelper+0x2b>
  release(&ptable.lock);
8010379d:	c7 45 08 60 42 11 80 	movl   $0x80114260,0x8(%ebp)
}
...
801037a9:	5d                   	pop    %ebp
  release(&ptable.lock);
801037aa:	e9 f1 0c 00 00       	jmp    801044a0 <release>
801037af:	90                   	nop
...
801037b6:	68 25 79 10 80       	push   $0x80107925
801037bb:	68 60 42 11 80       	push   $0x80114260
801037c0:	e8 db 0a 00 00       	call   801042a0 <initlock>
}
...
801037dc:	e8 5f ef ff ff       	call   80102740 <lapicid>
  for (i = 0; i < ncpu; ++i) {
801037e1:	8b 35 60 2d 11 80    	mov    0x80112d60,%esi
801037e7:	85 f6                	test   %esi,%esi
801037e9:	7e 42                	jle    8010382d <mycpu+0x5d>
    if (cpus[i].apicid == apicid)
801037eb:	0f b6 15 e0 27 11 80 	movzbl 0x801127e0,%edx
801037f2:	39 d0                	cmp    %edx,%eax
801037f4:	74 30                	je     80103826 <mycpu+0x56>
801037f6:	b9 90 28 11 80       	mov    $0x80112890,%ecx
  for (i = 0; i < ncpu; ++i) {
...
8010381a:	05 e0 27 11 80       	add    $0x801127e0,%eax
}
...
8010385b:	2d e0 27 11 80       	sub    $0x801127e0,%eax
}
80103860:	c9                   	leave  
  return mycpu()-cpus;
...
80103874:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103877:	e8 94 0a 00 00       	call   80104310 <pushcli>
  c = mycpu();
8010387c:	e8 4f ff ff ff       	call   801037d0 <mycpu>
  p = c->proc;
80103881:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103887:	e8 c4 0a 00 00       	call   80104350 <popcli>
}
...
801038bd:	0f 84 c4 00 00 00    	je     80103987 <userinit+0xe7>
...
8010393f:	68 55 79 10 80       	push   $0x80107955
80103944:	50                   	push   %eax
80103945:	e8 86 0d 00 00       	call   801046d0 <safestrcpy>
  p->cwd = namei("/");
8010394a:	c7 04 24 5e 79 10 80 	movl   $0x8010795e,(%esp)
80103951:	e8 9a e5 ff ff       	call   80101ef0 <namei>
80103956:	89 43 6c             	mov    %eax,0x6c(%ebx)
  acquire(&ptable.lock);
80103959:	c7 04 24 60 42 11 80 	movl   $0x80114260,(%esp)
80103960:	e8 7b 0a 00 00       	call   801043e0 <acquire>
  p->state = RUNNABLE;
80103965:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  p->containerID = 0;
8010396c:	c7 43 18 00 00 00 00 	movl   $0x0,0x18(%ebx)
  release(&ptable.lock);
80103973:	c7 04 24 60 42 11 80 	movl   $0x80114260,(%esp)
8010397a:	e8 21 0b 00 00       	call   801044a0 <release>
}
...
8010398a:	68 3c 79 10 80       	push   $0x8010793c
8010398f:	e8 fc c9 ff ff       	call   80100390 <panic>
...
801039a8:	e8 63 09 00 00       	call   80104310 <pushcli>
  c = mycpu();
801039ad:	e8 1e fe ff ff       	call   801037d0 <mycpu>
  p = c->proc;
...
801039cc:	e8 6f 30 00 00       	call   80106a40 <switchuvm>
  return 0;
...
801039ea:	e8 a1 32 00 00       	call   80106c90 <allocuvm>
...
80103a0a:	e8 b1 33 00 00       	call   80106dc0 <deallocuvm>
...
80103a75:	89 c8                	mov    %ecx,%eax
  *np->tf = *curproc->tf;
80103a77:	8b 79 1c             	mov    0x1c(%ecx),%edi
80103a7a:	8b 73 1c             	mov    0x1c(%ebx),%esi
...
80103ab9:	83 c3 70             	add    $0x70,%ebx
  np->cwd = idup(curproc->cwd);
80103abc:	e8 9f db ff ff       	call   80101660 <idup>
...
80103ad6:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103ad9:	c7 04 24 60 42 11 80 	movl   $0x80114260,(%esp)
...
80103b0b:	c3                   	ret    
    return -1;
80103b0c:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80103b11:	eb ef                	jmp    80103b02 <fork+0xe2>
    kfree(np->kstack);
80103b13:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
80103b16:	83 ec 0c             	sub    $0xc,%esp
80103b19:	ff 73 08             	pushl  0x8(%ebx)
80103b1c:	e8 ff e7 ff ff       	call   80102320 <kfree>
    np->kstack = 0;
80103b21:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
    np->state = UNUSED;
80103b28:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
    return -1;
80103b2f:	83 c4 10             	add    $0x10,%esp
80103b32:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80103b37:	eb c9                	jmp    80103b02 <fork+0xe2>
...
80103b46:	83 ec 0c             	sub    $0xc,%esp
  struct cpu *c = mycpu();
80103b49:	e8 82 fc ff ff       	call   801037d0 <mycpu>
...
80103b61:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103b64:	bb 94 42 11 80       	mov    $0x80114294,%ebx
    acquire(&ptable.lock);
80103b69:	68 60 42 11 80       	push   $0x80114260
...
80103b95:	58                   	pop    %eax
80103b96:	5a                   	pop    %edx
80103b97:	ff 73 20             	pushl  0x20(%ebx)
...
80103ba2:	e8 84 0b 00 00       	call   8010472b <swtch>
      switchkvm();
80103ba7:	e8 74 2e 00 00       	call   80106a20 <switchkvm>
      c->proc = 0;
...
80103bbc:	81 fb 94 62 11 80    	cmp    $0x80116294,%ebx
80103bc2:	72 bc                	jb     80103b80 <scheduler+0x40>
    release(&ptable.lock);
80103bc4:	83 ec 0c             	sub    $0xc,%esp
80103bc7:	68 60 42 11 80       	push   $0x80114260
...
80103bfd:	68 60 42 11 80       	push   $0x80114260
...
80103c2e:	83 c3 20             	add    $0x20,%ebx
  intena = mycpu()->intena;
...
80103cc4:	8d 5e 2c             	lea    0x2c(%esi),%ebx
80103cc7:	8d 7e 6c             	lea    0x6c(%esi),%edi
...
80103d04:	c7 46 6c 00 00 00 00 	movl   $0x0,0x6c(%esi)
  acquire(&ptable.lock);
80103d0b:	c7 04 24 60 42 11 80 	movl   $0x80114260,(%esp)
...
80103dad:	68 ad 79 10 80       	push   $0x801079ad
80103db2:	e8 d9 c5 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103db7:	83 ec 0c             	sub    $0xc,%esp
80103dba:	68 a0 79 10 80       	push   $0x801079a0
...
80103dd7:	68 60 42 11 80       	push   $0x80114260
...
80103dfd:	e8 de fd ff ff       	call   80103be0 <sched>
  release(&ptable.lock);
80103e02:	c7 04 24 60 42 11 80 	movl   $0x80114260,(%esp)
...
80103ea1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  p->chan = chan;
80103ea8:	89 7b 24             	mov    %edi,0x24(%ebx)
  p->state = SLEEPING;
...
80103ec9:	68 bf 79 10 80       	push   $0x801079bf
80103ece:	e8 bd c4 ff ff       	call   80100390 <panic>
    panic("sleep");
80103ed3:	83 ec 0c             	sub    $0xc,%esp
80103ed6:	68 b9 79 10 80       	push   $0x801079b9
...
80103f72:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103f79:	e8 72 2e 00 00       	call   80106df0 <freevm>
        release(&ptable.lock);
80103f7e:	c7 04 24 60 42 11 80 	movl   $0x80114260,(%esp)
        p->pid = 0;
80103f85:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
80103f8c:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
80103f93:	c6 43 70 00          	movb   $0x0,0x70(%ebx)
        p->killed = 0;
80103f97:	c7 43 28 00 00 00 00 	movl   $0x0,0x28(%ebx)
        p->state = UNUSED;
...
80103fb9:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80103fbe:	68 60 42 11 80       	push   $0x80114260
...
8010405f:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
      p->killed = 1;
80104063:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
      if(p->state == SLEEPING){
...
80104076:	68 60 42 11 80       	push   $0x80114260
...
80104093:	68 60 42 11 80       	push   $0x80114260
...
801040b6:	8d 75 e8             	lea    -0x18(%ebp),%esi
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801040b9:	bb 94 42 11 80       	mov    $0x80114294,%ebx
{
...
801040ee:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
801040f1:	ba d0 79 10 80       	mov    $0x801079d0,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801040f6:	77 11                	ja     80104109 <procdump+0x59>
801040f8:	8b 14 85 30 7a 10 80 	mov    -0x7fef85d0(,%eax,4),%edx
      state = "???";
801040ff:	b8 d0 79 10 80       	mov    $0x801079d0,%eax
80104104:	85 d2                	test   %edx,%edx
80104106:	0f 44 d0             	cmove  %eax,%edx
    cprintf("%d %s %s", p->pid, state, p->name);
80104109:	8d 43 70             	lea    0x70(%ebx),%eax
8010410c:	50                   	push   %eax
8010410d:	52                   	push   %edx
8010410e:	ff 73 10             	pushl  0x10(%ebx)
80104111:	68 d4 79 10 80       	push   $0x801079d4
...
8010412e:	8b 43 20             	mov    0x20(%ebx),%eax
...
8010414d:	68 01 74 10 80       	push   $0x80107401
...
8010417a:	68 48 7a 10 80       	push   $0x80107a48
...
801041e3:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
801041e9:	e8 82 f6 ff ff       	call   80103870 <myproc>
...
80104273:	e8 f8 f5 ff ff       	call   80103870 <myproc>
...
8010432f:	e8 9c f4 ff ff       	call   801037d0 <mycpu>
80104334:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
  mycpu()->ncli += 1;
8010433a:	e8 91 f4 ff ff       	call   801037d0 <mycpu>
...
8010437c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104380:	e8 4b f4 ff ff       	call   801037d0 <mycpu>
...
80104395:	68 53 7a 10 80       	push   $0x80107a53
8010439a:	e8 f1 bf ff ff       	call   80100390 <panic>
    panic("popcli");
8010439f:	83 ec 0c             	sub    $0xc,%esp
801043a2:	68 6a 7a 10 80       	push   $0x80107a6a
...
801043c8:	e8 03 f4 ff ff       	call   801037d0 <mycpu>
...
80104487:	68 71 7a 10 80       	push   $0x80107a71
...
801044dc:	68 79 7a 10 80       	push   $0x80107a79
...
80104747:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
8010474a:	e8 21 f1 ff ff       	call   80103870 <myproc>
...
80104787:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
8010478a:	e8 e1 f0 ff ff       	call   80103870 <myproc>
...
801047f5:	e8 76 f0 ff ff       	call   80103870 <myproc>
801047fa:	8b 40 1c             	mov    0x1c(%eax),%eax
801047fd:	8b 55 08             	mov    0x8(%ebp),%edx
80104800:	8b 40 44             	mov    0x44(%eax),%eax
80104803:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104806:	e8 65 f0 ff ff       	call   80103870 <myproc>
  if(addr >= curproc->sz || addr+4 > curproc->sz)
...
80104848:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
8010484b:	e8 20 f0 ff ff       	call   80103870 <myproc>
...
801048e4:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
801048e7:	e8 84 ef ff ff       	call   80103870 <myproc>
...
80104918:	50                   	push   %eax
            curproc->pid, curproc->name, num);
80104919:	8d 43 70             	lea    0x70(%ebx),%eax
    cprintf("%d %s: unknown sys call %d\n",
8010491c:	50                   	push   %eax
8010491d:	ff 73 10             	pushl  0x10(%ebx)
80104920:	68 81 7a 10 80       	push   $0x80107a81
80104925:	e8 36 bd ff ff       	call   80100660 <cprintf>
    curproc->tf->eax = -1;
8010492a:	8b 43 1c             	mov    0x1c(%ebx),%eax
...
80104a74:	68 2c 7b 10 80       	push   $0x80107b2c
...
80104a8c:	68 2b 7b 10 80       	push   $0x80107b2b
...
80104aa5:	68 1f 7b 10 80       	push   $0x80107b1f
...
80104aba:	68 2e 7b 10 80       	push   $0x80107b2e
80104abf:	e8 cc b8 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104ac4:	83 ec 0c             	sub    $0xc,%esp
80104ac7:	68 10 7b 10 80       	push   $0x80107b10
...
80104b04:	e8 67 ed ff ff       	call   80103870 <myproc>
80104b09:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104b0c:	8b 44 90 2c          	mov    0x2c(%eax,%edx,4),%eax
...
80104b49:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104b4b:	e8 20 ed ff ff       	call   80103870 <myproc>
...
80104b60:	8b 54 98 2c          	mov    0x2c(%eax,%ebx,4),%edx
80104b64:	85 d2                	test   %edx,%edx
80104b66:	75 f0                	jne    80104b58 <sys_dup+0x28>
      curproc->ofile[fd] = f;
80104b68:	89 74 98 2c          	mov    %esi,0x2c(%eax,%ebx,4)
  filedup(f);
...
80104c93:	78 2b                	js     80104cc0 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104c95:	e8 d6 eb ff ff       	call   80103870 <myproc>
80104c9a:	8b 55 f0             	mov    -0x10(%ebp),%edx
  fileclose(f);
80104c9d:	83 ec 0c             	sub    $0xc,%esp
  myproc()->ofile[fd] = 0;
80104ca0:	c7 44 90 2c 00 00 00 	movl   $0x0,0x2c(%eax,%edx,4)
80104ca7:	00 
  fileclose(f);
...
80104eb9:	58                   	pop    %eax
80104eba:	5a                   	pop    %edx
80104ebb:	68 2c 7b 10 80       	push   $0x80107b2c
...
80104ed4:	68 2b 7b 10 80       	push   $0x80107b2b
...
801050cf:	0f 84 a6 00 00 00    	je     8010517b <sys_open+0x12b>
  struct proc *curproc = myproc();
801050d5:	e8 96 e7 ff ff       	call   80103870 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801050e6:	0f 84 ac 00 00 00    	je     80105198 <sys_open+0x148>
    if(curproc->ofile[fd] == 0){
801050ec:	8b 54 98 2c          	mov    0x2c(%eax,%ebx,4),%edx
...
801050f4:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
801050f7:	89 7c 98 2c          	mov    %edi,0x2c(%eax,%ebx,4)
  iunlock(ip);
...
801052a5:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
801052a8:	e8 c3 e5 ff ff       	call   80103870 <myproc>
...
8010546c:	e8 ef dd ff ff       	call   80103260 <pipealloc>
...
8010547f:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105481:	e8 ea e3 ff ff       	call   80103870 <myproc>
...
801054be:	74 28                	je     801054e8 <sys_pipe+0xa8>
    if(curproc->ofile[fd] == 0){
801054c0:	8b 4c 90 2c          	mov    0x2c(%eax,%edx,4),%ecx
801054c4:	85 c9                	test   %ecx,%ecx
801054c6:	75 f0                	jne    801054b8 <sys_pipe+0x78>
      curproc->ofile[fd] = f;
801054c8:	89 7c 90 2c          	mov    %edi,0x2c(%eax,%edx,4)
      myproc()->ofile[fd0] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
...
801054ed:	c7 44 b0 0c 00 00 00 	movl   $0x0,0xc(%eax,%esi,4)
801054f4:	00 
...
80105537:	83 3c 85 c0 a5 10 80 	cmpl   $0x1,-0x7fef5a40(,%eax,4)
8010553e:	01 
8010553f:	74 1f                	je     80105560 <sys_create_container+0x40>
  }
  else{
    containers[id] = 1;
...
80105541:	83 ec 0c             	sub    $0xc,%esp
    containers[id] = 1;
80105544:	c7 04 85 c0 a5 10 80 	movl   $0x1,-0x7fef5a40(,%eax,4)
8010554b:	01 00 00 00 
  createContainer(id);
8010554f:	50                   	push   %eax
80105550:	e8 0b 1c 00 00       	call   80107160 <createContainer>
  return id;
}
...
80105563:	68 74 7b 10 80       	push   $0x80107b74
80105568:	e8 f3 b0 ff ff       	call   80100660 <cprintf>
8010556d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105570:	83 c4 10             	add    $0x10,%esp
  createContainer(id);
80105573:	83 ec 0c             	sub    $0xc,%esp
80105576:	50                   	push   %eax
80105577:	e8 e4 1b 00 00       	call   80107160 <createContainer>
}
8010557c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010557f:	c9                   	leave  
80105580:	c3                   	ret    
80105581:	eb 0d                	jmp    80105590 <sys_destroy_container>
80105583:	90                   	nop
80105584:	90                   	nop
80105585:	90                   	nop
80105586:	90                   	nop
...
80105590 <sys_destroy_container>:
...
8010559c:	e8 4f f2 ff ff       	call   801047f0 <argint>
  if(containers[id] == 0){
801055a1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801055a4:	83 c4 10             	add    $0x10,%esp
801055a7:	8b 14 85 c0 a5 10 80 	mov    -0x7fef5a40(,%eax,4),%edx
801055ae:	85 d2                	test   %edx,%edx
801055b0:	74 1e                	je     801055d0 <sys_destroy_container+0x40>
  }
  else{
...
801055b2:	83 ec 0c             	sub    $0xc,%esp
    containers[id] = 0;
801055b5:	c7 04 85 c0 a5 10 80 	movl   $0x0,-0x7fef5a40(,%eax,4)
801055bc:	00 00 00 00 
  destroyContainer(id);
801055c0:	50                   	push   %eax
801055c1:	e8 da 1b 00 00       	call   801071a0 <destroyContainer>
  return 0;
}
...
801055d3:	68 94 7b 10 80       	push   $0x80107b94
...
801055e7:	e8 b4 1b 00 00       	call   801071a0 <destroyContainer>
}
801055ec:	31 c0                	xor    %eax,%eax
801055ee:	c9                   	leave  
801055ef:	c3                   	ret    

801055f0 <sys_join_container>:
...
80105608:	8b 04 85 c0 a5 10 80 	mov    -0x7fef5a40(,%eax,4),%eax
8010560f:	85 c0                	test   %eax,%eax
80105611:	74 2d                	je     80105640 <sys_join_container+0x50>
    cprintf("This container doesn't exists");
    return 0;
  }
  myproc()->containerID = id;
80105613:	e8 58 e2 ff ff       	call   80103870 <myproc>
80105618:	8b 5d f4             	mov    -0xc(%ebp),%ebx
8010561b:	89 58 18             	mov    %ebx,0x18(%eax)
  //Add this process in this container
  addProcessToContainer(myproc()->pid, id);
8010561e:	e8 4d e2 ff ff       	call   80103870 <myproc>
80105623:	83 ec 08             	sub    $0x8,%esp
80105626:	53                   	push   %ebx
80105627:	ff 70 10             	pushl  0x10(%eax)
8010562a:	e8 31 1c 00 00       	call   80107260 <addProcessToContainer>
  return 0;
8010562f:	83 c4 10             	add    $0x10,%esp
}
80105632:	31 c0                	xor    %eax,%eax
...
80105643:	68 b8 7b 10 80       	push   $0x80107bb8
...
80105664:	83 ec 04             	sub    $0x4,%esp
  int pid = myproc()->pid;
80105667:	e8 04 e2 ff ff       	call   80103870 <myproc>
8010566c:	8b 58 10             	mov    0x10(%eax),%ebx
  int containerID = myproc()->containerID;
8010566f:	e8 fc e1 ff ff       	call   80103870 <myproc>
  removeProcessFromContainer(pid, containerID);
80105674:	83 ec 08             	sub    $0x8,%esp
80105677:	ff 70 18             	pushl  0x18(%eax)
8010567a:	53                   	push   %ebx
8010567b:	e8 40 1c 00 00       	call   801072c0 <removeProcessFromContainer>
  return 0;
}
...
80105695:	e8 d6 e1 ff ff       	call   80103870 <myproc>
8010569a:	8b 70 10             	mov    0x10(%eax),%esi
  int containerID = myproc()->containerID;
8010569d:	e8 ce e1 ff ff       	call   80103870 <myproc>
801056a2:	8b 58 18             	mov    0x18(%eax),%ebx
  cprintf("My containerID is: %d", containerID);
801056a5:	83 ec 08             	sub    $0x8,%esp
801056a8:	53                   	push   %ebx
801056a9:	68 d6 7b 10 80       	push   $0x80107bd6
801056ae:	e8 ad af ff ff       	call   80100660 <cprintf>
  psHelper(procID, containerID);
801056b3:	58                   	pop    %eax
801056b4:	5a                   	pop    %edx
801056b5:	53                   	push   %ebx
801056b6:	56                   	push   %esi
801056b7:	e8 84 e0 ff ff       	call   80103740 <psHelper>
  return 0;
}
801056bc:	8d 65 f8             	lea    -0x8(%ebp),%esp
...
801056d6:	e8 45 1c 00 00       	call   80107320 <listContainersHelper>
  return 0;
}
...
801056e3:	5d                   	pop    %ebp
  return fork();
801056e4:	e9 37 e3 ff ff       	jmp    80103a20 <fork>
...
801056f3:	83 ec 08             	sub    $0x8,%esp
  exit();
801056f6:	e8 a5 e5 ff ff       	call   80103ca0 <exit>
...
80105703:	5d                   	pop    %ebp
  return wait();
80105704:	e9 d7 e7 ff ff       	jmp    80103ee0 <wait>
...
8010571c:	e8 cf f0 ff ff       	call   801047f0 <argint>
...
8010572e:	e8 fd e8 ff ff       	call   80104030 <kill>
...
8010576d:	e8 7e f0 ff ff       	call   801047f0 <argint>
...
80105786:	e8 15 e2 ff ff       	call   801039a0 <growproc>
...
801057bd:	e8 2e f0 ff ff       	call   801047f0 <argint>
...
801057d0:	68 a0 62 11 80       	push   $0x801162a0
...
801057dd:	83 c4 10             	add    $0x10,%esp
  ticks0 = ticks;
801057e0:	8b 1d e0 6a 11 80    	mov    0x80116ae0,%ebx
  while(ticks - ticks0 < n){
...
801057f3:	68 a0 62 11 80       	push   $0x801162a0
801057f8:	68 e0 6a 11 80       	push   $0x80116ae0
801057fd:	e8 1e e6 ff ff       	call   80103e20 <sleep>
  while(ticks - ticks0 < n){
80105802:	a1 e0 6a 11 80       	mov    0x80116ae0,%eax
...
80105820:	68 a0 62 11 80       	push   $0x801162a0
80105825:	e8 76 ec ff ff       	call   801044a0 <release>
      return -1;
...
80105843:	68 a0 62 11 80       	push   $0x801162a0
80105848:	e8 53 ec ff ff       	call   801044a0 <release>
  return 0;
...
80105864:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105867:	68 a0 62 11 80       	push   $0x801162a0
8010586c:	e8 6f eb ff ff       	call   801043e0 <acquire>
  xticks = ticks;
80105871:	8b 1d e0 6a 11 80    	mov    0x80116ae0,%ebx
  release(&tickslock);
80105877:	c7 04 24 a0 62 11 80 	movl   $0x801162a0,(%esp)
8010587e:	e8 1d ec ff ff       	call   801044a0 <release>
  return xticks;
}
...
801058c7:	c7 04 c5 e2 62 11 80 	movl   $0x8e000008,-0x7fee9d1e(,%eax,8)
801058ce:	08 00 00 8e 
801058d2:	66 89 14 c5 e0 62 11 	mov    %dx,-0x7fee9d20(,%eax,8)
801058d9:	80 
801058da:	c1 ea 10             	shr    $0x10,%edx
801058dd:	66 89 14 c5 e6 62 11 	mov    %dx,-0x7fee9d1a(,%eax,8)
801058e4:	80 
  for(i = 0; i < 256; i++)
...
801058f4:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801058f7:	c7 05 e2 64 11 80 08 	movl   $0xef000008,0x801164e2
801058fe:	00 00 ef 
  initlock(&tickslock, "time");
80105901:	68 ec 7b 10 80       	push   $0x80107bec
80105906:	68 a0 62 11 80       	push   $0x801162a0
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010590b:	66 a3 e0 64 11 80    	mov    %ax,0x801164e0
80105911:	c1 e8 10             	shr    $0x10,%eax
80105914:	66 a3 e6 64 11 80    	mov    %ax,0x801164e6
  initlock(&tickslock, "time");
8010591a:	e8 81 e9 ff ff       	call   801042a0 <initlock>
}
...
8010593b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010593f:	b8 e0 62 11 80       	mov    $0x801162e0,%eax
...
80105980:	ff 24 85 94 7c 10 80 	jmp    *-0x7fef836c(,%eax,4)
...
801059dd:	56                   	push   %esi
            myproc()->pid, myproc()->name, tf->trapno,
801059de:	83 c2 70             	add    $0x70,%edx
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801059e1:	52                   	push   %edx
801059e2:	ff 70 10             	pushl  0x10(%eax)
801059e5:	68 50 7c 10 80       	push   $0x80107c50
...
801059f7:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
  }
...
80105a0c:	8b 50 28             	mov    0x28(%eax),%edx
...
80105a6d:	8b 58 28             	mov    0x28(%eax),%ebx
80105a70:	85 db                	test   %ebx,%ebx
80105a72:	0f 85 e8 00 00 00    	jne    80105b60 <trap+0x200>
    myproc()->tf = tf;
80105a78:	e8 f3 dd ff ff       	call   80103870 <myproc>
80105a7d:	89 78 1c             	mov    %edi,0x1c(%eax)
    syscall();
80105a80:	e8 5b ee ff ff       	call   801048e0 <syscall>
    if(myproc()->killed)
80105a85:	e8 e6 dd ff ff       	call   80103870 <myproc>
80105a8a:	8b 48 28             	mov    0x28(%eax),%ecx
...
80105b27:	68 f8 7b 10 80       	push   $0x80107bf8
...
80105b5a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105b60:	e8 3b e1 ff ff       	call   80103ca0 <exit>
80105b65:	e9 0e ff ff ff       	jmp    80105a78 <trap+0x118>
80105b6a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    exit();
80105b70:	e8 2b e1 ff ff       	call   80103ca0 <exit>
80105b75:	e9 aa fe ff ff       	jmp    80105a24 <trap+0xc4>
80105b7a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      acquire(&tickslock);
80105b80:	83 ec 0c             	sub    $0xc,%esp
80105b83:	68 a0 62 11 80       	push   $0x801162a0
80105b88:	e8 53 e8 ff ff       	call   801043e0 <acquire>
      wakeup(&ticks);
80105b8d:	c7 04 24 e0 6a 11 80 	movl   $0x80116ae0,(%esp)
      ticks++;
80105b94:	83 05 e0 6a 11 80 01 	addl   $0x1,0x80116ae0
      wakeup(&ticks);
80105b9b:	e8 30 e4 ff ff       	call   80103fd0 <wakeup>
      release(&tickslock);
80105ba0:	c7 04 24 a0 62 11 80 	movl   $0x801162a0,(%esp)
80105ba7:	e8 f4 e8 ff ff       	call   801044a0 <release>
...
80105bc5:	68 1c 7c 10 80       	push   $0x80107c1c
80105bca:	e8 91 aa ff ff       	call   80100660 <cprintf>
      panic("trap");
80105bcf:	83 c4 14             	add    $0x14,%esp
80105bd2:	68 f1 7b 10 80       	push   $0x80107bf1
...
{
  if(!uart)
80105be0:	a1 10 a6 10 80       	mov    0x8010a610,%eax
{
...
80105cb7:	74 5a                	je     80105d13 <uartinit+0xb3>
  uart = 1;
80105cb9:	c7 05 10 a6 10 80 01 	movl   $0x1,0x8010a610
80105cc0:	00 00 00 
...
80105ccc:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105ccf:	bb 14 7d 10 80       	mov    $0x80107d14,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80105cf8:	74 19                	je     80105d13 <uartinit+0xb3>
  if(!uart)
80105cfa:	8b 15 10 a6 10 80    	mov    0x8010a610,%edx
...
80105d20 <uartputc>:
  if(!uart)
80105d20:	8b 15 10 a6 10 80    	mov    0x8010a610,%edx
{
...
8010683a:	e8 b1 dc ff ff       	call   801044f0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
801068dd:	68 1c 7d 10 80       	push   $0x80107d1c
...
80106982:	68 26 76 10 80       	push   $0x80107626
...
801069aa:	c7 80 58 28 11 80 ff 	movl   $0xffff,-0x7feed7a8(%eax)
801069b1:	ff 00 00 
801069b4:	c7 80 5c 28 11 80 00 	movl   $0xcf9a00,-0x7feed7a4(%eax)
801069bb:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801069be:	c7 80 60 28 11 80 ff 	movl   $0xffff,-0x7feed7a0(%eax)
801069c5:	ff 00 00 
801069c8:	c7 80 64 28 11 80 00 	movl   $0xcf9200,-0x7feed79c(%eax)
801069cf:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801069d2:	c7 80 68 28 11 80 ff 	movl   $0xffff,-0x7feed798(%eax)
801069d9:	ff 00 00 
801069dc:	c7 80 6c 28 11 80 00 	movl   $0xcffa00,-0x7feed794(%eax)
801069e3:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801069e6:	c7 80 70 28 11 80 ff 	movl   $0xffff,-0x7feed790(%eax)
801069ed:	ff 00 00 
801069f0:	c7 80 74 28 11 80 00 	movl   $0xcff200,-0x7feed78c(%eax)
801069f7:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
801069fa:	05 50 28 11 80       	add    $0x80112850,%eax
  pd[1] = (uint)p;
...
80106a20:	a1 e4 6a 11 80       	mov    0x80116ae4,%eax
{
...
80106a64:	0f 84 c2 00 00 00    	je     80106b2c <switchuvm+0xec>
  pushcli();
80106a6a:	e8 a1 d8 ff ff       	call   80104310 <pushcli>
...
80106b7f:	e8 6c d9 ff ff       	call   801044f0 <memset>
...
80106bb0:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106bb1:	e9 ea d9 ff ff       	jmp    801045a0 <memmove>
    panic("inituvm: more than a page");
80106bb6:	83 ec 0c             	sub    $0xc,%esp
80106bb9:	68 61 7d 10 80       	push   $0x80107d61
...
80106cdb:	e8 10 d8 ff ff       	call   801044f0 <memset>
...
80106d1d:	68 99 7d 10 80       	push   $0x80107d99
...
80106d53:	68 b1 7d 10 80       	push   $0x80107db1
...
80106e5c:	68 cd 7d 10 80       	push   $0x80107dcd
...
80106e90:	e8 5b d6 ff ff       	call   801044f0 <memset>
...
80106efb:	a3 e4 6a 11 80       	mov    %eax,0x80116ae4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106f2f:	68 de 7d 10 80       	push   $0x80107dde
...
80106f80:	e8 1b d6 ff ff       	call   801045a0 <memmove>
...
80107019:	68 02 7e 10 80       	push   $0x80107e02
8010701e:	e8 6d 93 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80107023:	83 ec 0c             	sub    $0xc,%esp
80107026:	68 e8 7d 10 80       	push   $0x80107de8
...
801070af:	e8 ec d4 ff ff       	call   801045a0 <memmove>
    len -= n;
    buf += n;
...
80107111:	ba b8 2e 11 80       	mov    $0x80112eb8,%edx
  struct container *con;
  for(int i=0; i<NCONT; i++){
80107116:	31 c9                	xor    %ecx,%ecx
void containerInit(void){
80107118:	89 e5                	mov    %esp,%ebp
8010711a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80107120:	8d 82 00 ff ff ff    	lea    -0x100(%edx),%eax
    con = &ctable.container[i];
    con->containerID = i;
80107126:	89 8a fc fe ff ff    	mov    %ecx,-0x104(%edx)
    con->state = CUNUSED;
8010712c:	c7 02 02 00 00 00    	movl   $0x2,(%edx)
80107132:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    for(int j=0; j<NPROC; j++){
      con->presentProc[j] = 0;
80107138:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
8010713e:	83 c0 04             	add    $0x4,%eax
    for(int j=0; j<NPROC; j++){
80107141:	39 d0                	cmp    %edx,%eax
80107143:	75 f3                	jne    80107138 <containerInit+0x28>
  for(int i=0; i<NCONT; i++){
80107145:	83 c1 01             	add    $0x1,%ecx
80107148:	8d 90 08 01 00 00    	lea    0x108(%eax),%edx
8010714e:	83 f9 14             	cmp    $0x14,%ecx
80107151:	75 cd                	jne    80107120 <containerInit+0x10>
    }
  }
}
80107153:	5d                   	pop    %ebp
...
80107163:	83 ec 14             	sub    $0x14,%esp
  struct container *con;
  acquire(&ctable.lock);
80107166:	68 80 2d 11 80       	push   $0x80112d80
8010716b:	e8 70 d2 ff ff       	call   801043e0 <acquire>
  con = &ctable.container[id];
  release(&ctable.lock);
80107170:	c7 04 24 80 2d 11 80 	movl   $0x80112d80,(%esp)
80107177:	e8 24 d3 ff ff       	call   801044a0 <release>
  con->state = CWAITING;
8010717c:	69 45 08 08 01 00 00 	imul   $0x108,0x8(%ebp),%eax
}
80107183:	83 c4 10             	add    $0x10,%esp
  con->state = CWAITING;
80107186:	c7 80 b8 2e 11 80 01 	movl   $0x1,-0x7feed148(%eax)
8010718d:	00 00 00 
}
80107190:	c9                   	leave  
80107191:	c3                   	ret    
...
801071a5:	53                   	push   %ebx
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p<&ptable.proc[NPROC]; p++){
801071a6:	bb 94 42 11 80       	mov    $0x80114294,%ebx
void destroyContainer(int id){
801071ab:	83 ec 18             	sub    $0x18,%esp
801071ae:	8b 7d 08             	mov    0x8(%ebp),%edi
  acquire(&ctable.lock);
801071b1:	68 80 2d 11 80       	push   $0x80112d80
801071b6:	e8 25 d2 ff ff       	call   801043e0 <acquire>
  release(&ctable.lock);
801071bb:	c7 04 24 80 2d 11 80 	movl   $0x80112d80,(%esp)
801071c2:	e8 d9 d2 ff ff       	call   801044a0 <release>
  con->state = CUNUSED;
801071c7:	69 c7 08 01 00 00    	imul   $0x108,%edi,%eax
  acquire(&ptable.lock);
801071cd:	c7 04 24 60 42 11 80 	movl   $0x80114260,(%esp)
    int pid = p->pid;
    if(con->presentProc[pid] == 1){
801071d4:	6b ff 42             	imul   $0x42,%edi,%edi
  con->state = CUNUSED;
801071d7:	c7 80 b8 2e 11 80 02 	movl   $0x2,-0x7feed148(%eax)
801071de:	00 00 00 
  acquire(&ptable.lock);
801071e1:	e8 fa d1 ff ff       	call   801043e0 <acquire>
801071e6:	83 c4 10             	add    $0x10,%esp
801071e9:	eb 10                	jmp    801071fb <destroyContainer+0x5b>
801071eb:	90                   	nop
801071ec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for(p = ptable.proc; p<&ptable.proc[NPROC]; p++){
801071f0:	83 eb 80             	sub    $0xffffff80,%ebx
801071f3:	81 fb 94 62 11 80    	cmp    $0x80116294,%ebx
801071f9:	73 4b                	jae    80107246 <destroyContainer+0xa6>
    int pid = p->pid;
801071fb:	8b 73 10             	mov    0x10(%ebx),%esi
    if(con->presentProc[pid] == 1){
801071fe:	8d 44 3e 0c          	lea    0xc(%esi,%edi,1),%eax
80107202:	83 3c 85 88 2d 11 80 	cmpl   $0x1,-0x7feed278(,%eax,4)
80107209:	01 
8010720a:	75 e4                	jne    801071f0 <destroyContainer+0x50>
      //This proc is present in the container, SO KILL IT
      con->presentProc[pid] = 0;
      release(&ptable.lock);
8010720c:	83 ec 0c             	sub    $0xc,%esp
  for(p = ptable.proc; p<&ptable.proc[NPROC]; p++){
8010720f:	83 eb 80             	sub    $0xffffff80,%ebx
      con->presentProc[pid] = 0;
80107212:	c7 04 85 88 2d 11 80 	movl   $0x0,-0x7feed278(,%eax,4)
80107219:	00 00 00 00 
      release(&ptable.lock);
8010721d:	68 60 42 11 80       	push   $0x80114260
80107222:	e8 79 d2 ff ff       	call   801044a0 <release>
      kill(pid);
80107227:	89 34 24             	mov    %esi,(%esp)
8010722a:	e8 01 ce ff ff       	call   80104030 <kill>
      acquire(&ptable.lock);
8010722f:	c7 04 24 60 42 11 80 	movl   $0x80114260,(%esp)
80107236:	e8 a5 d1 ff ff       	call   801043e0 <acquire>
8010723b:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p<&ptable.proc[NPROC]; p++){
8010723e:	81 fb 94 62 11 80    	cmp    $0x80116294,%ebx
80107244:	72 b5                	jb     801071fb <destroyContainer+0x5b>
    }
  }
  release(&ptable.lock);
80107246:	c7 45 08 60 42 11 80 	movl   $0x80114260,0x8(%ebp)
}
...
80107253:	5d                   	pop    %ebp
  release(&ptable.lock);
80107254:	e9 47 d2 ff ff       	jmp    801044a0 <release>
80107259:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

80107260 <addProcessToContainer>:
...
80107265:	8b 75 08             	mov    0x8(%ebp),%esi
80107268:	8b 5d 0c             	mov    0xc(%ebp),%ebx
  struct container *con;
  acquire(&ctable.lock);
8010726b:	83 ec 0c             	sub    $0xc,%esp
8010726e:	68 80 2d 11 80       	push   $0x80112d80
80107273:	e8 68 d1 ff ff       	call   801043e0 <acquire>
80107278:	83 c4 10             	add    $0x10,%esp
  for(con = ctable.container; con < &ctable.container[NCONT]; con++){
8010727b:	b8 b4 2d 11 80       	mov    $0x80112db4,%eax
80107280:	eb 12                	jmp    80107294 <addProcessToContainer+0x34>
80107282:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80107288:	05 08 01 00 00       	add    $0x108,%eax
8010728d:	3d 54 42 11 80       	cmp    $0x80114254,%eax
80107292:	73 0c                	jae    801072a0 <addProcessToContainer+0x40>
    if(con->containerID == containerID){
80107294:	39 18                	cmp    %ebx,(%eax)
80107296:	75 f0                	jne    80107288 <addProcessToContainer+0x28>
      //This is the container ID, add this process
      con->presentProc[pid] = 1; // Added the process
80107298:	c7 44 b0 04 01 00 00 	movl   $0x1,0x4(%eax,%esi,4)
8010729f:	00 
      break;
    }
  }
  release(&ctable.lock);
801072a0:	c7 45 08 80 2d 11 80 	movl   $0x80112d80,0x8(%ebp)
}
801072a7:	8d 65 f8             	lea    -0x8(%ebp),%esp
801072aa:	5b                   	pop    %ebx
801072ab:	5e                   	pop    %esi
801072ac:	5d                   	pop    %ebp
  release(&ctable.lock);
801072ad:	e9 ee d1 ff ff       	jmp    801044a0 <release>
801072b2:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801072b9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

801072c0 <removeProcessFromContainer>:
...
801072c5:	8b 75 08             	mov    0x8(%ebp),%esi
801072c8:	8b 5d 0c             	mov    0xc(%ebp),%ebx
  struct container *con;
  acquire(&ctable.lock);
801072cb:	83 ec 0c             	sub    $0xc,%esp
801072ce:	68 80 2d 11 80       	push   $0x80112d80
801072d3:	e8 08 d1 ff ff       	call   801043e0 <acquire>
801072d8:	83 c4 10             	add    $0x10,%esp
  for(con = ctable.container; con < &ctable.container[NCONT]; con++){
801072db:	b8 b4 2d 11 80       	mov    $0x80112db4,%eax
801072e0:	eb 12                	jmp    801072f4 <removeProcessFromContainer+0x34>
801072e2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
801072e8:	05 08 01 00 00       	add    $0x108,%eax
801072ed:	3d 54 42 11 80       	cmp    $0x80114254,%eax
801072f2:	73 0c                	jae    80107300 <removeProcessFromContainer+0x40>
    if(con->containerID == containerID){
801072f4:	39 18                	cmp    %ebx,(%eax)
801072f6:	75 f0                	jne    801072e8 <removeProcessFromContainer+0x28>
      //This is the container ID, remove this process
      con->presentProc[pid] = 0; // Remove the process
801072f8:	c7 44 b0 04 00 00 00 	movl   $0x0,0x4(%eax,%esi,4)
801072ff:	00 
      break;
    }
  }
  release(&ctable.lock);
80107300:	c7 45 08 80 2d 11 80 	movl   $0x80112d80,0x8(%ebp)
}
80107307:	8d 65 f8             	lea    -0x8(%ebp),%esp
8010730a:	5b                   	pop    %ebx
8010730b:	5e                   	pop    %esi
8010730c:	5d                   	pop    %ebp
  release(&ctable.lock);
8010730d:	e9 8e d1 ff ff       	jmp    801044a0 <release>
80107312:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80107319:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

80107320 <listContainersHelper>:
...
80107325:	be b4 2d 11 80       	mov    $0x80112db4,%esi
  acquire(&ctable.lock);
8010732a:	83 ec 0c             	sub    $0xc,%esp
8010732d:	68 80 2d 11 80       	push   $0x80112d80
80107332:	e8 a9 d0 ff ff       	call   801043e0 <acquire>
80107337:	83 c4 10             	add    $0x10,%esp
8010733a:	eb 12                	jmp    8010734e <listContainersHelper+0x2e>
8010733c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for(c = ctable.container; c < &ctable.container[NCONT]; c++){
80107340:	81 c6 08 01 00 00    	add    $0x108,%esi
80107346:	81 fe 54 42 11 80    	cmp    $0x80114254,%esi
8010734c:	73 46                	jae    80107394 <listContainersHelper+0x74>
    if(containers[c->containerID] == 1){
8010734e:	8b 06                	mov    (%esi),%eax
80107350:	83 3c 85 c0 a5 10 80 	cmpl   $0x1,-0x7fef5a40(,%eax,4)
80107357:	01 
80107358:	75 e6                	jne    80107340 <listContainersHelper+0x20>
...
8010735a:	83 ec 08             	sub    $0x8,%esp
      ...
      for(int j=0; j<NPROC; j++){
8010735d:	31 db                	xor    %ebx,%ebx
      cprintf("The container with id %d is initialised: \n", c->containerID);
8010735f:	50                   	push   %eax
80107360:	68 40 7e 10 80       	push   $0x80107e40
80107365:	e8 f6 92 ff ff       	call   80100660 <cprintf>
8010736a:	83 c4 10             	add    $0x10,%esp
8010736d:	eb 09                	jmp    80107378 <listContainersHelper+0x58>
8010736f:	90                   	nop
      for(int j=0; j<NPROC; j++){
80107370:	83 c3 01             	add    $0x1,%ebx
80107373:	83 fb 40             	cmp    $0x40,%ebx
80107376:	74 c8                	je     80107340 <listContainersHelper+0x20>
        if(c->presentProc[j] == 1){
80107378:	83 7c 9e 04 01       	cmpl   $0x1,0x4(%esi,%ebx,4)
8010737d:	75 f1                	jne    80107370 <listContainersHelper+0x50>
          cprintf("The process with id %d is present in container with id %d: \n", j, c->containerID);
8010737f:	83 ec 04             	sub    $0x4,%esp
80107382:	ff 36                	pushl  (%esi)
80107384:	53                   	push   %ebx
80107385:	68 6c 7e 10 80       	push   $0x80107e6c
8010738a:	e8 d1 92 ff ff       	call   80100660 <cprintf>
8010738f:	83 c4 10             	add    $0x10,%esp
80107392:	eb dc                	jmp    80107370 <listContainersHelper+0x50>
        }
      }
    }
  }
...
80107397:	68 80 2d 11 80       	push   $0x80112d80
8010739c:	e8 ff d0 ff ff       	call   801044a0 <release>
}
801073a1:	83 c4 10             	add    $0x10,%esp
801073a4:	8d 65 f8             	lea    -0x8(%ebp),%esp
801073a7:	5b                   	pop    %ebx
801073a8:	5e                   	pop    %esi
801073a9:	5d                   	pop    %ebp
801073aa:	c3                   	ret    
