...
801003c0:	e8 9b 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003c5:	c7 04 24 0f 7b 10 80 	movl   $0x80107b0f,(%esp)
...
8010123a:	e8 71 31 00 00       	call   801043b0 <acquire>
...
80101ed8:	68 72 78 10 80       	push   $0x80107872
...
80102332:	81 fb f4 6a 11 80    	cmp    $0x80116af4,%ebx
...
80102b24:	e8 47 17 00 00       	call   80104270 <initlock>
  readsb(dev, &sb);
80102b29:	58                   	pop    %eax
...
80102bbb:	e8 f0 17 00 00       	call   801043b0 <acquire>
...
80102c2e:	e8 7d 17 00 00       	call   801043b0 <acquire>
  log.outstanding -= 1;
...
80102d0f:	e8 9c 16 00 00       	call   801043b0 <acquire>
    wakeup(&log);
...
80102dbe:	e8 ed 15 00 00       	call   801043b0 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102e72:	e8 49 2a 00 00       	call   801058c0 <idtinit>
...
80102e93:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102e96:	e8 15 3b 00 00       	call   801069b0 <switchkvm>
  seginit();
80102e9b:	e8 80 3a 00 00       	call   80106920 <seginit>
  lapicinit();
...
80102ec7:	68 f4 6a 11 80       	push   $0x80116af4
...
80102ee0:	e8 3b 3a 00 00       	call   80106920 <seginit>
  picinit();       // disable pic
...
80102ef4:	e8 f7 2c 00 00       	call   80105bf0 <uartinit>
  pinit();         // process table
80102ef9:	e8 92 08 00 00       	call   80103790 <pinit>
  tvinit();        // trap vectors
80102efe:	e8 3d 29 00 00       	call   80105840 <tvinit>
  binit();         // buffer cache
...
80103311:	e8 5a 0f 00 00       	call   80104270 <initlock>
  (*f0)->type = FD_PIPE;
...
8010336f:	e8 3c 10 00 00       	call   801043b0 <acquire>
  if(writable){
...
8010340d:	e8 9e 0f 00 00       	call   801043b0 <acquire>
  for(i = 0; i < n; i++){
...
80103520:	e8 8b 0e 00 00       	call   801043b0 <acquire>
...
80103621:	e8 8a 0d 00 00       	call   801043b0 <acquire>
...
80103633:	81 fb b4 4d 11 80    	cmp    $0x80114db4,%ebx
...
80103684:	89 53 1c             	mov    %edx,0x1c(%ebx)
  *(uint*)sp = (uint)trapret;
80103687:	c7 40 14 32 58 10 80 	movl   $0x80105832,0x14(%eax)
  p->context = (struct context*)sp;
...
80103696:	e8 25 0e 00 00       	call   801044c0 <memset>
...
801036ba:	e8 b1 0d 00 00       	call   80104470 <release>
}
...
801036eb:	e8 80 0d 00 00       	call   80104470 <release>
...
80103735:	8b 75 0c             	mov    0xc(%ebp),%esi
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103738:	bb b4 2d 11 80       	mov    $0x80112db4,%ebx
8010373d:	eb 0c                	jmp    8010374b <psHelper+0x1b>
8010373f:	90                   	nop
80103740:	83 eb 80             	sub    $0xffffff80,%ebx
80103743:	81 fb b4 4d 11 80    	cmp    $0x80114db4,%ebx
80103749:	73 32                	jae    8010377d <psHelper+0x4d>
    if(p->containerID == containerID){
8010374b:	39 73 18             	cmp    %esi,0x18(%ebx)
8010374e:	75 f0                	jne    80103740 <psHelper+0x10>
      if(p->state == RUNNING || p->state == RUNNABLE){
80103750:	8b 43 0c             	mov    0xc(%ebx),%eax
80103753:	83 e8 03             	sub    $0x3,%eax
80103756:	83 f8 01             	cmp    $0x1,%eax
80103759:	77 e5                	ja     80103740 <psHelper+0x10>
        cprintf("pid:%d name:%s\n", p->pid, p->name);
8010375b:	8d 43 70             	lea    0x70(%ebx),%eax
8010375e:	83 ec 04             	sub    $0x4,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103761:	83 eb 80             	sub    $0xffffff80,%ebx
        cprintf("pid:%d name:%s\n", p->pid, p->name);
80103764:	50                   	push   %eax
80103765:	ff 73 90             	pushl  -0x70(%ebx)
80103768:	68 55 76 10 80       	push   $0x80107655
8010376d:	e8 ee ce ff ff       	call   80100660 <cprintf>
80103772:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103775:	81 fb b4 4d 11 80    	cmp    $0x80114db4,%ebx
8010377b:	72 ce                	jb     8010374b <psHelper+0x1b>
}
8010377d:	8d 65 f8             	lea    -0x8(%ebp),%esp
80103780:	5b                   	pop    %ebx
80103781:	5e                   	pop    %esi
80103782:	5d                   	pop    %ebp
80103783:	c3                   	ret    
...
80103796:	68 65 76 10 80       	push   $0x80107665
8010379b:	68 80 2d 11 80       	push   $0x80112d80
...
80103893:	e8 68 35 00 00       	call   80106e00 <setupkvm>
...
801038b1:	e8 2a 32 00 00       	call   80106ae0 <inituvm>
...
80103963:	68 7c 76 10 80       	push   $0x8010767c
...
8010399c:	e8 2f 30 00 00       	call   801069d0 <switchuvm>
  return 0;
...
801039ba:	e8 61 32 00 00       	call   80106c20 <allocuvm>
...
801039da:	e8 71 33 00 00       	call   80106d50 <deallocuvm>
...
80103a28:	e8 a3 34 00 00       	call   80106ed0 <copyuvm>
...
80103a77:	89 44 b2 2c          	mov    %eax,0x2c(%edx,%esi,4)
  for(i = 0; i < NOFILE; i++)
...
80103a86:	ff 73 6c             	pushl  0x6c(%ebx)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103a89:	83 c3 70             	add    $0x70,%ebx
  np->cwd = idup(curproc->cwd);
...
80103a94:	83 c4 0c             	add    $0xc,%esp
  np->cwd = idup(curproc->cwd);
80103a97:	89 47 6c             	mov    %eax,0x6c(%edi)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103a9a:	8d 47 70             	lea    0x70(%edi),%eax
...
80103aa6:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103aa9:	c7 04 24 80 2d 11 80 	movl   $0x80112d80,(%esp)
80103ab0:	e8 fb 08 00 00       	call   801043b0 <acquire>
  np->state = RUNNABLE;
80103ab5:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
80103abc:	c7 04 24 80 2d 11 80 	movl   $0x80112d80,(%esp)
...
80103b31:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103b34:	bb b4 2d 11 80       	mov    $0x80112db4,%ebx
    acquire(&ptable.lock);
80103b39:	68 80 2d 11 80       	push   $0x80112d80
...
80103b60:	e8 6b 2e 00 00       	call   801069d0 <switchuvm>
      swtch(&(c->scheduler), p->context);
80103b65:	58                   	pop    %eax
80103b66:	5a                   	pop    %edx
80103b67:	ff 73 20             	pushl  0x20(%ebx)
...
80103b72:	e8 84 0b 00 00       	call   801046fb <swtch>
      switchkvm();
80103b77:	e8 34 2e 00 00       	call   801069b0 <switchkvm>
      c->proc = 0;
80103b7c:	c7 86 ac 00 00 00 00 	movl   $0x0,0xac(%esi)
80103b83:	00 00 00 
80103b86:	83 c4 10             	add    $0x10,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103b89:	83 eb 80             	sub    $0xffffff80,%ebx
80103b8c:	81 fb b4 4d 11 80    	cmp    $0x80114db4,%ebx
80103b92:	72 bc                	jb     80103b50 <scheduler+0x40>
    release(&ptable.lock);
80103b94:	83 ec 0c             	sub    $0xc,%esp
80103b97:	68 80 2d 11 80       	push   $0x80112d80
...
80103bcd:	68 80 2d 11 80       	push   $0x80112d80
...
80103bfe:	83 c3 20             	add    $0x20,%ebx
  intena = mycpu()->intena;
...
80103cd4:	c7 46 6c 00 00 00 00 	movl   $0x0,0x6c(%esi)
  acquire(&ptable.lock);
80103cdb:	c7 04 24 80 2d 11 80 	movl   $0x80112d80,(%esp)
...
80103d47:	75 e7                	jne    80103d30 <exit+0xc0>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103d49:	b8 b4 2d 11 80       	mov    $0x80112db4,%eax
80103d4e:	eb 0a                	jmp    80103d5a <exit+0xea>
80103d50:	83 e8 80             	sub    $0xffffff80,%eax
80103d53:	3d b4 4d 11 80       	cmp    $0x80114db4,%eax
80103d58:	73 d6                	jae    80103d30 <exit+0xc0>
    if(p->state == SLEEPING && p->chan == chan){
80103d5a:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80103d5e:	75 f0                	jne    80103d50 <exit+0xe0>
80103d60:	3b 48 24             	cmp    0x24(%eax),%ecx
...
80103d7d:	68 ed 76 10 80       	push   $0x801076ed
80103d82:	e8 09 c6 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103d87:	83 ec 0c             	sub    $0xc,%esp
80103d8a:	68 e0 76 10 80       	push   $0x801076e0
...
80103da7:	68 80 2d 11 80       	push   $0x80112d80
...
80103dcd:	e8 de fd ff ff       	call   80103bb0 <sched>
  release(&ptable.lock);
80103dd2:	c7 04 24 80 2d 11 80 	movl   $0x80112d80,(%esp)
...
80103e20:	81 fe 80 2d 11 80    	cmp    $0x80112d80,%esi
80103e26:	74 50                	je     80103e78 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
80103e28:	83 ec 0c             	sub    $0xc,%esp
80103e2b:	68 80 2d 11 80       	push   $0x80112d80
...
80103e4c:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
    release(&ptable.lock);
80103e53:	c7 04 24 80 2d 11 80 	movl   $0x80112d80,(%esp)
...
80103e99:	68 ff 76 10 80       	push   $0x801076ff
80103e9e:	e8 ed c4 ff ff       	call   80100390 <panic>
    panic("sleep");
80103ea3:	83 ec 0c             	sub    $0xc,%esp
80103ea6:	68 f9 76 10 80       	push   $0x801076f9
...
80103f42:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103f49:	e8 32 2e 00 00       	call   80106d80 <freevm>
        release(&ptable.lock);
80103f4e:	c7 04 24 80 2d 11 80 	movl   $0x80112d80,(%esp)
        p->pid = 0;
80103f55:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
80103f5c:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
80103f63:	c6 43 70 00          	movb   $0x0,0x70(%ebx)
        p->killed = 0;
80103f67:	c7 43 28 00 00 00 00 	movl   $0x0,0x28(%ebx)
        p->state = UNUSED;
...
80103f89:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80103f8e:	68 80 2d 11 80       	push   $0x80112d80
...
80103fdf:	3d b4 4d 11 80       	cmp    $0x80114db4,%eax
80103fe4:	72 e4                	jb     80103fca <wakeup+0x2a>
  wakeup1(chan);
  release(&ptable.lock);
80103fe6:	c7 45 08 80 2d 11 80 	movl   $0x80112d80,0x8(%ebp)
}
...
8010402f:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
      p->killed = 1;
80104033:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
      if(p->state == SLEEPING){
...
80104046:	68 80 2d 11 80       	push   $0x80112d80
...
80104063:	68 80 2d 11 80       	push   $0x80112d80
...
80104086:	8d 75 e8             	lea    -0x18(%ebp),%esi
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104089:	bb b4 2d 11 80       	mov    $0x80112db4,%ebx
{
...
801040be:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
801040c1:	ba 10 77 10 80       	mov    $0x80107710,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801040c6:	77 11                	ja     801040d9 <procdump+0x59>
801040c8:	8b 14 85 70 77 10 80 	mov    -0x7fef8890(,%eax,4),%edx
      state = "???";
801040cf:	b8 10 77 10 80       	mov    $0x80107710,%eax
801040d4:	85 d2                	test   %edx,%edx
801040d6:	0f 44 d0             	cmove  %eax,%edx
    cprintf("%d %s %s", p->pid, state, p->name);
801040d9:	8d 43 70             	lea    0x70(%ebx),%eax
801040dc:	50                   	push   %eax
801040dd:	52                   	push   %edx
801040de:	ff 73 10             	pushl  0x10(%ebx)
801040e1:	68 14 77 10 80       	push   $0x80107714
...
801040fe:	8b 43 20             	mov    0x20(%ebx),%eax
...
8010411d:	68 41 71 10 80       	push   $0x80107141
...
8010414a:	68 88 77 10 80       	push   $0x80107788
...
80104365:	68 93 77 10 80       	push   $0x80107793
8010436a:	e8 21 c0 ff ff       	call   80100390 <panic>
    panic("popcli");
8010436f:	83 ec 0c             	sub    $0xc,%esp
80104372:	68 aa 77 10 80       	push   $0x801077aa
...
80104457:	68 b1 77 10 80       	push   $0x801077b1
...
801044ac:	68 b9 77 10 80       	push   $0x801077b9
...
801048e8:	50                   	push   %eax
            curproc->pid, curproc->name, num);
801048e9:	8d 43 70             	lea    0x70(%ebx),%eax
    cprintf("%d %s: unknown sys call %d\n",
801048ec:	50                   	push   %eax
801048ed:	ff 73 10             	pushl  0x10(%ebx)
801048f0:	68 c1 77 10 80       	push   $0x801077c1
801048f5:	e8 66 bd ff ff       	call   80100660 <cprintf>
    curproc->tf->eax = -1;
801048fa:	8b 43 1c             	mov    0x1c(%ebx),%eax
...
80104a44:	68 68 78 10 80       	push   $0x80107868
...
80104a5c:	68 67 78 10 80       	push   $0x80107867
...
80104a75:	68 5b 78 10 80       	push   $0x8010785b
...
80104a8a:	68 6a 78 10 80       	push   $0x8010786a
80104a8f:	e8 fc b8 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104a94:	83 ec 0c             	sub    $0xc,%esp
80104a97:	68 4c 78 10 80       	push   $0x8010784c
...
80104adc:	8b 44 90 2c          	mov    0x2c(%eax,%edx,4),%eax
...
80104b30:	8b 54 98 2c          	mov    0x2c(%eax,%ebx,4),%edx
80104b34:	85 d2                	test   %edx,%edx
80104b36:	75 f0                	jne    80104b28 <sys_dup+0x28>
      curproc->ofile[fd] = f;
80104b38:	89 74 98 2c          	mov    %esi,0x2c(%eax,%ebx,4)
  filedup(f);
...
80104c6d:	83 ec 0c             	sub    $0xc,%esp
  myproc()->ofile[fd] = 0;
80104c70:	c7 44 90 2c 00 00 00 	movl   $0x0,0x2c(%eax,%edx,4)
80104c77:	00 
  fileclose(f);
...
80104e89:	58                   	pop    %eax
80104e8a:	5a                   	pop    %edx
80104e8b:	68 68 78 10 80       	push   $0x80107868
...
80104ea4:	68 67 78 10 80       	push   $0x80107867
...
801050b6:	0f 84 ac 00 00 00    	je     80105168 <sys_open+0x148>
    if(curproc->ofile[fd] == 0){
801050bc:	8b 54 98 2c          	mov    0x2c(%eax,%ebx,4),%edx
...
801050c4:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
801050c7:	89 7c 98 2c          	mov    %edi,0x2c(%eax,%ebx,4)
  iunlock(ip);
...
80105496:	75 f0                	jne    80105488 <sys_pipe+0x78>
      curproc->ofile[fd] = f;
80105498:	89 7c 90 2c          	mov    %edi,0x2c(%eax,%edx,4)
      myproc()->ofile[fd0] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
...
801054bd:	c7 44 b0 0c 00 00 00 	movl   $0x0,0xc(%eax,%esi,4)
801054c4:	00 
...
801054fc:	e8 bf f2 ff ff       	call   801047c0 <argint>
  if(containers[id] == 1){
80105501:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105504:	83 c4 10             	add    $0x10,%esp
80105507:	83 3c 85 c0 a5 10 80 	cmpl   $0x1,-0x7fef5a40(,%eax,4)
8010550e:	01 
8010550f:	74 1f                	je     80105530 <sys_create_container+0x40>
...
80105511:	83 ec 0c             	sub    $0xc,%esp
    containers[id] = 1;
80105514:	c7 04 85 c0 a5 10 80 	movl   $0x1,-0x7fef5a40(,%eax,4)
8010551b:	01 00 00 00 
    cprintf("Container created successfully\n");
8010551f:	68 d0 78 10 80       	push   $0x801078d0
...
80105533:	68 b0 78 10 80       	push   $0x801078b0
80105538:	e8 23 b1 ff ff       	call   80100660 <cprintf>
...
80105550 <sys_destroy_container>:
...
8010555c:	e8 5f f2 ff ff       	call   801047c0 <argint>
  if(containers[id] == 0){
80105561:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105564:	83 c4 10             	add    $0x10,%esp
80105567:	8b 14 85 c0 a5 10 80 	mov    -0x7fef5a40(,%eax,4),%edx
8010556e:	85 d2                	test   %edx,%edx
80105570:	74 16                	je     80105588 <sys_destroy_container+0x38>
    cprintf("This is id is already non-existant\n");
  }
  else{
    containers[id] = 0;
80105572:	c7 04 85 c0 a5 10 80 	movl   $0x0,-0x7fef5a40(,%eax,4)
80105579:	00 00 00 00 
  }
  return 0;
}
...
8010558b:	68 f0 78 10 80       	push   $0x801078f0
80105590:	e8 cb b0 ff ff       	call   80100660 <cprintf>
...
801055b8:	8b 04 85 c0 a5 10 80 	mov    -0x7fef5a40(,%eax,4),%eax
801055bf:	85 c0                	test   %eax,%eax
801055c1:	74 2d                	je     801055f0 <sys_join_container+0x50>
    cprintf("This container doesn't exists");
    return 0;
  }
  myproc()->containerID = id;
801055c3:	e8 88 e2 ff ff       	call   80103850 <myproc>
801055c8:	8b 5d f4             	mov    -0xc(%ebp),%ebx
801055cb:	89 58 18             	mov    %ebx,0x18(%eax)
  //Add this process in this container
  addProcessToContainer(myproc()->pid, id);
801055ce:	e8 7d e2 ff ff       	call   80103850 <myproc>
801055d3:	83 ec 08             	sub    $0x8,%esp
801055d6:	53                   	push   %ebx
801055d7:	ff 70 10             	pushl  0x10(%eax)
801055da:	e8 c1 1a 00 00       	call   801070a0 <addProcessToContainer>
  return 0;
...
801055f3:	68 14 79 10 80       	push   $0x80107914
801055f8:	e8 63 b0 ff ff       	call   80100660 <cprintf>
    return 0;
...
80105614:	83 ec 04             	sub    $0x4,%esp
  int pid = myproc()->pid;
80105617:	e8 34 e2 ff ff       	call   80103850 <myproc>
8010561c:	8b 58 10             	mov    0x10(%eax),%ebx
  int containerID = myproc()->containerID;
8010561f:	e8 2c e2 ff ff       	call   80103850 <myproc>
  removeProcessFromContainer(pid, containerID);
80105624:	83 ec 08             	sub    $0x8,%esp
80105627:	ff 70 18             	pushl  0x18(%eax)
8010562a:	53                   	push   %ebx
8010562b:	e8 a0 1a 00 00       	call   801070d0 <removeProcessFromContainer>
  return 0;
}
...
80105647:	e8 04 e2 ff ff       	call   80103850 <myproc>
8010564c:	8b 58 10             	mov    0x10(%eax),%ebx
  int containerID = myproc()->containerID;
8010564f:	e8 fc e1 ff ff       	call   80103850 <myproc>
  psHelper(procID, containerID);
80105654:	83 ec 08             	sub    $0x8,%esp
80105657:	ff 70 18             	pushl  0x18(%eax)
8010565a:	53                   	push   %ebx
8010565b:	e8 d0 e0 ff ff       	call   80103730 <psHelper>
  return 0;
}
...
80105683:	83 ec 08             	sub    $0x8,%esp
  exit();
80105686:	e8 e5 e5 ff ff       	call   80103c70 <exit>
...
80105693:	5d                   	pop    %ebp
  return wait();
80105694:	e9 17 e8 ff ff       	jmp    80103eb0 <wait>
...
801056ac:	e8 0f f1 ff ff       	call   801047c0 <argint>
...
801056be:	e8 3d e9 ff ff       	call   80104000 <kill>
...
801056fd:	e8 be f0 ff ff       	call   801047c0 <argint>
...
8010574d:	e8 6e f0 ff ff       	call   801047c0 <argint>
...
80105760:	68 c0 4d 11 80       	push   $0x80114dc0
80105765:	e8 46 ec ff ff       	call   801043b0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010576a:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010576d:	83 c4 10             	add    $0x10,%esp
  ticks0 = ticks;
80105770:	8b 1d 00 56 11 80    	mov    0x80115600,%ebx
  while(ticks - ticks0 < n){
...
80105783:	68 c0 4d 11 80       	push   $0x80114dc0
80105788:	68 00 56 11 80       	push   $0x80115600
8010578d:	e8 5e e6 ff ff       	call   80103df0 <sleep>
  while(ticks - ticks0 < n){
80105792:	a1 00 56 11 80       	mov    0x80115600,%eax
...
801057a6:	8b 40 28             	mov    0x28(%eax),%eax
801057a9:	85 c0                	test   %eax,%eax
801057ab:	74 d3                	je     80105780 <sys_sleep+0x40>
      release(&tickslock);
801057ad:	83 ec 0c             	sub    $0xc,%esp
801057b0:	68 c0 4d 11 80       	push   $0x80114dc0
801057b5:	e8 b6 ec ff ff       	call   80104470 <release>
      return -1;
...
801057d3:	68 c0 4d 11 80       	push   $0x80114dc0
801057d8:	e8 93 ec ff ff       	call   80104470 <release>
  return 0;
...
801057f4:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
801057f7:	68 c0 4d 11 80       	push   $0x80114dc0
801057fc:	e8 af eb ff ff       	call   801043b0 <acquire>
  xticks = ticks;
80105801:	8b 1d 00 56 11 80    	mov    0x80115600,%ebx
  release(&tickslock);
80105807:	c7 04 24 c0 4d 11 80 	movl   $0x80114dc0,(%esp)
8010580e:	e8 5d ec ff ff       	call   80104470 <release>
  return xticks;
}
...
80105857:	c7 04 c5 02 4e 11 80 	movl   $0x8e000008,-0x7feeb1fe(,%eax,8)
8010585e:	08 00 00 8e 
80105862:	66 89 14 c5 00 4e 11 	mov    %dx,-0x7feeb200(,%eax,8)
80105869:	80 
8010586a:	c1 ea 10             	shr    $0x10,%edx
8010586d:	66 89 14 c5 06 4e 11 	mov    %dx,-0x7feeb1fa(,%eax,8)
80105874:	80 
  for(i = 0; i < 256; i++)
...
80105884:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105887:	c7 05 02 50 11 80 08 	movl   $0xef000008,0x80115002
8010588e:	00 00 ef 
  initlock(&tickslock, "time");
80105891:	68 32 79 10 80       	push   $0x80107932
80105896:	68 c0 4d 11 80       	push   $0x80114dc0
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010589b:	66 a3 00 50 11 80    	mov    %ax,0x80115000
801058a1:	c1 e8 10             	shr    $0x10,%eax
801058a4:	66 a3 06 50 11 80    	mov    %ax,0x80115006
  initlock(&tickslock, "time");
801058aa:	e8 c1 e9 ff ff       	call   80104270 <initlock>
}
...
801058cb:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801058cf:	b8 00 4e 11 80       	mov    $0x80114e00,%eax
...
80105910:	ff 24 85 d8 79 10 80 	jmp    *-0x7fef8628(,%eax,4)
...
80105920:	e8 2b df ff ff       	call   80103850 <myproc>
...
80105940:	e8 eb de ff ff       	call   80103830 <cpuid>
...
80105951:	e8 fa de ff ff       	call   80103850 <myproc>
80105956:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105959:	e8 f2 de ff ff       	call   80103850 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105975:	68 94 79 10 80       	push   $0x80107994
8010597a:	e8 e1 ac ff ff       	call   80100660 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
8010597f:	83 c4 20             	add    $0x20,%esp
80105982:	e8 c9 de ff ff       	call   80103850 <myproc>
...
8010598e:	e8 bd de ff ff       	call   80103850 <myproc>
80105993:	85 c0                	test   %eax,%eax
80105995:	74 1d                	je     801059b4 <trap+0xc4>
80105997:	e8 b4 de ff ff       	call   80103850 <myproc>
8010599c:	8b 50 28             	mov    0x28(%eax),%edx
...
801059b4:	e8 97 de ff ff       	call   80103850 <myproc>
801059b9:	85 c0                	test   %eax,%eax
801059bb:	74 0b                	je     801059c8 <trap+0xd8>
801059bd:	e8 8e de ff ff       	call   80103850 <myproc>
...
801059d6:	8b 40 28             	mov    0x28(%eax),%eax
...
801059fd:	8b 58 28             	mov    0x28(%eax),%ebx
...
80105a0d:	89 78 1c             	mov    %edi,0x1c(%eax)
    syscall();
80105a10:	e8 9b ee ff ff       	call   801048b0 <syscall>
    if(myproc()->killed)
80105a15:	e8 36 de ff ff       	call   80103850 <myproc>
80105a1a:	8b 48 28             	mov    0x28(%eax),%ecx
...
80105a4d:	e8 0e cd ff ff       	call   80102760 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105a52:	e8 f9 dd ff ff       	call   80103850 <myproc>
...
80105a64:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80105a68:	e8 b3 cb ff ff       	call   80102620 <kbdintr>
    lapiceoi();
...
80105aaf:	e8 7c dd ff ff       	call   80103830 <cpuid>
80105ab4:	56                   	push   %esi
80105ab5:	53                   	push   %ebx
80105ab6:	50                   	push   %eax
80105ab7:	68 3c 79 10 80       	push   $0x8010793c
80105abc:	e8 9f ab ff ff       	call   80100660 <cprintf>
    lapiceoi();
80105ac1:	e8 9a cc ff ff       	call   80102760 <lapiceoi>
    break;
...
80105adc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ideintr();
80105ae0:	e8 ab c5 ff ff       	call   80102090 <ideintr>
80105ae5:	e9 63 ff ff ff       	jmp    80105a4d <trap+0x15d>
80105aea:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105af0:	e8 7b e1 ff ff       	call   80103c70 <exit>
80105af5:	e9 0e ff ff ff       	jmp    80105a08 <trap+0x118>
80105afa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    exit();
80105b00:	e8 6b e1 ff ff       	call   80103c70 <exit>
80105b05:	e9 aa fe ff ff       	jmp    801059b4 <trap+0xc4>
80105b0a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      acquire(&tickslock);
80105b10:	83 ec 0c             	sub    $0xc,%esp
80105b13:	68 c0 4d 11 80       	push   $0x80114dc0
80105b18:	e8 93 e8 ff ff       	call   801043b0 <acquire>
      wakeup(&ticks);
80105b1d:	c7 04 24 00 56 11 80 	movl   $0x80115600,(%esp)
      ticks++;
80105b24:	83 05 00 56 11 80 01 	addl   $0x1,0x80115600
      wakeup(&ticks);
80105b2b:	e8 70 e4 ff ff       	call   80103fa0 <wakeup>
      release(&tickslock);
80105b30:	c7 04 24 c0 4d 11 80 	movl   $0x80114dc0,(%esp)
80105b37:	e8 34 e9 ff ff       	call   80104470 <release>
80105b3c:	83 c4 10             	add    $0x10,%esp
80105b3f:	e9 09 ff ff ff       	jmp    80105a4d <trap+0x15d>
80105b44:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105b47:	e8 e4 dc ff ff       	call   80103830 <cpuid>
...
80105b55:	68 60 79 10 80       	push   $0x80107960
80105b5a:	e8 01 ab ff ff       	call   80100660 <cprintf>
      panic("trap");
80105b5f:	83 c4 14             	add    $0x14,%esp
80105b62:	68 37 79 10 80       	push   $0x80107937
...
{
  if(!uart)
80105b70:	a1 10 a6 10 80       	mov    0x8010a610,%eax
{
...
80105bc5:	e8 b6 cb ff ff       	call   80102780 <microdelay>
...
80105c47:	74 5a                	je     80105ca3 <uartinit+0xb3>
  uart = 1;
80105c49:	c7 05 10 a6 10 80 01 	movl   $0x1,0x8010a610
80105c50:	00 00 00 
...
80105c5c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105c5f:	bb 58 7a 10 80       	mov    $0x80107a58,%ebx
  ioapicenable(IRQ_COM1, 0);
80105c64:	6a 00                	push   $0x0
80105c66:	6a 04                	push   $0x4
80105c68:	e8 73 c6 ff ff       	call   801022e0 <ioapicenable>
...
80105c88:	74 19                	je     80105ca3 <uartinit+0xb3>
  if(!uart)
80105c8a:	8b 15 10 a6 10 80    	mov    0x8010a610,%edx
...
80105cb0 <uartputc>:
  if(!uart)
80105cb0:	8b 15 10 a6 10 80    	mov    0x8010a610,%edx
{
...
801067b4:	e8 17 bd ff ff       	call   801024d0 <kalloc>
...
801067ca:	e8 f1 dc ff ff       	call   801044c0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
8010686d:	68 60 7a 10 80       	push   $0x80107a60
...
801068c4:	e8 57 ba ff ff       	call   80102320 <kfree>
      *pte = 0;
...
80106923:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106926:	e8 05 cf ff ff       	call   80103830 <cpuid>
...
8010693a:	c7 80 58 28 11 80 ff 	movl   $0xffff,-0x7feed7a8(%eax)
80106941:	ff 00 00 
80106944:	c7 80 5c 28 11 80 00 	movl   $0xcf9a00,-0x7feed7a4(%eax)
8010694b:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
8010694e:	c7 80 60 28 11 80 ff 	movl   $0xffff,-0x7feed7a0(%eax)
80106955:	ff 00 00 
80106958:	c7 80 64 28 11 80 00 	movl   $0xcf9200,-0x7feed79c(%eax)
8010695f:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106962:	c7 80 68 28 11 80 ff 	movl   $0xffff,-0x7feed798(%eax)
80106969:	ff 00 00 
8010696c:	c7 80 6c 28 11 80 00 	movl   $0xcffa00,-0x7feed794(%eax)
80106973:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106976:	c7 80 70 28 11 80 ff 	movl   $0xffff,-0x7feed790(%eax)
8010697d:	ff 00 00 
80106980:	c7 80 74 28 11 80 00 	movl   $0xcff200,-0x7feed78c(%eax)
80106987:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
8010698a:	05 50 28 11 80       	add    $0x80112850,%eax
  pd[1] = (uint)p;
...
801069b0:	a1 04 56 11 80       	mov    0x80115604,%eax
{
...
801069f4:	0f 84 c2 00 00 00    	je     80106abc <switchuvm+0xec>
  pushcli();
801069fa:	e8 e1 d8 ff ff       	call   801042e0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
801069ff:	e8 ac cd ff ff       	call   801037b0 <mycpu>
80106a04:	89 c6                	mov    %eax,%esi
80106a06:	e8 a5 cd ff ff       	call   801037b0 <mycpu>
80106a0b:	89 c7                	mov    %eax,%edi
80106a0d:	e8 9e cd ff ff       	call   801037b0 <mycpu>
80106a12:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106a15:	83 c7 08             	add    $0x8,%edi
80106a18:	e8 93 cd ff ff       	call   801037b0 <mycpu>
...
80106a61:	e8 4a cd ff ff       	call   801037b0 <mycpu>
...
80106a79:	e8 32 cd ff ff       	call   801037b0 <mycpu>
80106a7e:	81 c6 00 10 00 00    	add    $0x1000,%esi
80106a84:	89 70 0c             	mov    %esi,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106a87:	e8 24 cd ff ff       	call   801037b0 <mycpu>
...
80106afb:	77 49                	ja     80106b46 <inituvm+0x66>
  mem = kalloc();
80106afd:	e8 ce b9 ff ff       	call   801024d0 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106b0f:	e8 ac d9 ff ff       	call   801044c0 <memset>
...
80106b40:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106b41:	e9 2a da ff ff       	jmp    80104570 <memmove>
    panic("inituvm: more than a page");
80106b46:	83 ec 0c             	sub    $0xc,%esp
80106b49:	68 a5 7a 10 80       	push   $0x80107aa5
...
80106bd1:	e8 9a ad ff ff       	call   80101970 <readi>
...
80106c99:	0f 86 81 00 00 00    	jbe    80106d20 <allocuvm+0x100>
    mem = kalloc();
80106c9f:	e8 2c b8 ff ff       	call   801024d0 <kalloc>
    if(mem == 0){
...
80106cad:	68 dd 7a 10 80       	push   $0x80107add
...
80106ce3:	68 f5 7a 10 80       	push   $0x80107af5
...
80106d0b:	e8 10 b6 ff ff       	call   80102320 <kfree>
      return 0;
...
80106dec:	68 11 7b 10 80       	push   $0x80107b11
...
80106e20:	e8 9b d6 ff ff       	call   801044c0 <memset>
...
80106e8b:	a3 04 56 11 80       	mov    %eax,0x80115604
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106ebf:	68 22 7b 10 80       	push   $0x80107b22
...
80106f10:	e8 5b d6 ff ff       	call   80104570 <memmove>
...
80106f65:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
80106f68:	e8 63 b5 ff ff       	call   801024d0 <kalloc>
...
8010703f:	e8 2c d5 ff ff       	call   80104570 <memmove>
    len -= n;
    buf += n;
...
801070a0 <addProcessToContainer>:
//     }
...
801070a1:	b8 54 56 11 80       	mov    $0x80115654,%eax
void addProcessToContainer(int pid, int containerID){
801070a6:	89 e5                	mov    %esp,%ebp
801070a8:	8b 55 0c             	mov    0xc(%ebp),%edx
801070ab:	eb 0f                	jmp    801070bc <addProcessToContainer+0x1c>
801070ad:	8d 76 00             	lea    0x0(%esi),%esi
  for(con = ctable.container; con < &ctable.container[NCONT]; con++){
801070b0:	05 08 01 00 00       	add    $0x108,%eax
801070b5:	3d f4 6a 11 80       	cmp    $0x80116af4,%eax
801070ba:	73 0f                	jae    801070cb <addProcessToContainer+0x2b>
    if(con->containerID == containerID){
801070bc:	39 10                	cmp    %edx,(%eax)
801070be:	75 f0                	jne    801070b0 <addProcessToContainer+0x10>
      //This is the container ID, add this process
      con->presentProc[pid] = 1; // Added the process
801070c0:	8b 55 08             	mov    0x8(%ebp),%edx
801070c3:	c7 44 90 04 01 00 00 	movl   $0x1,0x4(%eax,%edx,4)
801070ca:	00 
      break;
    }
  }
...
801070d0:	55                   	push   %ebp
  struct container *con;
  for(con = ctable.container; con < &ctable.container[NCONT]; con++){
801070d1:	b8 54 56 11 80       	mov    $0x80115654,%eax
void removeProcessFromContainer(int pid, int containerID){
801070d6:	89 e5                	mov    %esp,%ebp
801070d8:	8b 55 0c             	mov    0xc(%ebp),%edx
801070db:	eb 0f                	jmp    801070ec <removeProcessFromContainer+0x1c>
801070dd:	8d 76 00             	lea    0x0(%esi),%esi
  for(con = ctable.container; con < &ctable.container[NCONT]; con++){
801070e0:	05 08 01 00 00       	add    $0x108,%eax
801070e5:	3d f4 6a 11 80       	cmp    $0x80116af4,%eax
801070ea:	73 0f                	jae    801070fb <removeProcessFromContainer+0x2b>
    if(con->containerID == containerID){
801070ec:	39 10                	cmp    %edx,(%eax)
801070ee:	75 f0                	jne    801070e0 <removeProcessFromContainer+0x10>
      //This is the container ID, remove this process
      con->presentProc[pid] = 0; // Remove the process
801070f0:	8b 55 08             	mov    0x8(%ebp),%edx
801070f3:	c7 44 90 04 00 00 00 	movl   $0x0,0x4(%eax,%edx,4)
801070fa:	00 
      break;
    }
  }
