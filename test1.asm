...
main(void)
{
   ...
   e:	83 ec 04             	sub    $0x4,%esp
	...
	create_container();
  11:	e8 1c 03 00 00       	call   332 <create_container>
  create_container();
  16:	e8 17 03 00 00       	call   332 <create_container>
  create_container();
  1b:	e8 12 03 00 00       	call   332 <create_container>
	// int *mal1 = malloc(6);
	// int *mal2 = malloc(10);
	// printf(1, "%d %d\n", mal1, mal2);
  ...
  2d:	e8 a0 02 00 00       	call   2d2 <open>
	close(fd);
  32:	89 04 24             	mov    %eax,(%esp)
  35:	e8 80 02 00 00       	call   2ba <close>
	// 	wait();
	// 	exit();
	// }
	// sleep(2);
...
printf(int fd, const char *fmt, ...)
{
 ...
 5e4:	e9 8f fe ff ff       	jmp    478 <printf+0x48>
          s = "(null)";
 5e9:	bb 93 07 00 00       	mov    $0x793,%ebx
        while(*s != 0){
