...
main(void)
{
  ...
  list_containers();
  30:	e8 15 03 00 00       	call   34a <list_containers>

	wait();
  35:	e8 50 02 00 00       	call   28a <wait>
	exit();
 ...
 40c:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 448:	50                   	push   %eax
 449:	57                   	push   %edi
 44a:	e8 53 fe ff ff       	call   2a2 <write>
 ...
 4aa:	50                   	push   %eax
 4ab:	57                   	push   %edi
 4ac:	e8 f1 fd ff ff       	call   2a2 <write>
 ...
 59b:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5a0:	bb 20 07 00 00       	mov    $0x720,%ebx
 ...
 5d6:	73 18                	jae    5f0 <free+0x40>
{
 ...
 62a:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 62d:	a3 c0 09 00 00       	mov    %eax,0x9c0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 649:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 64c:	8b 15 c0 09 00 00    	mov    0x9c0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
