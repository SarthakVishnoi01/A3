...
main(void)
{
   ...
   e:	83 ec 04             	sub    $0x4,%esp
	...
	create_container();
  11:	e8 4c 03 00 00       	call   362 <create_container>
  create_container();
  16:	e8 47 03 00 00       	call   362 <create_container>
  create_container();
  1b:	e8 42 03 00 00       	call   362 <create_container>
	//Malloc
	// int *mal1 = malloc(6);
	// int *mal2 = malloc(10);
	// printf(1, "%d %d\n", mal1, mal2);
  ...
  27:	75 31                	jne    5a <main+0x5a>
		join_container(2);
  29:	83 ec 0c             	sub    $0xc,%esp
  2c:	6a 02                	push   $0x2
  2e:	e8 37 03 00 00       	call   36a <join_container>
		ps();
  33:	e8 4a 03 00 00       	call   382 <ps>
		container_malloc(5);
  38:	c7 04 24 05 00 00 00 	movl   $0x5,(%esp)
  3f:	e8 4e 03 00 00       	call   392 <container_malloc>
		container_malloc(3);
  44:	c7 04 24 03 00 00 00 	movl   $0x3,(%esp)
  4b:	e8 42 03 00 00       	call   392 <container_malloc>
		wait();
  50:	e8 75 02 00 00       	call   2ca <wait>
		exit();
  55:	e8 68 02 00 00       	call   2c2 <exit>
	}
	sleep(2);
  5a:	83 ec 0c             	sub    $0xc,%esp
  5d:	6a 02                	push   $0x2
  5f:	e8 ee 02 00 00       	call   352 <sleep>
	wait();
  64:	e8 61 02 00 00       	call   2ca <wait>
	exit();
