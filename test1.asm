...
main(void)
{
   ...
   e:	51                   	push   %ecx
	...
	create_container();
   f:	e8 9e 03 00 00       	call   3b2 <create_container>
  create_container();
  14:	e8 99 03 00 00       	call   3b2 <create_container>
  create_container();
  19:	e8 94 03 00 00       	call   3b2 <create_container>

  int cid1 = fork();
  1e:	e8 e7 02 00 00       	call   30a <fork>
  if(cid1 == 0){
  23:	85 c0                	test   %eax,%eax
  25:	75 19                	jne    40 <main+0x40>
    join_container(1);
  27:	83 ec 0c             	sub    $0xc,%esp
  2a:	6a 01                	push   $0x1
  2c:	e8 89 03 00 00       	call   3ba <join_container>
    ps();
  31:	e8 9c 03 00 00       	call   3d2 <ps>
    wait();
  36:	e8 df 02 00 00       	call   31a <wait>
    // list_containers();
    exit();
  ...
  43:	6a 02                	push   $0x2
  45:	e8 58 03 00 00       	call   3a2 <sleep>
  // destroy_container(1);
  list_containers();
  4a:	e8 8b 03 00 00       	call   3da <list_containers>

  int cid2 = fork();
  4f:	e8 b6 02 00 00       	call   30a <fork>
  if(cid2 == 0){
  54:	83 c4 10             	add    $0x10,%esp
  57:	85 c0                	test   %eax,%eax
  59:	75 19                	jne    74 <main+0x74>
    join_container(2);
  5b:	83 ec 0c             	sub    $0xc,%esp
  5e:	6a 02                	push   $0x2
  60:	e8 55 03 00 00       	call   3ba <join_container>
    wait();
  65:	e8 b0 02 00 00       	call   31a <wait>
    ps();
  6a:	e8 63 03 00 00       	call   3d2 <ps>
    exit();
  ...
  77:	6a 02                	push   $0x2
  79:	e8 24 03 00 00       	call   3a2 <sleep>
  // list_containers();

  ps();
  7e:	e8 4f 03 00 00       	call   3d2 <ps>
	wait();
  83:	e8 92 02 00 00       	call   31a <wait>
  ...
  8f:	e8 5c 06 00 00       	call   6f0 <malloc>
  94:	89 c3                	mov    %eax,%ebx
	int *mal2 = malloc(10);
  96:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
  9d:	e8 4e 06 00 00       	call   6f0 <malloc>
	printf(1, "%d %d\n", *mal1, *mal2);
  a2:	ff 30                	pushl  (%eax)
  a4:	ff 33                	pushl  (%ebx)
...
printf(int fd, const char *fmt, ...)
{
 ...
 644:	e9 8f fe ff ff       	jmp    4d8 <printf+0x48>
          s = "(null)";
 649:	bb ef 07 00 00       	mov    $0x7ef,%ebx
        while(*s != 0){
 ...
 661:	a1 a0 0a 00 00       	mov    0xaa0,%eax
{
 ...
 69d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 69f:	a3 a0 0a 00 00       	mov    %eax,0xaa0
}
 6a4:	5b                   	pop    %ebx
 6a5:	5e                   	pop    %esi
 6a6:	5f                   	pop    %edi
 ...
 6b6:	72 ce                	jb     686 <free+0x26>
{
 ...
 6d7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6da:	a3 a0 0a 00 00       	mov    %eax,0xaa0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6fc:	8b 15 a0 0a 00 00    	mov    0xaa0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 73f:	73 47                	jae    788 <malloc+0x98>
    ...
    if(p == freep)
 741:	39 05 a0 0a 00 00    	cmp    %eax,0xaa0
 ...
 766:	e8 f5 fe ff ff       	call   660 <free>
  return freep;
 76b:	8b 15 a0 0a 00 00    	mov    0xaa0,%edx
 ...
 7b7:	0a 00 00 
 7ba:	c7 05 a4 0a 00 00 a4 	movl   $0xaa4,0xaa4
 7c1:	0a 00 00 
    base.s.size = 0;
 7c4:	b8 a4 0a 00 00       	mov    $0xaa4,%eax
 7c9:	c7 05 a8 0a 00 00 00 	movl   $0x0,0xaa8
 7d0:	00 00 00 
