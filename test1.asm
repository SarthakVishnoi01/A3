...
main(void)
{
   ...
   e:	83 ec 10             	sub    $0x10,%esp
	...
	create_container(1);
  11:	6a 01                	push   $0x1
  13:	e8 0a 03 00 00       	call   322 <create_container>
  create_container(2);
  18:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  1f:	e8 fe 02 00 00       	call   322 <create_container>
  create_container(3);
  24:	c7 04 24 03 00 00 00 	movl   $0x3,(%esp)
  2b:	e8 f2 02 00 00       	call   322 <create_container>
	wait();
  30:	e8 55 02 00 00       	call   28a <wait>
	exit();
  35:	e8 48 02 00 00       	call   282 <exit>
  3a:	66 90                	xchg   %ax,%ax
  3c:	66 90                	xchg   %ax,%ax
  3e:	66 90                	xchg   %ax,%ax
 ...
 3fc:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 58b:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 590:	bb 10 07 00 00       	mov    $0x710,%ebx
 ...
 5c6:	73 18                	jae    5e0 <free+0x40>
{
 ...
 5f7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5f9:	a3 b0 09 00 00       	mov    %eax,0x9b0
}
 5fe:	5b                   	pop    %ebx
 5ff:	5e                   	pop    %esi
 600:	5f                   	pop    %edi
 ...
 61a:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 61d:	a3 b0 09 00 00       	mov    %eax,0x9b0
    p->s.size += bp->s.size;
