...
main(void)
{
   ...
   e:	83 ec 10             	sub    $0x10,%esp
	...
	create_container(1);
  11:	6a 01                	push   $0x1
  13:	e8 8a 03 00 00       	call   3a2 <create_container>
  create_container(2);
  18:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  1f:	e8 7e 03 00 00       	call   3a2 <create_container>
  create_container(3);
  24:	c7 04 24 03 00 00 00 	movl   $0x3,(%esp)
  2b:	e8 72 03 00 00       	call   3a2 <create_container>

  int cid1 = fork();
  30:	e8 c5 02 00 00       	call   2fa <fork>
  if(cid1 == 0){
  ...
  3f:	6a 01                	push   $0x1
  41:	e8 64 03 00 00       	call   3aa <join_container>
    ps();
  46:	e8 77 03 00 00       	call   3c2 <ps>
    wait();
  4b:	e8 ba 02 00 00       	call   30a <wait>
    // list_containers();
    exit();
  50:	e8 ad 02 00 00       	call   302 <exit>
  }
  sleep(2);
  55:	83 ec 0c             	sub    $0xc,%esp
  58:	6a 02                	push   $0x2
  5a:	e8 33 03 00 00       	call   392 <sleep>
  // destroy_container(1);
  list_containers();
  5f:	e8 66 03 00 00       	call   3ca <list_containers>

  int cid2 = fork();
  64:	e8 91 02 00 00       	call   2fa <fork>
  if(cid2 == 0){
  ...
  73:	6a 02                	push   $0x2
  75:	e8 30 03 00 00       	call   3aa <join_container>
    wait();
  7a:	e8 8b 02 00 00       	call   30a <wait>
    ps();
  7f:	e8 3e 03 00 00       	call   3c2 <ps>
    exit();
  84:	e8 79 02 00 00       	call   302 <exit>
  }

  sleep(2);
  89:	83 ec 0c             	sub    $0xc,%esp
  8c:	6a 02                	push   $0x2
  8e:	e8 ff 02 00 00       	call   392 <sleep>
  // list_containers();

  ps();
  93:	e8 2a 03 00 00       	call   3c2 <ps>
	wait();
  98:	e8 6d 02 00 00       	call   30a <wait>
	exit();
  9d:	e8 60 02 00 00       	call   302 <exit>
  a2:	66 90                	xchg   %ax,%ax
  a4:	66 90                	xchg   %ax,%ax
  a6:	66 90                	xchg   %ax,%ax
  a8:	66 90                	xchg   %ax,%ax
