...
00000480 <writetest>:
{
  ...
  printf(stdout, "small file test ok\n");
    ...
    printf(stdout, "error: open small failed!\n");
     ...
     5ff:	ff 35 f8 5d 00 00    	pushl  0x5df8
    ...
    printf(stdout, "read failed\n");
     ...
     617:	ff 35 f8 5d 00 00    	pushl  0x5df8
    ...
    printf(stdout, "unlink small failed\n");
     ...
     62f:	ff 35 f8 5d 00 00    	pushl  0x5df8
    ...
    printf(stdout, "error: creat small failed!\n");
     ...
     647:	ff 35 f8 5d 00 00    	pushl  0x5df8
...
00000660 <writetest1>:
{
  ...
  printf(stdout, "big files ok\n");
     ...
     7d0:	ff 35 f8 5d 00 00    	pushl  0x5df8
    ...
    printf(stdout, "error: open big failed!\n");
     ...
     7e8:	ff 35 f8 5d 00 00    	pushl  0x5df8
    ...
    printf(stdout, "error: creat big failed!\n");
     ...
     800:	ff 35 f8 5d 00 00    	pushl  0x5df8
    ...
    printf(stdout, "unlink big failed\n");
     ...
     818:	ff 35 f8 5d 00 00    	pushl  0x5df8
     ...
     a16:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a62:	57                   	push   %edi
     a63:	68 e0 85 00 00       	push   $0x85e0
     ...
     a88:	38 9c 0b e0 85 00 00 	cmp    %bl,0x85e0(%ebx,%ecx,1)
     ...
     ab2:	68 b6 40 00 00       	push   $0x40b6
     ab7:	6a 01                	push   $0x1
     ab9:	e8 82 2f 00 00       	call   3a40 <printf>
          return;
     ...
     ad9:	8d 96 09 04 00 00    	lea    0x409(%esi),%edx
{
     ...
     ae8:	88 9c 18 e0 85 00 00 	mov    %bl,0x85e0(%eax,%ebx,1)
     ...
     b00:	68 e0 85 00 00       	push   $0x85e0
  ...
  printf(1, "pipe1 ok\n");
     b3d:	58                   	pop    %eax
     b3e:	5a                   	pop    %edx
     b3f:	68 db 40 00 00       	push   $0x40db
     b44:	6a 01                	push   $0x1
     ...
     b59:	68 c4 40 00 00       	push   $0x40c4
     b5e:	6a 01                	push   $0x1
     b60:	e8 db 2e 00 00       	call   3a40 <printf>
      exit();
     b65:	e8 58 2d 00 00       	call   38c2 <exit>
    printf(1, "pipe() failed\n");
     b6a:	83 ec 08             	sub    $0x8,%esp
     b6d:	68 99 40 00 00       	push   $0x4099
     b72:	6a 01                	push   $0x1
    ...
    printf(1, "fork() failed\n");
     ...
     b81:	68 e5 40 00 00       	push   $0x40e5
     b86:	6a 01                	push   $0x1
     b88:	e8 b3 2e 00 00       	call   3a40 <printf>
    exit();
     b8d:	e8 30 2d 00 00       	call   38c2 <exit>
        printf(1, "pipe1 oops 1\n");
     b92:	83 ec 08             	sub    $0x8,%esp
     b95:	68 a8 40 00 00       	push   $0x40a8
     b9a:	6a 01                	push   $0x1
     b9c:	e8 9f 2e 00 00       	call   3a40 <printf>
        exit();
...
00000bb0 <preempt>:
{
  ...
  printf(1, "preempt: ");
     bb9:	68 f4 40 00 00       	push   $0x40f4
     bbe:	6a 01                	push   $0x1
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     c0a:	6a 01                	push   $0x1
     c0c:	68 b9 46 00 00       	push   $0x46b9
     ...
     c24:	68 fe 40 00 00       	push   $0x40fe
     c29:	6a 01                	push   $0x1
     c2b:	e8 10 2e 00 00       	call   3a40 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     c56:	68 e0 85 00 00       	push   $0x85e0
    ...
    printf(1, "preempt read error");
     ...
     c6e:	68 12 41 00 00       	push   $0x4112
     c73:	6a 01                	push   $0x1
     c75:	e8 c6 2d 00 00       	call   3a40 <printf>
    return;
  ...
  printf(1, "kill... ");
     c90:	58                   	pop    %eax
     c91:	5a                   	pop    %edx
     c92:	68 25 41 00 00       	push   $0x4125
     c97:	6a 01                	push   $0x1
     c99:	e8 a2 2d 00 00       	call   3a40 <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     cb6:	59                   	pop    %ecx
     cb7:	5b                   	pop    %ebx
     cb8:	68 2e 41 00 00       	push   $0x412e
     cbd:	6a 01                	push   $0x1
     cbf:	e8 7c 2d 00 00       	call   3a40 <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     cd3:	5e                   	pop    %esi
     cd4:	5f                   	pop    %edi
     cd5:	68 37 41 00 00       	push   $0x4137
     cda:	6a 01                	push   $0x1
     cdc:	e8 5f 2d 00 00       	call   3a40 <printf>
...
00000cf0 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     d1e:	68 a1 4c 00 00       	push   $0x4ca1
     d23:	6a 01                	push   $0x1
     ...
     d3b:	68 43 41 00 00       	push   $0x4143
     d40:	6a 01                	push   $0x1
  ...
  printf(1, "exitwait ok\n");
     ...
     d5b:	68 53 41 00 00       	push   $0x4153
     d60:	6a 01                	push   $0x1
...
00000d80 <mem>:
{
  ...
  printf(1, "mem test\n");
     d89:	68 60 41 00 00       	push   $0x4160
     d8e:	6a 01                	push   $0x1
     d90:	e8 ab 2c 00 00       	call   3a40 <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    printf(1, "mem ok\n");
     e01:	58                   	pop    %eax
     e02:	5a                   	pop    %edx
     e03:	68 84 41 00 00       	push   $0x4184
     e08:	6a 01                	push   $0x1
    ...
    wait();
     ...
     e2b:	68 6a 41 00 00       	push   $0x416a
     e30:	6a 01                	push   $0x1
...
00000e50 <sharedfd>:
{
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     edc:	68 8c 4e 00 00       	push   $0x4e8c
     ee1:	6a 01                	push   $0x1
     ee3:	e8 58 2b 00 00       	call   3a40 <printf>
      break;
  ...
  fd = open("sharedfd", 0);
     ...
     f0a:	5a                   	pop    %edx
     f0b:	6a 00                	push   $0x0
     f0d:	68 9b 41 00 00       	push   $0x419b
  ...
  unlink("sharedfd");
     f7a:	c7 04 24 9b 41 00 00 	movl   $0x419b,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     ...
     f9f:	68 a4 41 00 00       	push   $0x41a4
     fa4:	6a 01                	push   $0x1
     fa6:	e8 95 2a 00 00       	call   3a40 <printf>
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     ...
     fb9:	68 60 4e 00 00       	push   $0x4e60
     fbe:	6a 01                	push   $0x1
     fc0:	e8 7b 2a 00 00       	call   3a40 <printf>
    return;
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     ...
     fd3:	68 ac 4e 00 00       	push   $0x4eac
     fd8:	6a 01                	push   $0x1
     fda:	e8 61 2a 00 00       	call   3a40 <printf>
    return;
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     fef:	53                   	push   %ebx
     ff0:	52                   	push   %edx
     ff1:	68 b1 41 00 00       	push   $0x41b1
     ff6:	6a 01                	push   $0x1
     ff8:	e8 43 2a 00 00       	call   3a40 <printf>
    exit();
...
00001010 <fourfiles>:
{
  ...
  printf(1, "fourfiles test\n");
    1016:	be c6 41 00 00       	mov    $0x41c6,%esi
  for(pi = 0; pi < 4; pi++){
    101b:	31 db                	xor    %ebx,%ebx
{
    101d:	83 ec 34             	sub    $0x34,%esp
  char *names[] = { "f0", "f1", "f2", "f3" };
    1020:	c7 45 d8 c6 41 00 00 	movl   $0x41c6,-0x28(%ebp)
    1027:	c7 45 dc 0f 43 00 00 	movl   $0x430f,-0x24(%ebp)
  printf(1, "fourfiles test\n");
    102e:	68 cc 41 00 00       	push   $0x41cc
    1033:	6a 01                	push   $0x1
  char *names[] = { "f0", "f1", "f2", "f3" };
    1035:	c7 45 e0 13 43 00 00 	movl   $0x4313,-0x20(%ebp)
    103c:	c7 45 e4 c9 41 00 00 	movl   $0x41c9,-0x1c(%ebp)
  printf(1, "fourfiles test\n");
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    1091:	c7 45 d4 c6 41 00 00 	movl   $0x41c6,-0x2c(%ebp)
    fd = open(fname, 0);
    ...
    10cc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        if(buf[j] != '0'+i){
    10d0:	0f be 8a e0 85 00 00 	movsbl 0x85e0(%edx),%ecx
  ...
  printf(1, "fourfiles ok\n");
    ...
    1117:	68 0a 42 00 00       	push   $0x420a
    111c:	6a 01                	push   $0x1
    111e:	e8 1d 29 00 00       	call   3a40 <printf>
}
    ...
    113c:	68 ed 41 00 00       	push   $0x41ed
    1141:	6a 01                	push   $0x1
    1143:	e8 f8 28 00 00       	call   3a40 <printf>
          exit();
    ...
    1175:	68 e0 85 00 00       	push   $0x85e0
    ...
    118a:	68 e0 85 00 00       	push   $0x85e0
    118f:	56                   	push   %esi
    ...
    11ac:	50                   	push   %eax
    11ad:	68 dc 41 00 00       	push   $0x41dc
    11b2:	6a 01                	push   $0x1
    11b4:	e8 87 28 00 00       	call   3a40 <printf>
          exit();
    11b9:	e8 04 27 00 00       	call   38c2 <exit>
        printf(1, "create failed\n");
    11be:	83 ec 08             	sub    $0x8,%esp
    11c1:	68 67 44 00 00       	push   $0x4467
    11c6:	6a 01                	push   $0x1
    ...
    11d5:	53                   	push   %ebx
    11d6:	68 f9 41 00 00       	push   $0x41f9
    11db:	6a 01                	push   $0x1
    11dd:	e8 5e 28 00 00       	call   3a40 <printf>
      exit();
    11e2:	e8 db 26 00 00       	call   38c2 <exit>
      printf(1, "fork failed\n");
    11e7:	83 ec 08             	sub    $0x8,%esp
    11ea:	68 a1 4c 00 00       	push   $0x4ca1
    11ef:	6a 01                	push   $0x1
    11f1:	e8 4a 28 00 00       	call   3a40 <printf>
      exit();
    ...
    1206:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "createdelete test\n");
    120b:	68 18 42 00 00       	push   $0x4218
    1210:	6a 01                	push   $0x1
    1212:	e8 29 28 00 00       	call   3a40 <printf>
  ...
  printf(1, "createdelete ok\n");
    ...
    130c:	68 2b 42 00 00       	push   $0x422b
    1311:	6a 01                	push   $0x1
    1313:	e8 28 27 00 00       	call   3a40 <printf>
}
    ...
    1398:	68 19 3e 00 00       	push   $0x3e19
    139d:	6a 01                	push   $0x1
    139f:	e8 9c 26 00 00       	call   3a40 <printf>
            exit();
    ...
    13b8:	57                   	push   %edi
    13b9:	68 d8 4e 00 00       	push   $0x4ed8
    13be:	6a 01                	push   $0x1
    13c0:	e8 7b 26 00 00       	call   3a40 <printf>
        exit();
    13c5:	e8 f8 24 00 00       	call   38c2 <exit>
          printf(1, "create failed\n");
    13ca:	83 ec 08             	sub    $0x8,%esp
    13cd:	68 67 44 00 00       	push   $0x4467
    13d2:	6a 01                	push   $0x1
    13d4:	e8 67 26 00 00       	call   3a40 <printf>
          exit();
    13d9:	e8 e4 24 00 00       	call   38c2 <exit>
      printf(1, "fork failed\n");
    13de:	83 ec 08             	sub    $0x8,%esp
    13e1:	68 a1 4c 00 00       	push   $0x4ca1
    13e6:	6a 01                	push   $0x1
    ...
    13fd:	57                   	push   %edi
    13fe:	68 fc 4e 00 00       	push   $0x4efc
    1403:	6a 01                	push   $0x1
    1405:	e8 36 26 00 00       	call   3a40 <printf>
        exit();
...
00001410 <unlinkread>:
{
  ...
  printf(1, "unlinkread test\n");
    ...
    1418:	68 3c 42 00 00       	push   $0x423c
    141d:	6a 01                	push   $0x1
    141f:	e8 1c 26 00 00       	call   3a40 <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    1424:	5b                   	pop    %ebx
    1425:	5e                   	pop    %esi
    1426:	68 02 02 00 00       	push   $0x202
    142b:	68 4d 42 00 00       	push   $0x424d
  ...
  write(fd, "hello", 5);
    ...
    1445:	6a 05                	push   $0x5
    1447:	68 72 42 00 00       	push   $0x4272
    144c:	50                   	push   %eax
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    145b:	5a                   	pop    %edx
    145c:	6a 02                	push   $0x2
    145e:	68 4d 42 00 00       	push   $0x424d
  ...
  if(unlink("unlinkread") != 0){
    ...
    1478:	68 4d 42 00 00       	push   $0x424d
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1495:	68 4d 42 00 00       	push   $0x424d
  ...
  write(fd1, "yyy", 3);
    14a4:	6a 03                	push   $0x3
    14a6:	68 aa 42 00 00       	push   $0x42aa
    14ab:	50                   	push   %eax
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    14c1:	68 e0 85 00 00       	push   $0x85e0
    14c6:	53                   	push   %ebx
  ...
  if(buf[0] != 'h'){
    14d8:	80 3d e0 85 00 00 68 	cmpb   $0x68,0x85e0
    14df:	75 6b                	jne    154c <unlinkread+0x13c>
  if(write(fd, buf, 10) != 10){
    14e1:	83 ec 04             	sub    $0x4,%esp
    14e4:	6a 0a                	push   $0xa
    14e6:	68 e0 85 00 00       	push   $0x85e0
    14eb:	53                   	push   %ebx
  ...
  unlink("unlinkread");
    1502:	c7 04 24 4d 42 00 00 	movl   $0x424d,(%esp)
    1509:	e8 04 24 00 00       	call   3912 <unlink>
  printf(1, "unlinkread ok\n");
    150e:	58                   	pop    %eax
    150f:	5a                   	pop    %edx
    1510:	68 f5 42 00 00       	push   $0x42f5
    1515:	6a 01                	push   $0x1
    1517:	e8 24 25 00 00       	call   3a40 <printf>
}
    ...
    1526:	51                   	push   %ecx
    1527:	51                   	push   %ecx
    1528:	68 58 42 00 00       	push   $0x4258
    152d:	6a 01                	push   $0x1
    152f:	e8 0c 25 00 00       	call   3a40 <printf>
    exit();
    1534:	e8 89 23 00 00       	call   38c2 <exit>
    printf(1, "unlinkread write failed\n");
    1539:	51                   	push   %ecx
    153a:	51                   	push   %ecx
    153b:	68 dc 42 00 00       	push   $0x42dc
    1540:	6a 01                	push   $0x1
    1542:	e8 f9 24 00 00       	call   3a40 <printf>
    exit();
    1547:	e8 76 23 00 00       	call   38c2 <exit>
    printf(1, "unlinkread wrong data\n");
    154c:	53                   	push   %ebx
    154d:	53                   	push   %ebx
    154e:	68 c5 42 00 00       	push   $0x42c5
    1553:	6a 01                	push   $0x1
    1555:	e8 e6 24 00 00       	call   3a40 <printf>
    exit();
    155a:	e8 63 23 00 00       	call   38c2 <exit>
    printf(1, "unlinkread read failed");
    155f:	56                   	push   %esi
    1560:	56                   	push   %esi
    1561:	68 ae 42 00 00       	push   $0x42ae
    1566:	6a 01                	push   $0x1
    1568:	e8 d3 24 00 00       	call   3a40 <printf>
    exit();
    156d:	e8 50 23 00 00       	call   38c2 <exit>
    printf(1, "unlink unlinkread failed\n");
    1572:	50                   	push   %eax
    1573:	50                   	push   %eax
    1574:	68 90 42 00 00       	push   $0x4290
    1579:	6a 01                	push   $0x1
    157b:	e8 c0 24 00 00       	call   3a40 <printf>
    exit();
    1580:	e8 3d 23 00 00       	call   38c2 <exit>
    printf(1, "open unlinkread failed\n");
    1585:	50                   	push   %eax
    1586:	50                   	push   %eax
    1587:	68 78 42 00 00       	push   $0x4278
    158c:	6a 01                	push   $0x1
    158e:	e8 ad 24 00 00       	call   3a40 <printf>
    exit();
...
000015a0 <linktest>:
{
  ...
  printf(1, "linktest\n");
    15a7:	68 04 43 00 00       	push   $0x4304
    15ac:	6a 01                	push   $0x1
    15ae:	e8 8d 24 00 00       	call   3a40 <printf>
  unlink("lf1");
    15b3:	c7 04 24 0e 43 00 00 	movl   $0x430e,(%esp)
    15ba:	e8 53 23 00 00       	call   3912 <unlink>
  unlink("lf2");
    15bf:	c7 04 24 12 43 00 00 	movl   $0x4312,(%esp)
    15c6:	e8 47 23 00 00       	call   3912 <unlink>
  fd = open("lf1", O_CREATE|O_RDWR);
    15cb:	58                   	pop    %eax
    15cc:	5a                   	pop    %edx
    15cd:	68 02 02 00 00       	push   $0x202
    15d2:	68 0e 43 00 00       	push   $0x430e
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    15ec:	6a 05                	push   $0x5
    15ee:	68 72 42 00 00       	push   $0x4272
    15f3:	50                   	push   %eax
  ...
  if(link("lf1", "lf2") < 0){
    160e:	5b                   	pop    %ebx
    160f:	58                   	pop    %eax
    1610:	68 12 43 00 00       	push   $0x4312
    1615:	68 0e 43 00 00       	push   $0x430e
  ...
  unlink("lf1");
    ...
    162d:	68 0e 43 00 00       	push   $0x430e
    1632:	e8 db 22 00 00       	call   3912 <unlink>
  if(open("lf1", 0) >= 0){
    1637:	58                   	pop    %eax
    1638:	5a                   	pop    %edx
    1639:	6a 00                	push   $0x0
    163b:	68 0e 43 00 00       	push   $0x430e
  ...
  fd = open("lf2", 0);
    ...
    1653:	6a 00                	push   $0x0
    1655:	68 12 43 00 00       	push   $0x4312
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1674:	68 e0 85 00 00       	push   $0x85e0
    1679:	50                   	push   %eax
  ...
  if(link("lf2", "lf2") >= 0){
    1694:	58                   	pop    %eax
    1695:	5a                   	pop    %edx
    1696:	68 12 43 00 00       	push   $0x4312
    169b:	68 12 43 00 00       	push   $0x4312
  ...
  unlink("lf2");
    ...
    16b3:	68 12 43 00 00       	push   $0x4312
    16b8:	e8 55 22 00 00       	call   3912 <unlink>
  if(link("lf2", "lf1") >= 0){
    16bd:	59                   	pop    %ecx
    16be:	5b                   	pop    %ebx
    16bf:	68 0e 43 00 00       	push   $0x430e
    16c4:	68 12 43 00 00       	push   $0x4312
  ...
  if(link(".", "lf1") >= 0){
    ...
    16d8:	68 0e 43 00 00       	push   $0x430e
    16dd:	68 d6 45 00 00       	push   $0x45d6
  ...
  printf(1, "linktest ok\n");
    ...
    16f1:	68 ac 43 00 00       	push   $0x43ac
    16f6:	6a 01                	push   $0x1
    16f8:	e8 43 23 00 00       	call   3a40 <printf>
}
    ...
    1705:	50                   	push   %eax
    1706:	50                   	push   %eax
    1707:	68 16 43 00 00       	push   $0x4316
    170c:	6a 01                	push   $0x1
    170e:	e8 2d 23 00 00       	call   3a40 <printf>
    exit();
    1713:	e8 aa 21 00 00       	call   38c2 <exit>
    printf(1, "link . lf1 succeeded! oops\n");
    1718:	50                   	push   %eax
    1719:	50                   	push   %eax
    171a:	68 90 43 00 00       	push   $0x4390
    171f:	6a 01                	push   $0x1
    1721:	e8 1a 23 00 00       	call   3a40 <printf>
    exit();
    1726:	e8 97 21 00 00       	call   38c2 <exit>
    printf(1, "link non-existant succeeded! oops\n");
    172b:	52                   	push   %edx
    172c:	52                   	push   %edx
    172d:	68 44 4f 00 00       	push   $0x4f44
    1732:	6a 01                	push   $0x1
    1734:	e8 07 23 00 00       	call   3a40 <printf>
    exit();
    1739:	e8 84 21 00 00       	call   38c2 <exit>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    173e:	50                   	push   %eax
    173f:	50                   	push   %eax
    1740:	68 72 43 00 00       	push   $0x4372
    1745:	6a 01                	push   $0x1
    1747:	e8 f4 22 00 00       	call   3a40 <printf>
    exit();
    174c:	e8 71 21 00 00       	call   38c2 <exit>
    printf(1, "read lf2 failed\n");
    1751:	51                   	push   %ecx
    1752:	51                   	push   %ecx
    1753:	68 61 43 00 00       	push   $0x4361
    1758:	6a 01                	push   $0x1
    175a:	e8 e1 22 00 00       	call   3a40 <printf>
    exit();
    175f:	e8 5e 21 00 00       	call   38c2 <exit>
    printf(1, "open lf2 failed\n");
    1764:	53                   	push   %ebx
    1765:	53                   	push   %ebx
    1766:	68 50 43 00 00       	push   $0x4350
    176b:	6a 01                	push   $0x1
    176d:	e8 ce 22 00 00       	call   3a40 <printf>
    exit();
    1772:	e8 4b 21 00 00       	call   38c2 <exit>
    printf(1, "unlinked lf1 but it is still there!\n");
    1777:	50                   	push   %eax
    1778:	50                   	push   %eax
    1779:	68 1c 4f 00 00       	push   $0x4f1c
    177e:	6a 01                	push   $0x1
    1780:	e8 bb 22 00 00       	call   3a40 <printf>
    exit();
    1785:	e8 38 21 00 00       	call   38c2 <exit>
    printf(1, "link lf1 lf2 failed\n");
    178a:	51                   	push   %ecx
    178b:	51                   	push   %ecx
    178c:	68 3b 43 00 00       	push   $0x433b
    1791:	6a 01                	push   $0x1
    1793:	e8 a8 22 00 00       	call   3a40 <printf>
    exit();
    1798:	e8 25 21 00 00       	call   38c2 <exit>
    printf(1, "write lf1 failed\n");
    179d:	50                   	push   %eax
    179e:	50                   	push   %eax
    179f:	68 29 43 00 00       	push   $0x4329
    17a4:	6a 01                	push   $0x1
    17a6:	e8 95 22 00 00       	call   3a40 <printf>
    exit();
    ...
    17bb:	bf 56 55 55 55       	mov    $0x55555556,%edi
{
  ...
  printf(1, "concreate test\n");
    17c3:	68 b9 43 00 00       	push   $0x43b9
    17c8:	6a 01                	push   $0x1
    17ca:	e8 71 22 00 00       	call   3a40 <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    1880:	53                   	push   %ebx
    1881:	68 cc 43 00 00       	push   $0x43cc
    1886:	6a 01                	push   $0x1
    1888:	e8 b3 21 00 00       	call   3a40 <printf>
        exit();
    ...
    189b:	53                   	push   %ebx
    189c:	68 c9 43 00 00       	push   $0x43c9
  ...
  for(i = 0; i < 40; i++){
    18b3:	83 c6 01             	add    $0x1,%esi
      link("C0", file);
    18b6:	53                   	push   %ebx
    18b7:	68 c9 43 00 00       	push   $0x43c9
  ...
  fd = open(".", 0);
    ...
    18ec:	5e                   	pop    %esi
    18ed:	6a 00                	push   $0x0
    18ef:	68 d6 45 00 00       	push   $0x45d6
  ...
  printf(1, "concreate ok\n");
    ...
    1a43:	68 1e 44 00 00       	push   $0x441e
    1a48:	6a 01                	push   $0x1
    1a4a:	e8 f1 1f 00 00       	call   3a40 <printf>
}
    ...
    1a5a:	68 a1 4c 00 00       	push   $0x4ca1
    1a5f:	6a 01                	push   $0x1
    1a61:	e8 da 1f 00 00       	call   3a40 <printf>
      exit();
    1a66:	e8 57 1e 00 00       	call   38c2 <exit>
    printf(1, "concreate not enough files in directory listing\n");
    1a6b:	83 ec 08             	sub    $0x8,%esp
    1a6e:	68 68 4f 00 00       	push   $0x4f68
    1a73:	6a 01                	push   $0x1
    1a75:	e8 c6 1f 00 00       	call   3a40 <printf>
    exit();
    ...
    1a85:	50                   	push   %eax
    1a86:	68 01 44 00 00       	push   $0x4401
    1a8b:	6a 01                	push   $0x1
    1a8d:	e8 ae 1f 00 00       	call   3a40 <printf>
        exit();
    ...
    1a9d:	50                   	push   %eax
    1a9e:	68 e8 43 00 00       	push   $0x43e8
    1aa3:	6a 01                	push   $0x1
...
00001ac0 <linkunlink>:
{
  ...
  printf(1, "linkunlink test\n");
    1ac9:	68 2c 44 00 00       	push   $0x442c
    1ace:	6a 01                	push   $0x1
    1ad0:	e8 6b 1f 00 00       	call   3a40 <printf>
  unlink("x");
    1ad5:	c7 04 24 b9 46 00 00 	movl   $0x46b9,(%esp)
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1b18:	68 b9 46 00 00       	push   $0x46b9
  ...
  for(i = 0; i < 100; i++){
    ...
    1b4d:	68 b9 46 00 00       	push   $0x46b9
  ...
  printf(1, "linkunlink ok\n");
    ...
    1b76:	68 41 44 00 00       	push   $0x4441
    1b7b:	6a 01                	push   $0x1
    1b7d:	e8 be 1e 00 00       	call   3a40 <printf>
}
    ...
    1b93:	68 b9 46 00 00       	push   $0x46b9
    1b98:	68 3d 44 00 00       	push   $0x443d
    ...
    1bad:	68 a1 4c 00 00       	push   $0x4ca1
    1bb2:	6a 01                	push   $0x1
    1bb4:	e8 87 1e 00 00       	call   3a40 <printf>
    exit();
...
00001bd0 <bigdir>:
{
  ...
  printf(1, "bigdir test\n");
    1bd9:	68 50 44 00 00       	push   $0x4450
    1bde:	6a 01                	push   $0x1
    1be0:	e8 5b 1e 00 00       	call   3a40 <printf>
  unlink("bd");
    1be5:	c7 04 24 5d 44 00 00 	movl   $0x445d,(%esp)
    1bec:	e8 21 1d 00 00       	call   3912 <unlink>
  fd = open("bd", O_CREATE);
    1bf1:	58                   	pop    %eax
    1bf2:	5a                   	pop    %edx
    1bf3:	68 00 02 00 00       	push   $0x200
    1bf8:	68 5d 44 00 00       	push   $0x445d
  ...
  close(fd);
    ...
    if(link("bd", name) != 0){
    1c2c:	57                   	push   %edi
    1c2d:	68 5d 44 00 00       	push   $0x445d
    name[1] = '0' + (i / 64);
  ...
  unlink("bd");
    ...
    1c63:	68 5d 44 00 00       	push   $0x445d
  ...
  printf(1, "bigdir ok\n");
    ...
    1cac:	68 9f 44 00 00       	push   $0x449f
    1cb1:	6a 01                	push   $0x1
    1cb3:	e8 88 1d 00 00       	call   3a40 <printf>
}
    ...
    1cc6:	68 76 44 00 00       	push   $0x4476
    1ccb:	6a 01                	push   $0x1
    1ccd:	e8 6e 1d 00 00       	call   3a40 <printf>
      exit();
    1cd2:	e8 eb 1b 00 00       	call   38c2 <exit>
      printf(1, "bigdir unlink failed");
    1cd7:	83 ec 08             	sub    $0x8,%esp
    1cda:	68 8a 44 00 00       	push   $0x448a
    1cdf:	6a 01                	push   $0x1
    1ce1:	e8 5a 1d 00 00       	call   3a40 <printf>
      exit();
    1ce6:	e8 d7 1b 00 00       	call   38c2 <exit>
    printf(1, "bigdir create failed\n");
    1ceb:	83 ec 08             	sub    $0x8,%esp
    1cee:	68 60 44 00 00       	push   $0x4460
    1cf3:	6a 01                	push   $0x1
    1cf5:	e8 46 1d 00 00       	call   3a40 <printf>
    exit();
...
00001d00 <subdir>:
{
  ...
  printf(1, "subdir test\n");
    1d07:	68 aa 44 00 00       	push   $0x44aa
    1d0c:	6a 01                	push   $0x1
    1d0e:	e8 2d 1d 00 00       	call   3a40 <printf>
  unlink("ff");
    1d13:	c7 04 24 33 45 00 00 	movl   $0x4533,(%esp)
    1d1a:	e8 f3 1b 00 00       	call   3912 <unlink>
  if(mkdir("dd") != 0){
    1d1f:	c7 04 24 d0 45 00 00 	movl   $0x45d0,(%esp)
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d3e:	68 09 45 00 00       	push   $0x4509
  ...
  write(fd, "ff", 2);
    ...
    1d58:	6a 02                	push   $0x2
    1d5a:	68 33 45 00 00       	push   $0x4533
    1d5f:	50                   	push   %eax
  ...
  if(unlink("dd") >= 0){
    1d6d:	c7 04 24 d0 45 00 00 	movl   $0x45d0,(%esp)
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1d87:	68 e4 44 00 00       	push   $0x44e4
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1da4:	68 06 45 00 00       	push   $0x4506
  ...
  write(fd, "FF", 2);
    ...
    1dbe:	6a 02                	push   $0x2
    1dc0:	68 27 45 00 00       	push   $0x4527
    1dc5:	50                   	push   %eax
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1dd4:	5a                   	pop    %edx
    1dd5:	6a 00                	push   $0x0
    1dd7:	68 2a 45 00 00       	push   $0x452a
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1e23:	5b                   	pop    %ebx
    1e24:	58                   	pop    %eax
    1e25:	68 6a 45 00 00       	push   $0x456a
    1e2a:	68 06 45 00 00       	push   $0x4506
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1e42:	68 06 45 00 00       	push   $0x4506
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1e5a:	6a 00                	push   $0x0
    1e5c:	68 06 45 00 00       	push   $0x4506
  ...
  if(chdir("dd") != 0){
    ...
    1e74:	68 d0 45 00 00       	push   $0x45d0
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1e8c:	68 9e 45 00 00       	push   $0x459e
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1ea4:	68 c4 45 00 00       	push   $0x45c4
  ...
  if(chdir("./..") != 0){
    ...
    1ebc:	68 d3 45 00 00       	push   $0x45d3
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1ed4:	6a 00                	push   $0x0
    1ed6:	68 6a 45 00 00       	push   $0x456a
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1f16:	5b                   	pop    %ebx
    1f17:	6a 00                	push   $0x0
    1f19:	68 06 45 00 00       	push   $0x4506
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f36:	68 1e 46 00 00       	push   $0x461e
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f53:	68 43 46 00 00       	push   $0x4643
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1f70:	68 d0 45 00 00       	push   $0x45d0
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1f88:	6a 02                	push   $0x2
    1f8a:	68 d0 45 00 00       	push   $0x45d0
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1fa2:	6a 01                	push   $0x1
    1fa4:	68 d0 45 00 00       	push   $0x45d0
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1fbc:	68 b2 46 00 00       	push   $0x46b2
    1fc1:	68 1e 46 00 00       	push   $0x461e
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    1fd9:	68 b2 46 00 00       	push   $0x46b2
    1fde:	68 43 46 00 00       	push   $0x4643
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    1ff6:	68 6a 45 00 00       	push   $0x456a
    1ffb:	68 09 45 00 00       	push   $0x4509
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    2013:	68 1e 46 00 00       	push   $0x461e
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    202b:	68 43 46 00 00       	push   $0x4643
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2043:	68 6a 45 00 00       	push   $0x456a
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    205b:	68 43 46 00 00       	push   $0x4643
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2073:	68 1e 46 00 00       	push   $0x461e
  ...
  if(chdir("dd/ff") == 0){
    ...
    208b:	68 09 45 00 00       	push   $0x4509
  ...
  if(chdir("dd/xx") == 0){
    ...
    20a3:	68 b5 46 00 00       	push   $0x46b5
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    20bb:	68 6a 45 00 00       	push   $0x456a
  ...
  if(unlink("dd/ff") != 0){
    ...
    20d3:	68 09 45 00 00       	push   $0x4509
  ...
  if(unlink("dd") == 0){
    ...
    20eb:	68 d0 45 00 00       	push   $0x45d0
  ...
  if(unlink("dd/dd") < 0){
    ...
    2103:	68 e5 44 00 00       	push   $0x44e5
  ...
  if(unlink("dd") < 0){
    ...
    211b:	68 d0 45 00 00       	push   $0x45d0
  ...
  printf(1, "subdir ok\n");
    ...
    2133:	68 b2 47 00 00       	push   $0x47b2
    2138:	6a 01                	push   $0x1
    213a:	e8 01 19 00 00       	call   3a40 <printf>
}
    ...
    2147:	50                   	push   %eax
    2148:	50                   	push   %eax
    2149:	68 4f 45 00 00       	push   $0x454f
    214e:	6a 01                	push   $0x1
    2150:	e8 eb 18 00 00       	call   3a40 <printf>
    exit();
    2155:	e8 68 17 00 00       	call   38c2 <exit>
    printf(1, "chdir dd/../../dd failed\n");
    215a:	50                   	push   %eax
    215b:	50                   	push   %eax
    215c:	68 aa 45 00 00       	push   $0x45aa
    2161:	6a 01                	push   $0x1
    2163:	e8 d8 18 00 00       	call   3a40 <printf>
    exit();
    2168:	e8 55 17 00 00       	call   38c2 <exit>
    printf(1, "unlink dd/dd/ff failed\n");
    216d:	52                   	push   %edx
    216e:	52                   	push   %edx
    216f:	68 75 45 00 00       	push   $0x4575
    2174:	6a 01                	push   $0x1
    2176:	e8 c5 18 00 00       	call   3a40 <printf>
    exit();
    217b:	e8 42 17 00 00       	call   38c2 <exit>
    printf(1, "create dd/ff/ff succeeded!\n");
    2180:	50                   	push   %eax
    2181:	50                   	push   %eax
    2182:	68 27 46 00 00       	push   $0x4627
    2187:	6a 01                	push   $0x1
    2189:	e8 b2 18 00 00       	call   3a40 <printf>
    exit();
    218e:	e8 2f 17 00 00       	call   38c2 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded!\n");
    2193:	52                   	push   %edx
    2194:	52                   	push   %edx
    2195:	68 0c 50 00 00       	push   $0x500c
    219a:	6a 01                	push   $0x1
    219c:	e8 9f 18 00 00       	call   3a40 <printf>
    exit();
    21a1:	e8 1c 17 00 00       	call   38c2 <exit>
    printf(1, "mkdir dd/ff/ff succeeded!\n");
    21a6:	52                   	push   %edx
    21a7:	52                   	push   %edx
    21a8:	68 bb 46 00 00       	push   $0x46bb
    21ad:	6a 01                	push   $0x1
    21af:	e8 8c 18 00 00       	call   3a40 <printf>
    exit();
    21b4:	e8 09 17 00 00       	call   38c2 <exit>
    printf(1, "link dd/ff dd/dd/ffff succeeded!\n");
    21b9:	51                   	push   %ecx
    21ba:	51                   	push   %ecx
    21bb:	68 7c 50 00 00       	push   $0x507c
    21c0:	6a 01                	push   $0x1
    21c2:	e8 79 18 00 00       	call   3a40 <printf>
    exit();
    21c7:	e8 f6 16 00 00       	call   38c2 <exit>
    printf(1, "open dd/dd/../ff failed\n");
    21cc:	50                   	push   %eax
    21cd:	50                   	push   %eax
    21ce:	68 36 45 00 00       	push   $0x4536
    21d3:	6a 01                	push   $0x1
    21d5:	e8 66 18 00 00       	call   3a40 <printf>
    exit();
    21da:	e8 e3 16 00 00       	call   38c2 <exit>
    printf(1, "create dd/dd/ff failed\n");
    21df:	51                   	push   %ecx
    21e0:	51                   	push   %ecx
    21e1:	68 0f 45 00 00       	push   $0x450f
    21e6:	6a 01                	push   $0x1
    21e8:	e8 53 18 00 00       	call   3a40 <printf>
    exit();
    21ed:	e8 d0 16 00 00       	call   38c2 <exit>
    printf(1, "chdir ./.. failed\n");
    21f2:	50                   	push   %eax
    21f3:	50                   	push   %eax
    21f4:	68 d8 45 00 00       	push   $0x45d8
    21f9:	6a 01                	push   $0x1
    21fb:	e8 40 18 00 00       	call   3a40 <printf>
    exit();
    2200:	e8 bd 16 00 00       	call   38c2 <exit>
    printf(1, "link dd/dd/ff dd/dd/ffff failed\n");
    2205:	51                   	push   %ecx
    2206:	51                   	push   %ecx
    2207:	68 c4 4f 00 00       	push   $0x4fc4
    220c:	6a 01                	push   $0x1
    220e:	e8 2d 18 00 00       	call   3a40 <printf>
    exit();
    2213:	e8 aa 16 00 00       	call   38c2 <exit>
    printf(1, "link dd/xx/ff dd/dd/xx succeeded!\n");
    2218:	53                   	push   %ebx
    2219:	53                   	push   %ebx
    221a:	68 58 50 00 00       	push   $0x5058
    221f:	6a 01                	push   $0x1
    2221:	e8 1a 18 00 00       	call   3a40 <printf>
    exit();
    2226:	e8 97 16 00 00       	call   38c2 <exit>
    printf(1, "link dd/ff/ff dd/dd/xx succeeded!\n");
    222b:	50                   	push   %eax
    222c:	50                   	push   %eax
    222d:	68 34 50 00 00       	push   $0x5034
    2232:	6a 01                	push   $0x1
    2234:	e8 07 18 00 00       	call   3a40 <printf>
    exit();
    2239:	e8 84 16 00 00       	call   38c2 <exit>
    printf(1, "open dd wronly succeeded!\n");
    223e:	50                   	push   %eax
    223f:	50                   	push   %eax
    2240:	68 97 46 00 00       	push   $0x4697
    2245:	6a 01                	push   $0x1
    2247:	e8 f4 17 00 00       	call   3a40 <printf>
    exit();
    224c:	e8 71 16 00 00       	call   38c2 <exit>
    printf(1, "open dd rdwr succeeded!\n");
    2251:	50                   	push   %eax
    2252:	50                   	push   %eax
    2253:	68 7e 46 00 00       	push   $0x467e
    2258:	6a 01                	push   $0x1
    225a:	e8 e1 17 00 00       	call   3a40 <printf>
    exit();
    225f:	e8 5e 16 00 00       	call   38c2 <exit>
    printf(1, "create dd succeeded!\n");
    2264:	50                   	push   %eax
    2265:	50                   	push   %eax
    2266:	68 68 46 00 00       	push   $0x4668
    226b:	6a 01                	push   $0x1
    226d:	e8 ce 17 00 00       	call   3a40 <printf>
    exit();
    2272:	e8 4b 16 00 00       	call   38c2 <exit>
    printf(1, "create dd/xx/ff succeeded!\n");
    2277:	50                   	push   %eax
    2278:	50                   	push   %eax
    2279:	68 4c 46 00 00       	push   $0x464c
    227e:	6a 01                	push   $0x1
    2280:	e8 bb 17 00 00       	call   3a40 <printf>
    exit();
    2285:	e8 38 16 00 00       	call   38c2 <exit>
    printf(1, "chdir dd failed\n");
    228a:	50                   	push   %eax
    228b:	50                   	push   %eax
    228c:	68 8d 45 00 00       	push   $0x458d
    2291:	6a 01                	push   $0x1
    2293:	e8 a8 17 00 00       	call   3a40 <printf>
    exit();
    2298:	e8 25 16 00 00       	call   38c2 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    229d:	50                   	push   %eax
    229e:	50                   	push   %eax
    229f:	68 e8 4f 00 00       	push   $0x4fe8
    22a4:	6a 01                	push   $0x1
    22a6:	e8 95 17 00 00       	call   3a40 <printf>
    exit();
    22ab:	e8 12 16 00 00       	call   38c2 <exit>
    printf(1, "subdir mkdir dd/dd failed\n");
    22b0:	53                   	push   %ebx
    22b1:	53                   	push   %ebx
    22b2:	68 eb 44 00 00       	push   $0x44eb
    22b7:	6a 01                	push   $0x1
    22b9:	e8 82 17 00 00       	call   3a40 <printf>
    exit();
    22be:	e8 ff 15 00 00       	call   38c2 <exit>
    printf(1, "unlink dd (non-empty dir) succeeded!\n");
    22c3:	50                   	push   %eax
    22c4:	50                   	push   %eax
    22c5:	68 9c 4f 00 00       	push   $0x4f9c
    22ca:	6a 01                	push   $0x1
    22cc:	e8 6f 17 00 00       	call   3a40 <printf>
    exit();
    22d1:	e8 ec 15 00 00       	call   38c2 <exit>
    printf(1, "create dd/ff failed\n");
    22d6:	50                   	push   %eax
    22d7:	50                   	push   %eax
    22d8:	68 cf 44 00 00       	push   $0x44cf
    22dd:	6a 01                	push   $0x1
    22df:	e8 5c 17 00 00       	call   3a40 <printf>
    exit();
    22e4:	e8 d9 15 00 00       	call   38c2 <exit>
    printf(1, "subdir mkdir dd failed\n");
    22e9:	50                   	push   %eax
    22ea:	50                   	push   %eax
    22eb:	68 b7 44 00 00       	push   $0x44b7
    22f0:	6a 01                	push   $0x1
    22f2:	e8 49 17 00 00       	call   3a40 <printf>
    exit();
    22f7:	e8 c6 15 00 00       	call   38c2 <exit>
    printf(1, "unlink dd failed\n");
    22fc:	50                   	push   %eax
    22fd:	50                   	push   %eax
    22fe:	68 a0 47 00 00       	push   $0x47a0
    2303:	6a 01                	push   $0x1
    2305:	e8 36 17 00 00       	call   3a40 <printf>
    exit();
    230a:	e8 b3 15 00 00       	call   38c2 <exit>
    printf(1, "unlink dd/dd failed\n");
    230f:	52                   	push   %edx
    2310:	52                   	push   %edx
    2311:	68 8b 47 00 00       	push   $0x478b
    2316:	6a 01                	push   $0x1
    2318:	e8 23 17 00 00       	call   3a40 <printf>
    exit();
    231d:	e8 a0 15 00 00       	call   38c2 <exit>
    printf(1, "unlink non-empty dd succeeded!\n");
    2322:	51                   	push   %ecx
    2323:	51                   	push   %ecx
    2324:	68 a0 50 00 00       	push   $0x50a0
    2329:	6a 01                	push   $0x1
    232b:	e8 10 17 00 00       	call   3a40 <printf>
    exit();
    2330:	e8 8d 15 00 00       	call   38c2 <exit>
    printf(1, "unlink dd/ff failed\n");
    2335:	53                   	push   %ebx
    2336:	53                   	push   %ebx
    2337:	68 76 47 00 00       	push   $0x4776
    233c:	6a 01                	push   $0x1
    233e:	e8 fd 16 00 00       	call   3a40 <printf>
    exit();
    2343:	e8 7a 15 00 00       	call   38c2 <exit>
    printf(1, "chdir dd/xx succeeded!\n");
    2348:	50                   	push   %eax
    2349:	50                   	push   %eax
    234a:	68 5e 47 00 00       	push   $0x475e
    234f:	6a 01                	push   $0x1
    2351:	e8 ea 16 00 00       	call   3a40 <printf>
    exit();
    2356:	e8 67 15 00 00       	call   38c2 <exit>
    printf(1, "chdir dd/ff succeeded!\n");
    235b:	50                   	push   %eax
    235c:	50                   	push   %eax
    235d:	68 46 47 00 00       	push   $0x4746
    2362:	6a 01                	push   $0x1
    2364:	e8 d7 16 00 00       	call   3a40 <printf>
    exit();
    2369:	e8 54 15 00 00       	call   38c2 <exit>
    printf(1, "unlink dd/ff/ff succeeded!\n");
    236e:	50                   	push   %eax
    236f:	50                   	push   %eax
    2370:	68 2a 47 00 00       	push   $0x472a
    2375:	6a 01                	push   $0x1
    2377:	e8 c4 16 00 00       	call   3a40 <printf>
    exit();
    237c:	e8 41 15 00 00       	call   38c2 <exit>
    printf(1, "unlink dd/xx/ff succeeded!\n");
    2381:	50                   	push   %eax
    2382:	50                   	push   %eax
    2383:	68 0e 47 00 00       	push   $0x470e
    2388:	6a 01                	push   $0x1
    238a:	e8 b1 16 00 00       	call   3a40 <printf>
    exit();
    238f:	e8 2e 15 00 00       	call   38c2 <exit>
    printf(1, "mkdir dd/dd/ffff succeeded!\n");
    2394:	50                   	push   %eax
    2395:	50                   	push   %eax
    2396:	68 f1 46 00 00       	push   $0x46f1
    239b:	6a 01                	push   $0x1
    239d:	e8 9e 16 00 00       	call   3a40 <printf>
    exit();
    23a2:	e8 1b 15 00 00       	call   38c2 <exit>
    printf(1, "mkdir dd/xx/ff succeeded!\n");
    23a7:	50                   	push   %eax
    23a8:	50                   	push   %eax
    23a9:	68 d6 46 00 00       	push   $0x46d6
    23ae:	6a 01                	push   $0x1
    23b0:	e8 8b 16 00 00       	call   3a40 <printf>
    exit();
    23b5:	e8 08 15 00 00       	call   38c2 <exit>
    printf(1, "read dd/dd/ffff wrong len\n");
    23ba:	50                   	push   %eax
    23bb:	50                   	push   %eax
    23bc:	68 03 46 00 00       	push   $0x4603
    23c1:	6a 01                	push   $0x1
    23c3:	e8 78 16 00 00       	call   3a40 <printf>
    exit();
    23c8:	e8 f5 14 00 00       	call   38c2 <exit>
    printf(1, "open dd/dd/ffff failed\n");
    23cd:	50                   	push   %eax
    23ce:	50                   	push   %eax
    23cf:	68 eb 45 00 00       	push   $0x45eb
    23d4:	6a 01                	push   $0x1
    23d6:	e8 65 16 00 00       	call   3a40 <printf>
    exit();
...
000023e0 <bigwrite>:
{
  ...
  printf(1, "bigwrite test\n");
    ...
    23ed:	68 bd 47 00 00       	push   $0x47bd
    23f2:	6a 01                	push   $0x1
    23f4:	e8 47 16 00 00       	call   3a40 <printf>
  unlink("bigwrite");
    23f9:	c7 04 24 cc 47 00 00 	movl   $0x47cc,(%esp)
    ...
    2418:	68 cc 47 00 00       	push   $0x47cc
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    unlink("bigwrite");
    2466:	c7 04 24 cc 47 00 00 	movl   $0x47cc,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    ...
    2480:	68 ff 47 00 00       	push   $0x47ff
    2485:	6a 01                	push   $0x1
    2487:	e8 b4 15 00 00       	call   3a40 <printf>
}
    ...
    2496:	50                   	push   %eax
    2497:	53                   	push   %ebx
    2498:	68 ed 47 00 00       	push   $0x47ed
    249d:	6a 01                	push   $0x1
    249f:	e8 9c 15 00 00       	call   3a40 <printf>
        exit();
    24a4:	e8 19 14 00 00       	call   38c2 <exit>
      printf(1, "cannot create bigwrite\n");
    24a9:	83 ec 08             	sub    $0x8,%esp
    24ac:	68 d5 47 00 00       	push   $0x47d5
    24b1:	6a 01                	push   $0x1
    24b3:	e8 88 15 00 00       	call   3a40 <printf>
      exit();
...
000024c0 <bigfile>:
{
  ...
  printf(1, "bigfile test\n");
    24c9:	68 0c 48 00 00       	push   $0x480c
    24ce:	6a 01                	push   $0x1
    24d0:	e8 6b 15 00 00       	call   3a40 <printf>
  unlink("bigfile");
    24d5:	c7 04 24 28 48 00 00 	movl   $0x4828,(%esp)
    24dc:	e8 31 14 00 00       	call   3912 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    24e1:	5e                   	pop    %esi
    24e2:	5f                   	pop    %edi
    24e3:	68 02 02 00 00       	push   $0x202
    24e8:	68 28 48 00 00       	push   $0x4828
  ...
  fd = open("bigfile", 0);
    ...
    254e:	5b                   	pop    %ebx
    254f:	6a 00                	push   $0x0
    2551:	68 28 48 00 00       	push   $0x4828
  ...
  unlink("bigfile");
    ...
    25d5:	68 28 48 00 00       	push   $0x4828
    25da:	e8 33 13 00 00       	call   3912 <unlink>
  printf(1, "bigfile test ok\n");
    25df:	58                   	pop    %eax
    25e0:	5a                   	pop    %edx
    25e1:	68 b7 48 00 00       	push   $0x48b7
    25e6:	6a 01                	push   $0x1
    25e8:	e8 53 14 00 00       	call   3a40 <printf>
}
    ...
    25fb:	68 84 48 00 00       	push   $0x4884
    2600:	6a 01                	push   $0x1
    2602:	e8 39 14 00 00       	call   3a40 <printf>
      exit();
    2607:	e8 b6 12 00 00       	call   38c2 <exit>
      printf(1, "short read bigfile\n");
    260c:	83 ec 08             	sub    $0x8,%esp
    260f:	68 70 48 00 00       	push   $0x4870
    2614:	6a 01                	push   $0x1
    2616:	e8 25 14 00 00       	call   3a40 <printf>
      exit();
    261b:	e8 a2 12 00 00       	call   38c2 <exit>
      printf(1, "read bigfile failed\n");
    2620:	83 ec 08             	sub    $0x8,%esp
    2623:	68 5b 48 00 00       	push   $0x485b
    2628:	6a 01                	push   $0x1
    262a:	e8 11 14 00 00       	call   3a40 <printf>
      exit();
    262f:	e8 8e 12 00 00       	call   38c2 <exit>
      printf(1, "write bigfile failed\n");
    2634:	83 ec 08             	sub    $0x8,%esp
    2637:	68 30 48 00 00       	push   $0x4830
    263c:	6a 01                	push   $0x1
    263e:	e8 fd 13 00 00       	call   3a40 <printf>
      exit();
    2643:	e8 7a 12 00 00       	call   38c2 <exit>
    printf(1, "cannot open bigfile\n");
    2648:	83 ec 08             	sub    $0x8,%esp
    264b:	68 46 48 00 00       	push   $0x4846
    2650:	6a 01                	push   $0x1
    2652:	e8 e9 13 00 00       	call   3a40 <printf>
    exit();
    2657:	e8 66 12 00 00       	call   38c2 <exit>
    printf(1, "cannot create bigfile");
    265c:	83 ec 08             	sub    $0x8,%esp
    265f:	68 1a 48 00 00       	push   $0x481a
    2664:	6a 01                	push   $0x1
    2666:	e8 d5 13 00 00       	call   3a40 <printf>
    exit();
    266b:	e8 52 12 00 00       	call   38c2 <exit>
    printf(1, "read bigfile wrong total\n");
    2670:	83 ec 08             	sub    $0x8,%esp
    2673:	68 9d 48 00 00       	push   $0x489d
    2678:	6a 01                	push   $0x1
    267a:	e8 c1 13 00 00       	call   3a40 <printf>
    exit();
...
00002690 <fourteen>:
{
  ...
  printf(1, "fourteen test\n");
    2696:	68 c8 48 00 00       	push   $0x48c8
    269b:	6a 01                	push   $0x1
    269d:	e8 9e 13 00 00       	call   3a40 <printf>
  if(mkdir("12345678901234") != 0){
    26a2:	c7 04 24 03 49 00 00 	movl   $0x4903,(%esp)
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    26bc:	68 c0 50 00 00       	push   $0x50c0
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26d9:	68 10 51 00 00       	push   $0x5110
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    26f8:	5a                   	pop    %edx
    26f9:	6a 00                	push   $0x0
    26fb:	68 80 51 00 00       	push   $0x5180
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    2715:	c7 04 24 f4 48 00 00 	movl   $0x48f4,(%esp)
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    272b:	68 1c 52 00 00       	push   $0x521c
  ...
  printf(1, "fourteen ok\n");
    ...
    273f:	68 12 49 00 00       	push   $0x4912
    2744:	6a 01                	push   $0x1
    2746:	e8 f5 12 00 00       	call   3a40 <printf>
}
    ...
    2750:	50                   	push   %eax
    2751:	50                   	push   %eax
    2752:	68 d7 48 00 00       	push   $0x48d7
    2757:	6a 01                	push   $0x1
    2759:	e8 e2 12 00 00       	call   3a40 <printf>
    exit();
    275e:	e8 5f 11 00 00       	call   38c2 <exit>
    printf(1, "mkdir 12345678901234/123456789012345 succeeded!\n");
    2763:	50                   	push   %eax
    2764:	50                   	push   %eax
    2765:	68 3c 52 00 00       	push   $0x523c
    276a:	6a 01                	push   $0x1
    276c:	e8 cf 12 00 00       	call   3a40 <printf>
    exit();
    2771:	e8 4c 11 00 00       	call   38c2 <exit>
    printf(1, "mkdir 12345678901234/12345678901234 succeeded!\n");
    2776:	52                   	push   %edx
    2777:	52                   	push   %edx
    2778:	68 ec 51 00 00       	push   $0x51ec
    277d:	6a 01                	push   $0x1
    277f:	e8 bc 12 00 00       	call   3a40 <printf>
    exit();
    2784:	e8 39 11 00 00       	call   38c2 <exit>
    printf(1, "open 12345678901234/12345678901234/12345678901234 failed\n");
    2789:	51                   	push   %ecx
    278a:	51                   	push   %ecx
    278b:	68 b0 51 00 00       	push   $0x51b0
    2790:	6a 01                	push   $0x1
    2792:	e8 a9 12 00 00       	call   3a40 <printf>
    exit();
    2797:	e8 26 11 00 00       	call   38c2 <exit>
    printf(1, "create 123456789012345/123456789012345/123456789012345 failed\n");
    279c:	51                   	push   %ecx
    279d:	51                   	push   %ecx
    279e:	68 40 51 00 00       	push   $0x5140
    27a3:	6a 01                	push   $0x1
    27a5:	e8 96 12 00 00       	call   3a40 <printf>
    exit();
    27aa:	e8 13 11 00 00       	call   38c2 <exit>
    printf(1, "mkdir 12345678901234/123456789012345 failed\n");
    27af:	50                   	push   %eax
    27b0:	50                   	push   %eax
    27b1:	68 e0 50 00 00       	push   $0x50e0
    27b6:	6a 01                	push   $0x1
    27b8:	e8 83 12 00 00       	call   3a40 <printf>
    exit();
...
000027d0 <rmdot>:
{
  ...
  printf(1, "rmdot test\n");
    27d6:	68 1f 49 00 00       	push   $0x491f
    27db:	6a 01                	push   $0x1
    27dd:	e8 5e 12 00 00       	call   3a40 <printf>
  if(mkdir("dots") != 0){
    27e2:	c7 04 24 2b 49 00 00 	movl   $0x492b,(%esp)
  ...
  if(chdir("dots") != 0){
    ...
    27fc:	68 2b 49 00 00       	push   $0x492b
  ...
  if(unlink(".") == 0){
    ...
    2814:	68 d6 45 00 00       	push   $0x45d6
  ...
  if(unlink("..") == 0){
    ...
    282c:	68 d5 45 00 00       	push   $0x45d5
  ...
  if(chdir("/") != 0){
    ...
    2844:	68 a9 3d 00 00       	push   $0x3da9
  ...
  if(unlink("dots/.") == 0){
    ...
    285c:	68 73 49 00 00       	push   $0x4973
  ...
  if(unlink("dots/..") == 0){
    ...
    2870:	68 91 49 00 00       	push   $0x4991
  ...
  if(unlink("dots") != 0){
    ...
    2884:	68 2b 49 00 00       	push   $0x492b
  ...
  printf(1, "rmdot ok\n");
    ...
    2898:	68 c6 49 00 00       	push   $0x49c6
    289d:	6a 01                	push   $0x1
    289f:	e8 9c 11 00 00       	call   3a40 <printf>
}
    ...
    28a9:	50                   	push   %eax
    28aa:	50                   	push   %eax
    28ab:	68 30 49 00 00       	push   $0x4930
    28b0:	6a 01                	push   $0x1
    28b2:	e8 89 11 00 00       	call   3a40 <printf>
    exit();
    28b7:	e8 06 10 00 00       	call   38c2 <exit>
    printf(1, "unlink dots failed!\n");
    28bc:	50                   	push   %eax
    28bd:	50                   	push   %eax
    28be:	68 b1 49 00 00       	push   $0x49b1
    28c3:	6a 01                	push   $0x1
    28c5:	e8 76 11 00 00       	call   3a40 <printf>
    exit();
    28ca:	e8 f3 0f 00 00       	call   38c2 <exit>
    printf(1, "unlink dots/.. worked!\n");
    28cf:	52                   	push   %edx
    28d0:	52                   	push   %edx
    28d1:	68 99 49 00 00       	push   $0x4999
    28d6:	6a 01                	push   $0x1
    28d8:	e8 63 11 00 00       	call   3a40 <printf>
    exit();
    28dd:	e8 e0 0f 00 00       	call   38c2 <exit>
    printf(1, "unlink dots/. worked!\n");
    28e2:	51                   	push   %ecx
    28e3:	51                   	push   %ecx
    28e4:	68 7a 49 00 00       	push   $0x497a
    28e9:	6a 01                	push   $0x1
    28eb:	e8 50 11 00 00       	call   3a40 <printf>
    exit();
    28f0:	e8 cd 0f 00 00       	call   38c2 <exit>
    printf(1, "chdir / failed\n");
    28f5:	50                   	push   %eax
    28f6:	50                   	push   %eax
    28f7:	68 ab 3d 00 00       	push   $0x3dab
    28fc:	6a 01                	push   $0x1
    28fe:	e8 3d 11 00 00       	call   3a40 <printf>
    exit();
    2903:	e8 ba 0f 00 00       	call   38c2 <exit>
    printf(1, "rm .. worked!\n");
    2908:	50                   	push   %eax
    2909:	50                   	push   %eax
    290a:	68 64 49 00 00       	push   $0x4964
    290f:	6a 01                	push   $0x1
    2911:	e8 2a 11 00 00       	call   3a40 <printf>
    exit();
    2916:	e8 a7 0f 00 00       	call   38c2 <exit>
    printf(1, "rm . worked!\n");
    291b:	50                   	push   %eax
    291c:	50                   	push   %eax
    291d:	68 56 49 00 00       	push   $0x4956
    2922:	6a 01                	push   $0x1
    2924:	e8 17 11 00 00       	call   3a40 <printf>
    exit();
    2929:	e8 94 0f 00 00       	call   38c2 <exit>
    printf(1, "chdir dots failed\n");
    292e:	50                   	push   %eax
    292f:	50                   	push   %eax
    2930:	68 43 49 00 00       	push   $0x4943
    2935:	6a 01                	push   $0x1
    2937:	e8 04 11 00 00       	call   3a40 <printf>
    exit();
...
00002950 <dirfile>:
{
  ...
  printf(1, "dir vs file\n");
    2957:	68 d0 49 00 00       	push   $0x49d0
    295c:	6a 01                	push   $0x1
    295e:	e8 dd 10 00 00       	call   3a40 <printf>
  fd = open("dirfile", O_CREATE);
    2963:	59                   	pop    %ecx
    2964:	5b                   	pop    %ebx
    2965:	68 00 02 00 00       	push   $0x200
    296a:	68 dd 49 00 00       	push   $0x49dd
  ...
  if(chdir("dirfile") == 0){
    2988:	c7 04 24 dd 49 00 00 	movl   $0x49dd,(%esp)
  ...
  fd = open("dirfile/xx", 0);
    ...
    29a2:	6a 00                	push   $0x0
    29a4:	68 16 4a 00 00       	push   $0x4a16
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    29c1:	68 16 4a 00 00       	push   $0x4a16
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    29d9:	68 16 4a 00 00       	push   $0x4a16
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    29f1:	68 16 4a 00 00       	push   $0x4a16
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2a09:	68 16 4a 00 00       	push   $0x4a16
    2a0e:	68 7a 4a 00 00       	push   $0x4a7a
  ...
  if(unlink("dirfile") != 0){
    ...
    2a26:	68 dd 49 00 00       	push   $0x49dd
  ...
  fd = open(".", O_RDWR);
    ...
    2a3e:	6a 02                	push   $0x2
    2a40:	68 d6 45 00 00       	push   $0x45d6
  ...
  fd = open(".", 0);
    ...
    2a58:	6a 00                	push   $0x0
    2a5a:	68 d6 45 00 00       	push   $0x45d6
  ...
  if(write(fd, "x", 1) > 0){
    2a69:	6a 01                	push   $0x1
    2a6b:	68 b9 46 00 00       	push   $0x46b9
    2a70:	50                   	push   %eax
  ...
  printf(1, "dir vs file OK\n");
    2a86:	58                   	pop    %eax
    2a87:	5a                   	pop    %edx
    2a88:	68 ad 4a 00 00       	push   $0x4aad
    2a8d:	6a 01                	push   $0x1
    2a8f:	e8 ac 0f 00 00       	call   3a40 <printf>
}
    ...
    2a9c:	50                   	push   %eax
    2a9d:	50                   	push   %eax
    2a9e:	68 21 4a 00 00       	push   $0x4a21
    2aa3:	6a 01                	push   $0x1
    2aa5:	e8 96 0f 00 00       	call   3a40 <printf>
    exit();
    2aaa:	e8 13 0e 00 00       	call   38c2 <exit>
    printf(1, "chdir dirfile succeeded!\n");
    2aaf:	50                   	push   %eax
    2ab0:	50                   	push   %eax
    2ab1:	68 fc 49 00 00       	push   $0x49fc
    2ab6:	6a 01                	push   $0x1
    2ab8:	e8 83 0f 00 00       	call   3a40 <printf>
    exit();
    2abd:	e8 00 0e 00 00       	call   38c2 <exit>
    printf(1, "create dirfile failed\n");
    2ac2:	52                   	push   %edx
    2ac3:	52                   	push   %edx
    2ac4:	68 e5 49 00 00       	push   $0x49e5
    2ac9:	6a 01                	push   $0x1
    2acb:	e8 70 0f 00 00       	call   3a40 <printf>
    exit();
    2ad0:	e8 ed 0d 00 00       	call   38c2 <exit>
    printf(1, "write . succeeded!\n");
    2ad5:	51                   	push   %ecx
    2ad6:	51                   	push   %ecx
    2ad7:	68 99 4a 00 00       	push   $0x4a99
    2adc:	6a 01                	push   $0x1
    2ade:	e8 5d 0f 00 00       	call   3a40 <printf>
    exit();
    2ae3:	e8 da 0d 00 00       	call   38c2 <exit>
    printf(1, "open . for writing succeeded!\n");
    2ae8:	53                   	push   %ebx
    2ae9:	53                   	push   %ebx
    2aea:	68 90 52 00 00       	push   $0x5290
    2aef:	6a 01                	push   $0x1
    2af1:	e8 4a 0f 00 00       	call   3a40 <printf>
    exit();
    2af6:	e8 c7 0d 00 00       	call   38c2 <exit>
    printf(1, "unlink dirfile failed!\n");
    2afb:	50                   	push   %eax
    2afc:	50                   	push   %eax
    2afd:	68 81 4a 00 00       	push   $0x4a81
    2b02:	6a 01                	push   $0x1
    2b04:	e8 37 0f 00 00       	call   3a40 <printf>
    exit();
    2b09:	e8 b4 0d 00 00       	call   38c2 <exit>
    printf(1, "link to dirfile/xx succeeded!\n");
    2b0e:	50                   	push   %eax
    2b0f:	50                   	push   %eax
    2b10:	68 70 52 00 00       	push   $0x5270
    2b15:	6a 01                	push   $0x1
    2b17:	e8 24 0f 00 00       	call   3a40 <printf>
    exit();
    2b1c:	e8 a1 0d 00 00       	call   38c2 <exit>
    printf(1, "unlink dirfile/xx succeeded!\n");
    2b21:	50                   	push   %eax
    2b22:	50                   	push   %eax
    2b23:	68 5c 4a 00 00       	push   $0x4a5c
    2b28:	6a 01                	push   $0x1
    2b2a:	e8 11 0f 00 00       	call   3a40 <printf>
    exit();
    2b2f:	e8 8e 0d 00 00       	call   38c2 <exit>
    printf(1, "mkdir dirfile/xx succeeded!\n");
    2b34:	50                   	push   %eax
    2b35:	50                   	push   %eax
    2b36:	68 3f 4a 00 00       	push   $0x4a3f
    2b3b:	6a 01                	push   $0x1
    2b3d:	e8 fe 0e 00 00       	call   3a40 <printf>
    exit();
    ...
    2b54:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name\n");
    2b5c:	68 bd 4a 00 00       	push   $0x4abd
    2b61:	6a 01                	push   $0x1
    2b63:	e8 d8 0e 00 00       	call   3a40 <printf>
    2b68:	83 c4 10             	add    $0x10,%esp
    2b6b:	90                   	nop
    2b6c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(mkdir("irefd") != 0){
    2b70:	83 ec 0c             	sub    $0xc,%esp
    2b73:	68 ce 4a 00 00       	push   $0x4ace
    ...
    2b8b:	68 ce 4a 00 00       	push   $0x4ace
    ...
    2ba3:	68 83 41 00 00       	push   $0x4183
    2ba8:	e8 7d 0d 00 00       	call   392a <mkdir>
    link("README", "");
    2bad:	59                   	pop    %ecx
    2bae:	58                   	pop    %eax
    2baf:	68 83 41 00 00       	push   $0x4183
    2bb4:	68 7a 4a 00 00       	push   $0x4a7a
    2bb9:	e8 64 0d 00 00       	call   3922 <link>
    fd = open("", O_CREATE);
    2bbe:	58                   	pop    %eax
    2bbf:	5a                   	pop    %edx
    2bc0:	68 00 02 00 00       	push   $0x200
    2bc5:	68 83 41 00 00       	push   $0x4183
    ...
    2bea:	68 b8 46 00 00       	push   $0x46b8
    ...
    2c0a:	68 b8 46 00 00       	push   $0x46b8
  ...
  chdir("/");
    ...
    2c23:	68 a9 3d 00 00       	push   $0x3da9
    2c28:	e8 05 0d 00 00       	call   3932 <chdir>
  printf(1, "empty file name OK\n");
    2c2d:	58                   	pop    %eax
    2c2e:	5a                   	pop    %edx
    2c2f:	68 fc 4a 00 00       	push   $0x4afc
    2c34:	6a 01                	push   $0x1
    2c36:	e8 05 0e 00 00       	call   3a40 <printf>
}
    ...
    2c46:	68 d4 4a 00 00       	push   $0x4ad4
    2c4b:	6a 01                	push   $0x1
    2c4d:	e8 ee 0d 00 00       	call   3a40 <printf>
      exit();
    2c52:	e8 6b 0c 00 00       	call   38c2 <exit>
      printf(1, "chdir irefd failed\n");
    2c57:	83 ec 08             	sub    $0x8,%esp
    2c5a:	68 e8 4a 00 00       	push   $0x4ae8
    2c5f:	6a 01                	push   $0x1
    2c61:	e8 da 0d 00 00       	call   3a40 <printf>
      exit();
    ...
    2c74:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fork test\n");
    2c79:	68 10 4b 00 00       	push   $0x4b10
    2c7e:	6a 01                	push   $0x1
    2c80:	e8 bb 0d 00 00       	call   3a40 <printf>
  ...
  printf(1, "fork test OK\n");
    ...
    2ccb:	68 42 4b 00 00       	push   $0x4b42
    2cd0:	6a 01                	push   $0x1
    2cd2:	e8 69 0d 00 00       	call   3a40 <printf>
}
    ...
    2ce3:	68 b0 52 00 00       	push   $0x52b0
    2ce8:	6a 01                	push   $0x1
    2cea:	e8 51 0d 00 00       	call   3a40 <printf>
    exit();
    ...
    2cfc:	68 1b 4b 00 00       	push   $0x4b1b
    2d01:	6a 01                	push   $0x1
    2d03:	e8 38 0d 00 00       	call   3a40 <printf>
      exit();
    2d08:	e8 b5 0b 00 00       	call   38c2 <exit>
    printf(1, "wait got too many\n");
    2d0d:	83 ec 08             	sub    $0x8,%esp
    2d10:	68 2f 4b 00 00       	push   $0x4b2f
    2d15:	6a 01                	push   $0x1
    2d17:	e8 24 0d 00 00       	call   3a40 <printf>
    exit();
    ...
    2d36:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "sbrk test\n");
    2d3b:	68 50 4b 00 00       	push   $0x4b50
  ...
  *lastaddr = 99;
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    2faa:	68 f8 4b 00 00       	push   $0x4bf8
    2faf:	ff 35 f8 5d 00 00    	pushl  0x5df8
    2fb5:	e8 86 0a 00 00       	call   3a40 <printf>
}
    ...
    2fe1:	6a 01                	push   $0x1
    2fe3:	68 b9 46 00 00       	push   $0x46b9
    ...
    300e:	53                   	push   %ebx
    300f:	56                   	push   %esi
    3010:	68 5b 4b 00 00       	push   $0x4b5b
    3015:	ff 35 f8 5d 00 00    	pushl  0x5df8
    301b:	e8 20 0a 00 00       	call   3a40 <printf>
      exit();
    3020:	83 c4 20             	add    $0x20,%esp
    3023:	e8 9a 08 00 00       	call   38c2 <exit>
    printf(stdout, "failed sbrk leaked memory\n");
    3028:	83 ec 08             	sub    $0x8,%esp
    302b:	68 dd 4b 00 00       	push   $0x4bdd
    3030:	ff 35 f8 5d 00 00    	pushl  0x5df8
    3036:	e8 05 0a 00 00       	call   3a40 <printf>
    exit();
    303b:	e8 82 08 00 00       	call   38c2 <exit>
    printf(1, "pipe() failed\n");
    3040:	83 ec 08             	sub    $0x8,%esp
    3043:	68 99 40 00 00       	push   $0x4099
    3048:	6a 01                	push   $0x1
    304a:	e8 f1 09 00 00       	call   3a40 <printf>
    exit();
    ...
    3057:	50                   	push   %eax
    3058:	53                   	push   %ebx
    3059:	68 c4 4b 00 00       	push   $0x4bc4
    305e:	ff 35 f8 5d 00 00    	pushl  0x5df8
    3064:	e8 d7 09 00 00       	call   3a40 <printf>
      kill(ppid);
    ...
    3079:	68 a1 4c 00 00       	push   $0x4ca1
    307e:	ff 35 f8 5d 00 00    	pushl  0x5df8
    3084:	e8 b7 09 00 00       	call   3a40 <printf>
      exit();
    3089:	e8 34 08 00 00       	call   38c2 <exit>
    printf(stdout, "sbrk downsize failed, a %x c %x\n", a, c);
    308e:	50                   	push   %eax
    308f:	53                   	push   %ebx
    3090:	68 a4 53 00 00       	push   $0x53a4
    3095:	ff 35 f8 5d 00 00    	pushl  0x5df8
    309b:	e8 a0 09 00 00       	call   3a40 <printf>
    exit();
    30a0:	e8 1d 08 00 00       	call   38c2 <exit>
    printf(stdout, "sbrk de-allocation didn't really deallocate\n");
    30a5:	83 ec 08             	sub    $0x8,%esp
    30a8:	68 74 53 00 00       	push   $0x5374
    30ad:	ff 35 f8 5d 00 00    	pushl  0x5df8
    30b3:	e8 88 09 00 00       	call   3a40 <printf>
    exit();
    30b8:	e8 05 08 00 00       	call   38c2 <exit>
    printf(stdout, "sbrk re-allocation failed, a %x c %x\n", a, c);
    30bd:	56                   	push   %esi
    30be:	53                   	push   %ebx
    30bf:	68 4c 53 00 00       	push   $0x534c
    30c4:	ff 35 f8 5d 00 00    	pushl  0x5df8
    30ca:	e8 71 09 00 00       	call   3a40 <printf>
    exit();
    30cf:	e8 ee 07 00 00       	call   38c2 <exit>
    printf(stdout, "sbrk deallocation produced wrong address, a %x c %x\n", a, c);
    30d4:	50                   	push   %eax
    30d5:	53                   	push   %ebx
    30d6:	68 14 53 00 00       	push   $0x5314
    30db:	ff 35 f8 5d 00 00    	pushl  0x5df8
    30e1:	e8 5a 09 00 00       	call   3a40 <printf>
    exit();
    30e6:	e8 d7 07 00 00       	call   38c2 <exit>
    printf(stdout, "sbrk could not deallocate\n");
    30eb:	83 ec 08             	sub    $0x8,%esp
    30ee:	68 a9 4b 00 00       	push   $0x4ba9
    30f3:	ff 35 f8 5d 00 00    	pushl  0x5df8
    30f9:	e8 42 09 00 00       	call   3a40 <printf>
    exit();
    30fe:	e8 bf 07 00 00       	call   38c2 <exit>
    printf(stdout, "sbrk test failed to grow big address space; enough phys mem?\n");
    3103:	83 ec 08             	sub    $0x8,%esp
    3106:	68 d4 52 00 00       	push   $0x52d4
    310b:	ff 35 f8 5d 00 00    	pushl  0x5df8
    3111:	e8 2a 09 00 00       	call   3a40 <printf>
    exit();
    ...
    3123:	68 8d 4b 00 00       	push   $0x4b8d
    3128:	ff 35 f8 5d 00 00    	pushl  0x5df8
    312e:	e8 0d 09 00 00       	call   3a40 <printf>
    exit();
    3133:	e8 8a 07 00 00       	call   38c2 <exit>
    printf(stdout, "sbrk test fork failed\n");
    3138:	83 ec 08             	sub    $0x8,%esp
    313b:	68 76 4b 00 00       	push   $0x4b76
    3140:	ff 35 f8 5d 00 00    	pushl  0x5df8
    3146:	e8 f5 08 00 00       	call   3a40 <printf>
    exit();
...
00003160 <validatetest>:
{
  ...
  printf(stdout, "validate test\n");
    ...
    316a:	68 06 4c 00 00       	push   $0x4c06
    316f:	ff 35 f8 5d 00 00    	pushl  0x5df8
    3175:	e8 c6 08 00 00       	call   3a40 <printf>
    ...
    31af:	5a                   	pop    %edx
    31b0:	53                   	push   %ebx
    31b1:	68 15 4c 00 00       	push   $0x4c15
  ...
  printf(stdout, "validate ok\n");
    ...
    31d4:	68 39 4c 00 00       	push   $0x4c39
    31d9:	ff 35 f8 5d 00 00    	pushl  0x5df8
    31df:	e8 5c 08 00 00       	call   3a40 <printf>
}
    ...
    31f6:	68 20 4c 00 00       	push   $0x4c20
    31fb:	ff 35 f8 5d 00 00    	pushl  0x5df8
    3201:	e8 3a 08 00 00       	call   3a40 <printf>
      exit();
...
00003210 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    3216:	68 46 4c 00 00       	push   $0x4c46
    321b:	ff 35 f8 5d 00 00    	pushl  0x5df8
    3221:	e8 1a 08 00 00       	call   3a40 <printf>
    if(uninit[i] != '\0'){
    3226:	83 c4 10             	add    $0x10,%esp
    3229:	80 3d c0 5e 00 00 00 	cmpb   $0x0,0x5ec0
    ...
    3240:	80 b8 c0 5e 00 00 00 	cmpb   $0x0,0x5ec0(%eax)
  ...
  printf(stdout, "bss test ok\n");
    ...
    3256:	68 61 4c 00 00       	push   $0x4c61
    325b:	ff 35 f8 5d 00 00    	pushl  0x5df8
    3261:	e8 da 07 00 00       	call   3a40 <printf>
}
    ...
    326e:	68 50 4c 00 00       	push   $0x4c50
    3273:	ff 35 f8 5d 00 00    	pushl  0x5df8
    3279:	e8 c2 07 00 00       	call   3a40 <printf>
      exit();
...
00003290 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    3296:	68 6e 4c 00 00       	push   $0x4c6e
  ...
  fd = open("bigarg-ok", 0);
    ...
    32ba:	6a 00                	push   $0x0
    32bc:	68 6e 4c 00 00       	push   $0x4c6e
  ...
  unlink("bigarg-ok");
    32da:	c7 04 24 6e 4c 00 00 	movl   $0x4c6e,(%esp)
    32e1:	e8 2c 06 00 00       	call   3912 <unlink>
}
    32e6:	83 c4 10             	add    $0x10,%esp
    32e9:	c9                   	leave  
    32ea:	c3                   	ret    
    32eb:	b8 20 5e 00 00       	mov    $0x5e20,%eax
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    32f0:	c7 00 c8 53 00 00    	movl   $0x53c8,(%eax)
    32f6:	83 c0 04             	add    $0x4,%eax
    for(i = 0; i < MAXARG-1; i++)
    32f9:	3d 9c 5e 00 00       	cmp    $0x5e9c,%eax
    32fe:	75 f0                	jne    32f0 <bigargtest+0x60>
    printf(stdout, "bigarg test\n");
    3300:	51                   	push   %ecx
    3301:	51                   	push   %ecx
    3302:	68 78 4c 00 00       	push   $0x4c78
    3307:	ff 35 f8 5d 00 00    	pushl  0x5df8
    args[MAXARG-1] = 0;
    330d:	c7 05 9c 5e 00 00 00 	movl   $0x0,0x5e9c
    3314:	00 00 00 
    printf(stdout, "bigarg test\n");
    3317:	e8 24 07 00 00       	call   3a40 <printf>
    exec("echo", args);
    331c:	58                   	pop    %eax
    331d:	5a                   	pop    %edx
    331e:	68 20 5e 00 00       	push   $0x5e20
    3323:	68 45 3e 00 00       	push   $0x3e45
    3328:	e8 cd 05 00 00       	call   38fa <exec>
    printf(stdout, "bigarg test ok\n");
    332d:	59                   	pop    %ecx
    332e:	58                   	pop    %eax
    332f:	68 85 4c 00 00       	push   $0x4c85
    3334:	ff 35 f8 5d 00 00    	pushl  0x5df8
    333a:	e8 01 07 00 00       	call   3a40 <printf>
    fd = open("bigarg-ok", O_CREATE);
    333f:	58                   	pop    %eax
    3340:	5a                   	pop    %edx
    3341:	68 00 02 00 00       	push   $0x200
    3346:	68 6e 4c 00 00       	push   $0x4c6e
    ...
    335d:	50                   	push   %eax
    335e:	50                   	push   %eax
    335f:	68 ae 4c 00 00       	push   $0x4cae
    3364:	ff 35 f8 5d 00 00    	pushl  0x5df8
    336a:	e8 d1 06 00 00       	call   3a40 <printf>
    exit();
    336f:	e8 4e 05 00 00       	call   38c2 <exit>
    printf(stdout, "bigargtest: fork failed\n");
    3374:	52                   	push   %edx
    3375:	52                   	push   %edx
    3376:	68 95 4c 00 00       	push   $0x4c95
    337b:	ff 35 f8 5d 00 00    	pushl  0x5df8
    3381:	e8 ba 06 00 00       	call   3a40 <printf>
    exit();
    ...
    3396:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fsfull test\n");
    339b:	68 c3 4c 00 00       	push   $0x4cc3
    33a0:	6a 01                	push   $0x1
    33a2:	e8 99 06 00 00       	call   3a40 <printf>
    ...
    3438:	50                   	push   %eax
    3439:	68 d0 4c 00 00       	push   $0x4cd0
    343e:	6a 01                	push   $0x1
    3440:	e8 fb 05 00 00       	call   3a40 <printf>
    ...
    3472:	68 e0 85 00 00       	push   $0x85e0
    3477:	57                   	push   %edi
    ...
    348a:	56                   	push   %esi
    348b:	68 ec 4c 00 00       	push   $0x4cec
    3490:	6a 01                	push   $0x1
    3492:	e8 a9 05 00 00       	call   3a40 <printf>
    close(fd);
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    34b4:	50                   	push   %eax
    34b5:	68 dc 4c 00 00       	push   $0x4cdc
    34ba:	6a 01                	push   $0x1
    34bc:	e8 7f 05 00 00       	call   3a40 <printf>
      break;
  ...
  printf(1, "fsfull test finished\n");
    ...
    3568:	68 fc 4c 00 00       	push   $0x4cfc
    356d:	6a 01                	push   $0x1
    356f:	e8 cc 04 00 00       	call   3a40 <printf>
}
...
00003580 <uio>:
{
  ...
  printf(1, "uio test\n");
    3586:	68 12 4d 00 00       	push   $0x4d12
    358b:	6a 01                	push   $0x1
  ...
  printf(1, "uio test done\n");
    ...
    35a8:	68 1c 4d 00 00       	push   $0x4d1c
    35ad:	6a 01                	push   $0x1
    ...
    35dd:	50                   	push   %eax
    35de:	50                   	push   %eax
    35df:	68 a1 4c 00 00       	push   $0x4ca1
    35e4:	6a 01                	push   $0x1
...
000035f0 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    35f7:	6a 00                	push   $0x0
    35f9:	68 2b 4d 00 00       	push   $0x4d2b
  ...
  printf(1, "arg test passed\n");
    362d:	58                   	pop    %eax
    362e:	5a                   	pop    %edx
    362f:	68 3d 4d 00 00       	push   $0x4d3d
    3634:	6a 01                	push   $0x1
    ...
    3643:	51                   	push   %ecx
    3644:	51                   	push   %ecx
    3645:	68 30 4d 00 00       	push   $0x4d30
    364a:	6a 02                	push   $0x2
...
00003660 <rand>:
  randstate = randstate * 1664525 + 1013904223;
    3660:	69 05 f4 5d 00 00 0d 	imul   $0x19660d,0x5df4,%eax
    3667:	66 19 00 
{
    366a:	55                   	push   %ebp
  ...
  randstate = randstate * 1664525 + 1013904223;
    ...
    3673:	a3 f4 5d 00 00       	mov    %eax,0x5df4
}
    3678:	c3                   	ret    
...
00003982 <ps>:
SYSCALL(ps)
    3982:	b8 1a 00 00 00       	mov    $0x1a,%eax
    3987:	cd 40                	int    $0x40
    3989:	c3                   	ret    

0000398a <list_containers>:
SYSCALL(list_containers)
    398a:	b8 1b 00 00 00       	mov    $0x1b,%eax
    398f:	cd 40                	int    $0x40
    3991:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  while(--i >= 0)
    3a01:	8d 79 ff             	lea    -0x1(%ecx),%edi
    3a04:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    3a08:	0f b6 44 3d d8       	movzbl -0x28(%ebp,%edi,1),%eax
  write(fd, &c, 1);
    3a0d:	83 ec 04             	sub    $0x4,%esp
  while(--i >= 0)
    3a10:	83 ef 01             	sub    $0x1,%edi
  write(fd, &c, 1);
    3a13:	6a 01                	push   $0x1
    3a15:	53                   	push   %ebx
    3a16:	56                   	push   %esi
    3a17:	88 45 d7             	mov    %al,-0x29(%ebp)
    3a1a:	e8 c3 fe ff ff       	call   38e2 <write>
  while(--i >= 0)
    3a1f:	83 c4 10             	add    $0x10,%esp
    3a22:	83 ff ff             	cmp    $0xffffffff,%edi
    3a25:	75 e1                	jne    3a08 <printint+0x68>
    putc(fd, buf[i]);
}
    3a27:	8d 65 f4             	lea    -0xc(%ebp),%esp
    3a2a:	5b                   	pop    %ebx
    3a2b:	5e                   	pop    %esi
    3a2c:	5f                   	pop    %edi
    3a2d:	5d                   	pop    %ebp
    ...
    3a4c:	8b 75 0c             	mov    0xc(%ebp),%esi
{
  ...
  write(fd, &c, 1);
    ...
    3a88:	50                   	push   %eax
    3a89:	57                   	push   %edi
    3a8a:	e8 53 fe ff ff       	call   38e2 <write>
  ...
  write(fd, &c, 1);
    ...
    3aea:	50                   	push   %eax
    3aeb:	57                   	push   %edi
    3aec:	e8 f1 fd ff ff       	call   38e2 <write>
    ...
    3b01:	e8 dc fd ff ff       	call   38e2 <write>
  for(i = 0; fmt[i]; i++){
  ...
  for(i = 0; fmt[i]; i++){
    ...
    3b5d:	74 7c                	je     3bdb <printf+0x19b>
        while(*s != 0){
    3b5f:	0f b6 03             	movzbl (%ebx),%eax
    3b62:	84 c0                	test   %al,%al
    3b64:	74 29                	je     3b8f <printf+0x14f>
  ...
  write(fd, &c, 1);
    3b7e:	50                   	push   %eax
    3b7f:	57                   	push   %edi
    3b80:	e8 5d fd ff ff       	call   38e2 <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    ...
    3bcf:	50                   	push   %eax
    3bd0:	57                   	push   %edi
    3bd1:	e8 0c fd ff ff       	call   38e2 <write>
    3bd6:	e9 5b ff ff ff       	jmp    3b36 <printf+0xf6>
        while(*s != 0){
    3bdb:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
    3be0:	bb f8 54 00 00       	mov    $0x54f8,%ebx
    3be5:	eb 89                	jmp    3b70 <printf+0x130>
    3be7:	66 90                	xchg   %ax,%ax
    3be9:	66 90                	xchg   %ax,%ax
    3beb:	66 90                	xchg   %ax,%ax
    3bed:	66 90                	xchg   %ax,%ax
    3bef:	90                   	nop
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3bf1:	a1 a0 5e 00 00       	mov    0x5ea0,%eax
{
  ...
  bp = (Header*)ap - 1;
    3c00:	8d 4b f8             	lea    -0x8(%ebx),%ecx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3c03:	39 c8                	cmp    %ecx,%eax
    3c05:	73 19                	jae    3c20 <free+0x30>
    3c07:	89 f6                	mov    %esi,%esi
    3c09:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    3c10:	39 d1                	cmp    %edx,%ecx
    3c12:	72 1c                	jb     3c30 <free+0x40>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    3c14:	39 d0                	cmp    %edx,%eax
    3c16:	73 18                	jae    3c30 <free+0x40>
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3c1e:	72 f0                	jb     3c10 <free+0x20>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    3c20:	39 d0                	cmp    %edx,%eax
    3c22:	72 f4                	jb     3c18 <free+0x28>
    3c24:	39 d1                	cmp    %edx,%ecx
    3c26:	73 f0                	jae    3c18 <free+0x28>
    3c28:	90                   	nop
    3c29:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      break;
  if(bp + bp->s.size == p->s.ptr){
    3c30:	8b 73 fc             	mov    -0x4(%ebx),%esi
    3c33:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    3c36:	39 fa                	cmp    %edi,%edx
    3c38:	74 19                	je     3c53 <free+0x63>
  ...
  if(p + p->s.size == bp){
    ...
    3c45:	74 23                	je     3c6a <free+0x7a>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
  } else
    p->s.ptr = bp;
    3c47:	89 08                	mov    %ecx,(%eax)
  freep = p;
    3c49:	a3 a0 5e 00 00       	mov    %eax,0x5ea0
}
    3c4e:	5b                   	pop    %ebx
    3c4f:	5e                   	pop    %esi
    3c50:	5f                   	pop    %edi
    ...
    3c52:	c3                   	ret    
    bp->s.size += p->s.ptr->s.size;
    3c53:	03 72 04             	add    0x4(%edx),%esi
    3c56:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
    3c59:	8b 10                	mov    (%eax),%edx
    3c5b:	8b 12                	mov    (%edx),%edx
    3c5d:	89 53 f8             	mov    %edx,-0x8(%ebx)
  if(p + p->s.size == bp){
    3c60:	8b 50 04             	mov    0x4(%eax),%edx
    3c63:	8d 34 d0             	lea    (%eax,%edx,8),%esi
    3c66:	39 f1                	cmp    %esi,%ecx
    3c68:	75 dd                	jne    3c47 <free+0x57>
    p->s.size += bp->s.size;
    3c6a:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
    3c6d:	a3 a0 5e 00 00       	mov    %eax,0x5ea0
    p->s.size += bp->s.size;
    3c72:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    3c75:	8b 53 f8             	mov    -0x8(%ebx),%edx
    3c78:	89 10                	mov    %edx,(%eax)
}
    3c7a:	5b                   	pop    %ebx
    3c7b:	5e                   	pop    %esi
    3c7c:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3c8c:	8b 15 a0 5e 00 00    	mov    0x5ea0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  if((prevp = freep) == 0){
    ...
    3c9d:	0f 84 93 00 00 00    	je     3d36 <malloc+0xb6>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    3caa:	76 64                	jbe    3d10 <malloc+0x90>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    3ccf:	76 3f                	jbe    3d10 <malloc+0x90>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
  ...
  return freep;
    ...
    3d0a:	eb 1c                	jmp    3d28 <malloc+0xa8>
    3d0c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      if(p->s.size == nunits)
    3d10:	39 cf                	cmp    %ecx,%edi
    3d12:	74 1c                	je     3d30 <malloc+0xb0>
        p->s.size -= nunits;
    ...
    3d34:	eb e9                	jmp    3d1f <malloc+0x9f>
    base.s.ptr = freep = prevp = &base;
    ...
    3d56:	00 00 00 
    3d59:	e9 4e ff ff ff       	jmp    3cac <malloc+0x2c>
