...
0000396a <list_containers>:
SYSCALL(list_containers)
    396a:	b8 1b 00 00 00       	mov    $0x1b,%eax
    396f:	cd 40                	int    $0x40
    3971:	c3                   	ret    

00003972 <container_malloc>:
SYSCALL(container_malloc)
    3972:	b8 1c 00 00 00       	mov    $0x1c,%eax
    3977:	cd 40                	int    $0x40
    3979:	c3                   	ret    

0000397a <scheduler_log_on>:
SYSCALL(scheduler_log_on)
    397a:	b8 1f 00 00 00       	mov    $0x1f,%eax
    397f:	cd 40                	int    $0x40
    3981:	c3                   	ret    

00003982 <scheduler_log_off>:
SYSCALL(scheduler_log_off)
    3982:	b8 20 00 00 00       	mov    $0x20,%eax
    3987:	cd 40                	int    $0x40
    3989:	c3                   	ret    

0000398a <memory_log_on>:
SYSCALL(memory_log_on)
    398a:	b8 1d 00 00 00       	mov    $0x1d,%eax
    398f:	cd 40                	int    $0x40
    3991:	c3                   	ret    

00003992 <memory_log_off>:
SYSCALL(memory_log_off)
    3992:	b8 1e 00 00 00       	mov    $0x1e,%eax
    3997:	cd 40                	int    $0x40
    3999:	c3                   	ret    
