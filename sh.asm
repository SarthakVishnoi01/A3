     ...
     489:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4ad:	50                   	push   %eax
     4ae:	68 58 18 00 00       	push   $0x1858
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4fd:	50                   	push   %eax
     4fe:	68 58 18 00 00       	push   $0x1858
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     60d:	50                   	push   %eax
     60e:	68 58 18 00 00       	push   $0x1858
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     663:	68 01 12 00 00       	push   $0x1201
     668:	53                   	push   %ebx
     669:	56                   	push   %esi
  ...
  return cmd;
     ...
     6ee:	68 e4 11 00 00       	push   $0x11e4
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     70f:	68 04 12 00 00       	push   $0x1204
     714:	57                   	push   %edi
     715:	56                   	push   %esi
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     75e:	68 1b 12 00 00       	push   $0x121b
     763:	57                   	push   %edi
     764:	56                   	push   %esi
    ...
    if(argc >= MAXARGS)
     ...
     7a8:	68 0d 12 00 00       	push   $0x120d
  ...
  cmd->eargv[argc] = 0;
     ...
     7fa:	68 06 12 00 00       	push   $0x1206
...
00000810 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     82b:	68 20 12 00 00       	push   $0x1220
     830:	56                   	push   %esi
     831:	53                   	push   %ebx
...
00000880 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     8bb:	68 22 12 00 00       	push   $0x1222
     8c0:	56                   	push   %esi
     8c1:	53                   	push   %ebx
  ...
  if(peek(ps, es, ";")){
     ...
     8d1:	68 1e 12 00 00       	push   $0x121e
     8d6:	56                   	push   %esi
     8d7:	53                   	push   %ebx
...
00000920 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     92f:	68 04 12 00 00       	push   $0x1204
     934:	56                   	push   %esi
     935:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     95b:	68 40 12 00 00       	push   $0x1240
     960:	56                   	push   %esi
     961:	53                   	push   %ebx
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     9c5:	ff 24 85 80 12 00 00 	jmp    *0x1280(,%eax,4)
...
00000a60 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a87:	68 c9 11 00 00       	push   $0x11c9
     a8c:	53                   	push   %ebx
     a8d:	50                   	push   %eax
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     aaf:	52                   	push   %edx
     ab0:	50                   	push   %eax
     ab1:	68 42 12 00 00       	push   $0x1242
     ab6:	6a 02                	push   $0x2
     ab8:	e8 d3 03 00 00       	call   e90 <printf>
    panic("syntax");
     abd:	c7 04 24 06 12 00 00 	movl   $0x1206,(%esp)
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  while(--i >= 0)
     e51:	8d 79 ff             	lea    -0x1(%ecx),%edi
     e54:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
     e58:	0f b6 44 3d d8       	movzbl -0x28(%ebp,%edi,1),%eax
  write(fd, &c, 1);
     e5d:	83 ec 04             	sub    $0x4,%esp
  while(--i >= 0)
     e60:	83 ef 01             	sub    $0x1,%edi
  write(fd, &c, 1);
     e63:	6a 01                	push   $0x1
     e65:	53                   	push   %ebx
     e66:	56                   	push   %esi
     e67:	88 45 d7             	mov    %al,-0x29(%ebp)
     e6a:	e8 c3 fe ff ff       	call   d32 <write>
  while(--i >= 0)
     e6f:	83 c4 10             	add    $0x10,%esp
     e72:	83 ff ff             	cmp    $0xffffffff,%edi
     e75:	75 e1                	jne    e58 <printint+0x68>
    putc(fd, buf[i]);
}
     ...
     e9c:	8b 75 0c             	mov    0xc(%ebp),%esi
{
  ...
  write(fd, &c, 1);
     ...
     ed8:	50                   	push   %eax
     ed9:	57                   	push   %edi
     eda:	e8 53 fe ff ff       	call   d32 <write>
  ...
  write(fd, &c, 1);
     ...
     f3a:	50                   	push   %eax
     f3b:	57                   	push   %edi
     f3c:	e8 f1 fd ff ff       	call   d32 <write>
  ...
  for(i = 0; fmt[i]; i++){
     ...
     fad:	74 7c                	je     102b <printf+0x19b>
        while(*s != 0){
     faf:	0f b6 03             	movzbl (%ebx),%eax
     fb2:	84 c0                	test   %al,%al
     fb4:	74 29                	je     fdf <printf+0x14f>
  ...
  write(fd, &c, 1);
    ...
    101f:	50                   	push   %eax
    1020:	57                   	push   %edi
    1021:	e8 0c fd ff ff       	call   d32 <write>
    1026:	e9 5b ff ff ff       	jmp    f86 <printf+0xf6>
        while(*s != 0){
    102b:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
    1030:	bb 98 12 00 00       	mov    $0x1298,%ebx
    1035:	eb 89                	jmp    fc0 <printf+0x130>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1041:	a1 c4 18 00 00       	mov    0x18c4,%eax
{
    ...
    1066:	73 18                	jae    1080 <free+0x40>
{
  ...
  freep = p;
    1099:	a3 c4 18 00 00       	mov    %eax,0x18c4
}
    109e:	5b                   	pop    %ebx
    109f:	5e                   	pop    %esi
    10a0:	5f                   	pop    %edi
  ...
  freep = p;
    10bd:	a3 c4 18 00 00       	mov    %eax,0x18c4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    10dc:	8b 15 c4 18 00 00    	mov    0x18c4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  if((prevp = freep) == 0){
    ...
    10ed:	0f 84 93 00 00 00    	je     1186 <malloc+0xb6>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    10fa:	76 64                	jbe    1160 <malloc+0x90>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    111f:	76 3f                	jbe    1160 <malloc+0x90>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
  ...
  return freep;
    ...
    115a:	eb 1c                	jmp    1178 <malloc+0xa8>
    115c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      if(p->s.size == nunits)
    1160:	39 cf                	cmp    %ecx,%edi
    1162:	74 1c                	je     1180 <malloc+0xb0>
        p->s.size -= nunits;
    ...
    1184:	eb e9                	jmp    116f <malloc+0x9f>
    base.s.ptr = freep = prevp = &base;
    ...
    11a6:	00 00 00 
    11a9:	e9 4e ff ff ff       	jmp    10fc <malloc+0x2c>
