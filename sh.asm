...
00000de2 <container_malloc>:
SYSCALL(container_malloc)
     de2:	b8 1c 00 00 00       	mov    $0x1c,%eax
     de7:	cd 40                	int    $0x40
     de9:	c3                   	ret    

00000dea <scheduler_log_on>:
SYSCALL(scheduler_log_on)
     dea:	b8 1f 00 00 00       	mov    $0x1f,%eax
     def:	cd 40                	int    $0x40
     df1:	c3                   	ret    

00000df2 <scheduler_log_off>:
SYSCALL(scheduler_log_off)
     df2:	b8 20 00 00 00       	mov    $0x20,%eax
     df7:	cd 40                	int    $0x40
     df9:	c3                   	ret    

00000dfa <memory_log_on>:
SYSCALL(memory_log_on)
     dfa:	b8 1d 00 00 00       	mov    $0x1d,%eax
     dff:	cd 40                	int    $0x40
     e01:	c3                   	ret    

00000e02 <memory_log_off>:
